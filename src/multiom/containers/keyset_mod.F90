...
#define PP_FILE_NAME 'keyset_@TEMPLATE_KEY_FNAME@_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'KEYSET_@TEMPLATE_KEY_NAME@_MOD'
MODULE KEYSET_@TEMPLATE_KEY_NAME@_MOD
...
INTERFACE
  PP_THREAD_SAFE FUNCTION KEYSET_FUNCTION_@TEMPLATE_KEY_NAME@_IF( KEY, HOOKS ) RESULT(RET)
    ! Symbols imported from other modules within the project.
    USE :: DATAKINDS_DEF_MOD, ONLY: JPIB_K
  ...
  END FUNCTION KEYSET_FUNCTION_@TEMPLATE_KEY_NAME@_IF
END INTERFACE

TYPE, ABSTRACT :: KEYSET_FUNCTOR_@TEMPLATE_KEY_NAME@_A
CONTAINS
PROCEDURE(KEYSET_FUNCTOR_@TEMPLATE_KEY_NAME@_IF), DEFERRED, PUBLIC, PASS :: APPLY
END TYPE

ABSTRACT INTERFACE
  PP_THREAD_SAFE FUNCTION KEYSET_FUNCTOR_@TEMPLATE_KEY_NAME@_IF( THIS, KEY, HOOKS ) RESULT(RET)
    ! Symbols imported from other modules within the project.
    USE :: DATAKINDS_DEF_MOD, ONLY: JPIB_K
    USE :: HOOKS_MOD,         ONLY: HOOKS_T
    !> Templated use
    @TEMPLATE_USE_KEY@
    IMPORT :: KEYSET_FUNCTOR_@TEMPLATE_KEY_NAME@_A
  IMPLICIT NONE
    CLASS(KEYSET_FUNCTOR_@TEMPLATE_KEY_NAME@_A), INTENT(INOUT) :: THIS
    @TEMPLATE_KEY_DUMMY_TYPE@,                   INTENT(IN)    :: KEY
    TYPE(HOOKS_T),                               INTENT(INOUT) :: HOOKS
    INTEGER(KIND=JPIB_K) :: RET
  END FUNCTION KEYSET_FUNCTOR_@TEMPLATE_KEY_NAME@_IF
END INTERFACE

!> @brief Datatype used to to store a node of the tree
TYPE :: KEYSET_@TEMPLATE_KEY_NAME@_NODE_T
  ...
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER :: PARENT => NULL()

  !> Pointer to the lef subtree
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER :: LEFT   => NULL()

  !> Pointer to the right subtree
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER :: RIGHT  => NULL()

END TYPE


!> @brief Datatype used to to store the entire map
TYPE :: KEYSET_@TEMPLATE_KEY_NAME@_T

  !> Pointer to the class
  PRIVATE

  !> Pointer to the root node
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER :: ROOT => NULL()
...
TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), TARGET :: NIL

!> Whitelist of public symbols
PUBLIC :: KEYSET_@TEMPLATE_KEY_NAME@_T
PUBLIC :: KEYSET_FUNCTION_@TEMPLATE_KEY_NAME@_IF
PUBLIC :: KEYSET_FUNCTOR_@TEMPLATE_KEY_NAME@_A
...
#define PP_PROCEDURE_NAME 'KEYSET_INSERT_NODE'
PP_THREAD_SAFE FUNCTION KEYSET_INSERT_NODE( ROOT, KEY, INSERTED, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER, INTENT(INOUT) :: ROOT
  @TEMPLATE_KEY_DUMMY_TYPE@,                        INTENT(IN)    :: KEY
  ...
  ! Local variables
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER :: INSERTION_POINT
  LOGICAL :: FOUND
  ...
  IF ( ASSOCIATED( ROOT, NIL  ) ) THEN
    ...
    INSERTION_POINT => NIL
    PP_TRYCALL(ERRFLAG_UNABLE_TO_INITIALIZE_NODE) KEYSET_NODE_INIT( ROOT, INSERTION_POINT, KEY, HOOKS )
  ...
  ELSE
    ...
    IF ( .NOT.FOUND ) THEN
      ...
      IF ( KEY .LT. INSERTION_POINT%KEY ) THEN
        ...
        PP_TRYCALL(ERRFLAG_UNABLE_TO_INITIALIZE_NODE) KEYSET_NODE_INIT( INSERTION_POINT%LEFT, INSERTION_POINT, KEY, HOOKS )
      ...
      ELSE
        ...
        PP_TRYCALL(ERRFLAG_UNABLE_TO_ALLOCATE_NODE) KEYSET_NODE_INIT( INSERTION_POINT%RIGHT, INSERTION_POINT, KEY, HOOKS )
...
END FUNCTION KEYSET_INSERT_NODE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'KEYSET_REMOVE_NODE'
PP_THREAD_SAFE FUNCTION KEYSET_REMOVE_NODE( ROOT, KEY, FOUND, HOOKS ) RESULT(RET)
...
END FUNCTION KEYSET_REMOVE_NODE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_NAME 'KEYSET_FREE_NODE'
RECURSIVE FUNCTION KEYSET_FREE_NODE( CURRENT, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER, INTENT(INOUT) :: CURRENT
  TYPE(HOOKS_T),                                 INTENT(INOUT) :: HOOKS
  ...
  IF ( .NOT.ASSOCIATED( CURRENT, NIL ) ) THEN
    ...
    PP_TRYCALL(ERRFLAG_UNABLE_TO_FREE_NODE) KEYSET_FREE_NODE( CURRENT%LEFT, HOOKS )

    ! Deallocate right subtree.
    PP_TRYCALL(ERRFLAG_UNABLE_TO_FREE_NODE) KEYSET_FREE_NODE( CURRENT%RIGHT, HOOKS )
...
IMPLICIT NONE
  ...
  ELSE
    ...
    SearchLoop: DO  WHILE( .NOT.ASSOCIATED( CURRENT, NIL ) .AND. ( KEY .NE. CURRENT%KEY ) )
      ...
      !WRITE(*,*) 'KEY: ', KEY, 'CURRENT: ', CURRENT%KEY
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'KEYSET_NODE_INIT'
PP_THREAD_SAFE FUNCTION KEYSET_NODE_INIT( THIS, PARENT, KEY, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T),          INTENT(INOUT) :: THIS
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER, INTENT(IN)    :: PARENT
  @TEMPLATE_KEY_DUMMY_TYPE@,                        INTENT(IN)    :: KEY
  TYPE(HOOKS_T),                                    INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER, INTENT(INOUT) :: X
  TYPE(HOOKS_T),                                 INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER, INTENT(INOUT) :: ROOT
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER, INTENT(INOUT) :: CUR
  TYPE(HOOKS_T),                                 INTENT(INOUT) :: HOOKS
  ...
  ! Local variables
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER :: Y
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER :: X
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER, INTENT(INOUT) :: ROOT
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), TARGET,  INTENT(INOUT) :: X_
  TYPE(HOOKS_T),                                 INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER,  INTENT(IN)    :: X
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER, INTENT(IN)    :: X
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER, INTENT(OUT)   :: Y
  TYPE(HOOKS_T),                                 INTENT(INOUT) :: HOOKS
  ...
  ! Local variables
  LOGICAL :: IS_LEAF
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER :: X_
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER, INTENT(INOUT) :: NODE_1
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER, INTENT(INOUT) :: NODE_2
  TYPE(HOOKS_T),                                 INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER, INTENT(INOUT) :: ROOT
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER, INTENT(INOUT) :: Z
  TYPE(HOOKS_T),                                 INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Local variables
  LOGICAL :: IS_LEAF
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER :: W
...
!>
#define PP_PROCEDURE_TYPE 'RECURSIVE FUNCTION'
#define PP_PROCEDURE_NAME 'KEYSET_LIST_NODE'
RECURSIVE FUNCTION KEYSET_LIST_NODE( ROOT, CURRENT, CNT, UNIT, PREFIX, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  IF ( .NOT.IS_LEAF ) THEN
    ...
    PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_LEFT_SUBTREE) KEYSET_LIST_NODE( ROOT, CURRENT%LEFT, CNT, UNIT, PREFIX, HOOKS )
    ...
    PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_RIGHT_SUBTREE) KEYSET_LIST_NODE( ROOT, CURRENT%RIGHT, CNT, UNIT, PREFIX, HOOKS )
...
!>
#define PP_PROCEDURE_TYPE 'RECURSIVE FUNCTION'
#define PP_PROCEDURE_NAME 'KEYSET_FUNCTION_NODE'
RECURSIVE FUNCTION KEYSET_FUNCTION_NODE( ROOT, CURRENT, FUNCTION, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER,           INTENT(IN)    :: ROOT
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER,           INTENT(IN)    :: CURRENT
  PROCEDURE(KEYSET_FUNCTION_@TEMPLATE_KEY_NAME@_IF), POINTER, INTENT(IN)    :: FUNCTION
  TYPE(HOOKS_T),                                              INTENT(INOUT) :: HOOKS
  ...
  IF ( .NOT.IS_LEAF ) THEN
    ...
    PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_LEFT_SUBTREE) KEYSET_FUNCTION_NODE( ROOT, CURRENT%LEFT, FUNCTION, HOOKS )
    PP_TRYCALL(ERRFLAG_CALL_MAP_FUNCTION_ERROR) FUNCTION( CURRENT%KEY, HOOKS )
    PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_RIGHT_SUBTREE) KEYSET_FUNCTION_NODE( ROOT, CURRENT%RIGHT, FUNCTION, HOOKS )
...
END FUNCTION KEYSET_FUNCTION_NODE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'RECURSIVE FUNCTION'
#define PP_PROCEDURE_NAME 'KEYSET_FUNCTOR_NODE'
RECURSIVE FUNCTION KEYSET_FUNCTOR_NODE( ROOT, CURRENT, FUNCTOR, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T),     POINTER, INTENT(IN)    :: ROOT
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T),     POINTER, INTENT(IN)    :: CURRENT
  CLASS(KEYSET_FUNCTOR_@TEMPLATE_KEY_NAME@_A), POINTER, INTENT(IN)    :: FUNCTOR
  TYPE(HOOKS_T),                                        INTENT(INOUT) :: HOOKS
  ...
  IF ( .NOT.IS_LEAF ) THEN
    ...
    PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_LEFT_SUBTREE) KEYSET_FUNCTOR_NODE( ROOT, CURRENT%LEFT, FUNCTOR, HOOKS )
    PP_TRYCALL(ERRFLAG_CALL_MAP_FUNCTOR_ERROR) FUNCTOR%APPLY( CURRENT%KEY, HOOKS )
    PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_RIGHT_SUBTREE) KEYSET_FUNCTOR_NODE( ROOT, CURRENT%RIGHT, FUNCTOR, HOOKS )
...
END FUNCTION KEYSET_FUNCTOR_NODE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'RECURSIVE FUNCTION'
#define PP_PROCEDURE_NAME 'KEYSET_RENUMBER_NODE'
RECURSIVE FUNCTION KEYSET_RENUMBER_NODE( ROOT, IDX, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T),  INTENT(INOUT) :: ROOT
  ...
  IF ( .NOT. IS_LEAF ) THEN
    PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_RENUMBER_NODE) KEYSET_RENUMBER_NODE( ROOT%LEFT, IDX, HOOKS )
  ENDIF

  ! Renumber right subtree
  PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_ISLEAF) NODE_ISLEAF( ROOT%RIGHT, IS_LEAF, HOOKS )
  IF ( .NOT. IS_LEAF ) THEN
    PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_RENUMBER_NODE) KEYSET_RENUMBER_NODE( ROOT%RIGHT, IDX, HOOKS )
  ENDIF
...
END FUNCTION KEYSET_RENUMBER_NODE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'RECURSIVE FUNCTION'
#define PP_PROCEDURE_NAME 'KEYSET_NODE_WRITE_CONNECTIVITY'
RECURSIVE FUNCTION KEYSET_NODE_WRITE_CONNECTIVITY( ROOT, UNIT, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_ISLEAF) NODE_ISLEAF( ROOT%LEFT, IS_LEAF, HOOKS )
  IF ( .NOT.IS_LEAF ) THEN
    PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_WRITE_CONNECTIVITY) KEYSET_NODE_WRITE_CONNECTIVITY( ROOT%LEFT, UNIT, HOOKS )
  ENDIF

  ! Write connectivity of the right subtree
  PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_ISLEAF) NODE_ISLEAF( ROOT%RIGHT, IS_LEAF, HOOKS )
  IF ( .NOT.IS_LEAF ) THEN
    PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_WRITE_CONNECTIVITY) KEYSET_NODE_WRITE_CONNECTIVITY( ROOT%RIGHT, UNIT, HOOKS )
  ENDIF
...
END FUNCTION KEYSET_NODE_WRITE_CONNECTIVITY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'RECURSIVE FUNCTION'
#define PP_PROCEDURE_NAME 'KEYSET_WRITE_NODE'
RECURSIVE FUNCTION KEYSET_WRITE_NODE( ROOT, UNIT , HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  CLASS(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), INTENT(INOUT) :: ROOT
  INTEGER(KIND=JPIB_K),                  INTENT(IN)    :: UNIT
  TYPE(HOOKS_T),                         INTENT(INOUT) :: HOOKS
  ...
  ! Local error codes
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_CALL_ISLEAF=1_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_CALL_KEYSET_WRITE_NODE=2_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_WRITE_ERROR=3_JPIB_K
  ...
  IF ( .NOT. ASSOCIATED( ROOT%LEFT, NIL ) ) THEN
    PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_KEYSET_WRITE_NODE) KEYSET_WRITE_NODE( ROOT%LEFT, UNIT, HOOKS )
  ENDIF

  ! Write nodes in the right subtree
  PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_ISLEAF) NODE_ISLEAF( ROOT%RIGHT, IS_LEAF, HOOKS )
  IF ( .NOT. ASSOCIATED( ROOT%RIGHT, NIL ) ) THEN
    PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_KEYSET_WRITE_NODE) KEYSET_WRITE_NODE( ROOT%RIGHT, UNIT, HOOKS )
  ENDIF
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_UNABLE_TO_CALL_ISLEAF)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to call isleaf' )
    CASE (ERRFLAG_UNABLE_TO_CALL_KEYSET_WRITE_NODE)
...
END FUNCTION KEYSET_WRITE_NODE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'KEYSET_INIT'
PP_THREAD_SAFE FUNCTION KEYSET_INIT( KEYSET, HOOKS ) RESULT(RET)
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'KEYSET_FREE'
PP_THREAD_SAFE FUNCTION KEYSET_FREE( KEYSET, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Local error codes
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_CALL_KEYSET_FREE=1_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_CALL_KEYSET_INIT=2_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_KEYSET_INIT) KEYSET_INIT( KEYSET, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    ! Handle different errors
    SELECT CASE(ERRIDX)
    CASE (ERRFLAG_UNABLE_TO_CALL_KEYSET_FREE)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to call map free' )
    CASE (ERRFLAG_UNABLE_TO_CALL_KEYSET_INIT)
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'KEYSET_MINIMUM'
PP_THREAD_SAFE FUNCTION KEYSET_MINIMUM( KEYSET, KEY, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  IF ( KEYSET%SIZE .GT. 0 ) THEN
    ...
    ! Recursive deletion of the tree.
    PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_MINIMUM) MINIMUM( KEYSET%ROOT, Y, HOOKS )
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'KEYSET_MAXIMUM'
PP_THREAD_SAFE FUNCTION KEYSET_MAXIMUM( KEYSET, KEY, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  IF ( KEYSET%SIZE .GT. 0 ) THEN
    ...
    ! Recursive deletion of the tree.
    PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_MINIMUM) MAXIMUM( KEYSET%ROOT, Y, HOOKS )
...
#define PP_PROCEDURE_TYPE 'RECURSIVE FUNCTION'
#define PP_PROCEDURE_NAME 'KEYSET_GET_SORTED_KEYS_INT_NODE'
RECURSIVE FUNCTION KEYSET_GET_SORTED_KEYS_NODE( NODE, SORTED_KEYS, CNT, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Local variables
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER :: Y
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER :: PREV
  LOGICAL :: IS_LEAF

  ! Local error codes
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_CALL_ISLEAF=1_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_CALL_KEYSET_GET_SORTED_KEYS_NODE=2_JPIB_K
  ...
  IF ( .NOT. IS_LEAF ) THEN
    ...
    PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_KEYSET_GET_SORTED_KEYS_NODE) KEYSET_GET_SORTED_KEYS_NODE( NODE%LEFT,  SORTED_KEYS, CNT, HOOKS )

    CNT = CNT + 1
    PP_DEBUG_CRITICAL_COND_THROW( CNT.GT.SIZE(SORTED_KEYS), ERRFLAG_OUT_OF_BOUNDS )
    SORTED_KEYS(CNT) = NODE%KEY

    PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_KEYSET_GET_SORTED_KEYS_NODE) KEYSET_GET_SORTED_KEYS_NODE( NODE%RIGHT, SORTED_KEYS, CNT, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_UNABLE_TO_CALL_ISLEAF)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to call isleaf' )
    CASE (ERRFLAG_UNABLE_TO_CALL_KEYSET_GET_SORTED_KEYS_NODE)
...
END FUNCTION KEYSET_GET_SORTED_KEYS_NODE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'KEYSET_GET_SORTED_KEYS'
PP_THREAD_SAFE FUNCTION KEYSET_GET_SORTED_KEYS( KEYSET, SORTED_KEYS, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Local error codes
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_KEYSET_NOT_INITIALIZED=1_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_WRONG_SIZE=2_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_CALL_KEYSET_GET_SORTED_KEYS_NODE=3_JPIB_K
  ...
  ! Error handing
  PP_DEBUG_CRITICAL_COND_THROW( .NOT.ASSOCIATED(KEYSET%ROOT), ERRFLAG_KEYSET_NOT_INITIALIZED )
  PP_DEBUG_CRITICAL_COND_THROW( KEYSET%SIZE .NE. SIZE(SORTED_KEYS), ERRFLAG_WRONG_SIZE )
  ...
  IF ( KEYSET%SIZE .GT. 0 ) THEN
    ...
    ! Recursive deletion of the tree.
    CNT = 0
    PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_KEYSET_GET_SORTED_KEYS_NODE) KEYSET_GET_SORTED_KEYS_NODE( KEYSET%ROOT, SORTED_KEYS, CNT, HOOKS )
  ENDIF
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    ! Handle different errors
    SELECT CASE(ERRIDX)
    CASE (ERRFLAG_KEYSET_NOT_INITIALIZED)
...
END FUNCTION KEYSET_GET_SORTED_KEYS
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'KEYSET_INSERT'
PP_THREAD_SAFE FUNCTION KEYSET_INSERT( THIS, KEY, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Local error codes
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_CALL_KEYSET_INSERT_NODE=1_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_KEYSET_INSERT_NODE) KEYSET_INSERT_NODE( THIS%ROOT, KEY, INSERTED, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    ! Handle different errors
    SELECT CASE(ERRIDX)
    CASE (ERRFLAG_UNABLE_TO_CALL_KEYSET_INSERT_NODE)
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'KEYSET_MATCH'
PP_THREAD_SAFE FUNCTION KEYSET_MATCH( THIS, KEY, MATCH, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  TYPE(KEYSET_@TEMPLATE_KEY_NAME@_NODE_T), POINTER :: SEARCHED_NODE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'KEYSET_REMOVE'
PP_THREAD_SAFE FUNCTION KEYSET_REMOVE( THIS, KEY, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Local error codes
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_CALL_ISLEAF=1_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_CALL_KEYSET_REMOVE_NODE=2_JPIB_K
  ...
  IF ( .NOT.ROOT_IS_LEAF ) THEN
    PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_KEYSET_REMOVE_NODE) KEYSET_REMOVE_NODE( THIS%ROOT, KEY, FOUND, HOOKS )
    IF ( FOUND ) THEN
      THIS%SIZE = THIS%SIZE - 1
    ENDIF
  ENDIF
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_UNABLE_TO_CALL_ISLEAF)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to call isleaf' )
    CASE (ERRFLAG_UNABLE_TO_CALL_KEYSET_REMOVE_NODE)
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'KEYSET_LIST'
PP_THREAD_SAFE FUNCTION KEYSET_LIST( THIS, UNIT, PREFIX, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  CNT = 0_JPIB_K
  PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_KEYSET_LIST_NODE) KEYSET_LIST_NODE( THIS%ROOT, THIS%ROOT, CNT, UNIT, PREFIX, HOOKS )
...
!> @brief Lists all keys in the map.
!>
!> This subroutine apply a function to all nodes in the keyset.
!>
!> @param [inout] THIS     The map structure to list the key-value pairs from.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'KEYSET_FUNCTION'
PP_THREAD_SAFE FUNCTION KEYSET_FUNCTION( THIS, FUNCTION, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Local error codes
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_CALL_KEYSET_FUNCTION_NODE=1_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_KEYSET_FUNCTION_NODE) KEYSET_FUNCTION_NODE( THIS%ROOT, THIS%ROOT, FUNCTION, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    ! Handle different errors
    SELECT CASE(ERRIDX)
    CASE (ERRFLAG_UNABLE_TO_CALL_KEYSET_FUNCTION_NODE)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to call map list node' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'KEYSET_FUNCTOR'
PP_THREAD_SAFE FUNCTION KEYSET_FUNCTOR( THIS, FUNCTOR, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Local error codes
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_CALL_KEYSET_FUNCTOR_NODE=1_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_KEYSET_FUNCTOR_NODE) KEYSET_FUNCTOR_NODE( THIS%ROOT, THIS%ROOT, FUNCTOR, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    ! Handle different errors
    SELECT CASE(ERRIDX)
    CASE (ERRFLAG_UNABLE_TO_CALL_KEYSET_FUNCTOR_NODE)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to call map list node' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'KEYSET_PRINT'
PP_THREAD_SAFE FUNCTION KEYSET_PRINT( THIS, NAME, IDX, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_CALL_KEYSET_RENUMBER_NODE=2_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_CALL_ISLEAF=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_CALL_KEYSET_WRITE_NODE=4_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_CALL_KEYSET_WRITE_CONNECTIVITY=5_JPIB_K
  ...
  UNIT = 0
  PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_KEYSET_RENUMBER_NODE) KEYSET_RENUMBER_NODE( THIS%ROOT, UNIT, HOOKS )
  UNIT=131
  ...
  IF ( .NOT. ROOT_IS_LEAF ) THEN
    ...
    PP_DEBUG_CRITICAL_COND_THROW( WRITE_STATUS .NE. 0, ERRFLAG_UNABLE_TO_WRITE_FILE )
    PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_KEYSET_WRITE_NODE) KEYSET_WRITE_NODE( THIS%ROOT, UNIT, HOOKS )
    WRITE(UNIT,'(A)',IOSTAT=WRITE_STATUS) ''
    PP_DEBUG_CRITICAL_COND_THROW( WRITE_STATUS .NE. 0, ERRFLAG_UNABLE_TO_WRITE_FILE )
    WRITE(UNIT,'(A)',IOSTAT=WRITE_STATUS) '// Connectivity'
    PP_DEBUG_CRITICAL_COND_THROW( WRITE_STATUS .NE. 0, ERRFLAG_UNABLE_TO_WRITE_FILE )
    PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_KEYSET_WRITE_CONNECTIVITY) KEYSET_NODE_WRITE_CONNECTIVITY( THIS%ROOT, UNIT, HOOKS )
    WRITE(UNIT,'(A)',IOSTAT=WRITE_STATUS) ''
    PP_DEBUG_CRITICAL_COND_THROW( WRITE_STATUS .NE. 0, ERRFLAG_UNABLE_TO_WRITE_FILE )
    WRITE(UNIT,'(A)',IOSTAT=WRITE_STATUS) '}'
    PP_DEBUG_CRITICAL_COND_THROW( WRITE_STATUS .NE. 0, ERRFLAG_UNABLE_TO_WRITE_FILE )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_UNABLE_TO_CALL_KEYSET_RENUMBER_NODE)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to call map renumber node' )
    CASE (ERRFLAG_UNABLE_TO_CALL_ISLEAF)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to call isleaf' )
    CASE (ERRFLAG_UNABLE_TO_CALL_KEYSET_WRITE_NODE)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to call map write node' )
    CASE (ERRFLAG_UNABLE_TO_CALL_KEYSET_WRITE_CONNECTIVITY)
...
END FUNCTION KEYSET_PRINT
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


END MODULE KEYSET_@TEMPLATE_KEY_NAME@_MOD
