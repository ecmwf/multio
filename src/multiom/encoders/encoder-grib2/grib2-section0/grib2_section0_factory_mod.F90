...
PP_THREAD_SAFE FUNCTION MAKE_GRIB2_SECTION0_CFG( GRIB2_SECTION0, &
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_INITIALIZATION_ERROR)  GRIB2_SECTION0%INIT( CFG, OPT, HOOKS )
...
PP_THREAD_SAFE FUNCTION MAKE_GRIB2_SECTION0_LAZY( GRIB2_SECTION0, &
...
IMPLICIT NONE
  ...
  !> Initialization of the section
  PP_TRYCALL(ERRFLAG_INITIALIZATION_ERROR)  GRIB2_SECTION0%INIT( MSG, PAR, OPT, HOOKS )
#else
