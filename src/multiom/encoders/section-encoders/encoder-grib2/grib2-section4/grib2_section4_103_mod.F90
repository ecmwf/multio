!>
!> @file grib2_section4_103_mod.F90
!>
!> @brief Module for managing GRIB2 Section 4 operations.
!>
!> The `GRIB2_SECTION4_103_MOD` module contains procedures to initialize, allocate,
...
!>   - @see GRIB2_SECTION4_103_INIT
!>   - @see GRIB2_SECTION4_103_ALLOCATE
!>   - @see GRIB2_SECTION4_103_PRESET
!>   - @see GRIB2_SECTION4_103_RUNTIME
!>   - @see GRIB2_SECTION4_103_TO_BE_ENCODED
!>   - @see GRIB2_SECTION4_103_FREE
!>
...
#define PP_FILE_NAME 'grib2_section4_103_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'GRIB2_SECTION4_103_MOD'
MODULE GRIB2_SECTION4_103_MOD
...
!>
!> The `GRIB2_SECTION4_103_T` type extends the base class `GRIB_SECTION_BASE_A` and
...
!> environments.
!>
TYPE, EXTENDS(GRIB_SECTION_BASE_A) :: GRIB2_SECTION4_103_T

  !> Default symbols visibility
  PRIVATE

  !> Integer section number
  INTEGER(KIND=JPIB_K) :: TEMPLATE_NUMBER_ = 103_JPIB_K
  ...
  CLASS(GRIB_SECTION_BASE_A), POINTER :: PERIOD_ => NULL()
...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_CFG => GRIB2_SECTION4_103_INIT_CFG
  ...
  !> the GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_LAZY => GRIB2_SECTION4_103_INIT_LAZY
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ALLOCATE => GRIB2_SECTION4_103_ALLOCATE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => GRIB2_SECTION4_103_PRESET
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => GRIB2_SECTION4_103_RUNTIME
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => GRIB2_SECTION4_103_TO_BE_ENCODED
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: FREE => GRIB2_SECTION4_103_FREE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRINT => GRIB2_SECTION4_103_PRINT
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_TIME_CONFIGURATOR => GRIB2_SECTION4_103_BUILD_TIME_HANDLER
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_MODEL_CONFIGURATOR => GRIB2_SECTION4_103_BUILD_MODEL_HANDLER
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_PARAM_CONFIGURATOR => GRIB2_SECTION4_103_BUILD_PARAM_HANDLER

  !>
  !> @brief Build the directions/frequencies configurator object
  !>
  !> This procedure allocates the proper directions/frequencies configurator
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_PERIOD_CONFIGURATOR => GRIB2_SECTION4_103_BUILD_PERIOD_HANDLER
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_LEVEL_CONFIGURATOR => GRIB2_SECTION4_103_BUILD_LEVEL_HANDLER
...
PUBLIC :: G2S4_103_ALLOCATE

CONTAINS

#if 0
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_103_REGISTER'
PP_THREAD_SAFE FUNCTION G2S4_103_REGISTER( REGISTER, HOOKS ) RESULT(RET)

  !> Symbols imported from other modules within the project.
  USE :: DATAKINDS_DEF_MOD,        ONLY: JPIB_K
  USE :: GRIB_SECTION_BASE_MOD,    ONLY: GRIB_SECTION_REGISTER_T
  USE :: GRIB_SECTION_BASE_MOD,    ONLY: GRIB_SECTION_ALLOCATOR_IF
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  TYPE(GRIB_SECTION_REGISTER_T), INTENT(IN)    :: REGISTER
  ...
  !> Local variables
  PROCEDURE(GRIB_SECTION_ALLOCATOR_IF), POINTER :: FN
  ...
  FN => G2S4_103_ALLOCATE

  ! Register the allocator
  PP_TRYCALL(ERRFLAG_UNABLE_TO_REGISTER) REGISTER%REGISTER_ALLOCATOR( FN, HOOKS )
...
END FUNCTION G2S4_103_REGISTER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
#endif

#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_103_ALLOCATE'
PP_THREAD_SAFE FUNCTION G2S4_103_ALLOCATE( GRIB_SECTION, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ALLOCATE( GRIB2_SECTION4_103_T::GRIB_SECTION, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
...
END FUNCTION G2S4_103_ALLOCATE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION4_103_T` representing the GRIB section being initialized.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_103_INIT_CFG'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_103_INIT_CFG( THIS, &
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(GRIB2_SECTION4_103_T),  INTENT(INOUT) :: THIS
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_INIT_PERIOD_HANDLER=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_INIT_LEVEL_HANDLER=4_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_INIT_MODEL_HANDLER=5_JPIB_K
  ...
  THIS%TEMPLATE_NUMBER_ = 103_JPIB_K
  THIS%TYPE_ = 'SECTION'
  THIS%SUBTYPE_ = 'PRODUCT_DEFINITION_SECTION'
  THIS%KIND_   = '4.103'

  ! Time, and paramId subcomponents of the section
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_INIT_PERIOD_HANDLER) THIS%BUILD_PERIOD_CONFIGURATOR( CFG, OPT, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_INIT_LEVEL_HANDLER) THIS%BUILD_LEVEL_CONFIGURATOR( CFG, OPT, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_INIT_MODEL_HANDLER) THIS%BUILD_MODEL_CONFIGURATOR( CFG, OPT, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_UNABLE_TO_INIT_PARAM_HANDLER )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to initialize param handler' )
    CASE ( ERRFLAG_UNABLE_TO_INIT_PERIOD_HANDLER )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to initialize period handler' )
...
END FUNCTION GRIB2_SECTION4_103_INIT_CFG
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_103_INIT_LAZY'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_103_INIT_LAZY( THIS, &
&               MSG, PAR, OPT, HOOKS ) RESULT(RET)
  ...
  USE :: GRIB2_SECTION4_PERIOD_FACTORY_MOD, ONLY: MAKE_GRIB2_PERIOD_CONFIGURATOR
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_BUILD_PERIOD_CONFIGURATOR=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_BUILD_MODEL_CONFIGURATOR=4_JPIB_K
...
&  THIS%MODEL_, THIS%TEMPLATE_NUMBER_, MSG, PAR, OPT, HOOKS )
...
&  THIS%PARAMID_, THIS%TEMPLATE_NUMBER_, MSG, PAR, OPT, HOOKS )
  ...
  ! Build the dir/freq configurator
  PP_TRYCALL(ERRFLAG_UNABLE_TO_BUILD_PERIOD_CONFIGURATOR) MAKE_GRIB2_PERIOD_CONFIGURATOR( &
&  THIS%PARAMID_, THIS%TEMPLATE_NUMBER_, MSG, PAR, OPT, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_UNABLE_TO_BUILD_PERIOD_CONFIGURATOR )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to build period configurator' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
END FUNCTION GRIB2_SECTION4_103_INIT_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION4_103_T` representing the GRIB section to allocate resources for.
!>   @param [in]    MSG      All the mars keywords needed to describe the field `FORTRAN_MESSAGE_T`.
!>   @param [in]    PAR      All information outside mars keywords needed to describe the field `PARAMETRIZATION_T`.
!>   @param [in]    OPT      The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_103_ALLOCATE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_103_ALLOCATE( THIS, &
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_ALLOCATE_PERIOD=5_JPIB_K
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PERIOD_CONFIGURATOR_NOT_ASSOCIATED=8_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_ALLOCATE_LEVEL=9_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_LEVEL_CONFIGURATOR_NOT_ASSOCIATED=11_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_ALLOCATE_MODEL=10_JPIB_K
  ...
  PP_DEBUG_CRITICAL_COND_THROW( .NOT. ASSOCIATED(THIS%PERIOD_), ERRFLAG_PERIOD_CONFIGURATOR_NOT_ASSOCIATED )
  ...
  PP_TRYCALL(ERRFLAG_ALLOCATE_PERIOD) THIS%PERIOD_%ALLOCATE( MSG, PAR, OPT, METADATA, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_METADATA )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'error while using metadata' )
    CASE ( ERRFLAG_ALLOCATE_PERIOD )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to allocate period' )
    ...
    CASE ( ERRFLAG_PERIOD_CONFIGURATOR_NOT_ASSOCIATED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'period configurator not associated' )
...
END FUNCTION GRIB2_SECTION4_103_ALLOCATE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION4_103_T` representing the GRIB section to be preset.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_103_PRESET'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_103_PRESET( THIS, &
&  MSG, PAR, OPT,  METADATA, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PRESET_PERIOD=5_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TIME_CONFIGURATOR_NOT_ASSOCIATED=6_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PARAMID_CONFIGURATOR_NOT_ASSOCIATED=7_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PERIOD_CONFIGURATOR_NOT_ASSOCIATED=8_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PRESET_LEVEL=9_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_LEVEL_CONFIGURATOR_NOT_ASSOCIATED=10_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_PRESET_PERIOD) THIS%PERIOD_%PRESET( MSG, PAR, OPT, METADATA, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_PRESET_PERIOD )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to preset direction/frequencies' )
    CASE ( ERRFLAG_METADATA )
...
END FUNCTION GRIB2_SECTION4_103_PRESET
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS      An object of type `GRIB2_SECTION4_103_T` representing the GRIB section for runtime execution.
!>   @param [in]    MSG       The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR       The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_103_RUNTIME'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_103_RUNTIME( THIS, &
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_RUNTIME_PERIOD=5_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TIME_CONFIGURATOR_NOT_ASSOCIATED=6_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PARAMID_CONFIGURATOR_NOT_ASSOCIATED=7_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PERIOD_CONFIGURATOR_NOT_ASSOCIATED=8_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_RUNTIME_LEVEL=9_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_LEVEL_CONFIGURATOR_NOT_ASSOCIATED=12_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_RUNTIME_MODEL=10_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_RUNTIME_PERIOD) THIS%PERIOD_%RUNTIME( MSG, PAR, TIME_HIST, CURR_TIME, OPT, METADATA, HOOKS )
...
END FUNCTION GRIB2_SECTION4_103_RUNTIME
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS          An object of type `GRIB2_SECTION4_103_T` representing the GRIB section being checked.
!>   @param [in]    MSG           The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR           The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
!>   @param [in]    TIME_HIST     The time history object of type `TIME_HISTORY_T` providing historical time data.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_103_TO_BE_ENCODED'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_103_TO_BE_ENCODED( THIS, &
...
IMPLICIT NONE
  ...
  !> Local variables
  LOGICAL, DIMENSION(5) :: TO_BE_ENCODED_SUBS
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TO_BE_ENCODED_PERIOD=4_JPIB_K
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PERIOD_CONFIGURATOR_NOT_ASSOCIATED=8_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TO_BE_ENCODED_LEVEL=9_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_LEVEL_CONFIGURATOR_NOT_ASSOCIATED=12_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TO_BE_ENCODED_MODEL=11_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_MODEL_CONFIGURATOR_NOT_ASSOCIATED=13_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_TO_BE_ENCODED_PERIOD) THIS%PERIOD_%TO_BE_ENCODED( MSG, PAR, TIME_HIST, CURR_TIME, OPT, TO_BE_ENCODED_SUBS(3), HOOKS )
  ...
  PP_TRYCALL(ERRFLAG_TO_BE_ENCODED_MODEL) THIS%MODEL_%TO_BE_ENCODED( MSG, PAR, TIME_HIST, CURR_TIME, OPT, TO_BE_ENCODED_SUBS(5), HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_TO_BE_ENCODED_PERIOD )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to check if direction/frequencies are ready to be encoded' )
    CASE ( ERRFLAG_TIME_CONFIGURATOR_NOT_ASSOCIATED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'time configurator not associated' )
    CASE ( ERRFLAG_MODEL_CONFIGURATOR_NOT_ASSOCIATED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'model configurator not associated' )
...
END FUNCTION GRIB2_SECTION4_103_TO_BE_ENCODED
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION4_103_T` representing the GRIB section to be freed.
!>   @param [in]    OPT   The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_103_FREE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_103_FREE( THIS, OPT, HOOKS ) RESULT(RET)
  ...
  USE :: GRIB2_SECTION4_PERIOD_FACTORY_MOD,     ONLY: DESTROY_GRIB2_PERIOD_CONFIGURATOR
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_DESTROY_PERIOD=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_DESTROY_LEVEL=4_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_DESTROY_MODEL=5_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_DESTROY_PERIOD) DESTROY_GRIB2_PERIOD_CONFIGURATOR( THIS%PERIOD_, OPT, HOOKS )
...
END FUNCTION GRIB2_SECTION4_103_FREE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_103_PRINT'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_103_PRINT( THIS, &
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PERIOD_CONFIGURATOR_NOT_ASSOCIATED=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_LEVEL_CONFIGURATOR_NOT_ASSOCIATED=4_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_WRITE_ERROR=5_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CALL_PRINT_TIME=6_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CALL_PRINT_LEVEL=7_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CALL_PRINT_PERIOD=8_JPIB_K
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CALL_PRINT_MODEL=11_JPIB_K
...
&     '(', TRIM(ADJUSTL(THIS%KIND_)), '){'
  ...
  PP_TRYCALL(ERRFLAG_CALL_PRINT_PERIOD) THIS%PERIOD_%PRINT( UNIT, OFFSET+2, OPT, HOOKS, ', ...' )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_CALL_PRINT_PERIOD)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'error calling print period' )
...
END FUNCTION GRIB2_SECTION4_103_PRINT
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


!>
!> @brief Builds the time handler for GRIB2 section 4, template 103.
!>
!> This function constructs the time handler for GRIB2 section 4, template 103,
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_103_BUILD_TIME_HANDLER'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_103_BUILD_TIME_HANDLER( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_103_BUILD_TIME_HANDLER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_103_BUILD_MODEL_HANDLER'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_103_BUILD_MODEL_HANDLER( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_103_BUILD_MODEL_HANDLER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @brief Builds the param handler for GRIB2 section 4, template 103.
!>
!> This function constructs the param handler for GRIB2 section 4, template 103,
!> based on the provided configuration (`CFG`), options (`OPT`).
!> It modifies the `THIS` structure accordingly and returns an error code if the operation fails.
!> The function is thread-safe and uses preprocessor directives for debugging, logging, and tracing.
!>
...
!> @see GRIB2_SECTION4_103_ALLOCATE
!> @see GRIB2_SECTION4_103_PRESET
!> @see GRIB2_SECTION4_103_RUNPARAM
!> @see GRIB2_SECTION4_103_TO_BE_ENCODED
!> @see GRIB2_SECTION4_103_FREE
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_103_BUILD_PARAM_HANDLER'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_103_BUILD_PARAM_HANDLER( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_103_BUILD_PARAM_HANDLER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_103_BUILD_PERIOD_HANDLER'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_103_BUILD_PERIOD_HANDLER( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Local variables
  LOGICAL :: HAS_PERIOD_CONFIGURATOR
  TYPE(YAML_CONFIGURATION_T) :: PERIOD_CONFIGURATOR_CFG

  !> Local parameters
  CHARACTER(LEN=*), PARAMETER :: PERIOD_CONFIGURATOR_NAME='period-configurator'

  ! Local error codes
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PERIOD_CONFIGURATOR_ALREADY_ASSOCIATED=1_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_READ_CFG=2_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PERIOD_CONFIGURATOR_CFG_NOT_PRESENT=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_READ_SUBCFG=4_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_MAKE_PERIOD_CONFIGURATOR=5_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_DEALLOCATE=6_JPIB_K
  ...
  !> Error handling
  PP_DEBUG_CRITICAL_COND_THROW( ASSOCIATED(THIS%PERIOD_), ERRFLAG_PERIOD_CONFIGURATOR_ALREADY_ASSOCIATED )

  !> Check if a configuration for the indicator-section is available
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_CFG) YAML_CONFIGURATION_HAS_KEY( CFG, PERIOD_CONFIGURATOR_NAME, HAS_PERIOD_CONFIGURATOR, HOOKS )
  PP_DEBUG_CRITICAL_COND_THROW( .NOT. HAS_PERIOD_CONFIGURATOR, ERRFLAG_PERIOD_CONFIGURATOR_CFG_NOT_PRESENT )

  !> Read the subconfiguration for the indicator-section
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_SUBCFG) YAML_GET_SUBCONFIGURATION( CFG, PERIOD_CONFIGURATOR_NAME, PERIOD_CONFIGURATOR_CFG, HOOKS )

  !> Make the indicator-section
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_PERIOD_CONFIGURATOR) MAKE_GRIB2_PERIOD_CONFIGURATOR( THIS%PERIOD_, THIS%TEMPLATE_NUMBER_, PERIOD_CONFIGURATOR_CFG, OPT, HOOKS )

  !> Deallocate the indicator-section configuration
  PP_TRYCALL( ERRFLAG_UNABLE_TO_DEALLOCATE ) YAML_DELETE_CONFIGURATION( PERIOD_CONFIGURATOR_CFG, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    ! Handle different errors
    SELECT CASE(ERRIDX)
    CASE ( ERRFLAG_PERIOD_CONFIGURATOR_ALREADY_ASSOCIATED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'period configurator already associated' )
    CASE ( ERRFLAG_UNABLE_TO_READ_CFG )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to read configuration' )
    CASE ( ERRFLAG_PERIOD_CONFIGURATOR_CFG_NOT_PRESENT )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'period configurator configuration not present' )
    CASE ( ERRFLAG_UNABLE_TO_READ_SUBCFG )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to read subconfiguration' )
    CASE ( ERRFLAG_UNABLE_TO_MAKE_PERIOD_CONFIGURATOR )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to make period configurator' )
    CASE ( ERRFLAG_UNABLE_TO_DEALLOCATE )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to deallocate period configurator object' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
END FUNCTION GRIB2_SECTION4_103_BUILD_PERIOD_HANDLER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_103_BUILD_LEVEL_HANDLER'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_103_BUILD_LEVEL_HANDLER( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_103_BUILD_LEVEL_HANDLER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
