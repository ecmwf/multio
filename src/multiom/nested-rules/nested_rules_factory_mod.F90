...
#define PP_FILE_NAME 'nested_rules_factory_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'NESTED_RULES_FACTORY_MOD'
MODULE NESTED_RULES_FACTORY_MOD
IMPLICIT NONE

PRIVATE

PUBLIC :: MAKE_NESTED_RULES
PUBLIC :: DESTROY_NESTED_RULES

CONTAINS

#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'MAKE_NESTED_RULES'
PP_THREAD_SAFE FUNCTION MAKE_NESTED_RULES( RULES, &
&   RULES_CONFIGURATION, FILTER_OPT, HOOKS, NESTING_LEVEL ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(NESTED_RULE_CONTAINER_T), POINTER, DIMENSION(:), INTENT(INOUT) :: RULES
...
!&                       FILTER_OPT, HOOKS, NESTING_LEVEL=NESTING_LEVEL )
!      ELSE
!        PP_TRYCALL(ERRFLAG_READ_RULE_FROM_CFG) MAKE_RULE_FROM_CFG( RULES(I), I, RULE_CONFIGURATION, &
!&                       FILTER_OPT, HOOKS )
!      ENDIF
...
END FUNCTION MAKE_NESTED_RULES
...
RECURSIVE FUNCTION MAKE_RULE_FROM_CFG( RULE, ID, CFG, FILTER_OPT, HOOKS, NESTING_LEVEL ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(NESTED_RULE_CONTAINER_T),  INTENT(INOUT) :: RULE
...
RECURSIVE FUNCTION MAKE_RULE_FROM_FILE( RULE, ID, CFG, FILTER_OPT, HOOKS, NESTING_LEVEL ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Read the configuration from the file
  ! WRITE(*,*) 'Reading configuration from file: ', TRIM(ADJUSTL(FNAME))
  ...
  !> Read the rule
  PP_TRYCALL(ERRFLAG_UNABLE_TO_CONSTRUCT_THE_RULE) RULE%RULE_%INIT_CFG( ID, LOC_CFG, FILTER_OPT, HOOKS )
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'DESTROY_NESTED_RULES'
RECURSIVE FUNCTION DESTROY_NESTED_RULES( RULES, HOOKS ) RESULT(RET)
...
END FUNCTION DESTROY_NESTED_RULES
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


END MODULE NESTED_RULES_FACTORY_MOD
