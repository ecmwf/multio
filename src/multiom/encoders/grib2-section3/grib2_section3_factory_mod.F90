...
PP_THREAD_SAFE FUNCTION MAKE_GRIB2_SECTION3_CFG( GRIB2_SECTION3, DUMMY, &
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_INITIALIZATION_ERROR)  GRIB2_SECTION3%INIT( CFG, OPT, FACTORIES, HOOKS )
...
PP_THREAD_SAFE FUNCTION MAKE_GRIB2_SECTION3_LAZY( GRIB2_SECTION3, DUMMY, &
...
IMPLICIT NONE
  ...
  !> Initialization of the section
  PP_TRYCALL(ERRFLAG_INITIALIZATION_ERROR)  GRIB2_SECTION3%INIT( MSG, PAR, OPT, FACTORIES, HOOKS )
#endif
...
PP_THREAD_SAFE FUNCTION DESTROY_GRIB2_SECTION3( GRIB2_SECTION3, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Free the section
  PP_TRYCALL(ERRFLAG_FREE_ERROR)  GRIB2_SECTION3%FREE( OPT, DESTRUCTORS, HOOKS )
