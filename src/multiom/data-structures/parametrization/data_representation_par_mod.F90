...
PP_THREAD_SAFE FUNCTION DATA_REPRESENTATION_PAR_FREE( DATA_REPRESENTATION_PAR, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION DATA_REPRESENTATION_PAR_COPY_FROM( DATA_REPRESENTATION_PAR_TO, DATA_REPRESENTATION_PAR_FROM, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION READ_DATA_REPRESENTATION_PAR_FROM_YAML( DATA_REPRESENTATION_PAR, CONFIG, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION WRITE_DATA_REPRESENTATION_PAR_TO_YAML( DATA_REPRESENTATION_PAR, UNIT, OFFSET, HOOKS ) RESULT(RET)
