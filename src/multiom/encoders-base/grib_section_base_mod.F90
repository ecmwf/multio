...
TYPE :: GRIB_SECTION_DESTRUCTOR_T
  !> The function pointer type for the GRIB section factory
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_SECTION0_CFG => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_SECTION1_CFG => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_SECTION2_CFG => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_SECTION3_CFG => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_SECTION4_CFG => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_SECTION5_CFG => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_ORIGIN_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_TABLES_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_REFERENCE_TIME_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_DATA_TYPE_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_MODEL_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_POINT_IN_TIME_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_PARAM_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_LEVEL_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_ENSEMBLE_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_STATISTICS_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_SATELLITE_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_CHEM_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_DIRFREQ_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_PERIOD_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_RANDOM_PATTERNS_CONFIGURATOR_CFG => NULL()
END TYPE
