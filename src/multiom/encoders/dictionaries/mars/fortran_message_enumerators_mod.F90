...
PRIVATE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: MSGINTFLD_TIMESPAN_E=22_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MSGINTFLD_PACKING_E=23_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MSGINTFLD_TRUNCATION_E=24_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MSGINTFLD_HDATE_E=25_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MSGINTFLD_WAVELENGTH_E=26_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MSGINTFLD_DATASET_E=27_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MSGINTFLD_ACTIVITY_E=28_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MSGINTFLD_EXPERIMENT_E=29_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MSGINTFLD_GENERATION_E=30_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MSGINTFLD_REALIZATION_E=31_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MSGINTFLD_RESOLUTION_E=32_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MSGINTFLD_METHOD_E=33_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MSGINTFLD_SYSTEM_E=34_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: N_MSGINTFLDS=34_JPIB_K

  ! String enumerators
  INTEGER(KIND=JPIB_K), PARAMETER :: MSGSTRFLD_EXPVER_E=101_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MSGSTRFLD_GRID_E=102_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MSGSTRFLD_STATTYPE_E=103_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: N_MSGSTRFLDS=3_JPIB_K
  ...
  PUBLIC :: MSGINTFLD_TIMESPAN_E
  PUBLIC :: MSGINTFLD_PACKING_E
  PUBLIC :: MSGINTFLD_TRUNCATION_E
  PUBLIC :: MSGINTFLD_HDATE_E
  PUBLIC :: MSGINTFLD_DATASET_E
  PUBLIC :: MSGINTFLD_ACTIVITY_E
  PUBLIC :: MSGINTFLD_EXPERIMENT_E
  PUBLIC :: MSGINTFLD_GENERATION_E
  PUBLIC :: MSGINTFLD_REALIZATION_E
  PUBLIC :: MSGINTFLD_RESOLUTION_E
  PUBLIC :: MSGINTFLD_METHOD_E
  PUBLIC :: MSGINTFLD_SYSTEM_E
  PUBLIC :: N_MSGINTFLDS

  ! String enumerators
  PUBLIC :: MSGSTRFLD_EXPVER_E
  PUBLIC :: MSGSTRFLD_GRID_E
  PUBLIC :: MSGSTRFLD_STATTYPE_E
  PUBLIC :: N_MSGSTRFLDS
...
IMPLICIT NONE
  ...
  CASE (MSGINTFLD_CHEM_E)
    CMSGINTFLDS = 'chem'
  CASE (MSGINTFLD_WAVELENGTH_E)
    CMSGINTFLDS = 'wavelength'
  ...
  CASE (MSGINTFLD_STEP_E)
    CMSGINTFLDS = 'step'
  CASE (MSGINTFLD_TIMESPAN_E)
    CMSGINTFLDS = 'timespan'
  CASE (MSGINTFLD_PACKING_E)
    CMSGINTFLDS = 'packing'
  CASE (MSGINTFLD_TRUNCATION_E)
    CMSGINTFLDS = 'truncation'
  CASE (MSGINTFLD_DATASET_E)
    CMSGINTFLDS = 'dataset'
  CASE (MSGINTFLD_ACTIVITY_E)
    CMSGINTFLDS = 'activity'
  CASE (MSGINTFLD_EXPERIMENT_E)
    CMSGINTFLDS = 'experiment'
  CASE (MSGINTFLD_GENERATION_E)
    CMSGINTFLDS = 'generation'
  CASE (MSGINTFLD_REALIZATION_E)
    CMSGINTFLDS = 'realization'
  CASE (MSGINTFLD_RESOLUTION_E)
    CMSGINTFLDS = 'resolution'
  CASE (MSGINTFLD_METHOD_E)
    CMSGINTFLDS = 'method'
  CASE (MSGINTFLD_SYSTEM_E)
    CMSGINTFLDS = 'system'
...
IMPLICIT NONE
  ...
  CASE( 'wavelength' )
    IMSGINTFLDS = MSGINTFLD_WAVELENGTH_E
  CASE( 'param' )
  ...
  CASE( 'timespan' )
    IMSGINTFLDS = MSGINTFLD_TIMESPAN_E
  CASE( 'packing' )
    IMSGINTFLDS = MSGINTFLD_PACKING_E
  CASE ( 'truncation' )
    IMSGINTFLDS = MSGINTFLD_TRUNCATION_E
  CASE( 'dataset' )
    IMSGINTFLDS = MSGINTFLD_DATASET_E
  CASE ( 'activity' )
    IMSGINTFLDS = MSGINTFLD_ACTIVITY_E
  CASE ( 'experiment' )
    IMSGINTFLDS = MSGINTFLD_EXPERIMENT_E
  CASE ( 'generation' )
    IMSGINTFLDS = MSGINTFLD_GENERATION_E
  CASE ( 'realization' )
    IMSGINTFLDS = MSGINTFLD_REALIZATION_E
  CASE ( 'resolution' )
    IMSGINTFLDS = MSGINTFLD_RESOLUTION_E
  CASE ( 'method' )
    IMSGINTFLDS = MSGINTFLD_METHOD_E
  CASE ( 'system' )
    IMSGINTFLDS = MSGINTFLD_SYSTEM_E
  CASE( 'hdate' )
    IMSGINTFLDS = MSGINTFLD_HDATE_E
  CASE DEFAULT
    PP_DEBUG_CRITICAL_THROW( ERRFLAG_UNKNOWN_MSGINTFLD_UNARY )
  END SELECT
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_UNKNOWN_MSGINTFLD_UNARY)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unknown unknown intege field enumerator: '//TRIM(ADJUSTL(CMSGINTFLDS)) )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
IMPLICIT NONE
  ...
  ! WRITE(*,*) 'HAS_IMSGINTFLDS: ', IMSGINTFLDS, HAS_FIELD
...
IMPLICIT NONE
  ...
  CASE ('stattype')
    IMSGSTRINGFLDS = MSGSTRFLD_STATTYPE_E
  CASE DEFAULT
...
IMPLICIT NONE
  ...
  CASE (MSGSTRFLD_STATTYPE_E)
    CMSGSTRINGFLDS = 'stattype'
  CASE DEFAULT
    PP_DEBUG_CRITICAL_THROW( ERRFLAG_UNKNOWN_MSGSTRINGFLD_UNARY )
  END SELECT
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_UNKNOWN_MSGSTRINGFLD_UNARY)
      TMPSTR = REPEAT(' ', 32)
      WRITE(TMPSTR,'(I16)') IMSGSTRINGFLDS
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unknown enum for string field: '//TRIM(ADJUSTL(TMPSTR)) )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
