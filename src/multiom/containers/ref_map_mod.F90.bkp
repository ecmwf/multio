...
__THREAD_SAFE__ FUNCTION KEY_EQ( KEY_A, KEY_B ) RESULT( RES )
...
__THREAD_SAFE__ FUNCTION KEY_NE( KEY_A, KEY_B ) RESULT( RES )
...
__THREAD_SAFE__ FUNCTION KEY_LT( KEY_A, KEY_B ) RESULT( RES )
...
__THREAD_SAFE__ FUNCTION KEY_GT( KEY_A, KEY_B ) RESULT( RES )
...
__THREAD_SAFE__ FUNCTION KEY_LE( KEY_A, KEY_B ) RESULT( RES )
...
__THREAD_SAFE__ FUNCTION KEY_GE( KEY_A, KEY_B ) RESULT( RES )
...
__THREAD_SAFE__ SUBROUTINE KEY_FREE( KEY, ERR )
...
__THREAD_SAFE__ SUBROUTINE KEY_COPY( KEY1, KEY2, ERR )
...
__THREAD_SAFE__ FUNCTION MAP_INSERT_NODE( ROOT, KEY, VALUE, VALUE_DESTRUCTOR, FORCE ) RESULT(EX)
...
__THREAD_SAFE__ SUBROUTINE DEFAULT_VALUE_DESTRUCTOR( VALUE )
IMPLICIT NONE
  CLASS(*), POINTER, INTENT(INOUT) :: VALUE
  ! Nothing to do
...
__THREAD_SAFE__ SUBROUTINE MAP_REMOVE_NODE( ROOT, KEY )
...
__THREAD_SAFE__ SUBROUTINE SEARCH( ROOT, CURRENT, KEY, ERR )
...
__THREAD_SAFE__ SUBROUTINE MAP_NODE_INIT( THIS, PARENT, KEY, VALUE, VALUE_DESTRUCTOR )
...
__THREAD_SAFE__ SUBROUTINE ALLOCATE_NODE( CURRENT )
...
__THREAD_SAFE__ SUBROUTINE DEALLOCATE_NODE( X, ERR )
...
__THREAD_SAFE__ SUBROUTINE INSERT_FIXUP( ROOT, CUR )
...
__THREAD_SAFE__ SUBROUTINE ROTATE_LEFT(ROOT, X_)
...
__THREAD_SAFE__ SUBROUTINE ROTATE_RIGHT(ROOT, X_)
...
__THREAD_SAFE__ FUNCTION ISLEAF(X) RESULT(B)
...
__THREAD_SAFE__ FUNCTION SUCCESSOR( X, ERR ) RESULT( Y )
...
__THREAD_SAFE__ FUNCTION PREDECESSOR( X, ERR ) RESULT(Y)
...
__THREAD_SAFE__ FUNCTION MINIMUM( X ) RESULT( Y )
...
__THREAD_SAFE__ FUNCTION MAXIMUM( X ) RESULT( Y )
...
__THREAD_SAFE__ SUBROUTINE SWAP_DATA( NODE_1, NODE_2 )
...
__THREAD_SAFE__ SUBROUTINE REMOVE_NODE( ROOT, Z, ERR )
...
__THREAD_SAFE__ SUBROUTINE REMOVE_NODE_FIXUP( ROOT, X, ERR )
...
__THREAD_SAFE__ SUBROUTINE MAP_INIT( MAP )
...
__THREAD_SAFE__ SUBROUTINE MAP_FREE( MAP )
...
__THREAD_SAFE__ SUBROUTINE MAP_MINIMUM( MAP, KEY, VALUE )
...
__THREAD_SAFE__ SUBROUTINE MAP_MAXIMUM( MAP, KEY, VALUE )
...
__THREAD_SAFE__ FUNCTION MAP_GET_SORTED_KEYS_INT( MAP, SORTED_KEYS_INT ) RESULT(EX)
...
__THREAD_SAFE__ SUBROUTINE MAP_INSERT( THIS, KEY, VALUE, VALUE_DESTRUCTOR, FORCE )
...
__THREAD_SAFE__ FUNCTION MAP_GET( THIS, KEY, VALUE ) RESULT(EX)
...
__THREAD_SAFE__ SUBROUTINE MAP_REMOVE( THIS, KEY )
...
__THREAD_SAFE__ SUBROUTINE MAP_LIST( THIS, UNIT )
...
__THREAD_SAFE__ SUBROUTINE MAP_PRINT( THIS, NAME, IDX )
