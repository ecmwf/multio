...
PP_THREAD_SAFE FUNCTION DESTROY_GRIB2_DATA_TYPE_CONFIGURATOR( GRIB2_DATA_TYPE_CONFIGURATOR, OPT, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Free the section
  PP_TRYCALL(ERRFLAG_FREE_ERROR)  GRIB2_DATA_TYPE_CONFIGURATOR%FREE( OPT, HOOKS )
