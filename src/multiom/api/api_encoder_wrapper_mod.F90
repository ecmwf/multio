...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CHECK_ENVVAR = 13_JPIB_K
  ...
  IF ( HAS_OPTIONS ) THEN
    ...
    CASE ( OPT_DICT_TYPE_E )
      ...
      ENCODER_OPTIONS%GENERATE_TEST_CASES = OPT_DICT%GENERATE_TEST_CASES
  ...
  PP_TRYCALL(ERRFLAG_CHECK_ENVVAR) ENVVAR_IS_DEFINED( 'MULTIO_GENERATE_TEST_CASE', LDEFINED, HOOKS )
  IF ( LDEFINED ) THEN
    ENCODER_OPTIONS%GENERATE_TEST_CASES = .TRUE.
  ENDIF
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_CHECK_ENVVAR)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unable to check the environment variable' )
    CASE DEFAULT
