...
PP_THREAD_SAFE FUNCTION MAKE_GRIB2_SECTION2_CFG( GRIB2_SECTION2, DUMMY, &
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K),                INTENT(IN)    :: DUMMY
  ...
  PP_TRYCALL(ERRFLAG_INITIALIZATION_ERROR)  GRIB2_SECTION2%INIT( CFG, OPT, FACTORIES, HOOKS )
...
PP_THREAD_SAFE FUNCTION MAKE_GRIB2_SECTION2_LAZY( GRIB2_SECTION2, DUMMY, &
...
IMPLICIT NONE
  ...
  !> Initialization of the section
  PP_TRYCALL(ERRFLAG_INITIALIZATION_ERROR)  GRIB2_SECTION2%INIT( MSG, PAR, OPT, FACTORIES, HOOKS )
#else
...
PP_THREAD_SAFE FUNCTION DESTROY_GRIB2_SECTION2( GRIB2_SECTION2, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Free the section
  PP_TRYCALL(ERRFLAG_FREE_ERROR)  GRIB2_SECTION2%FREE( OPT, DESTRUCTORS, HOOKS )
