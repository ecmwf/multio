...
PUBLIC :: SET_BITS_PER_VALUE_GG_GRIBX_WAM
...
#define PP_PROCEDURE_TYPE 'SUBROUTINE'
#define PP_PROCEDURE_NAME 'SET_BITS_PER_VALUE_GG_GRIBX_WAM'
SUBROUTINE SET_BITS_PER_VALUE_GG_GRIBX_WAM( MODEL_PARAMS, GRIB_INFO, MSG, METADATA )
...
END SUBROUTINE SET_BITS_PER_VALUE_GG_GRIBX_WAM
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
