...
PRIVATE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: PARINTFLD_TYPE_OF_PROCESSED_DATA_E=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: PARINTFLD_SINK_TYPE_E=4_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: PARINTFLD_ENCODE_STEP_ZERO_E=5_JPIB_K

  !> Integer enumerators (time)
  INTEGER(KIND=JPIB_K), PARAMETER :: PARINTFLD_TIME_INITIAL_STEP_E=6_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: PARINTFLD_TIME_LENGTH_OF_TIME_STEP_IN_SECONDS_E=7_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: PARINTFLD_TIME_LENGTH_OF_TIME_RANGE_IN_SECONDS_E=8_JPIB_K

  !> Integer enumerators (bitmap)
  INTEGER(KIND=JPIB_K), PARAMETER :: PARINTFLD_BITMAP_NUMBER_OF_MISSING_VALUES_E=9_JPIB_K

  !> Integer enumerators (ensemble)
  INTEGER(KIND=JPIB_K), PARAMETER :: PARINTFLD_ENSEMBLE_TYPE_OF_ENSEMBLE_FORECAST_E=10_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: PARINTFLD_ENSEMBLE_NUMBER_OF_FORECASTS_IN_ENSEMBLE_E=11_JPIB_K

  !> Integer enumerators (analysis)
  INTEGER(KIND=JPIB_K), PARAMETER :: PARINTFLD_ANALYSIS_LENGTH_OF_TIME_WINDOW_E=12_JPIB_K

  !> Integer enumerators (satellite)
  INTEGER(KIND=JPIB_K), PARAMETER :: PARINTFLD_SATELLITE_SATELLITE_SERIES_E=13_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: PARINTFLD_SATELLITE_SCALED_FACTOR_OF_CENTRAL_VAWENUMBER_E=14_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: PARINTFLD_SATELLITE_SCALED_VALUE_OF_CENTRAL_VAWENUMBER_E=15_JPIB_K

  !> Integer enumerators (data-representation)
  INTEGER(KIND=JPIB_K), PARAMETER :: PARINTFLD_DATA_REPRESENTATION_BITS_PER_VALUE_E=16_JPIB_K

  !> Integer enumerators (data-representation)
  INTEGER(KIND=JPIB_K), PARAMETER :: PARINTFLD_DESTINE_LOCAL_VERSION_E=17_JPIB_K

  !> Total number of integer enumerators
  INTEGER(KIND=JPIB_K), PARAMETER :: N_PARINTFLDS=17_JPIB_K
  ...
  PUBLIC :: PARINTFLD_TYPE_OF_PROCESSED_DATA_E
  PUBLIC :: PARINTFLD_SINK_TYPE_E
  PUBLIC :: PARINTFLD_ENCODE_STEP_ZERO_E
  ...
  PUBLIC :: PARINTFLD_DESTINE_LOCAL_VERSION_E
  PUBLIC :: N_PARINTFLDS
...
IMPLICIT NONE
  ...
  CASE (PARINTFLD_DESTINE_LOCAL_VERSION_E)
    CPARINTFLDS = 'destine-local-tables-version'
  CASE DEFAULT
...
IMPLICIT NONE
  ...
  CASE ( 'generating-process-identifier' )
    IPARINTFLDS = PARINTFLD_GENERATING_PROCESS_IDENTIFIER_E
  CASE ( 'type-of-processed-data' )
    IPARINTFLDS = PARINTFLD_TYPE_OF_PROCESSED_DATA_E
  CASE ( 'direct-to-fdb' )
    IPARINTFLDS = PARINTFLD_SINK_TYPE_E
  CASE ( 'encode-step-zero' )
    IPARINTFLDS = PARINTFLD_ENCODE_STEP_ZERO_E
  ...
  CASE ( 'destine-local-tables-version' )
    IPARINTFLDS = PARINTFLD_DESTINE_LOCAL_VERSION_E
  CASE DEFAULT
    PP_DEBUG_CRITICAL_THROW( ERRFLAG_UNKNOWN_PARINTFLD_UNARY )
  END SELECT
