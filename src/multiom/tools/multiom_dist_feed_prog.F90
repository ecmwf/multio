...
PROGRAM MULTIOM_FEED_PROG
  ...
  USE :: MULTIOM_TOOLS_UTILS_MOD, ONLY: INITIALIZE_DIST_OUTPUT_MANAGER
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_INITIALIZE_MPI = 19_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_FINALIZE_MPI = 20_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_TABLE_OF_CONTENTS) INITIALIZE_DIST_OUTPUT_MANAGER( CMDARGS, &
&   MPI_RANK, MPI_SIZE, TOPOLOGY, PARAMETERS, OUTPUT_MANAGER, TOC, BIG_ENDIAN_READ, VERBOSE, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_UNABLE_TO_INITIALIZE_MPI)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Error initializing MPI' )
    CASE (ERRFLAG_UNABLE_TO_FINALIZE_MPI)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Error finalizing MPI' )
    CASE DEFAULT
