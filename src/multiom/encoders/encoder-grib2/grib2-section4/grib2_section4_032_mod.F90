...
CONTAINS
  ...
  !> This procedure allocates the proper time configurator
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_MODEL_CONFIGURATOR => GRIB2_SECTION4_032_BUILD_MODEL_HANDLER
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_032_FREE( THIS, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_032_BUILD_MODEL_HANDLER'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_032_BUILD_MODEL_HANDLER( THIS, &
&               CFG, OPT, FACTORIES, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_032_BUILD_MODEL_HANDLER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
