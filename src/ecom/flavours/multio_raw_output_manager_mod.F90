...
IMPLICIT NONE
  ...
  IF ( CFG%GET( MULTIO_RAW_OMNAME, MULTIO_RAW_CFG ) ) THEN
...
IMPLICIT NONE
  ...
  IF ( THIS%VERBOSE_ ) THEN
    ...
    WRITE(THIS%LOG_FNAME_,'(A,I8.8,A)', IOSTAT=STAT) MULTIO_RAW_OMNAME//'-output-manager-', PROCESSOR_TOPO%MYPROC_IO, '.log'
