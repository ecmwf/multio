...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_INITIALIZATION_ERROR)  GRIB2_PARAM_CONFIGURATOR%INIT( CFG, OPT, HOOKS )
...
IMPLICIT NONE
  ...
  !> Initialization of the section
  PP_TRYCALL(ERRFLAG_INITIALIZATION_ERROR)  GRIB2_PARAM_CONFIGURATOR%INIT( MSG, PAR, OPT, HOOKS )
