...
CONTAINS
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_DIRFREQ_CONFIGURATOR => GRIB2_SECTION4_103_BUILD_FREQDIR_HANDLER
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_103_BUILD_FREQDIR_HANDLER'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_103_BUILD_FREQDIR_HANDLER( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_103_BUILD_FREQDIR_HANDLER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
