...
CONTAINS
  ...
  PROCEDURE, NON_OVERRIDABLE, PUBLIC, PASS :: DUMP_SAMPLE  => LOG_METADATA_DUMP_SAMPLE

  !> @brief Get the size in bytes of the sample
  PROCEDURE, NON_OVERRIDABLE, PUBLIC, PASS :: SAMPLE_SIZE  => LOG_METADATA_SAMPLE_SIZE
  
  PROCEDURE, NON_OVERRIDABLE, PUBLIC, PASS :: SAFE_LOAD  => LOG_METADATA_SAFE_LOAD
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'LOG_METADATA_DUMP_SAMPLE'
PP_THREAD_SAFE FUNCTION LOG_METADATA_DUMP_SAMPLE( THIS, NAME, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Open the grib file
  PP_LOG_DEVELOP_STR( 'Dump sample not applicable to log metadata' )
...
END FUNCTION LOG_METADATA_DUMP_SAMPLE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'LOG_METADATA_SAMPLE_SIZE'
PP_THREAD_SAFE FUNCTION LOG_METADATA_SAMPLE_SIZE( THIS, SIZE, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Associate an invalid value to the return value
  SIZE = -1_JPIB_K
...
END FUNCTION LOG_METADATA_SAMPLE_SIZE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'LOG_METADATA_SAFE_LOAD'
PP_THREAD_SAFE FUNCTION LOG_METADATA_SAFE_LOAD( THIS, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Open the grib file
  PP_LOG_DEVELOP_STR( 'SAFE LOAD not applicable to log metadata' )
...
END FUNCTION LOG_METADATA_SAFE_LOAD
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
