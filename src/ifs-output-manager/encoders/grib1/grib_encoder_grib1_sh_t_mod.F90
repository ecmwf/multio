...
SUBROUTINE MAKE_GRIB1_SH_T_ENCODER( CFG, MODEL_PARAMS, METADATA_KIND, ENCODER )
...
SUBROUTINE ENCODER_GRIB1_SH_T_INITIALISE( THIS, MODEL_PARAMS, METADATA_KIND )
...
IMPLICIT NONE
  ...
  CALL GRIB_NEW_FROM_SAMPLES( THIS%SAMPLE_HANDLE_, TRIM(ADJUSTL(SAMPLE_NAME_GRIB1_SH_T)), STATUS=KRET )
...
IMPLICIT NONE
  ...
  PP_METADATA_INIT_FROM_SAMPLE( METADATA, SAMPLE_NAME_GRIB1_SH_T, THIS%SAMPLE_HANDLE_ )
