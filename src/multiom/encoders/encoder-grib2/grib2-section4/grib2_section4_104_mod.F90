...
IMPLICIT NONE
  ...
  !> Local parameters
  CHARACTER(LEN=*), PARAMETER :: PARAM_CONFIGURATOR_NAME='derections-frequencies-configurator'
  ...
  !> Make the indicator-section
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_PARAM_CONFIGURATOR) MAKE_GRIB2_DIRFREQ_CONFIGURATOR( THIS%PARAMID_, THIS%TEMPLATE_NUMBER_, PARAM_CONFIGURATOR_CFG, OPT, HOOKS )
