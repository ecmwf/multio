...
IMPLICIT NONE
  ...
  CASE ( 'scale-factor-of-wave-direction' )
    ITERATOR = PAR_ITERATOR_PERIOD_SCALE_FACTOR_DIR

  CASE ( 'scale-factor-of-wave-frequency' )
...
IMPLICIT NONE
  ...
  CASE (PAR_ITERATOR_PERIOD_SCALE_FACTOR_DIR)
    IF ( PAR_DICTIONARY%WAVE%SCALE_FACTOR_OF_WAVE_DIRECTION  .NE. UNDEF_PARAM_E ) THEN
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    ENDIF
  ...
  CASE (PAR_ITERATOR_PERIOD_SCALE_FACTOR_FREQ)
    IF ( PAR_DICTIONARY%WAVE%SCALE_FACTOR_OF_WAVE_FREQUENCY  .NE. UNDEF_PARAM_E ) THEN
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    ENDIF
...
IMPLICIT NONE
  ...
  CASE (PAR_ITERATOR_PERIOD_SCALE_FACTOR_DIR)
    KEY = 'scale-factor-of-wave-direction'

  CASE (PAR_ITERATOR_PERIOD_SCALE_FACTOR_FREQ)
    KEY = 'scale-factor-of-wave-frequency'
...
IMPLICIT NONE
  ...
  CASE (PAR_ITERATOR_PERIOD_SCALE_FACTOR_DIR)
    IF ( PAR_DICTIONARY%WAVE%SCALE_FACTOR_OF_WAVE_DIRECTION  .NE. UNDEF_PARAM_E ) THEN
      PP_TRYCALL(ERRFLAG_CONVERT_ENUM_STRING) CONVERT_TO_C_STRING( PAR_DICTIONARY%WAVE%SCALE_FACTOR_OF_WAVE_DIRECTION, VALUE, HOOKS )
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    ENDIF
  ...
  CASE (PAR_ITERATOR_PERIOD_SCALE_FACTOR_FREQ)
    IF ( PAR_DICTIONARY%WAVE%SCALE_FACTOR_OF_WAVE_FREQUENCY  .NE. UNDEF_PARAM_E ) THEN
      PP_TRYCALL(ERRFLAG_CONVERT_ENUM_STRING) CONVERT_TO_C_STRING( PAR_DICTIONARY%WAVE%SCALE_FACTOR_OF_WAVE_FREQUENCY, VALUE, HOOKS )
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    ENDIF
...
IMPLICIT NONE
  ...
  CASE (PAR_ITERATOR_PERIOD_SCALE_FACTOR_DIR)
    PP_TRYCALL(ERRFLAG_CONVERT_PAR_TO_ENUM) CINT2IINT(VALUE, ITEMP, HOOKS)
    PAR_DICTIONARY%WAVE%SCALE_FACTOR_OF_WAVE_DIRECTION = ITEMP

  CASE (PAR_ITERATOR_PERIOD_SCALE_FACTOR_FREQ)
    PP_TRYCALL(ERRFLAG_CONVERT_PAR_TO_ENUM) CINT2IINT(VALUE, ITEMP, HOOKS)
    PAR_DICTIONARY%WAVE%SCALE_FACTOR_OF_WAVE_FREQUENCY = ITEMP
...
IMPLICIT NONE
  ...
  CASE (PAR_ITERATOR_PERIOD_SCALE_FACTOR_DIR)
    PAR_DICTIONARY%WAVE%SCALE_FACTOR_OF_WAVE_DIRECTION = VALUE

  CASE (PAR_ITERATOR_PERIOD_SCALE_FACTOR_FREQ)
    PAR_DICTIONARY%WAVE%SCALE_FACTOR_OF_WAVE_FREQUENCY = VALUE
