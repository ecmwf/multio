...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_INIT_ORIGIN_HANDLER)         THIS%BUILD_ORIGIN_FROM_CFG( CFG, OPT, FACTORIES, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_INIT_TABLES_HANDLER)         THIS%BUILD_TABLES_FROM_CFG( CFG, OPT, FACTORIES, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_INIT_REFERENCE_TIME_HANDLER) THIS%BUILD_REFERENCE_TIME_FROM_CFG( CFG, OPT, FACTORIES, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_INIT_DATA_TYPE_HANDLER)      THIS%BUILD_DATA_TYPE_FROM_CFG( CFG, OPT, FACTORIES, HOOKS )
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_BUILD_ORIGIN_HANDLER) FACTORIES%MAKE_GRIB2_ORIGIN_CONFIGURATOR_LAZY( &
&    THIS%ORIGIN_, THIS%TEMPLATE_NUMBER_, MSG, PAR, OPT, FACTORIES, HOOKS )

  PP_TRYCALL(ERRFLAG_UNABLE_TO_BUILD_TABLES_HANDLER) FACTORIES%MAKE_GRIB2_TABLES_CONFIGURATOR_LAZY( &
&    THIS%TABLES_, THIS%TEMPLATE_NUMBER_, MSG, PAR, OPT, FACTORIES, HOOKS )

  PP_TRYCALL(ERRFLAG_UNABLE_TO_BUILD_REFERENCE_TIME_HANDLER) FACTORIES%MAKE_GRIB2_REFERENCE_TIME_CONFIGURATOR_LAZY( &
&    THIS%REFERENCE_TIME_, THIS%TEMPLATE_NUMBER_, MSG, PAR, OPT, FACTORIES, HOOKS )

  PP_TRYCALL(ERRFLAG_UNABLE_TO_BUILD_DATA_TYPE_HANDLER) FACTORIES%MAKE_GRIB2_DATA_TYPE_CONFIGURATOR_LAZY( &
&    THIS%DATA_TYPE_, THIS%TEMPLATE_NUMBER_, MSG, PAR, OPT, FACTORIES, HOOKS )
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION1_000_FREE(  THIS, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Destroy subsections
  PP_TRYCALL(ERRFLAG_UNABLE_TO_DESTROY_ORIGIN)         DESTRUCTORS%DESTROY_GRIB2_ORIGIN_CONFIGURATOR( THIS%ORIGIN_, OPT, DESTRUCTORS, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_DESTROY_TABLES)         DESTRUCTORS%DESTROY_GRIB2_TABLES_CONFIGURATOR( THIS%TABLES_, OPT, DESTRUCTORS, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_DESTROY_REFERENCE_TIME) DESTRUCTORS%DESTROY_GRIB2_REFERENCE_TIME_CONFIGURATOR( THIS%REFERENCE_TIME_, OPT, DESTRUCTORS, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_DESTROY_DATA_TYPE)      DESTRUCTORS%DESTROY_GRIB2_DATA_TYPE_CONFIGURATOR( THIS%DATA_TYPE_, OPT, DESTRUCTORS, HOOKS )
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_ORIGIN_CONFIGURATOR) FACTORIES%MAKE_GRIB2_ORIGIN_CONFIGURATOR_CFG( &
&    THIS%ORIGIN_, THIS%TEMPLATE_NUMBER_, ORIGIN_CONFIGURATOR_CFG, OPT, FACTORIES, HOOKS )
...
IMPLICIT NONE
  ...
  !> Make the indicator-section
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_TABLES_CONFIGURATOR) FACTORIES%MAKE_GRIB2_TABLES_CONFIGURATOR_CFG( &
&    THIS%TABLES_, THIS%TEMPLATE_NUMBER_, TABLES_CONFIGURATOR_CFG, OPT, FACTORIES, HOOKS )
...
IMPLICIT NONE
  ...
  !> Make the indicator-section
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_REFERENCE_TIME_CONFIGURATOR) FACTORIES%MAKE_GRIB2_REFERENCE_TIME_CONFIGURATOR_CFG( &
&   THIS%REFERENCE_TIME_, THIS%TEMPLATE_NUMBER_, REFERENCE_TIME_CONFIGURATOR_CFG, OPT, FACTORIES, HOOKS )
...
IMPLICIT NONE
  ...
  !> Make the indicator-section
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_DATA_TYPE_CONFIGURATOR) FACTORIES%MAKE_GRIB2_DATA_TYPE_CONFIGURATOR_CFG( &
&   THIS%DATA_TYPE_, THIS%TEMPLATE_NUMBER_, DATA_TYPE_CONFIGURATOR_CFG, OPT, FACTORIES, HOOKS )
