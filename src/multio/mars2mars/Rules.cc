...
const RuleList& mapAtmosphericComposition() {
    static auto rules_ = ruleList(
        ...
        rule(all(matchParams(217051)), setKey(&dm::FullMarsRecord::param, 402000), setKey(&dm::FullMarsRecord::chem, 900)),
        ...
        rule(all(matchParams(217054)), setKey(&dm::FullMarsRecord::param, 402000), setKey(&dm::FullMarsRecord::chem, 112)),
        ...
        rule(all(matchParams(217206)), setKey(&dm::FullMarsRecord::param, 402000), setKey(&dm::FullMarsRecord::chem, 917)),
        ...
        rule(all(matchParams(218206)), setKey(&dm::FullMarsRecord::param, 401000), setKey(&dm::FullMarsRecord::chem, 917)),
