...
SUBROUTINE NOOP_WRITE_ATM_DP( THIS, YDMSG, VALUES )
...
SUBROUTINE NOOP_WRITE_ATM_SP( THIS, YDMSG, VALUES )
...
SUBROUTINE NOOP_WRITE_WAM_DP( THIS, YDMSG, VALUES )
...
SUBROUTINE NOOP_WRITE_WAM_SP( THIS, YDMSG, VALUES )
