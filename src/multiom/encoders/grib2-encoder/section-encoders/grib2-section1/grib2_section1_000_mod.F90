...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_SECTION1_000_INIT_CFG
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_ALLOCATE_ORIGIN)         THIS%ORIGIN_%ALLOCATE( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_ALLOCATE_TABLES)         THIS%TABLES_%ALLOCATE( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_ALLOCATE_REFERENCE_TIME) THIS%REFERENCE_TIME_%ALLOCATE( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_ALLOCATE_DATA_TYPE)      THIS%DATA_TYPE_%ALLOCATE( MSG, GEO, PAR, OPT, METADATA, HOOKS )
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_PRESET_ORIGIN)         THIS%ORIGIN_%PRESET( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_PRESET_TABLES)         THIS%TABLES_%PRESET( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_PRESET_REFERENCE_TIME) THIS%REFERENCE_TIME_%PRESET( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_PRESET_DATA_TYPE)      THIS%DATA_TYPE_%PRESET( MSG, GEO, PAR, OPT, METADATA, HOOKS )
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_RUNTIME_ORIGIN)         THIS%ORIGIN_%RUNTIME(  MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_RUNTIME_TABLES)         THIS%TABLES_%RUNTIME(  MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_RUNTIME_REFERENCE_TIME) THIS%REFERENCE_TIME_%RUNTIME(  MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_RUNTIME_DATA_TYPE)      THIS%DATA_TYPE_%RUNTIME(  MSG, GEO, PAR, OPT, METADATA, HOOKS )
