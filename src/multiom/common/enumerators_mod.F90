...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: MODEL_IFS_E=4_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MODEL_AIFS_SINGLE_E=5_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MODEL_AIFS_ENS_E=6_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MODEL_AIFS_SINGLE_MSE_E=7_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MODEL_AIFS_ENS_CRPS_E=8_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MODEL_AIFS_ENS_DIFF_E=9_JPIB_K
