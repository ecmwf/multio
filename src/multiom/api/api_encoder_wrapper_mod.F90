...
IMPLICIT NONE
  ...
  ELSE
    ...
    ENCODER_FNAME = '{MULTIO_INSTALL_DIR}/share/multiom/49r2v9/mappings/mapping-rules.yaml'
    MAPPING_FNAME =  '{MULTIO_INSTALL_DIR}/share/multiom/49r2v9/encodings/encoding-rules.yaml'
    SAMPLE_FNAME   = '{MULTIO_INSTALL_DIR}/share/multiom/49r2v9/samples/sample.tmpl'
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_EXTRACT_ENCODER) EXTRACT_ENCODER( F_PAR_DICT, ENCODER, HOOKS )
