...
IMPLICIT NONE
  ...
  ! There are currently no legacy GRIB2 definitions for:
  !   NGRBMXTPR3, NGRBMNTPR3, NGRBMXTPR6, NGRBMNTPR6
  SELECT CASE (ILPARAM)
  CASE(NGRBSTL1,  NGRBSTL2,  NGRBSTL3,  NGRBSTL4,&
    &  NGRBISTL1, NGRBISTL2, NGRBISTL3, NGRBISTL4,&
    &  NGRBSWVL1, NGRBSWVL2, NGRBSWVL3, NGRBSWVL4, &
    &  NGRBMX2T3, NGRBMN2T3, NGRB10FG3, &
    &  NGRBMX2T6, NGRBMN2T6, NGRB10FG6, &
