...
#define PP_FILE_NAME 'grib_section_base_mod.F90'
...
TYPE :: GRIB_SECTION_FACTORY_T
  ...
  PROCEDURE(GRIB_SECTION_FACTORY_CFG), POINTER, NOPASS :: MAKE_GRIB2_SECTION0_CFG => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_CFG), POINTER, NOPASS :: MAKE_GRIB2_SECTION1_CFG => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_CFG), POINTER, NOPASS :: MAKE_GRIB2_SECTION2_CFG => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_CFG), POINTER, NOPASS :: MAKE_GRIB2_SECTION3_CFG => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_CFG), POINTER, NOPASS :: MAKE_GRIB2_SECTION4_CFG => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_CFG), POINTER, NOPASS :: MAKE_GRIB2_SECTION5_CFG => NULL()

  PROCEDURE(GRIB_SECTION_FACTORY_CFG),  POINTER, NOPASS :: MAKE_GRIB2_ORIGIN_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_LAZY), POINTER, NOPASS :: MAKE_GRIB2_ORIGIN_CONFIGURATOR_LAZY => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_CFG),  POINTER, NOPASS :: MAKE_GRIB2_TABLES_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_LAZY), POINTER, NOPASS :: MAKE_GRIB2_TABLES_CONFIGURATOR_LAZY => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_CFG),  POINTER, NOPASS :: MAKE_GRIB2_REFERENCE_TIME_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_LAZY), POINTER, NOPASS :: MAKE_GRIB2_REFERENCE_TIME_CONFIGURATOR_LAZY => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_CFG),  POINTER, NOPASS :: MAKE_GRIB2_DATA_TYPE_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_LAZY), POINTER, NOPASS :: MAKE_GRIB2_DATA_TYPE_CONFIGURATOR_LAZY => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_CFG),  POINTER, NOPASS :: MAKE_GRIB2_MODEL_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_LAZY), POINTER, NOPASS :: MAKE_GRIB2_MODEL_CONFIGURATOR_LAZY => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_CFG),  POINTER, NOPASS :: MAKE_GRIB2_POINT_IN_TIME_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_LAZY), POINTER, NOPASS :: MAKE_GRIB2_POINT_IN_TIME_CONFIGURATOR_LAZY => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_CFG),  POINTER, NOPASS :: MAKE_GRIB2_PARAM_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_LAZY), POINTER, NOPASS :: MAKE_GRIB2_PARAM_CONFIGURATOR_LAZY => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_CFG),  POINTER, NOPASS :: MAKE_GRIB2_LEVEL_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_LAZY), POINTER, NOPASS :: MAKE_GRIB2_LEVEL_CONFIGURATOR_LAZY => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_CFG),  POINTER, NOPASS :: MAKE_GRIB2_ENSEMBLE_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_LAZY), POINTER, NOPASS :: MAKE_GRIB2_ENSEMBLE_CONFIGURATOR_LAZY => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_CFG),  POINTER, NOPASS :: MAKE_GRIB2_STATISTICS_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_LAZY), POINTER, NOPASS :: MAKE_GRIB2_STATISTICS_CONFIGURATOR_LAZY => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_CFG),  POINTER, NOPASS :: MAKE_GRIB2_SATELLITE_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_LAZY), POINTER, NOPASS :: MAKE_GRIB2_SATELLITE_CONFIGURATOR_LAZY => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_CFG),  POINTER, NOPASS :: MAKE_GRIB2_CHEM_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_LAZY), POINTER, NOPASS :: MAKE_GRIB2_CHEM_CONFIGURATOR_LAZY => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_CFG),  POINTER, NOPASS :: MAKE_GRIB2_DIRFREQ_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_LAZY), POINTER, NOPASS :: MAKE_GRIB2_DIRFREQ_CONFIGURATOR_LAZY => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_CFG),  POINTER, NOPASS :: MAKE_GRIB2_PERIOD_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_LAZY), POINTER, NOPASS :: MAKE_GRIB2_PERIOD_CONFIGURATOR_LAZY => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_CFG),  POINTER, NOPASS :: MAKE_GRIB2_RANDOM_PATTERNS_CONFIGURATOR_CFG => NULL()
  PROCEDURE(GRIB_SECTION_FACTORY_LAZY), POINTER, NOPASS :: MAKE_GRIB2_RANDOM_PATTERNS_CONFIGURATOR_LAZY => NULL()

END TYPE

TYPE :: GRIB_SECTION_DESTRUCTOR_T
  !> The function pointer type for the GRIB section factory
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_ORIGIN_CONFIGURATOR => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_TABLES_CONFIGURATOR => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_REFERENCE_TIME_CONFIGURATOR => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_DATA_TYPE_CONFIGURATOR => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_MODEL_CONFIGURATOR => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_LEVEL_CONFIGURATOR => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_PARAM_CONFIGURATOR => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_POINT_IN_TIME_CONFIGURATOR => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_STATISTICS_CONFIGURATOR => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_ENSEMBLE_CONFIGURATOR => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_CHEM_CONFIGURATOR => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_DIRFREQ_CONFIGURATOR => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_PERIOD_CONFIGURATOR => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_RANDOM_PATTERNS_CONFIGURATOR => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_SECTION0 => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_SECTION1 => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_SECTION2 => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_SECTION3 => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_SECTION4 => NULL()
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_SECTION5 => NULL()
END TYPE

TYPE :: ENCODER_REGISTER_T

  !> Visibility of the encoders register
  PRIVATE

  !> The function pointer type for the GRIB section factory
  PROCEDURE(GRIB_SECTION_FACTORY_CFG), POINTER, NOPASS :: MAKE_GRIB2_CFG => NULL()
  ...
  !> The function pointer type for the GRIB section factory
  PROCEDURE(GRIB_SECTION_DESTRUCTOR), POINTER, NOPASS :: DESTROY_GRIB2_CFG => NULL()
...
CONTAINS
  PROCEDURE, PUBLIC, PASS :: REGISTER => ENCODERS_REGISTER_REGISTER
  PROCEDURE, PUBLIC, PASS :: RESET    => ENCODERS_REGISTER_RESET
  PROCEDURE, PUBLIC, PASS :: MAKE     => ENCODERS_REGISTER_MAKE
  PROCEDURE, PUBLIC, PASS :: DESTROY  => ENCODERS_REGISTER_DESTROY
  PROCEDURE, PUBLIC, PASS :: FREE     => ENCODERS_REGISTER_FREE
END TYPE


INTERFACE
PP_THREAD_SAFE FUNCTION GRIB_SECTION_FACTORY_CFG( GRIB_SECTION, ID, CFG, OPT, FACTORIES, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB_SECTION_FACTORY_CFG

PP_THREAD_SAFE FUNCTION GRIB_SECTION_FACTORY_LAZY( GRIB_SECTION, ID, MSG, PAR, OPT, FACTORIES, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB_SECTION_FACTORY_LAZY

PP_THREAD_SAFE FUNCTION GRIB_SECTION_DESTRUCTOR( GRIB_SECTION, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
  ...
  ! Imported abstract class
  IMPORT :: GRIB_SECTION_BASE_A
  IMPORT :: GRIB_SECTION_DESTRUCTOR_T
...
END FUNCTION GRIB_SECTION_DESTRUCTOR
...
&               OPT, FACTORIES, HOOKS ) RESULT(RET)
...
!>
PP_THREAD_SAFE FUNCTION GRIB_SECTION_FREE_IF( THIS, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
...
PUBLIC :: GRIB_SECTION_DESTRUCTOR_T
...
#define PP_PROCEDURE_NAME 'ENCODERS_REGISTER_REGISTER'
PP_THREAD_SAFE FUNCTION ENCODERS_REGISTER_REGISTER( THIS, NAME, MAKE_CALLBACK, DESTRUCTOR_CALLBACK, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(ENCODER_REGISTER_T),                    INTENT(INOUT) :: THIS
  CHARACTER(LEN=*),                             INTENT(OUT)   :: NAME
  PROCEDURE(GRIB_SECTION_FACTORY_CFG), POINTER, INTENT(IN)    :: MAKE_CALLBACK
  PROCEDURE(GRIB_SECTION_DESTRUCTOR),  POINTER, INTENT(IN)    :: DESTRUCTOR_CALLBACK
  TYPE(HOOKS_T),                                INTENT(INOUT) :: HOOKS
...
END FUNCTION ENCODERS_REGISTER_REGISTER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE

#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'ENCODERS_REGISTER_RESET'
PP_THREAD_SAFE FUNCTION ENCODERS_REGISTER_RESET( THIS, HOOKS ) RESULT(RET)
...
END FUNCTION ENCODERS_REGISTER_RESET
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE

#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'ENCODERS_REGISTER_FREE'
PP_THREAD_SAFE FUNCTION ENCODERS_REGISTER_FREE( THIS, HOOKS ) RESULT(RET)
...
END FUNCTION ENCODERS_REGISTER_FREE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE

#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'ENCODERS_REGISTER_MAKE'
PP_THREAD_SAFE FUNCTION ENCODERS_REGISTER_MAKE( THIS, GRIB_SECTION, ID, CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION ENCODERS_REGISTER_MAKE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'ENCODERS_REGISTER_DESTROY'
PP_THREAD_SAFE FUNCTION ENCODERS_REGISTER_DESTROY( THIS, GRIB_SECTION, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION ENCODERS_REGISTER_DESTROY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
