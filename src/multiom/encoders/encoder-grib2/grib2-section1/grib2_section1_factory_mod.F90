...
PP_THREAD_SAFE FUNCTION MAKE_GRIB2_SECTION1_CFG( GRIB2_SECTION1, DUMMY, &
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_INITIALIZATION_ERROR)  GRIB2_SECTION1%INIT( CFG, OPT, FACTORIES, HOOKS )
...
PP_THREAD_SAFE FUNCTION MAKE_GRIB2_SECTION1_LAZY( GRIB2_SECTION1, DUMMY, &
...
IMPLICIT NONE
  ...
  !> Initialization of the section
  PP_TRYCALL(ERRFLAG_INITIALIZATION_ERROR)  GRIB2_SECTION1%INIT( MSG, PAR, OPT, FACTORIES, HOOKS )
#else
...
PP_THREAD_SAFE FUNCTION DESTROY_GRIB2_SECTION1( GRIB2_SECTION1, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Free the section
  PP_TRYCALL(ERRFLAG_FREE_ERROR)  GRIB2_SECTION1%FREE( OPT, DESTRUCTORS, HOOKS )
