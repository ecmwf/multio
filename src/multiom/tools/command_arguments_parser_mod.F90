...
INTEGER(KIND=JPIB_K), PARAMETER :: ARG_REPLACE_FLUSH_STEP_AND_RESTART_E = 5_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: ARG_OUTPUT_MANAGER_E = 6_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: ARG_CONFIGURATION_FILE_E = 7_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: ARG_SEED_E = 8_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: ARG_READ_BIG_ENDIAN_E = 9_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: ARG_PROCESSORS_E = 10_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: ARG_PARAM_E = 11_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: ARG_REPRES_E = 12_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: ARG_LEVTYPE_E = 13_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: ARG_LEVEL_E = 14_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: ARG_STEP_E = 15_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: ARG_FREQUENCY_E = 16_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: ARG_DIRCTION_E = 17_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: ARG_FILTER_FILE_E = 18_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: ARG_USAGE_E = 19_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: ARG_LAST_E = 19_JPIB_K
...
TYPE :: COMMAND_LINE_ARGS_T
  ...
  LOGICAL :: REPLACE_FLUSH_STEP_AND_RESTART=.FALSE.
...
CONTAINS
  ...
  PROCEDURE, PUBLIC,  PASS, NON_OVERRIDABLE :: GET_REPLACE_FLUSH_STEP_AND_RESTART => COMMAND_LINE_ARGS_GET_REPLACE_FLUSH_STEP_AND_RESTART
  ...
  PROCEDURE, PRIVATE, PASS, NON_OVERRIDABLE :: PARSE_REPLACE_FLUSH_STEP_AND_RESTART => CMDARG_PARSE_REPLACE_FLUSH_STEP_AND_RESTART
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PARSE_REPLACE_FLUSH_STEP_AND_RESTART = 12_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PARSE_OUTPUT_MANAGER_TYPE = 13_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PARSE_CONFIGURATION_FILE = 14_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PARSE_PROCESSORS = 15_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PARSE_PARAM = 16_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PARSE_REPRES = 17_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PARSE_LEVTYPE = 18_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PARSE_LEVEL = 19_JPIB_K
  ...
  DO ARGID = 1, ARGSCOUNT
    ...
    CASE ( ARG_REPLACE_FLUSH_STEP_AND_RESTART_E )
      PP_TRYCALL(ERRFLAG_PARSE_REPLACE_FLUSH_STEP_AND_RESTART) THIS%PARSE_REPLACE_FLUSH_STEP_AND_RESTART( MATCH, VALUES, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_PARSE_REPLACE_FLUSH_STEP_AND_RESTART)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Error parsing the replace flush step and restart flag' )
...
IMPLICIT NONE
  ...
  ! Print Replace flush step and restart
  WRITE(UNIT, '(A)', IOSTAT=WRITE_STAT ) ' '
  PP_DEBUG_CRITICAL_COND_THROW( WRITE_STAT .NE. 0_JPIB_K, ERRFLAG_WRITE_ERROR )
  WRITE(UNIT, '(A)', IOSTAT=WRITE_STAT ) '----------------------------------------------'
  PP_DEBUG_CRITICAL_COND_THROW( WRITE_STAT .NE. 0_JPIB_K, ERRFLAG_WRITE_ERROR )
  WRITE(UNIT, '(A,L1)', IOSTAT=WRITE_STAT ) 'REPLACE FLUSH STEP AND RESTART: ', THIS%REPLACE_FLUSH_STEP_AND_RESTART
  PP_DEBUG_CRITICAL_COND_THROW( WRITE_STAT .NE. 0_JPIB_K, ERRFLAG_WRITE_ERROR )
...
IMPLICIT NONE
  ...
  WRITE( *, '(A)', IOSTAT=WRITE_STAT) ''
  PP_DEBUG_CRITICAL_COND_THROW( WRITE_STAT .NE. 0_JPIB_K, ERRFLAG_PRINT_USAGE_FILE )
  WRITE( *, '(A)', IOSTAT=WRITE_STAT) '*  -a, --replace-flush-step-and-restart'
  PP_DEBUG_CRITICAL_COND_THROW( WRITE_STAT .NE. 0_JPIB_K, ERRFLAG_PRINT_USAGE_FILE )
  WRITE( *, '(A)', IOSTAT=WRITE_STAT) '      format:      Flag only'
  PP_DEBUG_CRITICAL_COND_THROW( WRITE_STAT .NE. 0_JPIB_K, ERRFLAG_PRINT_USAGE_FILE )
  WRITE( *, '(A)', IOSTAT=WRITE_STAT) '      description: Replace default flushes with step-and-restart flushes'
  PP_DEBUG_CRITICAL_COND_THROW( WRITE_STAT .NE. 0_JPIB_K, ERRFLAG_PRINT_USAGE_FILE )
  WRITE( *, '(A)', IOSTAT=WRITE_STAT) ''
  PP_DEBUG_CRITICAL_COND_THROW( WRITE_STAT .NE. 0_JPIB_K, ERRFLAG_PRINT_USAGE_FILE )
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'COMMAND_LINE_ARGS_REPLACE_FLUSH_STEP_AND_RESTART'
PP_THREAD_SAFE FUNCTION COMMAND_LINE_ARGS_GET_REPLACE_FLUSH_STEP_AND_RESTART( THIS, REPLACE_FLUSH_STEP_AND_RESTART, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  CLASS(COMMAND_LINE_ARGS_T), INTENT(IN)    :: THIS
  LOGICAL,                    INTENT(OUT)   :: REPLACE_FLUSH_STEP_AND_RESTART
  TYPE(HOOKS_T),              INTENT(INOUT) :: HOOKS
  ...
  ! Copy the configuration file
  REPLACE_FLUSH_STEP_AND_RESTART = THIS%REPLACE_FLUSH_STEP_AND_RESTART
...
END FUNCTION COMMAND_LINE_ARGS_GET_REPLACE_FLUSH_STEP_AND_RESTART
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
IMPLICIT NONE
  ...
  CASE ( 'a' )
    IARG = ARG_REPLACE_FLUSH_STEP_AND_RESTART_E
...
IMPLICIT NONE
  ...
  CASE ( 'replace-flush-step-and-restart' )
    IARG = ARG_REPLACE_FLUSH_STEP_AND_RESTART_E
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_REPLACE_FLUSH_STEP_AND_RESTART_WITH_FILTER_FILE = 17_JPIB_K
  ...
  ELSE
    ...
    PP_DEBUG_CRITICAL_COND_THROW( ARGS_CHACKER(ARG_REPLACE_FLUSH_STEP_AND_RESTART_E).NE.0, ERRFLAG_REPLACE_FLUSH_STEP_AND_RESTART_WITH_FILTER_FILE )
  ENDIF
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_REPLACE_FLUSH_STEP_AND_RESTART_WITH_FILTER_FILE)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Replace flush step and restart with filter file' )
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'CMDARG_PARSE_REPLACE_FLUSH_STEP_AND_RESTART'
PP_THREAD_SAFE FUNCTION CMDARG_PARSE_REPLACE_FLUSH_STEP_AND_RESTART( THIS, MATCH, VALUES, HOOKS )  RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Parse the use values flag
  THIS%REPLACE_FLUSH_STEP_AND_RESTART = .TRUE.
...
END FUNCTION CMDARG_PARSE_REPLACE_FLUSH_STEP_AND_RESTART
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
IMPLICIT NONE
  ...
  IF (HAS_OPTIONS) THEN
    ...
    !
    ! Read output manager type
    PP_TRYCALL(ERRFLAG_HAS_KEY) YAML_CONFIGURATION_HAS_KEY( OPTIONS_CFG, 'replace-flush-step-and-restart', HAS_KEY, HOOKS )
    ...
    IF ( HAS_KEY ) THEN
      ...
      ! Read output manager type
      CTMP(1) = REPEAT( ' ', CMDARG_STRLEN )
      PP_TRYCALL(ERRFLAG_HAS_KEY) YAML_READ_STRING_WITH_ENV_EXPANSION( OPTIONS_CFG, 'replace-flush-step-and-restart', ATMP, HOOKS )
      PP_DEBUG_CRITICAL_COND_THROW( .NOT.ALLOCATED(ATMP), ERRFLAG_READ_STRING )
      READ(ATMP,*,IOSTAT=READ_STAT) THIS%REPLACE_FLUSH_STEP_AND_RESTART
      PP_DEBUG_CRITICAL_COND_THROW( READ_STAT.NE.0, ERRFLAG_READ_BOOL )
      DEALLOCATE(ATMP, STAT=DEALLOC_STAT, ERRMSG=ERRMSG)
    ENDIF
