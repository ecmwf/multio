!>
!> @file grib2_section4_snowlayer_mod.F90
!>
!> @brief Module for managing GRIB2 Section 4 level configuration operations.
!>
!> The `G2S4_SNOWLAYER_MOD` module contains procedures to initialize, allocate,
...
#define PP_FILE_NAME 'grib2_section4_snowlayer_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'GRIB2_SECTION4_SNOWLAYER_MOD'
MODULE GRIB2_SECTION4_SNOWLAYER_MOD
...
CHARACTER(LEN=*), PARAMETER :: TYPE_OF_LEVEL = 'snowLayer'
INTEGER(KIND=JPIB_K), PARAMETER :: TYPE_OF_FIRST_FIXED_SURFACE = 114_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: TYPE_OF_SECOND_FIXED_SURFACE = 114_JPIB_K

!>
!> @brief Type definition for GRIB2 Section 4 level configuration handler.
!>
!> The `GRIB2_SECTION4_SNOWLAYER_T` type extends the base class `GRIB_SECTION_BASE_A` and
...
!> environments.
!>
TYPE, EXTENDS(GRIB_SECTION_BASE_A) :: GRIB2_SECTION4_SNOWLAYER_T
...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_CFG => G2S4_SNOWLAYER_INIT_CFG
  ...
  !> the GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_LAZY => G2S4_SNOWLAYER_INIT_LAZY
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ALLOCATE => G2S4_SNOWLAYER_ALLOC
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => G2S4_SNOWLAYER_PRESET
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => G2S4_SNOWLAYER_RT
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => G2S4_SNOWLAYER_TBE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: CHECK => G2S4_SNOWLAYER_CHECK
...
PUBLIC :: GRIB2_SECTION4_SNOWLAYER_T
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION4_SNOWLAYER_T` representing the GRIB section being initialized.
...
#define PP_PROCEDURE_NAME 'G2S4_SNOWLAYER_INIT_CFG'
PP_THREAD_SAFE FUNCTION G2S4_SNOWLAYER_INIT_CFG( THIS, &
...
END FUNCTION G2S4_SNOWLAYER_INIT_CFG
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_SNOWLAYER_INIT_LAZY'
PP_THREAD_SAFE FUNCTION G2S4_SNOWLAYER_INIT_LAZY( THIS, &
...
END FUNCTION G2S4_SNOWLAYER_INIT_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION4_SNOWLAYER_T` representing the GRIB section to allocate resources for.
!>   @param [in]    MSG      All the mars keywords needed to describe the field `FORTRAN_MESSAGE_T`.
!>   @param [in]    PAR      All information outside mars keywords needed to describe the field `PARAMETRIZATION_T`.
!>   @param [in]    OPT      The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_SNOWLAYER_ALLOC'
PP_THREAD_SAFE FUNCTION G2S4_SNOWLAYER_ALLOC( THIS, &
...
IMPLICIT NONE
  ...
  ! Logging
  PP_LOG_DEVELOP_STR( 'Allocate: snowLayer' )
...
END FUNCTION G2S4_SNOWLAYER_ALLOC
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_SNOWLAYER_PRESET'
PP_THREAD_SAFE FUNCTION G2S4_SNOWLAYER_PRESET( THIS, &
&  MSG, PAR, OPT,  METADATA, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Logging
  PP_LOG_DEVELOP_STR( 'Preset: snowLayer' )
...
END FUNCTION G2S4_SNOWLAYER_PRESET
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS      An object of type `GRIB2_SECTION4_SNOWLAYER_T` representing the GRIB section for runlevel execution.
!>   @param [in]    MSG       The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR       The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_SNOWLAYER_RT'
PP_THREAD_SAFE FUNCTION G2S4_SNOWLAYER_RT( THIS, &
...
END FUNCTION G2S4_SNOWLAYER_RT
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS          An object of type `GRIB2_SECTION4_SNOWLAYER_T` representing the GRIB section being checked.
!>   @param [in]    MSG           The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR           The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
!>   @param [in]    TIME_HIST     The time history object of type `TIME_HISTORY_T` providing historical level data.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_SNOWLAYER_TBE'
PP_THREAD_SAFE FUNCTION G2S4_SNOWLAYER_TBE( THIS, &
...
END FUNCTION G2S4_SNOWLAYER_TBE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION4_SNOWLAYER_T` representing the GRIB section to be freed.
!>   @param [in]    OPT   The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_SNOWLAYER_FREE'
PP_THREAD_SAFE FUNCTION G2S4_SNOWLAYER_FREE( THIS, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_SNOWLAYER_CHECK'
PP_THREAD_SAFE FUNCTION G2S4_SNOWLAYER_CHECK( THIS, &
&  MSG, PAR, OPT, METADATA, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! According to the options decide where to set the levels (preset or runlevel)
  PP_LOG_INFO( 'check typeOfLevel: snowLayer' )
...
END FUNCTION G2S4_SNOWLAYER_CHECK
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
