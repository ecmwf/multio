!>
!> @file grib2_section5_000_mod.F90
!>
!> @brief Module for managing GRIB2 SECTION 5 operations.
!>
!> The `GRIB2_SECTION5_000_MOD` module contains procedures to initialize, allocate,
...
!>   - @see GRIB2_SECTION5_000_INIT
!>   - @see GRIB2_SECTION5_000_ALLOCATE
!>   - @see GRIB2_SECTION5_000_PRESET
!>   - @see GRIB2_SECTION5_000_RUNTIME
!>   - @see GRIB2_SECTION5_000_TO_BE_ENCODED
!>   - @see GRIB2_SECTION5_000_FREE
!>
...
#define PP_FILE_NAME 'grib2_section5_000_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'GRIB2_SECTION5_000_MOD'
MODULE GRIB2_SECTION5_000_MOD
...
!>
!> The `GRIB2_SECTION5_000_T` type extends the base class `GRIB_SECTION_BASE_A` and
...
!> environments.
!>
TYPE, EXTENDS(GRIB_SECTION_BASE_A) :: GRIB2_SECTION5_000_T
...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_CFG => GRIB2_SECTION5_000_INIT_CFG
  ...
  !> the GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_LAZY => GRIB2_SECTION5_000_INIT_LAZY
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ALLOCATE => GRIB2_SECTION5_000_ALLOCATE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => GRIB2_SECTION5_000_PRESET
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => GRIB2_SECTION5_000_RUNTIME
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => GRIB2_SECTION5_000_TO_BE_ENCODED
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: FREE => GRIB2_SECTION5_000_FREE
...
#define PP_PROCEDURE_NAME 'GRIB2_SECTION5_000_INIT_CFG'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION5_000_INIT_CFG( THIS, &
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(GRIB2_SECTION5_000_T),  INTENT(INOUT) :: THIS
...
END FUNCTION GRIB2_SECTION5_000_INIT_CFG
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION5_000_INIT_LAZY'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION5_000_INIT_LAZY( THIS, &
...
END FUNCTION GRIB2_SECTION5_000_INIT_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION5_000_ALLOCATE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION5_000_ALLOCATE( THIS, &
...
IMPLICIT NONE
  ...
  PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'dataRepresentationTemplateNumber', 0_JPIB_K )
...
END FUNCTION GRIB2_SECTION5_000_ALLOCATE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION5_000_T` representing the GRIB section to be preset.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION5_000_PRESET'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION5_000_PRESET( THIS, &
&  MSG, PAR, OPT, METADATA, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION5_000_PRESET
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!> @section interface
!>
!> @param [in]    THIS          An object of type `GRIB2_SECTION5_000_T` representing the GRIB section to be allocated.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION5_000_RUNTIME'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION5_000_RUNTIME( THIS, &
...
END FUNCTION GRIB2_SECTION5_000_RUNTIME
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS          An object of type `GRIB2_SECTION5_000_T` representing the GRIB section being checked.
!>   @param [in]    MSG           The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR           The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION5_000_TO_BE_ENCODED'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION5_000_TO_BE_ENCODED( THIS, &
...
END FUNCTION GRIB2_SECTION5_000_TO_BE_ENCODED
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION5_000_FREE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION5_000_FREE(  THIS, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION5_000_FREE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
