...
int multio_config_mpi_allow_world_default_comm(multio_configuration_t* cc, bool allow);
int multio_config_mpi_parent_comm(multio_configuration_t* cc, int parent_comm);
int multio_config_mpi_return_client_comm(multio_configuration_t* cc, int* return_client_comm);
int multio_config_mpi_return_server_comm(multio_configuration_t* cc, int* return_server_comm);
