...
#define PP_FILE_NAME 'nested_rules_tree_loader_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'NESTED_RULES_TREE_LOADER_MOD'
MODULE NESTED_RULES_TREE_LOADER_MOD

  ! Symbols imported from other modules within the project.
  USE :: DATAKINDS_DEF_MOD, ONLY: JPIB_K
  USE :: NESTED_RULES_LINEAR_LOADER_MOD, ONLY: NESTED_RULES_LINEAR_LOADER_T
...
TYPE :: NESTED_RULES_TREE_LOADER_T
  ...
  ! Children nodes
  TYPE(NESTED_RULES_TREE_LOADER_NODE_T), POINTER :: HEAD => NULL()
...
TYPE :: NESTED_RULES_TREE_LOADER_NODE_T
  ...
  TYPE(NESTED_RULES_LINEAR_LOADER_T), POINTER :: RULES_COLLECTION => NULL()

  ! Children nodes
  TYPE(FILTER_CONTAINER_T), DIMENSION(:), POINTER :: FILTERS => NULL()
  TYPE(NESTED_RULES_TREE_LOADER_NODE_T), DIMENSION(:), POINTER :: CHILDREN => NULL()

CONTAINS

  PROCEDURE, PUBLIC, NON_OVERRIDABLE, PASS :: INIT_CFG  => NESTED_RULES_TREE_LOADER_NODE_INIT_CFG
  ...
  PROCEDURE, PUBLIC, NON_OVERRIDABLE, PASS :: SIZE  => NESTED_RULES_TREE_LOADER_NODE_SIZE

  PROCEDURE, PRIVATE, NON_OVERRIDABLE, PASS :: READ_OPERATION => NESTED_RULES_TREE_LOADER_NODE_READ_OPERATION

END TYPE

! Whitelist of public symbols
PUBLIC :: NESTED_RULES_TREE_LOADER_T

CONTAINS

#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'NESTED_RULES_TREE_LOADER_INIT'
PP_THREAD_SAFE FUNCTION NESTED_RULES_TREE_LOADER_INIT( THIS, CFG, FILTER_OPT, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(NESTED_RULES_TREE_LOADER_T), INTENT(INOUT) :: THIS
  ...
  !> Local variables
  TYPE(YAML_CONFIGURATION_T) :: NESTED_RULES_CONFIGURATION
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_NO_NESTED_RULES=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TWO_NESTED_RULES=4_JPIB_K
  ...
  PP_DEBUG_CRITICAL_COND_THROW( (.NOT.HAS_NESTED_RULES.AND..NOT.HAS_ENCODING_RULES), ERRFLAG_NO_NESTED_RULES )
  PP_DEBUG_CRITICAL_COND_THROW( (HAS_NESTED_RULES.AND.HAS_ENCODING_RULES), ERRFLAG_TWO_NESTED_RULES )
  ...
  IF ( HAS_NESTED_RULES ) THEN
    PP_TRYCALL(ERRFLAG_RULES_INITIALIZE) THIS%HEAD%INIT_CFG( CFG, FILTER_OPT, THIS%SIZE_, LEVEL, HOOKS )
  ELSEIF ( HAS_NESTED_RULES ) THEN
    PP_TRYCALL(ERRFLAG_RULES_INITIALIZE) THIS%HEAD%INIT_RULES( CFG, FILTER_OPT, THIS%SIZE_, LEVEL, HOOKS )
  ENDIF
...
END FUNCTION NESTED_RULES_TREE_LOADER_INIT
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'NESTED_RULES_TREE_LOADER_COUNT_MATCHES'
PP_THREAD_SAFE FUNCTION NESTED_RULES_TREE_LOADER_COUNT_MATCHES( THIS, MSG, NUM_MATCHES, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Match the rules
  PP_TRYCALL(ERRFLAG_MATCH_RULES) THIS%HEAD%COUNT_MATCHES( MSG, NUM_MATCHES, HOOKS )
...
END FUNCTION NESTED_RULES_TREE_LOADER_COUNT_MATCHES
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'NESTED_RULES_TREE_LOADER_SIZE'
PP_THREAD_SAFE FUNCTION NESTED_RULES_TREE_LOADER_SIZE( THIS, SZ, MAX_SZ, NLEVELS, HOOKS ) RESULT(RET)
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'NESTED_RULES_TREE_LOADER_MATCH_SINGLE'
PP_THREAD_SAFE FUNCTION NESTED_RULES_TREE_LOADER_MATCH_SINGLE( THIS, MSG, RULE, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  CLASS(NESTED_RULES_TREE_LOADER_T), INTENT(IN)    :: THIS
  TYPE(FORTRAN_MESSAGE_T),           INTENT(IN)    :: MSG
  TYPE(NESTED_RULE_T), POINTER,      INTENT(OUT)   :: RULE
  TYPE(HOOKS_T),                     INTENT(INOUT) :: HOOKS
  ...
  !> Match the rules
  PP_TRYCALL(ERRFLAG_MATCH_RULES) THIS%HEAD%MATCH_SINGLE( MSG, RULE, HOOKS )
...
END FUNCTION NESTED_RULES_TREE_LOADER_MATCH_SINGLE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'NESTED_RULES_TREE_LOADER_MATCH_MULTIPLE'
PP_THREAD_SAFE FUNCTION NESTED_RULES_TREE_LOADER_MATCH_MULTIPLE( THIS, MSG, RULES, IRULE, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Match the rules
  IRULE = 0_JPIB_K
  PP_TRYCALL(ERRFLAG_MATCH_RULES) THIS%HEAD%MATCH( MSG, RULES, IRULE, HOOKS )
...
END FUNCTION NESTED_RULES_TREE_LOADER_MATCH_MULTIPLE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'NESTED_RULES_TREE_LOADER_FREE'
PP_THREAD_SAFE FUNCTION NESTED_RULES_TREE_LOADER_FREE( THIS, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Free rules
  PP_TRYCALL(ERRFLAG_FREE_RULES) THIS%HEAD%FREE( HOOKS)
...
END FUNCTION NESTED_RULES_TREE_LOADER_FREE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'NESTED_RULES_TREE_LOADER_PRINT'
PP_THREAD_SAFE FUNCTION NESTED_RULES_TREE_LOADER_PRINT( THIS, UNIT, OFFSET, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  IF ( ASSOCIATED(THIS%HEAD) ) THEN
    PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT) THIS%HEAD%PRINT( UNIT, OFFSET, HOOKS )
  ENDIF
...
END FUNCTION NESTED_RULES_TREE_LOADER_PRINT
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'NESTED_RULES_TREE_LOADER_NODE_INIT_CFG'
RECURSIVE FUNCTION NESTED_RULES_TREE_LOADER_NODE_INIT_CFG( THIS, CFG, &
&               FILTER_OPT, SIZE, NESTING_LEVEL, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(NESTED_RULES_TREE_LOADER_NODE_T), INTENT(INOUT) :: THIS
  TYPE(YAML_CONFIGURATION_T),             INTENT(IN)    :: CFG
  TYPE(FILTER_OPTIONS_T),                 INTENT(IN)    :: FILTER_OPT
  ...
  ! Load rules only if present
  IF ( NUMBER_OF_OPERATIONS .GT. 0_JPIB_K ) THEN
    ...
    DO I = 1, NUMBER_OF_OPERATIONS
      ...
      !> Read the operation
      PP_TRYCALL(ERRFLAG_READ_OPERATION) THIS%READ_OPERATION( I, OPERATION, FILTER_OPT, NESTING_LEVEL, HOOKS )

      IF ( HAS_NESTED_RULES ) THEN
        PP_TRYCALL(ERRFLAG_READ_NESTED_RULES) THIS%CHILDREN(I)%INIT_CFG( OPERATION, FILTER_OPT, SIZE, NESTING_LEVEL+1, HOOKS )
      ELSEIF ( HAS_ENCODING_RULES ) THEN
        PP_TRYCALL(ERRFLAG_READ_RULES) THIS%CHILDREN(I)%INIT_RULES( OPERATION, FILTER_OPT, SIZE, NESTING_LEVEL+1, HOOKS )
      ENDIF
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE(ERRFLAG_WRONG_NUMBER_OF_OPERATIONS)
      CTMP = REPEAT(' ',32)
      WRITE(CTMP,'(I32)') NUMBER_OF_OPERATIONS
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'wrong number of operations' )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'number of operations: ' // TRIM(CTMP) )
...
END FUNCTION NESTED_RULES_TREE_LOADER_NODE_INIT_CFG
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'NESTED_RULES_TREE_LOADER_NODE_INIT_RULES'
RECURSIVE FUNCTION NESTED_RULES_TREE_LOADER_NODE_INIT_RULES( THIS, CFG, &
&              FILTER_OPT, SIZE, NESTING_LEVEL, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_READ_RULES) THIS%RULES_COLLECTION%INIT( CFG, FILTER_OPT, HOOKS, NESTING_LEVEL=NESTING_LEVEL+1 )
...
END FUNCTION NESTED_RULES_TREE_LOADER_NODE_INIT_RULES
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'NESTED_RULES_TREE_LOADER_NODE_READ_OPERATION'
RECURSIVE FUNCTION NESTED_RULES_TREE_LOADER_NODE_READ_OPERATION( THIS, ID, CFG, FILTER_OPT, NESTING_LEVEL, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  IF ( IOP.EQ.FLT_INT_IGNORE_E .OR. IOP.EQ.FLT_INT_MATCH_E ) THEN
    ...
    CASE (MSGINTFLD_CLASS_E)
      PP_TRYCALL(ERRFLAG_READ_OPERATION) CCLASS2ICLASS( VALUE, THIS%CONDITION(2,ID), HOOKS )
    CASE DEFAULT
...
END FUNCTION NESTED_RULES_TREE_LOADER_NODE_READ_OPERATION
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'NESTED_RULES_TREE_LOADER_NODE_COUNT_MATCHES'
RECURSIVE FUNCTION NESTED_RULES_TREE_LOADER_NODE_COUNT_MATCHES( THIS, MSG, NUM_MATCHES, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  IF ( CONDITIONS(1) ) THEN
    DO I = 1, SIZE(THIS%FILTERS)
      PP_TRYCALL(ERRFLAG_UNABLE_TO_COUNT_MATCHES) THIS%FILTERS(I)%FILTER%MATCH( MSG, LMATCH, HOOKS )
      IF ( LMATCH ) THEN
        ! Recursive call to the children
        PP_TRYCALL(ERRFLAG_UNABLE_TO_COUNT_MATCHES) THIS%CHILDREN(I)%COUNT_MATCHES( MSG, NUM_MATCHES, HOOKS )
      ENDIF
    ENDDO
  ELSEIF ( CONDITIONS(2) ) THEN
    ! Count the number of matches in the rules collections
    PP_TRYCALL(ERRFLAG_UNABLE_TO_COUNT_MATCHES) THIS%RULES_COLLECTION%COUNT_MATCHES( MSG, TMP, HOOKS )
...
END FUNCTION NESTED_RULES_TREE_LOADER_NODE_COUNT_MATCHES
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'NESTED_RULES_TREE_LOADER_NODE_SIZE'
RECURSIVE FUNCTION NESTED_RULES_TREE_LOADER_NODE_SIZE( THIS, SZ, MAX_SZ, NLEVELS, HOOKS ) RESULT(RET)
...
END FUNCTION NESTED_RULES_TREE_LOADER_NODE_SIZE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'NESTED_RULES_TREE_LOADER_NODE_PRINT'
RECURSIVE FUNCTION NESTED_RULES_TREE_LOADER_NODE_PRINT( THIS, UNIT, OFFSET, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  IF ( CONDITIONS(1) ) THEN
    ...
    DO I = 1, SIZE(THIS%CHILDREN)
      ...
      PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT_NESTED_RULES) THIS%CHILDREN(I)%PRINT( UNIT, OFFSET+2, HOOKS )
    ENDDO

  ELSEIF ( CONDITIONS(2) ) THEN

    ! Count the number of matches in the rules collections
    PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT_RULES) THIS%RULES_COLLECTION%PRINT( UNIT, OFFSET, HOOKS )
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'NESTED_RULES_TREE_LOADER_NODE_MATCH_SINGLE'
RECURSIVE FUNCTION NESTED_RULES_TREE_LOADER_NODE_MATCH_SINGLE( THIS, MSG, RULE, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  IF ( CONDITIONS(1) ) THEN
    DO I = 1, SIZE(THIS%FILTERS)
      ...
      IF ( LMATCH ) THEN
        ! Recursive call to the children
        PP_TRYCALL(ERRFLAG_UNABLE_TO_GET_ENCODERS) THIS%CHILDREN(I)%MATCH_SINGLE( MSG, RULE, HOOKS )
      ENDIF
    ENDDO
  ELSEIF ( CONDITIONS(2) ) THEN
    ...
    ! MIVAL: Count the number of matches in the rules collections
    ! Count the number of matches in the rules collections
    PP_TRYCALL(ERRFLAG_UNABLE_MATCHES_RULE) THIS%RULES_COLLECTION%MATCH( MSG, RULE, HOOKS )
...
END FUNCTION NESTED_RULES_TREE_LOADER_NODE_MATCH_SINGLE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'NESTED_RULES_TREE_LOADER_NODE_MATCH_MULTIPLE'
RECURSIVE FUNCTION NESTED_RULES_TREE_LOADER_NODE_MATCH_MULTIPLE( THIS, MSG, RULES, IRULE, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  IF ( CONDITIONS(1) ) THEN
    DO I = 1, SIZE(THIS%FILTERS)
      ...
      IF ( LMATCH ) THEN
        ! Recursive call to the children
        PP_TRYCALL(ERRFLAG_UNABLE_TO_GET_ENCODERS) THIS%CHILDREN(I)%MATCH_MULTIPLE( MSG, RULES, IRULE, HOOKS )
      ENDIF
    ENDDO
  ELSEIF ( CONDITIONS(2) ) THEN
    ...
    ! MIVAL: Count the number of matches in the rules collections
    ! Count the number of matches in the rules collections
    PP_TRYCALL(ERRFLAG_UNABLE_TO_MATCH_RULES) THIS%RULES_COLLECTION%MATCH( MSG, RULES, IRULE, HOOKS )
...
END FUNCTION NESTED_RULES_TREE_LOADER_NODE_MATCH_MULTIPLE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'NESTED_RULES_TREE_LOADER_NODE_FREE'
RECURSIVE FUNCTION NESTED_RULES_TREE_LOADER_NODE_FREE( THIS, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  IF ( ASSOCIATED(THIS%CHILDREN) ) THEN
    ...
    !> Free nested rules
    DO I = 1, SIZE(THIS%CHILDREN)
      PP_TRYCALL(ERRFLAG_FREE_NESTED_RULES) THIS%CHILDREN(I)%FREE( HOOKS )
    ENDDO
  ...
  IF ( ASSOCIATED(THIS%RULES_COLLECTION) ) THEN
    ...
    PP_TRYCALL(ERRFLAG_FREE_RULES_COLLECTION) THIS%RULES_COLLECTION%FREE( HOOKS )
...
END FUNCTION NESTED_RULES_TREE_LOADER_NODE_FREE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE

END MODULE NESTED_RULES_TREE_LOADER_MOD
