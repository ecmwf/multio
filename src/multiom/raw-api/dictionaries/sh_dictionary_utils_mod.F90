...
#define PP_FILE_NAME 'sh_dictionary_utils_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'SH_DICTIONARY_UTILS_MOD'
MODULE SH_DICTIONARY_UTILS_MOD
...
END MODULE SH_DICTIONARY_UTILS_MOD
