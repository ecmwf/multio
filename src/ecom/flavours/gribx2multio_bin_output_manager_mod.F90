...
IMPLICIT NONE
  ...
  IF ( CFG%GET( 'gribx2multio-binary-output-manager', GRIBX2MULTIO_BIN_CFG ) ) THEN
...
IMPLICIT NONE
  ...
  IF ( THIS%VERBOSE_ ) THEN
    ...
    WRITE(THIS%LOG_FNAME_,'(A,I8.8,A)', IOSTAT=STAT) 'gribx2multio_bin_output_manager_', PROCESSOR_TOPO%MYPROC_IO, '.log'
