...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => G2S4_POINT_IN_TIME_DEFAULT_INIT
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => G2S4_POINT_IN_TIME_DEFAULT_TO_BE_ENCODED
...
#define PP_PROCEDURE_NAME 'G2S4_POINT_IN_TIME_DEFAULT_INIT'
PP_THREAD_SAFE FUNCTION G2S4_POINT_IN_TIME_DEFAULT_INIT( THIS, &
...
END FUNCTION G2S4_POINT_IN_TIME_DEFAULT_INIT
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_POINT_IN_TIME_DEFAULT_TO_BE_ENCODED'
PP_THREAD_SAFE FUNCTION G2S4_POINT_IN_TIME_DEFAULT_TO_BE_ENCODED( THIS, &
...
END FUNCTION G2S4_POINT_IN_TIME_DEFAULT_TO_BE_ENCODED
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
PP_THREAD_SAFE FUNCTION G2S4_POINT_IN_TIME_DEFAULT_FREE( THIS, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
