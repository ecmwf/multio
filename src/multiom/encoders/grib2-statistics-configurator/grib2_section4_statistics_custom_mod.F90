...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_SECTION4_STATISTICS_CUSTOM_INIT
...
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_STATISTICS_CUSTOM_INIT'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_STATISTICS_CUSTOM_INIT( THIS, &
...
END FUNCTION GRIB2_SECTION4_STATISTICS_CUSTOM_INIT
