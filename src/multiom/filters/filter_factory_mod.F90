...
RECURSIVE FUNCTION MAKE_FILTER( FILTER, CTYPE, CFG, OPT, HOOKS ) RESULT(RET)
  ...
  USE :: FILTER_SYSTEM_MOD,              ONLY: FILTER_SYSTEM_T
  USE :: FILTER_METHOD_MOD,              ONLY: FILTER_METHOD_T
  ...
  USE :: FILTER_HDATE_MOD,               ONLY: FILTER_HDATE_T
...
IMPLICIT NONE
  ...
  CASE( 'system' )
    ...
    ALLOCATE( FILTER_SYSTEM_T::FILTER, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )
  ...
  CASE( 'method' )
    ...
    ALLOCATE( FILTER_METHOD_T::FILTER, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )
  ...
  CASE( 'hdate' )
    ...
    ALLOCATE( FILTER_HDATE_T::FILTER, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )
