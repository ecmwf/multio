...
#define PP_FILE_NAME 'grib2_section4_heightaboveseaat2m_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'GRIB2_SECTION4_HEIGHTABOVESEAAT2M_MOD'
MODULE GRIB2_SECTION4_HEIGHTABOVESEAAT2M_MOD
...
!>
!> The `GRIB2_SECTION4_HEIGHTABOVESEAAT2M_T` type extends the base class `GRIB_SECTION_BASE_A` and
...
!> environments.
!>
TYPE, EXTENDS(GRIB_SECTION_BASE_A) :: GRIB2_SECTION4_HEIGHTABOVESEAAT2M_T
...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => G2S4_HEIGHTABOVESEA_INIT
...
PUBLIC :: GRIB2_SECTION4_HEIGHTABOVESEAAT2M_T
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION4_HEIGHTABOVESEAAT2M_T` representing the GRIB section being initialized.
...
#define PP_PROCEDURE_NAME 'G2S4_HEIGHTABOVESEA_INIT'
PP_THREAD_SAFE FUNCTION G2S4_HEIGHTABOVESEA_INIT( THIS, &
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(GRIB2_SECTION4_HEIGHTABOVESEAAT2M_T),  INTENT(INOUT) :: THIS
...
END FUNCTION G2S4_HEIGHTABOVESEA_INIT
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION4_HEIGHTABOVESEAAT2M_T` representing the GRIB section to allocate resources for.
...
IMPLICIT NONE
  ...
  ! Logging
  PP_LOG_DEVELOP_STR( 'Allocate heightAboveSeaAt2m' )
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION4_HEIGHTABOVESEAAT2M_T` representing the GRIB section to be preset.
...
IMPLICIT NONE
  ...
  PP_LOG_DEVELOP_STR( 'Preset heightAboveSeaAt2m' )
...
!>
!> @section interface
!>   @param [in]    THIS      An object of type `GRIB2_SECTION4_HEIGHTABOVESEAAT2M_T` representing the GRIB section for runlevel execution.
!>   @param [in]    MSG       The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR       The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
...
IMPLICIT NONE
  ...
  PP_LOG_DEVELOP_STR( 'Runtime heightAboveSeaAt2m' )
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION4_HEIGHTABOVESEAAT2M_T` representing the GRIB section to be freed.
!>   @param [in]    OPT   The encoder options structure of type `ENCODER_OPTIONS_T`.
...
PP_THREAD_SAFE FUNCTION G2S4_HEIGHTABOVESEA_FREE( THIS, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! According to the options decide where to set the levels (preset or runlevel)
  PP_LOG_INFO( 'TypeOfLevel: heightAboveSeaAt2m' )
...
IMPLICIT NONE
  ...
  ! According to the options decide where to set the levels (preset or runlevel)
  PP_LOG_INFO( 'check typeOfLevel: heightAboveSeaAt2m' )
