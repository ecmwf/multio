...
!>
SUBROUTINE MAKE_FCN_IF( CFG, MODEL_PARAMS, METADATA_KIND, ENCODER )
...
SUBROUTINE MAKE_ENCODERS( CFG, MODEL_PARAMS, METADATA_KIND )
...
IMPLICIT NONE
  ...
  IF ( .NOT.ALLOCATED(ENCODERS) ) THEN
    ...
    ENDIF
    ! IF (  ) THEN
    !   CALL ENCODERS( ENCODER_IDX( WAVE_INT_E,        REPRES_SPECTRAL_E, GRIB1_E ) )%CREATE( CFG, MODEL_PARAMS, METADATA_KIND, MAKE_GRIB1_SH_WI_ENCODER, DESTROY_GRIB1_SH_WI_ENCODER )
    ! ENDIF
    ! IF (  ) THEN
    !   CALL ENCODERS( ENCODER_IDX( WAVE_SPEC_E,       REPRES_SPECTRAL_E, GRIB1_E ) )%CREATE( CFG, MODEL_PARAMS, METADATA_KIND, MAKE_GRIB1_SH_WS_ENCODER, DESTROY_GRIB1_SH_WS_ENCODER )
    ! ENDIF
    ...
    ENDIF
    ! IF (  ) THEN
    !   CALL ENCODERS( ENCODER_IDX( WAVE_INT_E,        REPRES_SPECTRAL_E, GRIB2_E ) )%CREATE( CFG, MODEL_PARAMS, METADATA_KIND, MAKE_GRIB2_SH_WI_ENCODER, DESTROY_GRIB2_SH_WI_ENCODER )
    ! ENDIF
    ! IF (  ) THEN
    !   CALL ENCODERS( ENCODER_IDX( WAVE_SPEC_E,       REPRES_SPECTRAL_E, GRIB2_E ) )%CREATE( CFG, MODEL_PARAMS, METADATA_KIND, MAKE_GRIB2_SH_WS_ENCODER, DESTROY_GRIB2_SH_WS_ENCODER )
    ! ENDIF
...
SUBROUTINE CONTAINER_CREATE( THIS, CFG, MODEL_PARAMS, METADATA_KIND, MAKE_FCN, DESTROY_FCN )
...
FUNCTION ENCODE_ATM( MODEL_PARAMS, GRIB_INFO, TIME_HIST, MSG, METADATA ) RESULT(EX)
  ...
  USE :: TRACK_TIME_MOD,           ONLY: COMPUTE_CURRENT_TIME
