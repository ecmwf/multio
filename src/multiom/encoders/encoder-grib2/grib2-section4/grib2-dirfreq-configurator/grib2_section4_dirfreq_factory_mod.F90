...
PP_THREAD_SAFE FUNCTION DESTROY_GRIB2_DIRFREQ_CONFIGURATOR( GRIB2_DIRFREQ_CONFIGURATOR, OPT, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Free the section
  PP_TRYCALL(ERRFLAG_FREE_ERROR)  GRIB2_DIRFREQ_CONFIGURATOR%FREE( OPT, HOOKS )
