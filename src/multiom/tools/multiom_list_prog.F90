...
IMPLICIT NONE
  ...
  IF ( VERBOSE ) THEN
    PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT_CMD_LINE) CMDARGS%PRINT( OUTPUT_UNIT, HOOKS )
  ENDIF
  ...
  ! Print the header
  PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT_HEADER) PRINT_HEADER( CMDARGS, OUTPUT_UNIT, BIG_ENDIAN_READ, VERBOSE, HOOKS )
  ...
  FeederLoop: DO TOCID = 1, SIZE(TOC)
    ...
    CLASS IS ( TOC_SIM_INIT_T )
      ...
      PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT_SIMULATION_INIT) PRINT_SIMULATION_INIT( CMDARGS, OUTPUT_UNIT, TOC_ENTRY, BIG_ENDIAN_READ, VERBOSE, HOOKS )

    CLASS IS ( TOC_ATM_FIELD_T )

      PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT_ATM_MESSAGE) PRINT_ATM_MESSAGE( CMDARGS, OUTPUT_UNIT, TOC_ENTRY, BIG_ENDIAN_READ, VERBOSE, HOOKS )

    CLASS IS ( TOC_WAM_FIELD_T )

      PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT_WAM_MESSAGE) PRINT_WAM_MESSAGE( CMDARGS, OUTPUT_UNIT, TOC_ENTRY, BIG_ENDIAN_READ, VERBOSE, HOOKS )

    CLASS IS ( TOC_FLUSH_STEP_T )

      PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT_FLUSH) PRINT_FLUSH( CMDARGS, OUTPUT_UNIT, TOC_ENTRY, BIG_ENDIAN_READ, VERBOSE, HOOKS )

    CLASS IS ( TOC_FLUSH_STEP_RST_T )

      PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT_FLUSH_AND_RESTART) PRINT_FLUSH_AND_RESTART( CMDARGS, OUTPUT_UNIT, TOC_ENTRY, BIG_ENDIAN_READ, VERBOSE, HOOKS )

    CLASS IS ( TOC_FLUSH_LAST_STEP_T )

      PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT_FLUSH_LAST_STEP) PRINT_FLUSH_LAST_STEP( CMDARGS, OUTPUT_UNIT, TOC_ENTRY, BIG_ENDIAN_READ, VERBOSE, HOOKS )

    CLASS IS ( TOC_SIM_END_T )

      PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT_SIMULATION_END) PRINT_SIMULATION_END( CMDARGS, OUTPUT_UNIT, TOC_ENTRY, BIG_ENDIAN_READ, VERBOSE, HOOKS )
      EXIT FeederLoop
  ...
  ! Print the footer
  PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT_HEADER) PRINT_FOOTER( CMDARGS, OUTPUT_UNIT, BIG_ENDIAN_READ, VERBOSE, HOOKS )
