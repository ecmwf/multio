...
IMPLICIT NONE
  ...
  TYPE(REGULAR_LL_T), POINTER :: F_REGULAR_LL_P
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_EXTRACT_REGULAR_LL_DICTIONARY=15_JPIB_K
  ...
  CASE ( REGULAR_LL_DICT_TYPE_E )
    ...
    PP_TRYCALL(ERRFLAG_EXTRACT_REGULAR_LL_DICTIONARY) EXTRACT_REGULAR_LL_DICTIONARY( F_GEO_DICT_W, F_REGULAR_LL_P, HOOKS )
    F_GEO_DICT_P => F_REGULAR_LL_P
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_EXTRACT_REGULAR_LL_DICTIONARY)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unable to extract regular ll dictionary' )
