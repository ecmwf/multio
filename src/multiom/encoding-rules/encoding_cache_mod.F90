...
&       PAR, METADATA, ENCODING_RULES, CACHE_OPT, ENCODER_OPT, FILTER_OPT, HOOKS )
    ...
    ! WRITE(6_JPIB_K,*) '+ ENCODER CREATED :: '
    ! PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT_RULES) ROOT%ENCODERS_%PRINT_RULES( 6_JIB_K, HOOKS )
...
&             KEY, PAR, METADATA, ENCODING_RULES, CACHE_OPT, ENCODER_OPT, FILTER_OPT, HOOKS )
        ...
        ! WRITE(6_JPIB_K,*) '+ ENCODER CREATED :: '
        ! PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT_RULES) INSERTION_POINT%LEFT%ENCODERS_%PRINT_RULES( 6_JIB_K, HOOKS )
...
&             KEY, PAR, METADATA, ENCODING_RULES, CACHE_OPT, ENCODER_OPT, FILTER_OPT, HOOKS )
        ...
        ! WRITE(6_JPIB_K,*) '+ ENCODER CREATED :: '
        ! PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT_RULES) INSERTION_POINT%RIGHT%ENCODERS_%PRINT_RULES( 6_JIB_K, HOOKS )
    ...
    ELSE
      ...
      ! WRITE(6_JPIB_K,*) '+ ENCODER FOUND :: '
      ! PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT_RULES) INSERTION_POINT%ENCODERS_%PRINT_RULES( 6_JIB_K, HOOKS )
  ...
  WRITE(6_JPIB_K,*) '+ ENCODING WITH RULES :: '
  PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT_RULES) INSERTION_POINT%ENCODERS_%PRINT_RULES( 6_JPIB_K, HOOKS )
...
IMPLICIT NONE
  ...
  !> Create the encoders
  WRITE(*,*) 'ENCODING CACHE :: Creating encoders from rules'
