...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_INITIALIZATION_ERROR)  GRIB2_CHEM_CONFIGURATOR%INIT( CFG, OPT, HOOKS )
...
IMPLICIT NONE
  ...
  !> Initialization of the section
  PP_TRYCALL(ERRFLAG_INITIALIZATION_ERROR)  GRIB2_CHEM_CONFIGURATOR%INIT( MSG, PAR, OPT, HOOKS )
...
PP_THREAD_SAFE FUNCTION DESTROY_GRIB2_CHEM_CONFIGURATOR( GRIB2_CHEM_CONFIGURATOR, OPT, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Free the section
  PP_TRYCALL(ERRFLAG_FREE_ERROR)  GRIB2_CHEM_CONFIGURATOR%FREE( OPT, HOOKS )
