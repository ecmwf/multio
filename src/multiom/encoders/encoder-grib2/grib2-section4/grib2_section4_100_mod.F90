...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_100_FREE( THIS, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_DESTROY_DIRFREQ)  DESTRUCTORS%DESTROY_GRIB2_DIRFREQ_CONFIGURATOR( THIS%DIRFREQ_, OPT, DESTRUCTORS, HOOKS )
