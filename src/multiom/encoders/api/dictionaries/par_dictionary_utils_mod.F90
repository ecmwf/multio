...
#define PP_FILE_NAME 'par_dictionary_utils_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'PAR_DICTIONARY_UTILS_MOD'
MODULE PAR_DICTIONARY_UTILS_MOD
...
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_LAPLACIAN_SCALING_FACTOR = 16_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_PERIOD_MIN  = 17_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_PERIOD_MAX = 18_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_PERIOD_SCALE_FACTOR_DIR  = 19_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_PERIOD_SCALE_FACTOR_FREQ = 20_JPIB_K
...
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_DESTINE_LOCAL_VERSION = 27_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_UNDEF = 28_JPIB_K
...
IMPLICIT NONE
  ...
  CASE ( 'laplacianscalingfactor', 'laplacian-scaling-factor', 'laplacianoperator' )
    ITERATOR = PAR_ITERATOR_LAPLACIAN_SCALING_FACTOR
  ...
  CASE ( 'scalefactorofwavedirections', 'scale-factor-of-wave-directions' )
    ITERATOR = PAR_ITERATOR_PERIOD_SCALE_FACTOR_DIR

  CASE ( 'scalefactorofwavefrequencies', 'scale-factor-of-wave-frequencies' )
    ITERATOR = PAR_ITERATOR_PERIOD_SCALE_FACTOR_FREQ
  ...
  CASE ( 'destinelocalversion', 'destine-local-version' )
...
IMPLICIT NONE
  ...
  CASE (PAR_ITERATOR_PERIOD_SCALE_FACTOR_DIR)
    IF ( PAR_DICTIONARY%WAVE%SCALE_FACTOR_OF_WAVE_DIRECTIONS  .NE. UNDEF_PARAM_E ) THEN
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    ENDIF

  CASE (PAR_ITERATOR_PERIOD_SCALE_FACTOR_FREQ)
    IF ( PAR_DICTIONARY%WAVE%SCALE_FACTOR_OF_WAVE_FREQUENCIES  .NE. UNDEF_PARAM_E ) THEN
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    ENDIF
  ...
  CASE (PAR_ITERATOR_DESTINE_LOCAL_VERSION)
    IF ( PAR_DICTIONARY%DESTINE_LOCAL_VERSION  .NE. UNDEF_PARAM_E ) THEN
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    ENDIF
...
IMPLICIT NONE
  ...
  CASE (PAR_ITERATOR_PERIOD_SCALE_FACTOR_DIR)
    KEY = 'scale-factor-of-wave-directions'

  CASE (PAR_ITERATOR_PERIOD_SCALE_FACTOR_FREQ)
    KEY = 'scale-factor-of-wave-frequencies'
...
IMPLICIT NONE
  ...
  CASE (PAR_ITERATOR_PERIOD_SCALE_FACTOR_DIR)
    IF ( PAR_DICTIONARY%WAVE%SCALE_FACTOR_OF_WAVE_DIRECTIONS  .NE. UNDEF_PARAM_E ) THEN
      PP_TRYCALL(ERRFLAG_CONVERT_ENUM_STRING) CONVERT_TO_C_STRING( PAR_DICTIONARY%WAVE%SCALE_FACTOR_OF_WAVE_DIRECTIONS, VALUE, HOOKS )
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    ENDIF
  ...
  CASE (PAR_ITERATOR_PERIOD_SCALE_FACTOR_FREQ)
    IF ( PAR_DICTIONARY%WAVE%SCALE_FACTOR_OF_WAVE_FREQUENCIES  .NE. UNDEF_PARAM_E ) THEN
      PP_TRYCALL(ERRFLAG_CONVERT_ENUM_STRING) CONVERT_TO_C_STRING( PAR_DICTIONARY%WAVE%SCALE_FACTOR_OF_WAVE_FREQUENCIES, VALUE, HOOKS )
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    ENDIF
  ...
  CASE (PAR_ITERATOR_DESTINE_LOCAL_VERSION)
    IF ( PAR_DICTIONARY%DESTINE_LOCAL_VERSION  .NE. UNDEF_PARAM_E ) THEN
      PP_TRYCALL(ERRFLAG_CONVERT_ENUM_STRING) CONVERT_TO_C_STRING( PAR_DICTIONARY%DESTINE_LOCAL_VERSION, VALUE, HOOKS )
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    ENDIF
...
IMPLICIT NONE
  ...
  CASE (PAR_ITERATOR_LAPLACIAN_SCALING_FACTOR)
    PP_TRYCALL(ERRFLAG_CONVERT_PAR_TO_ENUM) CFLOAT2IFLOAT(VALUE, FTEMP, HOOKS)
    PAR_DICTIONARY%DATA_REPRESENTATION%LAPLACIAN_SCALE_FACTOR_ = FTEMP
  ...
  CASE (PAR_ITERATOR_PERIOD_SCALE_FACTOR_DIR)
    PP_TRYCALL(ERRFLAG_CONVERT_PAR_TO_ENUM) CINT2IINT(VALUE, ITEMP, HOOKS)
    PAR_DICTIONARY%WAVE%SCALE_FACTOR_OF_WAVE_DIRECTIONS = ITEMP

  CASE (PAR_ITERATOR_PERIOD_SCALE_FACTOR_FREQ)
    PP_TRYCALL(ERRFLAG_CONVERT_PAR_TO_ENUM) CINT2IINT(VALUE, ITEMP, HOOKS)
    PAR_DICTIONARY%WAVE%SCALE_FACTOR_OF_WAVE_FREQUENCIES = ITEMP
  ...
  CASE (PAR_ITERATOR_DESTINE_LOCAL_VERSION)
    PP_TRYCALL(ERRFLAG_CONVERT_PAR_TO_ENUM) CINT2IINT(VALUE, ITEMP, HOOKS)
    PAR_DICTIONARY%DESTINE_LOCAL_VERSION = ITEMP
...
IMPLICIT NONE
  ...
  CASE (PAR_ITERATOR_PERIOD_SCALE_FACTOR_DIR)
    PAR_DICTIONARY%WAVE%SCALE_FACTOR_OF_WAVE_DIRECTIONS = VALUE

  CASE (PAR_ITERATOR_PERIOD_SCALE_FACTOR_FREQ)
    PAR_DICTIONARY%WAVE%SCALE_FACTOR_OF_WAVE_FREQUENCIES = VALUE
  ...
  CASE (PAR_ITERATOR_DESTINE_LOCAL_VERSION)
    PAR_DICTIONARY%DESTINE_LOCAL_VERSION = VALUE
