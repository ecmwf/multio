...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_ENCODER_INIT_CFG
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_CALL_SEC0_ALLOC)  THIS%INDICATOR_SECTION_%ALLOCATE          ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(EERRFLAG_CALL_SEC1_ALLOC) THIS%IDENTIFICATION_SECTION_%ALLOCATE     ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(EERRFLAG_CALL_SEC2_ALLOC) THIS%LOCAL_USE_SECTION_%ALLOCATE          ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC3_ALLOC)  THIS%GRID_DEFINITION_SECTION_%ALLOCATE    ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC4_ALLOC)  THIS%PRODUCT_DEFINITION_SECTION_%ALLOCATE ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC5_ALLOC)  THIS%DATA_REPRESENTATION_SECTION_%ALLOCATE( MSG, GEO, PAR, OPT, METADATA, HOOKS )
...
IMPLICIT NONE
  ...
  ! Allocate the sections
  PP_TRYCALL(ERRFLAG_CALL_SEC0_PRESET) THIS%INDICATOR_SECTION_%PRESET          ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(EERRFLAG_CALL_SEC1_PRESET) THIS%IDENTIFICATION_SECTION_%PRESET    ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(EERRFLAG_CALL_SEC2_PRESET) THIS%LOCAL_USE_SECTION_%PRESET         ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC3_PRESET) THIS%GRID_DEFINITION_SECTION_%PRESET    ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC4_PRESET) THIS%PRODUCT_DEFINITION_SECTION_%PRESET ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC5_PRESET) THIS%DATA_REPRESENTATION_SECTION_%PRESET( MSG, GEO, PAR, OPT, METADATA, HOOKS )
...
IMPLICIT NONE
  ...
  ! Allocate the sections
  PP_TRYCALL(ERRFLAG_CALL_SEC0_RUNTIME) THIS%INDICATOR_SECTION_%RUNTIME          ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(EERRFLAG_CALL_SEC1_RUNTIME) THIS%IDENTIFICATION_SECTION_%RUNTIME    ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(EERRFLAG_CALL_SEC2_RUNTIME) THIS%LOCAL_USE_SECTION_%RUNTIME         ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC3_RUNTIME) THIS%GRID_DEFINITION_SECTION_%RUNTIME    ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC4_RUNTIME) THIS%PRODUCT_DEFINITION_SECTION_%RUNTIME ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC5_RUNTIME) THIS%DATA_REPRESENTATION_SECTION_%RUNTIME( MSG, GEO, PAR, OPT, METADATA, HOOKS )
