...
IMPLICIT NONE
  ...
  LOGICAL, DIMENSION(19) :: CONDITIONS
  ...
  CONDITIONS(17) =  ( THIS%REPRES .EQ. OTHER%REPRES )
  CONDITIONS(18) =  ( THIS%GRID .EQ. OTHER%GRID )
  CONDITIONS(19) =  ( THIS%TRUNCATION .EQ. OTHER%TRUNCATION )
...
IMPLICIT NONE
  ...
  !> Local variables
  LOGICAL, DIMENSION(19,2) :: CONDITIONS
  INTEGER(KIND=JPIB_K) :: I
  INTEGER(KIND=JPIB_K) :: TMP0
  INTEGER(KIND=JPIB_K) :: TMP1
  ...
  CONDITIONS(17,1) =  ( THIS%REPRES .EQ. OTHER%REPRES )
  CONDITIONS(18,1) =  ( THIS%GRID .EQ. OTHER%GRID )
  CONDITIONS(19,1) =  ( THIS%TRUNCATION .EQ. OTHER%TRUNCATION )
  ...
  CONDITIONS(17,2) = ( THIS%REPRES .LE. OTHER%REPRES )
  CONDITIONS(18,2) = ( THIS%GRID .LE. OTHER%GRID )
  CONDITIONS(19,2) = ( THIS%TRUNCATION .LE. OTHER%TRUNCATION )
