...
! Enumerators for step type
INTEGER(KIND=JPIB_K), PARAMETER :: STEPTYPE_UNDEF_E=-99
INTEGER(KIND=JPIB_K), PARAMETER :: STEPTYPE_INSTANT_E=0
INTEGER(KIND=JPIB_K), PARAMETER :: STEPTYPE_AVERAGE_E=100
INTEGER(KIND=JPIB_K), PARAMETER :: STEPTYPE_ACCUMUL_E=200

! Enumerators for type of level
INTEGER(KIND=JPIB_K), PARAMETER :: TYPE_OF_LEVEL_UNDEF_E=-99
...
TYPE :: GRIB_INFO_T
  ...
  INTEGER(KIND=JPIB_K)  :: REQUESTED_ENCODING_ = UNDEF_PARAM_E
...
! Whitelist of public variables (enumerators)
PUBLIC :: STEPTYPE_UNDEF_E
PUBLIC :: STEPTYPE_INSTANT_E
PUBLIC :: STEPTYPE_AVERAGE_E
PUBLIC :: STEPTYPE_ACCUMUL_E
PUBLIC :: TYPE_OF_LEVEL_UNDEF_E
