...
IMPLICIT NONE
  ...
  PUBLIC :: ENCODE_ALLOCATE_RAW_ENCODER
  PUBLIC :: ENCODE_PRESET_RAW_ENCODER
...
&  F_MARS_DICT, F_PAR_DICT, F_GEO_DICT, C_GRIB_SAMPLE_P, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  TYPE(PARAMETRIZATION_T),  INTENT(INOUT) :: F_PAR_DICT
  CLASS(REPRES_A), POINTER, INTENT(IN)    :: F_GEO_DICT
  ...
  ! Call the encoder
  F_PAR_DICT%GEOMETRY%REPRES => F_GEO_DICT
  F_PAR_DICT%GEOMETRY%TO_BE_DEALLOCATED = .FALSE.
  PP_TRYCALL(ERRFLAG_CALL_THE_ENCODER) RAW_ENCODER%PREPARE(  &
&    F_MARS_DICT, F_PAR_DICT, F_GEO_DICT, C_GRIB_SAMPLE_P, HOOKS )
  F_PAR_DICT%GEOMETRY%REPRES => NULL()
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'ENCODE_ALLOCATE_RAW_ENCODER'
PP_THREAD_SAFE FUNCTION ENCODE_ALLOCATE_RAW_ENCODER( WRAPPED_ENCODER, &
&  F_MARS_DICT, F_PAR_DICT, F_GEO_DICT, C_GRIB_SAMPLE_P, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  F_PAR_DICT%GEOMETRY%REPRES => F_GEO_DICT
  F_PAR_DICT%GEOMETRY%TO_BE_DEALLOCATED = .FALSE.
  PP_TRYCALL(ERRFLAG_CALL_THE_ENCODER) RAW_ENCODER%ALLOCATE(   &
&   F_MARS_DICT, F_PAR_DICT, F_GEO_DICT, C_GRIB_SAMPLE_P, HOOKS )
  F_PAR_DICT%GEOMETRY%REPRES => NULL()
...
END FUNCTION ENCODE_ALLOCATE_RAW_ENCODER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'ENCODE_PRESET_RAW_ENCODER'
PP_THREAD_SAFE FUNCTION ENCODE_PRESET_RAW_ENCODER( WRAPPED_ENCODER, &
&  F_MARS_DICT, F_PAR_DICT, F_GEO_DICT, C_GRIB_SAMPLE_P, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  F_PAR_DICT%GEOMETRY%REPRES => F_GEO_DICT
  F_PAR_DICT%GEOMETRY%TO_BE_DEALLOCATED = .FALSE.
  PP_TRYCALL(ERRFLAG_CALL_THE_ENCODER) RAW_ENCODER%PRESET(  &
&   F_MARS_DICT, F_PAR_DICT, F_GEO_DICT, C_GRIB_SAMPLE_P, HOOKS )
  F_PAR_DICT%GEOMETRY%REPRES => NULL()
...
END FUNCTION ENCODE_PRESET_RAW_ENCODER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
IMPLICIT NONE
  ...
  F_PAR_DICT%GEOMETRY%REPRES => F_GEO_DICT
  F_PAR_DICT%GEOMETRY%TO_BE_DEALLOCATED = .FALSE.
  PP_TRYCALL(ERRFLAG_CALL_THE_ENCODER) RAW_ENCODER%RUNTIME(  &
&   F_MARS_DICT, F_PAR_DICT, F_GEO_DICT, C_GRIB_SAMPLE_P, HOOKS )
  F_PAR_DICT%GEOMETRY%REPRES => NULL()
