...
const RuleList& mapAtmosphericComposition() {
    static auto rules_ = ruleList(
        ...
        rule(all(matchParams(210090)), setKey(&dm::FullMarsRecord::param, 469000), setKey(&dm::FullMarsRecord::chem, 934)),
        rule(all(matchParams(210091)), setKey(&dm::FullMarsRecord::param, 469000), setKey(&dm::FullMarsRecord::chem, 933)),
        ...
        rule(all(matchParams(215022)), setKey(&dm::FullMarsRecord::param, 457000), setKey(&dm::FullMarsRecord::chem, 901)),
        rule(all(matchParams(215023)), setKey(&dm::FullMarsRecord::param, 457000), setKey(&dm::FullMarsRecord::chem, 902)),
        rule(all(matchParams(215024)), setKey(&dm::FullMarsRecord::param, 457000), setKey(&dm::FullMarsRecord::chem, 903)),
        ...
        rule(all(matchParams(215046)), setKey(&dm::FullMarsRecord::param, 457000), setKey(&dm::FullMarsRecord::chem, 904)),
        rule(all(matchParams(215047)), setKey(&dm::FullMarsRecord::param, 457000), setKey(&dm::FullMarsRecord::chem, 905)),
        rule(all(matchParams(215048)), setKey(&dm::FullMarsRecord::param, 457000), setKey(&dm::FullMarsRecord::chem, 906)),
        ...
        rule(all(matchParams(215063)), setKey(&dm::FullMarsRecord::param, 457000), setKey(&dm::FullMarsRecord::chem, 908)),
        rule(all(matchParams(215064)), setKey(&dm::FullMarsRecord::param, 457000), setKey(&dm::FullMarsRecord::chem, 907)),
        ...
        rule(all(matchParams(215079)), setKey(&dm::FullMarsRecord::param, 457000), setKey(&dm::FullMarsRecord::chem, 910)),
        rule(all(matchParams(215080)), setKey(&dm::FullMarsRecord::param, 457000), setKey(&dm::FullMarsRecord::chem, 909)),
        ...
        rule(all(matchParams(215088)), setKey(&dm::FullMarsRecord::param, 457000), setKey(&dm::FullMarsRecord::chem, 911)),
