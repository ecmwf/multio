...
SUBROUTINE MAKE_GRIB2_GG_M_ENCODER( CFG, MODEL_PARAMS, METADATA_KIND, ENCODER, MIOH )
...
SUBROUTINE ENCODER_GRIB2_GG_M_INITIALISE( THIS, MODEL_PARAMS, METADATA_KIND, MIOH )
...
IMPLICIT NONE
  ...
  ! Load the sample
  PP_METADATA_INIT_FROM_SAMPLE_NAME( THIS%SAMPLE_, TRIM(ADJUSTL(SAMPLE_NAME_GRIB2_GG_M)) )

  ! Load the grib sample
  PP_LOG_DEVELOP_STR( 'ENCODER: grib2, gridded, model_level, preset' )
  ...
  CALL VERTICAL_LEVELS_PRESET_GRIBX_ATM( MODEL_PARAMS, THIS%SAMPLE_ )
...
& TIME_HIST, CURR_TIME, MSG, METADATA ) RESULT(EX)
  ...
  USE :: ENCODERS_UTILS_MOD, ONLY: SET_PRODUCT_DEFINITION_TEMPLATE_NUMBER_ATM
  USE :: ENCODERS_UTILS_MOD, ONLY: SET_COMPRESSION_ATM
...
IMPLICIT NONE
  ...
  PP_LOG_DEVELOP_STR( 'ENCODER: grib2, gridded, model_level, runtime' )
