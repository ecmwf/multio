...
PRIVATE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: PARINTFLD_TIME_INITIAL_STEP_E=2_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: PARINTFLD_TIME_LENGTH_OF_TIME_STEP_IN_SECONDS_E=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: PARINTFLD_TIME_LENGTH_OF_TIME_RANGE_IN_SECONDS_E=4_JPIB_K

  !> Integer enumerators (bitmap)
  INTEGER(KIND=JPIB_K), PARAMETER :: PARINTFLD_BITMAP_NUMBER_OF_MISSING_VALUES_E=5_JPIB_K

  !> Integer enumerators (ensemble)
  INTEGER(KIND=JPIB_K), PARAMETER :: PARINTFLD_ENSEMBLE_TYPE_OF_ENSEMBLE_FORECAST_E=6_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: PARINTFLD_ENSEMBLE_NUMBER_OF_FORECASTS_IN_ENSEMBLE_E=7_JPIB_K

  !> Integer enumerators (analysis)
  INTEGER(KIND=JPIB_K), PARAMETER :: PARINTFLD_ANALYSIS_LENGTH_OF_TIME_WINDOW_E=8_JPIB_K

  !> Integer enumerators (satellite)
  INTEGER(KIND=JPIB_K), PARAMETER :: PARINTFLD_SATELLITE_SATELLITE_SERIES_E=9_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: PARINTFLD_SATELLITE_SCALED_FACTOR_OF_CENTRAL_VAWENUMBER_E=10_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: PARINTFLD_SATELLITE_SCALED_VALUE_OF_CENTRAL_VAWENUMBER_E=11_JPIB_K

  !> Integer enumerators (data-representation)
  INTEGER(KIND=JPIB_K), PARAMETER :: PARINTFLD_DATA_REPRESENTATION_BITS_PER_VALUE_E=12_JPIB_K

  !> Total number of integer enumerators
  INTEGER(KIND=JPIB_K), PARAMETER :: N_PARINTFLDS=12_JPIB_K
