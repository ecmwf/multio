...
INTERFACE
  PP_THREAD_SAFE FUNCTION MAP_FUNCTION_@TEMPLATE_KEY_NAME@_@TEMPLATE_VALUE_NAME@_IF( KEY, VALUE, HOOKS ) RESULT(RET)
    ...
    @TEMPLATE_USE_VALUE@
  IMPLICIT NONE
    @TEMPLATE_KEY_DUMMY_TYPE@, POINTER, DIMENSION(:), INTENT(INOUT) :: KEY
...
TYPE :: MAP_@TEMPLATE_KEY_NAME@_@TEMPLATE_VALUE_NAME@_NODE_T
  ...
  !> Key
  @TEMPLATE_KEY_TYPE@, POINTER, DIMENSION(:) :: KEY => NULL()
...
!>
!> This subroutine compares two keys and returns a flag indicating if the
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  @TEMPLATE_KEY_DUMMY_TYPE@, DIMENSION(:), INTENT(IN)    :: KEY1
  @TEMPLATE_KEY_DUMMY_TYPE@, DIMENSION(:), INTENT(IN)    :: KEY2
...
IMPLICIT NONE
  ...
  @TEMPLATE_KEY_DUMMY_TYPE@, POINTER, DIMENSION(:),                     INTENT(IN)    :: KEY
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(MAP_@TEMPLATE_KEY_NAME@_@TEMPLATE_VALUE_NAME@_NODE_T), POINTER, INTENT(INOUT) :: ROOT
  @TEMPLATE_KEY_DUMMY_TYPE@, DIMENSION(:),          INTENT(IN)    :: KEY
...
IMPLICIT NONE
  ...
  @TEMPLATE_KEY_TYPE@, POINTER, DIMENSION(:) :: TMP_KEY
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  CLASS(MAP_@TEMPLATE_KEY_NAME@_@TEMPLATE_VALUE_NAME@_T), INTENT(INOUT) :: MAP
  @TEMPLATE_KEY_DUMMY_TYPE@, POINTER, DIMENSION(:),       INTENT(OUT)   :: KEY
  TYPE(HOOKS_T),                                          INTENT(INOUT) :: HOOKS
