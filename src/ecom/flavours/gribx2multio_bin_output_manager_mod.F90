...
IMPLICIT NONE
  ...
  IF ( CFG%GET( GRIBX2MULTIO_BIN_OMNAME, GRIBX2MULTIO_BIN_CFG ) ) THEN
...
IMPLICIT NONE
  ...
  IF ( THIS%VERBOSE_ ) THEN
    ...
    WRITE(THIS%LOG_FNAME_,'(A,I8.8,A)', IOSTAT=STAT) GRIBX2MULTIO_BIN_OMNAME//'-output-manager-', PROCESSOR_TOPO%MYPROC_IO, '.log'
