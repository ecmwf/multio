...
PP_THREAD_SAFE FUNCTION MAKE_GRIB2_SECTION5_CFG( GRIB2_SECTION5, DUMMY, &
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_INITIALIZATION_ERROR)  GRIB2_SECTION5%INIT( CFG, OPT, FACTORIES, HOOKS )
...
PP_THREAD_SAFE FUNCTION MAKE_GRIB2_SECTION5_LAZY( GRIB2_SECTION5, DUMMY, &
...
PP_THREAD_SAFE FUNCTION DESTROY_GRIB2_SECTION5( GRIB2_SECTION5, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Free the section
  PP_TRYCALL(ERRFLAG_FREE_ERROR)  GRIB2_SECTION5%FREE( OPT, DESTRUCTORS, HOOKS )
