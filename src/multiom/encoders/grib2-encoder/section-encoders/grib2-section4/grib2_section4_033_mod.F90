...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_SECTION4_033_INIT_CFG
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_ALLOCATE_SATELLITE) THIS%SATELLITE_%ALLOCATE( MSG, GEO, PAR, OPT, METADATA, HOOKS )
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_PRESET_SATELLITE) THIS%SATELLITE_%PRESET( MSG, GEO, PAR, OPT, METADATA, HOOKS )
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_RUNTIME_SATELLITE) THIS%SATELLITE_%RUNTIME(  MSG, GEO, PAR, OPT, METADATA, HOOKS )
