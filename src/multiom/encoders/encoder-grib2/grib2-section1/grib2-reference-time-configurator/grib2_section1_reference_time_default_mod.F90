!>
!> @file grib2_section1_reference_time_default_mod.F90
!>
!> @brief Module for managing GRIB2 Section 4 time configuration operations.
!>
!> The `GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_MOD` module contains procedures to initialize, allocate,
...
!>   - @see GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_PRESET
!>   - @see GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_RUNTIME
!>   - @see GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_TO_BE_ENCODED
!>   - @see GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_FREE
!>
...
#define PP_FILE_NAME 'grib2_section1_reference_time_default_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_MOD'
MODULE GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_MOD
...
!>
!> The `GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_T` type extends the base class `GRIB_SECTION_BASE_A` and
...
!> environments.
!>
TYPE, EXTENDS(GRIB_SECTION_BASE_A) :: GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_T
...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_CFG => GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_INIT_CFG
  ...
  !> the GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_LAZY => GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_INIT_LAZY
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ALLOCATE => GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_ALLOCATE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_PRESET
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_RUNTIME
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_TO_BE_ENCODED
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: FREE => GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_FREE
...
PUBLIC :: GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_T
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_T` representing the GRIB section being initialized.
...
#define PP_PROCEDURE_NAME 'GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_INIT_CFG'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_INIT_CFG( THIS, &
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_T),  INTENT(INOUT) :: THIS
...
END FUNCTION GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_INIT_CFG
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_INIT_LAZY'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_INIT_LAZY( THIS, &
...
END FUNCTION GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_INIT_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_T` representing the GRIB section to allocate resources for.
!>   @param [in]    MSG      All the mars keywords needed to describe the field `FORTRAN_MESSAGE_T`.
!>   @param [in]    PAR      All information outside mars keywords needed to describe the field `PARAMETRIZATION_T`.
!>   @param [in]    OPT      The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_ALLOCATE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_ALLOCATE( THIS, &
...
END FUNCTION GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_ALLOCATE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_T` representing the GRIB section to be preset.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_PRESET'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_PRESET( THIS, &
&  MSG, PAR, OPT,  METADATA, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Set date and time
  ! TODO: May change depending on time
  IF (MSG%HDATE.NE.UNDEF_PARAM_E) THEN
      PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'date', MSG%HDATE )
      PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'time', 0_JPIB_K )
  ELSE
      PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'date', MSG%DATE )
      PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'time', MSG%TIME/100 )
  ENDIF
...
END FUNCTION GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_PRESET
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS      An object of type `GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_T` representing the GRIB section for runtime execution.
!>   @param [in]    MSG       The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR       The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_RUNTIME'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_RUNTIME( THIS, &
&  MSG, PAR, TIME_HIST, CURR_TIME, OPT, METADATA, HOOKS ) RESULT(RET)
  ...
  USE :: METADATA_BASE_MOD,        ONLY: METADATA_BASE_A
  USE :: HOOKS_MOD,                ONLY: HOOKS_T
  USE :: GRIB2_SIGNIFICANCEOFREFERENCETIME_MOD, ONLY: SIGNIFICANCEOFREFERENCETIME_MAP
...
IMPLICIT NONE
  ...
  !> Local variables
  INTEGER(KIND=JPIB_K)               :: SORT
  INTEGER(KIND=JPIB_K), DIMENSION(6) :: DATE_TIME

  !> Error codes
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_METADATA=1_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_MAP=2_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAP) SIGNIFICANCEOFREFERENCETIME_MAP( MSG, PAR, SORT, HOOKS )
  PP_METADATA_SET( METADATA, ERRFLAG_METADATA,  'significanceOfReferenceTime', SORT )
  ...
  ! Unpack date time
  if(MSG%HDATE.NE.UNDEF_PARAM_E) THEN
      PP_TRYCALL(ERRFLAG_UNABLE_TO_CONVERT_DATETIME) YYYYMMDD_HHMMSS_TO_DATETIME( MSG%HDATE, 0_JPIB_K, DATE_TIME, HOOKS )
  ELSE
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_METADATA )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'error using metadata' )
    CASE ( ERRFLAG_UNABLE_TO_MAP )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to map significanceOfReferenceTime' )
...
END FUNCTION GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_RUNTIME
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS          An object of type `GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_T` representing the GRIB section being checked.
!>   @param [in]    MSG           The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR           The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
!>   @param [in]    TIME_HIST     The time history object of type `TIME_HISTORY_T` providing historical time data.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_TO_BE_ENCODED'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_TO_BE_ENCODED( THIS, &
...
END FUNCTION GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_TO_BE_ENCODED
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_T` representing the GRIB section to be freed.
!>   @param [in]    OPT   The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_FREE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_FREE( THIS, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_FREE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE

END MODULE GRIB2_SECTION1_REFERENCE_TIME_DEFAULT_MOD
