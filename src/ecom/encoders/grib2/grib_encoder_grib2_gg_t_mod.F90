...
SUBROUTINE MAKE_GRIB2_GG_T_ENCODER( CFG, MODEL_PARAMS, METADATA_KIND, ENCODER, MIOH )
...
SUBROUTINE ENCODER_GRIB2_GG_T_INITIALISE( THIS, MODEL_PARAMS, METADATA_KIND, MIOH )
...
IMPLICIT NONE
  ...
  ENDIF
  ! Load the sample
  PP_METADATA_INIT_FROM_SAMPLE_NAME( THIS%SAMPLE_, TRIM(ADJUSTL(SAMPLE_NAME_GRIB2_GG_T)) )

  ! Load the grib sample
  PP_LOG_DEVELOP_STR( 'ENCODER: grib2, gridded, theta_level, preset' )
...
IMPLICIT NONE
  ...
  PP_LOG_DEVELOP_STR( 'ENCODER: grib2, gridded, theta_level, runtime' )
