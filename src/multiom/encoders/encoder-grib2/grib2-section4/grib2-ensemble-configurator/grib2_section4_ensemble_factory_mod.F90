...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_INITIALIZATION_ERROR)  GRIB2_ENSEMBLE_CONFIGURATOR%INIT( CFG, OPT, FACTORIES, HOOKS )
...
IMPLICIT NONE
  ...
  !> Initialization of the section
  PP_TRYCALL(ERRFLAG_INITIALIZATION_ERROR)  GRIB2_ENSEMBLE_CONFIGURATOR%INIT( MSG, PAR, OPT, FACTORIES, HOOKS )
...
PP_THREAD_SAFE FUNCTION DESTROY_GRIB2_ENSEMBLE_CONFIGURATOR( GRIB2_ENSEMBLE_CONFIGURATOR, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Free the section
  PP_TRYCALL(ERRFLAG_FREE_ERROR)  GRIB2_ENSEMBLE_CONFIGURATOR%FREE( OPT, DESTRUCTORS, HOOKS )
  ...
  GRIB2_ENSEMBLE_CONFIGURATOR => NULL()
