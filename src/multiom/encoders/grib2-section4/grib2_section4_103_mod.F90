...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_SECTION4_103_INIT
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_103_INIT'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_103_INIT( THIS, &
...
END FUNCTION GRIB2_SECTION4_103_INIT
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_RUNTIME_PERIOD) THIS%PERIOD_%RUNTIME( MSG, PAR, OPT, METADATA, HOOKS )
