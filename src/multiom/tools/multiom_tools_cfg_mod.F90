...
IMPLICIT NONE
  ...
  IF ( ALLOCATED( CFG%PARAM_ID) ) THEN
    ...
    ! PP_DEBUG_CRITICAL_COND_THROW( WRITE_STAT .NE. 0, ERRFLAG_UNABLE_TO_WRITE )
    WRITE(OUTPUT_UNIT,*, IOSTAT=WRITE_STAT)  '+ param ids               :: ', CFG%PARAM_ID
    PP_DEBUG_CRITICAL_COND_THROW( WRITE_STAT .NE. 0, ERRFLAG_UNABLE_TO_WRITE )
  ELSE
  ...
  IF ( ALLOCATED( CFG%U_ID) ) THEN
    ...
    ! PP_DEBUG_CRITICAL_COND_THROW( WRITE_STAT .NE. 0, ERRFLAG_UNABLE_TO_WRITE )
    WRITE(OUTPUT_UNIT,*, IOSTAT=WRITE_STAT)  '+ levels ids              :: ', CFG%U_ID
    PP_DEBUG_CRITICAL_COND_THROW( WRITE_STAT .NE. 0, ERRFLAG_UNABLE_TO_WRITE )
  ELSE
  ...
  IF ( ALLOCATED( CFG%STEP_ID) ) THEN
    ...
    ! PP_DEBUG_CRITICAL_COND_THROW( WRITE_STAT .NE. 0, ERRFLAG_UNABLE_TO_WRITE )
    WRITE(OUTPUT_UNIT,*, IOSTAT=WRITE_STAT)  '+ steps ids               :: ', CFG%STEP_ID
    PP_DEBUG_CRITICAL_COND_THROW( WRITE_STAT .NE. 0, ERRFLAG_UNABLE_TO_WRITE )
  ELSE
  ...
  IF ( ALLOCATED( CFG%REPRES_ID) ) THEN
    ...
    ! PP_DEBUG_CRITICAL_COND_THROW( WRITE_STAT .NE. 0, ERRFLAG_UNABLE_TO_WRITE )
    WRITE(OUTPUT_UNIT,*, IOSTAT=WRITE_STAT)  '+ representation          :: ', CFG%REPRES_ID
    PP_DEBUG_CRITICAL_COND_THROW( WRITE_STAT .NE. 0, ERRFLAG_UNABLE_TO_WRITE )
  ELSE
  ...
  IF ( ALLOCATED( CFG%PREFIX_ID) ) THEN
    ...
    ! PP_DEBUG_CRITICAL_COND_THROW( WRITE_STAT .NE. 0, ERRFLAG_UNABLE_TO_WRITE )
    WRITE(OUTPUT_UNIT,*, IOSTAT=WRITE_STAT)  '+ prefix                  :: ', CFG%PREFIX_ID
    PP_DEBUG_CRITICAL_COND_THROW( WRITE_STAT .NE. 0, ERRFLAG_UNABLE_TO_WRITE )
  ELSE
