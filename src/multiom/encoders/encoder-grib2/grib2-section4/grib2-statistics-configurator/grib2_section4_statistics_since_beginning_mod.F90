...
&        MSG, PAR, TIME_HIST, CURR_TIME, OPT, TIME_SINCE_START, HOOKS )
  ...
  ENCODE_STEP_ZERO=THIS%ENCODE_STEP_ZERO_

  IF ( PAR%ENCODE_STEP_ZERO.NE.UNDEF_PARAM_E ) THEN
    ENCODE_STEP_ZERO=PAR%ENCODE_STEP_ZERO.GT.0_JPIB_K
  ENDIF
