...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_SECTION3_150_INIT_CFG
...
IMPLICIT NONE
  ...
  PP_DEBUG_CRITICAL_COND_THROW(  .NOT. ASSOCIATED(GEO), ERRFLAG_GEOMETRY_DESCRIPTION_NOT_ASSOCIATED )
