...
IMPLICIT NONE
  ...
  CERR = MIO_HANDLE%WRITE_GRIB_ENCODED( BUFFER )
  PP_DEBUG_CRITICAL_COND_THROW(CERR.NE.MULTIO_SUCCESS, 6)
...
IMPLICIT NONE
  ...
  CERR = MIOMD%NEW( MIO_HANDLE )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  1 )

  CERR = MIOMD%SET_LONG( "flushKind", INT(1, C_LONG) )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )

  CERR = MIOMD%SET_LONG( "step", INT( ISTEP, C_LONG ) )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  3 )

  CERR = MIO_HANDLE%FLUSH( MIOMD )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  4 )
...
IMPLICIT NONE
  ...
  CERR = MIOMD%SET_LONG( "flushKind", INT( 2, C_LONG) )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )
...
IMPLICIT NONE
  ...
  CERR = MIOMD%SET_LONG( "flushKind", INT(3, C_LONG) )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )
...
IMPLICIT NONE
  ...
  CERR = MIOMD%SET_LONG( "flushKind", INT(4,C_LONG) )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )

  CERR = MIOMD%SET_LONG( "step", INT(-1, C_LONG) )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  3 )
...
IMPLICIT NONE
  ...
  CERR = MIOMD%SET_STRING( "trigger", "step" )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )

  CERR = MIOMD%SET_LONG( "step", INT( STEP, C_LONG) )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  3 )

  CERR = MIO_HANDLE%NOTIFY(MIOMD)
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  4 )
