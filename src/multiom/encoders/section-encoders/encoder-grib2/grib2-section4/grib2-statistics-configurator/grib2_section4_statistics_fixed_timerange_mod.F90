!>
!> @file grib2_sECTION4_STATISTICS_FIXED_TIMERANGE_mod.F90
!>
!> @brief Module for managing GRIB2 Section 4 time configuration operations.
!>
!> The `GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_MOD` module contains procedures to initialize, allocate,
...
!>   - @see GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_INIT
!>   - @see GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_ALLOCATE
!>   - @see GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_PRESET
!>   - @see GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_RUNTIME
!>   - @see GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_TO_BE_ENCODED
!>   - @see GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_FREE
!>
...
#define PP_FILE_NAME 'grib2_section4_statistics_fixed_timerange_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_MOD'
...
!>
!> The `GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_T` type extends the base class `GRIB_SECTION_BASE_A` and
...
!> environments.
!>
TYPE, EXTENDS(GRIB_SECTION_BASE_A) :: GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_T

  !> Default symbols visibility
  PRIVATE

  !> Type-specific fields
  LOGICAL :: EMIT_STEP_ZERO_=.TRUE.
  INTEGER(KIND=JPIB_K) :: NUMBER_OF_TIME_RANGES_ = 0_JPIB_K
...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_CFG => GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_INIT_CFG
  ...
  !> the GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_LAZY => GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_INIT_LAZY
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ALLOCATE => GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_ALLOCATE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_PRESET
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_RUNTIME
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_TO_BE_ENCODED
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRINT => GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_PRINT
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: FREE => GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_FREE
...
PUBLIC :: GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_T
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_T` representing the GRIB section being initialized.
...
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_INIT_CFG'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_INIT_CFG( THIS, &
...
END FUNCTION GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_INIT_CFG
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_INIT_LAZY'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_INIT_LAZY( THIS, &
...
#if defined( PP_HAS_GET_GRIB2_FIXED_TIME_RANGE_CONFIGURATION_ID_FROM_MESSAGE )
  !> Symbols imported from the mapping module
  USE :: MARS2GRIB_MAPPING_MOD, ONLY: GET_GRIB2_FIXED_TIME_RANGE_CONFIGURATION_ID_FROM_MESSAGE
#endif
...
#if defined( PP_HAS_GET_GRIB2_FIXED_TIME_RANGE_CONFIGURATION_ID_FROM_MESSAGE )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ) GET_GRIB2_FIXED_TIME_RANGE_CONFIGURATION_ID_FROM_MESSAGE( &
...
END FUNCTION GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_INIT_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_T` representing the GRIB section to allocate resources for.
!>   @param [in]    MSG      All the mars keywords needed to describe the field `FORTRAN_MESSAGE_T`.
!>   @param [in]    PAR      All information outside mars keywords needed to describe the field `PARAMETRIZATION_T`.
!>   @param [in]    OPT      The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_ALLOCATE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_ALLOCATE( THIS, &
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CFG_NOT_ALLOCATED=3_JPIB_K
  ...
  PP_DEBUG_CRITICAL_COND_THROW( .NOT.ALLOCATED(THIS%TYPE_OF_STATISTICAL_PROCESS_), ERRFLAG_CFG_NOT_ALLOCATED )
  PP_DEBUG_CRITICAL_COND_THROW( .NOT.ALLOCATED(THIS%OVERALL_LENGTH_OF_TIMERANGE_IN_SECONDS_), ERRFLAG_CFG_NOT_ALLOCATED )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_CFG_NOT_ALLOCATED)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'error configuration not allocated' )
...
END FUNCTION GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_ALLOCATE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_T` representing the GRIB section to be preset.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_PRESET'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_PRESET( THIS, &
&  MSG, PAR, OPT,  METADATA, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_PRESET
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS      An object of type `GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_T` representing the GRIB section for runtime execution.
!>   @param [in]    MSG       The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR       The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_RUNTIME'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_RUNTIME( THIS, &
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_WRONG_TIMERANGE=10_JPIB_K
...
&        MSG, PAR, TIME_HIST, CURR_TIME, OPT, TIME_SINCE_START, HOOKS )
  ...
  FORECAST_TIME = MAX(0,TIME_SINCE_START-THIS%OVERALL_LENGTH_OF_TIMERANGE_IN_SECONDS_(1))
  ...
  !> Error handling
  ! PP_DEBUG_CRITICAL_COND_THROW( LOC_LENGTH_OF_TIME_RANGE.NE.THIS%OVERALL_LENGTH_OF_TIMERANGE_IN_SECONDS_(1), ERRFLAG_INVALID_FIELD )
  ! PP_DEBUG_CRITICAL_COND_THROW( MSG%TIMESPAN.EQ.UNDEF_PARAM_E, ERRFLAG_EXPECTED_TIMESPAN )
#if defined(ENABLE_CHECKS)
  IF ( MSG%TIMESPAN.NE.UNDEF_PARAM_E ) THEN
    PP_DEBUG_CRITICAL_COND_THROW( MSG%TIMESPAN.NE.THIS%OVERALL_LENGTH_OF_TIMERANGE_IN_SECONDS_(1)/3600, ERRFLAG_WRONG_TIMERANGE )
  ENDIF
#endif
  ...
  ! PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'forecastTime',  MSG%STEP )
  ! PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'lengthOfTimeRange',  MSG%TIMESPAN )

  ! PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'startStep', MAX(0_JPIB_K,MSG%STEP-MSG%TIMESPAN ) )
  PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'startStep', MAX(0_JPIB_K,MSG%STEP-THIS%OVERALL_LENGTH_OF_TIMERANGE_IN_SECONDS_(1)/3600 ) )
  PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'endStep',   MSG%STEP )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_WRONG_TIMERANGE )
      CTMP1 = REPEAT( ' ', 32 )
      WRITE( CTMP1, '(I32)' ) THIS%OVERALL_LENGTH_OF_TIMERANGE_IN_SECONDS_(1)/3600
      CTMP2 = REPEAT( ' ', 32 )
      WRITE( CTMP2, '(I32)' ) MSG%TIMESPAN
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'wrong time range' )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'got: '//TRIM(ADJUSTL(CTMP2)) )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'expected: '//TRIM(ADJUSTL(CTMP1)) )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
END FUNCTION GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_RUNTIME
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS          An object of type `GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_T` representing the GRIB section being checked.
!>   @param [in]    MSG           The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR           The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
!>   @param [in]    TIME_HIST     The time history object of type `TIME_HISTORY_T` providing historical time data.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_TO_BE_ENCODED'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_TO_BE_ENCODED( THIS, &
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K) :: FORECAST_TIME
  INTEGER(KIND=JPIB_K) :: TIME_SINCE_START
  INTEGER(KIND=JPIB_K) :: TIME_SINCE_LAST_POSTPROCESSING
...
!  FORECAST_TIME = MSG%STEP*PAR%TIME%LENGTH_OF_TIME_STEP_IN_SECONDS_ + MSG%STEP*PAR%TIME%INITIAL_STEP_ * HOURS2SECONDS

  ! Step zero should not be encoded for statistical fields
  !IF ( MSG%STEP .LT. 0_JPIB_K ) THEN
  !  TO_BE_ENCODED = .FALSE.
  !ELSEIF ( MSG%STEP .EQ. 0 ) THEN
  !  TO_BE_ENCODED = THIS%EMIT_STEP_ZERO_
  !ELSE
    ! TODO: TIME_SINCE_LAST_POSTPROCESSING = TIME_SINCE_START - TIME_HIST%LAST_
    ! IF ( TIME_SINCE_LAST_POSTPROCESSING .NE. THIS%OVERALL_LENGTH_OF_TIMERANGE_IN_SECONDS_(1)  ) THEN
      TO_BE_ENCODED = .TRUE.
    ! ELSE
    !   TO_BE_ENCODED = .TRUE.
    ! ENDIF
...
END FUNCTION GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_TO_BE_ENCODED
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS   An object of type `GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_T` representing the GRIB section to be freed.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_PRINT'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_PRINT( THIS, &
...
END FUNCTION GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_PRINT
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_FREE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_FREE( THIS, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_FREE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_READ_FROM_CFG( THIS, CFG, OPT, HOOKS ) RESULT(RET)
  ...
  USE :: ENUMERATORS_MOD,                ONLY: UNDEF_PARAM_E
  USE :: GRIB2_SECTION4_STATISTICS_UTILS_MOD,  ONLY: CLENGTH_OF_TIMERANGE2ILENGTH_OF_TIMERANGE
...
IMPLICIT NONE
  ...
  IF ( HAS_EMIT_STEP_ZERO ) THEN
    PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_CFG) YAML_READ_LOGICAL( CFG, 'emit-step-zero', THIS%EMIT_STEP_ZERO_, HOOKS )
  ELSE
    THIS%EMIT_STEP_ZERO_ = .FALSE.
  ENDIF
  ...
  IF ( HAS_TIMERANGES  ) THEN
    ...
    PP_TRYCALL(ERRFLAG_UNABLE_TO_GET_SUBCFG_SIZE) YAML_GET_CONFIGURATIONS_SIZE( TIME_RANGES_CONFIGURATION, THIS%NUMBER_OF_TIME_RANGES_, HOOKS )
    PP_DEBUG_CRITICAL_COND_THROW( THIS%NUMBER_OF_TIME_RANGES_ .LE. 0, ERRFLAG_WRONG_NUMBER_OF_TIMERANGES )
  ...
  ELSE
    ...
    PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_CFG) YAML_CONFIGURATION_HAS_KEY( CFG, 'overall-length-of-timerange-in-seconds', HAS_OVERALL_LENGTH_OF_TIMERANGE_IN_SECONDS, HOOKS )
    PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_CFG) YAML_CONFIGURATION_HAS_KEY( CFG, 'overall-length-of-timerange', HAS_OVERALL_LENGTH_OF_TIMERANGE, HOOKS )
    PP_DEBUG_CRITICAL_COND_THROW( .NOT. HAS_TYPE_OF_STATISTICAL_PROCESSING, ERRFLAG_UDEFINED_TYPE_OF_STATISTICAL_PROCESSING )
    PP_DEBUG_CRITICAL_COND_THROW( ALL( [.NOT.HAS_OVERALL_LENGTH_OF_TIMERANGE_IN_SECONDS, .NOT.HAS_OVERALL_LENGTH_OF_TIMERANGE]) , ERRFLAG_UDEFINED_LENGTH_OF_TIMERANGE )
    PP_DEBUG_CRITICAL_COND_THROW( ALL( [HAS_OVERALL_LENGTH_OF_TIMERANGE_IN_SECONDS, HAS_OVERALL_LENGTH_OF_TIMERANGE]) , ERRFLAG_OVERDEFINED_LENGTH_OF_TIMERANGE )
    ...
    !> Read the overall length of timerange in seconds
    IF ( HAS_OVERALL_LENGTH_OF_TIMERANGE_IN_SECONDS ) THEN
      PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_CFG) YAML_READ_INTEGER( CFG, 'overall-length-of-timerange-in-seconds', THIS%OVERALL_LENGTH_OF_TIMERANGE_IN_SECONDS_(I), HOOKS )
    ELSEIF ( HAS_OVERALL_LENGTH_OF_TIMERANGE ) THEN
      P_CLENGTH_OF_TIMERANGE2ILENGTH_OF_TIMERANGE => CLENGTH_OF_TIMERANGE2ILENGTH_OF_TIMERANGE
      PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_CFG) YAML_READ_INTEGER_WITH_FILTER( CFG, 'overall-length-of-timerange', THIS%OVERALL_LENGTH_OF_TIMERANGE_IN_SECONDS_(I), P_CLENGTH_OF_TIMERANGE2ILENGTH_OF_TIMERANGE, HOOKS )
    END IF
