...
PP_ERROR_HANDLER
  ...
  ErrorHandler: BLOCK
    ...
    CASE (15)
      MIO_ERR_STR = MULTIO_ERROR_STRING(CERR)
      PP_DEBUG_CREATE_ERROR_MSG( STR, 'Unable to set MultIO metadata (levtype): '//TRIM(ADJUSTL(MIO_ERR_STR)) )
      IF ( ALLOCATED( MIO_ERR_STR ) ) DEALLOCATE( MIO_ERR_STR )
    CASE (16)
      MIO_ERR_STR = MULTIO_ERROR_STRING(CERR)
      PP_DEBUG_CREATE_ERROR_MSG( STR, 'Unable to set MultIO metadata (level): '//TRIM(ADJUSTL(MIO_ERR_STR)) )
      IF ( ALLOCATED( MIO_ERR_STR ) ) DEALLOCATE( MIO_ERR_STR )
    CASE (17)
      MIO_ERR_STR = MULTIO_ERROR_STRING(CERR)
      PP_DEBUG_CREATE_ERROR_MSG( STR, 'Unable to set MultIO metadata (class): '//TRIM(ADJUSTL(MIO_ERR_STR)) )
      IF ( ALLOCATED( MIO_ERR_STR ) ) DEALLOCATE( MIO_ERR_STR )
    CASE (18)
      MIO_ERR_STR = MULTIO_ERROR_STRING(CERR)
      PP_DEBUG_CREATE_ERROR_MSG( STR, 'Unable to set MultIO metadata (stream): '//TRIM(ADJUSTL(MIO_ERR_STR)) )
      IF ( ALLOCATED( MIO_ERR_STR ) ) DEALLOCATE( MIO_ERR_STR )
    CASE (19)
      MIO_ERR_STR = MULTIO_ERROR_STRING(CERR)
      PP_DEBUG_CREATE_ERROR_MSG( STR, 'Unable to set MultIO metadata (type): '//TRIM(ADJUSTL(MIO_ERR_STR)) )
      IF ( ALLOCATED( MIO_ERR_STR ) ) DEALLOCATE( MIO_ERR_STR )
    CASE (20)
      MIO_ERR_STR = MULTIO_ERROR_STRING(CERR)
      PP_DEBUG_CREATE_ERROR_MSG( STR, 'Unable to set MultIO metadata (expver): '//TRIM(ADJUSTL(MIO_ERR_STR)) )
      IF ( ALLOCATED( MIO_ERR_STR ) ) DEALLOCATE( MIO_ERR_STR )
