...
PP_THREAD_SAFE FUNCTION MULTIO_GRIB2_ENCODER_OPEN( &
& C_OPTIONS_P, C_ENCODER_MTG2_PP, C_ENCODER_TYPE_P, LEN ) &
...
&        C_ENCODER_TYPE_P, LEN, F_ENCODER_TYPE_LOWERCASE, HOOKS, TOLOWER=.TRUE. )
...
&        C_ENCODER_MTG2_P(1), F_OPTIONS, HOOKS )
...
& C_MARS_DICT, C_PAR_DICT, C_CODES_HANDLE ) &
 BIND(C,NAME='multio_grib2_encoder_encode_f_02') RESULT(RET)
  ...
  USE :: MARS_DICTIONARY_WRAPPER_MOD,            ONLY: MARS_DICTIONARY_WRAPPER_EXTRACT
  ...
  USE :: CACHED_MAPPED_ENCODER_WRAPPER_MOD,      ONLY: CACHED_MAPPED_ENCODER_IDX_E
  USE :: CACHED_MAPPED_ENCODER_WRAPPER_MOD,      ONLY: ENCODE_CACHED_MAPPED_ENCODER
...
IMPLICIT NONE
  ...
  TYPE(C_PTR),  VALUE, INTENT(IN) :: C_CODES_HANDLE
...
&   C_ENCODER_MTG2, 1_JPIB_K, LOC_P_ENCODER, HOOKS )
  ...
  LOC_P_HANDLE => NULL()
  PP_TRYCALL(ERRFLAG_DEREFERENCE_DOUBLE_POINTER) DEREFERENCE_DOUBLE_C_POINTER( &
&   C_ENCODER_MTG2, 1_JPIB_K, LOC_P_HANDLE, HOOKS )
...
&  OBJ_ID, OBJ_SIZE, BUF_SIZE, HASH, HOOKS, VERIFY_CHECKSUM=.TRUE. )
  ...
  CASE (CACHED_MAPPED_ENCODER_IDX_E)
    ...
    PP_TRYCALL(ERRFLAG_UNABLE_TO_ENCODE) ENCODE_CACHED_MAPPED_ENCODER( &
&     LOC_P_ENCODER(1), F_MARS_DICT, F_PAR_DICT, LOC_P_HANDLE(1), HOOKS )
    PP_DEBUG_CRITICAL_COND_THROW( .NOT.C_ASSOCIATED(C_CODES_HANDLE), ERRFLAG_ENCODER_NOT_ASSOCIATED )
