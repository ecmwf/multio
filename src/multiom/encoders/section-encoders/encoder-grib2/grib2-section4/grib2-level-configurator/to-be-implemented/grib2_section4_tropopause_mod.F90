...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_CFG => G2S4_TROPOPAUSE_INIT_CFG
  ...
  !> the GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_LAZY => G2S4_TROPOPAUSE_INIT_LAZY
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => G2S4_TROPOPAUSE_TBE
...
#define PP_PROCEDURE_NAME 'G2S4_TROPOPAUSE_INIT_CFG'
PP_THREAD_SAFE FUNCTION G2S4_TROPOPAUSE_INIT_CFG( THIS, &
...
END FUNCTION G2S4_TROPOPAUSE_INIT_CFG
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_TROPOPAUSE_INIT_LAZY'
PP_THREAD_SAFE FUNCTION G2S4_TROPOPAUSE_INIT_LAZY( THIS, &
...
END FUNCTION G2S4_TROPOPAUSE_INIT_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS          An object of type `GRIB2_SECTION4_TROPOPAUSE_T` representing the GRIB section being checked.
!>   @param [in]    MSG           The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR           The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
!>   @param [in]    TIME_HIST     The time history object of type `TIME_HISTORY_T` providing historical level data.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_TROPOPAUSE_TBE'
PP_THREAD_SAFE FUNCTION G2S4_TROPOPAUSE_TBE( THIS, &
...
END FUNCTION G2S4_TROPOPAUSE_TBE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
PP_THREAD_SAFE FUNCTION G2S4_TROPOPAUSE_FREE( THIS, OPT, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  IF ( OPT%USE_TYPE_OF_LEVEL ) THEN
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'typeOfLevel', 'tropopause' )
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'level', MSG%LEVELIST )
  ELSE
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'TypeOfFirstFixedSurface', 7_JPIB_K )
