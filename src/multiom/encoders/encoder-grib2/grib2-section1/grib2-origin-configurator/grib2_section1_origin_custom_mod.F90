!>
!> @file grib2_section1_origin_custom_mod.F90
!>
!> @brief Module for managing GRIB2 Section 4 time configuration operations.
!>
!> The `GRIB2_SECTION1_ORIGIN_CUSTOM_MOD` module contains procedures to initialize, allocate,
...
!>   - @see GRIB2_SECTION1_ORIGIN_CUSTOM_INIT
!>   - @see GRIB2_SECTION1_ORIGIN_CUSTOM_ALLOCATE
!>   - @see GRIB2_SECTION1_ORIGIN_CUSTOM_PRESET
!>   - @see GRIB2_SECTION1_ORIGIN_CUSTOM_RUNTIME
!>   - @see GRIB2_SECTION1_ORIGIN_CUSTOM_TO_BE_ENCODED
!>   - @see GRIB2_SECTION1_ORIGIN_CUSTOM_FREE
!>
...
#define PP_FILE_NAME 'grib2_section1_origin_custom_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'GRIB2_SECTION1_ORIGIN_CUSTOM_MOD'
MODULE GRIB2_SECTION1_ORIGIN_CUSTOM_MOD
...
!>
!> The `GRIB2_SECTION1_ORIGIN_CUSTOM_T` type extends the base class `GRIB_SECTION_BASE_A` and
...
!> environments.
!>
TYPE, EXTENDS(GRIB_SECTION_BASE_A) :: GRIB2_SECTION1_ORIGIN_CUSTOM_T

  !> Default symbols visibility
  PRIVATE

  INTEGER(KIND=JPIB_K) :: SUB_CENTRE_ = 0_JPIB_K
  CHARACTER(LEN=4) :: CENTRE_=REPEAT('*',4)
...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_CFG => GRIB2_SECTION1_ORIGIN_CUSTOM_INIT_CFG
  ...
  !> the GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_LAZY => GRIB2_SECTION1_ORIGIN_CUSTOM_INIT_LAZY
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ALLOCATE => GRIB2_SECTION1_ORIGIN_CUSTOM_ALLOCATE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => GRIB2_SECTION1_ORIGIN_CUSTOM_PRESET
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => GRIB2_SECTION1_ORIGIN_CUSTOM_RUNTIME
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => GRIB2_SECTION1_ORIGIN_CUSTOM_TO_BE_ENCODED
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: FREE => GRIB2_SECTION1_ORIGIN_CUSTOM_FREE
...
PUBLIC :: GRIB2_SECTION1_ORIGIN_CUSTOM_T
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION1_ORIGIN_CUSTOM_T` representing the GRIB section being initialized.
...
#define PP_PROCEDURE_NAME 'GRIB2_SECTION1_ORIGIN_CUSTOM_INIT_CFG'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION1_ORIGIN_CUSTOM_INIT_CFG( THIS, &
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(GRIB2_SECTION1_ORIGIN_CUSTOM_T),  INTENT(INOUT) :: THIS
  ...
  !> Local variables
  LOGICAL :: HAS_SUB_CENTRE
  LOGICAL :: HAS_CENTRE
  CHARACTER(LEN=:), ALLOCATABLE :: CENTRE
  INTEGER(KIND=JPIB_K) :: DEALLOC_STATUS
  CHARACTER(LEN=:), ALLOCATABLE :: ERRMSG

  !> Local error codes
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_READ_CFG=2_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_NOT_ASSOCIATED_AFTER_READING=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_WRONG_LENGTH_AFTER_READING=4_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_DEALLOCATE_FAILED=5_JPIB_K
  ...
  THIS%SUBTYPE_ = 'ORIGIN'
  THIS%KIND_   = 'CUSTOM'

  ! Read the optional configuration
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_CFG) YAML_CONFIGURATION_HAS_KEY( CFG, 'sub-centre', HAS_SUB_CENTRE, HOOKS )

  ! Read the subCentre
  IF (HAS_SUB_CENTRE) THEN
    PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_CFG) YAML_READ_INTEGER( CFG, 'sub-centre',  THIS%SUB_CENTRE_, HOOKS )
  ELSE
    THIS%SUB_CENTRE_ = 0_JPIB_K
  END IF

  ! Read the optional configuration
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_CFG) YAML_CONFIGURATION_HAS_KEY( CFG, 'centre', HAS_CENTRE, HOOKS )

  ! Read the subCentre
  IF (HAS_CENTRE) THEN
    PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_CFG) YAML_READ_STRING( CFG, 'centre',  CENTRE, HOOKS )
    PP_DEBUG_CRITICAL_COND_THROW( .NOT.ALLOCATED(CENTRE), ERRFLAG_NOT_ASSOCIATED_AFTER_READING )
    PP_DEBUG_CRITICAL_COND_THROW( LEN_TRIM(CENTRE) .NE. 4, ERRFLAG_WRONG_LENGTH_AFTER_READING )
    THIS%CENTRE_ = TRIM(ADJUSTL(CENTRE))
    DEALLOCATE( CENTRE, STAT=DEALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( DEALLOC_STATUS .NE. 0, ERRFLAG_DEALLOCATE_FAILED )
  ELSE
    THIS%CENTRE_ = 'ecmf'
  END IF
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_NOT_ASSOCIATED_AFTER_READING )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'not associated after reading' )
    CASE ( ERRFLAG_WRONG_LENGTH_AFTER_READING )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'wrong length after reading' )
...
END FUNCTION GRIB2_SECTION1_ORIGIN_CUSTOM_INIT_CFG
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION1_ORIGIN_CUSTOM_INIT_LAZY'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION1_ORIGIN_CUSTOM_INIT_LAZY( THIS, &
...
IMPLICIT NONE
  ...
  !> Local error codes
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_WRONG_PATH=1_JPIB_K
  ...
  PP_DEBUG_CRITICAL_THROW( ERRFLAG_WRONG_PATH )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    ! Handle different errors
    SELECT CASE(ERRIDX)
    CASE ( ERRFLAG_WRONG_PATH )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'custom configurators cannot have lazy constructors' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
END FUNCTION GRIB2_SECTION1_ORIGIN_CUSTOM_INIT_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION1_ORIGIN_CUSTOM_T` representing the GRIB section to allocate resources for.
!>   @param [in]    MSG      All the mars keywords needed to describe the field `FORTRAN_MESSAGE_T`.
!>   @param [in]    PAR      All information outside mars keywords needed to describe the field `PARAMETRIZATION_T`.
!>   @param [in]    OPT      The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION1_ORIGIN_CUSTOM_ALLOCATE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION1_ORIGIN_CUSTOM_ALLOCATE( THIS, &
...
END FUNCTION GRIB2_SECTION1_ORIGIN_CUSTOM_ALLOCATE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION1_ORIGIN_CUSTOM_T` representing the GRIB section to be preset.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION1_ORIGIN_CUSTOM_PRESET'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION1_ORIGIN_CUSTOM_PRESET( THIS, &
&  MSG, PAR, OPT,  METADATA, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'center', THIS%CENTRE_ )
  PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'subCenter', THIS%SUB_CENTRE_ )
...
END FUNCTION GRIB2_SECTION1_ORIGIN_CUSTOM_PRESET
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS      An object of type `GRIB2_SECTION1_ORIGIN_CUSTOM_T` representing the GRIB section for runtime execution.
!>   @param [in]    MSG       The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR       The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION1_ORIGIN_CUSTOM_RUNTIME'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION1_ORIGIN_CUSTOM_RUNTIME( THIS, &
...
END FUNCTION GRIB2_SECTION1_ORIGIN_CUSTOM_RUNTIME
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS          An object of type `GRIB2_SECTION1_ORIGIN_CUSTOM_T` representing the GRIB section being checked.
!>   @param [in]    MSG           The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR           The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
!>   @param [in]    TIME_HIST     The time history object of type `TIME_HISTORY_T` providing historical time data.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION1_ORIGIN_CUSTOM_TO_BE_ENCODED'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION1_ORIGIN_CUSTOM_TO_BE_ENCODED( THIS, &
...
END FUNCTION GRIB2_SECTION1_ORIGIN_CUSTOM_TO_BE_ENCODED
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION1_ORIGIN_CUSTOM_T` representing the GRIB section to be freed.
!>   @param [in]    OPT   The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION1_ORIGIN_CUSTOM_FREE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION1_ORIGIN_CUSTOM_FREE( THIS, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION1_ORIGIN_CUSTOM_FREE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE



END MODULE GRIB2_SECTION1_ORIGIN_CUSTOM_MOD
