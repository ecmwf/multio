...
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_ENCODE_STEP_ZERO = 3_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_INITIAL_STEP = 4_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_LENGTH_OF_TIME_STEP = 5_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_LENGTH_OF_TIME_RANGE = 6_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_VALUES_SCALE_FACTOR = 7_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_PV = 8_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_NUMBER_OF_MISSING_VALUES = 9_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_VALUE_OF_MISSING_VALUES = 10_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_SYSTEM_NUMBER = 11_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_METHOD_NUMBER = 12_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_TYPE_OF_ENSEMBLE_FORECAST = 13_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_NUMBER_OF_FORECASTS_IN_ENSEMBLE = 14_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_LENGTH_OF_TIME_WINDOW = 15_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_BITS_PER_VALUE = 16_JPIB_K
...
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_UNDEF = 25_JPIB_K
