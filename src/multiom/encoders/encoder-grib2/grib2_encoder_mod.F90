...
PP_THREAD_SAFE FUNCTION GRIB2_ENCODER_INIT( THIS, &
...
&               ENCODER_CFG, ENCODER_OPT, FACTORIES, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_SEC0) FACTORIES%MAKE_GRIB2_SECTION0_CFG( THIS%INDICATOR_SECTION_, 0_JPIB_K, INDICATOR_SECTION_CFG, ENCODER_OPT, FACTORIES, HOOKS )
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_SEC1) FACTORIES%MAKE_GRIB2_SECTION1_CFG( THIS%IDENTIFICATION_SECTION_, 0_JPIB_K, IDENTIFICATION_SECTION_CFG, ENCODER_OPT, FACTORIES, HOOKS )
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_SEC2) FACTORIES%MAKE_GRIB2_SECTION2_CFG( THIS%LOCAL_USE_SECTION_, 0_JPIB_K, LOCAL_USE_SECTION_CFG, ENCODER_OPT, FACTORIES, HOOKS )
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_SEC3) FACTORIES%MAKE_GRIB2_SECTION3_CFG( THIS%GRID_DEFINITION_SECTION_, 0_JPIB_K, GRID_DEFINITION_SECTION_CFG, ENCODER_OPT, FACTORIES, HOOKS )
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_SEC4) FACTORIES%MAKE_GRIB2_SECTION4_CFG( THIS%PRODUCT_DEFINITION_SECTION_, 0_JPIB_K, PRODUCT_DEFINITION_SECTION_CFG, ENCODER_OPT, FACTORIES, HOOKS )
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_SEC5) FACTORIES%MAKE_GRIB2_SECTION5_CFG( THIS%DATA_REPRESENTATION_SECTION_, 0_JPIB_K, DATA_REPRESENTATION_SECTION_CFG, ENCODER_OPT, FACTORIES, HOOKS )
...
IMPLICIT NONE
  ...
  ! Allocate the sections
  PP_TRYCALL(ERRFLAG_CALL_SEC0_RUNTIME) THIS%INDICATOR_SECTION_%RUNTIME          ( MSG, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(EERRFLAG_CALL_SEC1_RUNTIME) THIS%IDENTIFICATION_SECTION_%RUNTIME    ( MSG, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(EERRFLAG_CALL_SEC2_RUNTIME) THIS%LOCAL_USE_SECTION_%RUNTIME         ( MSG, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC3_RUNTIME) THIS%GRID_DEFINITION_SECTION_%RUNTIME    ( MSG, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC4_RUNTIME) THIS%PRODUCT_DEFINITION_SECTION_%RUNTIME ( MSG, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC5_RUNTIME) THIS%DATA_REPRESENTATION_SECTION_%RUNTIME( MSG, PAR, OPT, METADATA, HOOKS )
