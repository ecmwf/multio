...
IMPLICIT NONE
  ...
  IF ( ALLOCATED(DATA%MSERIES) ) THEN
    ...
    DO I = LBOUND(DATA%MSERIES,1), UBOUND(DATA%MSERIES,1)
      WRITE(UNIT,'(A,I6,A,I10)') ' + SATELLITES_PARAMS%MSERIES(',I,').............. :: ', DATA%MSERIES(I)
    ENDDO
  ENDIF
  ...
  IF ( ALLOCATED(DATA%MSATID) ) THEN
    ...
    DO I = LBOUND(DATA%MSATID,1), UBOUND(DATA%MSATID,1)
      WRITE(UNIT,'(A,I6,A,I10)') ' + SATELLITES_PARAMS%MSATID(',I,').............. :: ', DATA%MSATID(I)
    ENDDO
  ENDIF
  ...
  IF ( ALLOCATED(DATA%MINST) ) THEN
    ...
    DO I = LBOUND(DATA%MINST,1), UBOUND(DATA%MINST,1)
      WRITE(UNIT,'(A,I6,A,I10)') ' + SATELLITES_PARAMS%MINST(',I,').............. :: ', DATA%MINST(I)
    ENDDO
  ENDIF
  ...
  IF ( ALLOCATED(DATA%MCHAN) ) THEN
    ...
    DO I = LBOUND(DATA%MCHAN,1), UBOUND(DATA%MCHAN,1)
      WRITE(UNIT,'(A,I6,A,I10)') ' + SATELLITES_PARAMS%MCHAN(',I,').............. :: ', DATA%MCHAN(I)
    ENDDO
  ENDIF
