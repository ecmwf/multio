...
CHARACTER(LEN=*), PARAMETER :: TYPE_OF_LEVEL = 'entireLake'
INTEGER(KIND=JPIB_K), PARAMETER :: TYPE_OF_FIRST_FIXED_SURFACE = 1_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: TYPE_OF_SECOND_FIXED_SURFACE = 162_JPIB_K
...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => G2S4_ENTIRELAKE_INIT
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: CHECK => G2S4_ENTIRELAKE_CHECK
...
#define PP_PROCEDURE_NAME 'G2S4_ENTIRELAKE_INIT'
PP_THREAD_SAFE FUNCTION G2S4_ENTIRELAKE_INIT( THIS, &
...
END FUNCTION G2S4_ENTIRELAKE_INIT
...
IMPLICIT NONE
  ...
  PP_LOG_DEVELOP_STR( 'Allocate: entireLake' )
...
IMPLICIT NONE
  ...
  ! Logging
  PP_LOG_DEVELOP_STR( 'Preset: entireLake' )
...
IMPLICIT NONE
  ...
  ! Logging
  PP_LOG_DEVELOP_STR( 'Runtime: entireLake' )
...
PP_THREAD_SAFE FUNCTION G2S4_ENTIRELAKE_FREE( THIS, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_ENTIRELAKE_CHECK'
PP_THREAD_SAFE FUNCTION G2S4_ENTIRELAKE_CHECK( THIS, &
&  MSG, PAR, OPT, METADATA, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! According to the options decide where to set the levels (preset or runlevel)
  PP_LOG_INFO( 'check typeOfLevel: entireLake' )
...
END FUNCTION G2S4_ENTIRELAKE_CHECK
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
