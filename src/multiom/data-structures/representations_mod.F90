...
TYPE, EXTENDS(REPRES_A) :: REGULAR_LL_T
  INTEGER(KIND=JPIB_K) :: TRUNCATE_DEGREES=0_JPIB_K
  INTEGER(KIND=JPIB_K) :: NUMBER_OF_POINTS_ALONG_A_MERIDIAN=0_JPIB_K
  INTEGER(KIND=JPIB_K) :: NUMBER_OF_POINTS_ALONG_A_PARALLEL=0_JPIB_K
  INTEGER(KIND=JPIB_K) :: NUMBER_OF_PARALLELS_BETWEEN_POLE_AND_EQUATOR=0_JPIB_K
  ...
  REAL(KIND=JPRD_K) :: IDIR_INC=0.0_JPRD_K
CONTAINS
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: WRITE_TO_YAML => REGULAR_LL_TO_YAML
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: FREE => REGULAR_LL_FREE
END TYPE

TYPE, EXTENDS(REPRES_A) :: HEALPIX_T
  INTEGER(KIND=JPIB_K) :: ORDERING_CONVENTION_ =0_JPIB_K
  INTEGER(KIND=JPIB_K) :: NSIDE_=0_JPIB_K
CONTAINS
...
TYPE, EXTENDS(REPRES_A) :: ORCA_T
CONTAINS
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: WRITE_TO_YAML => ORCA_TO_YAML
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: FREE => ORCA_FREE
END TYPE

TYPE, EXTENDS(REPRES_A) :: FESOM_T
CONTAINS
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: WRITE_TO_YAML => FESOM_TO_YAML
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: FREE => FESOM_FREE
END TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'REGULAR_LL_TO_YAML'
PP_THREAD_SAFE FUNCTION REGULAR_LL_TO_YAML( THIS, UNIT, OFFSET, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  CLASS(REGULAR_LL_T),  INTENT(IN)    :: THIS
  INTEGER(KIND=JPIB_K), INTENT(IN)    :: UNIT
  INTEGER(KIND=JPIB_K), INTENT(IN)    :: OFFSET
  TYPE(HOOKS_T),        INTENT(INOUT) :: HOOKS
...
END FUNCTION REGULAR_LL_TO_YAML
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_IOSTATUS_NOT_ZERO=1_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_CONVERT_TO_STRING=2_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_WRONG_ORDERING=3_JPIB_K
  ...
  ! ordering convention
  SELECT CASE ( THIS%ORDERING_CONVENTION_ )

  CASE (1)
    WRITE(UNIT,'(A)',IOSTAT=WRITE_STAT) REPEAT(' ',OFFSET+2)//': '//'ring'
    PP_DEBUG_CRITICAL_COND_THROW( WRITE_STAT .NE. 0, ERRFLAG_IOSTATUS_NOT_ZERO )

  CASE (2)
    WRITE(UNIT,'(A)',IOSTAT=WRITE_STAT) REPEAT(' ',OFFSET+2)//': '//'nested'
    PP_DEBUG_CRITICAL_COND_THROW( WRITE_STAT .NE. 0, ERRFLAG_IOSTATUS_NOT_ZERO )

  CASE DEFAULT
    PP_DEBUG_CRITICAL_THROW( ERRFLAG_UNABLE_TO_CONVERT_TO_STRING )
  END SELECT

  ! number of points along a meridian
  CTMP = REPEAT(' ',32)
  WRITE(CTMP,'(I8)',IOSTAT=WRITE_STAT) THIS%NSIDE_
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'ORCA_TO_YAML'
PP_THREAD_SAFE FUNCTION ORCA_TO_YAML( THIS, UNIT, OFFSET, HOOKS ) RESULT(RET)
...
END FUNCTION ORCA_TO_YAML
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'FESOM_TO_YAML'
PP_THREAD_SAFE FUNCTION FESOM_TO_YAML( THIS, UNIT, OFFSET, HOOKS ) RESULT(RET)
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'REGULAR_LL_FREE'
PP_THREAD_SAFE FUNCTION REGULAR_LL_FREE( REPRES, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  CLASS(REGULAR_LL_T), INTENT(INOUT) :: REPRES
  TYPE(HOOKS_T),       INTENT(INOUT) :: HOOKS
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'ORCA_FREE'
PP_THREAD_SAFE FUNCTION ORCA_FREE( REPRES, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  CLASS(ORCA_T), INTENT(INOUT) :: REPRES
  TYPE(HOOKS_T), INTENT(INOUT) :: HOOKS
...
END FUNCTION ORCA_FREE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE

#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'FESOM_FREE'
PP_THREAD_SAFE FUNCTION FESOM_FREE( REPRES, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  CLASS(FESOM_T), INTENT(INOUT) :: REPRES
  TYPE(HOOKS_T),  INTENT(INOUT) :: HOOKS
