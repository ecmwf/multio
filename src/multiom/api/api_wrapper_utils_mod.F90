...
#define PP_FILE_NAME 'api_wrapper_utils_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'API_WRAPPER_UTILS_MOD'
MODULE API_WRAPPER_UTILS_MOD
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: CACHED_ENCODER_IDX_E = 1_JPIB_K
...
#define PP_PROCEDURE_NAME 'CREATE_ENCODER'
PP_THREAD_SAFE FUNCTION CREATE_ENCODER( WRAPPED_ENCODER, ENCODER, HOOKS ) RESULT(RET)
...
&   WRAPPER, BUFFER, CACHED_ENCODER_IDX_E, CACHED_ENCODER_CONTAINER_BYTE_SIZE, HOOKS )
...
PP_THREAD_SAFE FUNCTION EXTRACT_ENCODER( WRAPPED_ENCODER, ENCODER, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION FREE_ENCODER( WRAPPED_ENCODER, HOOKS ) RESULT(RET)
...
END MODULE API_WRAPPER_UTILS_MOD
