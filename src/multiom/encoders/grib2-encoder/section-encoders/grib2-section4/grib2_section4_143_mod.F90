...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => G2S4_143_INIT_CFG
...
&  MSG, GEO, PAR, OPT,  METADATA, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_ALLOCATE_MODEL) THIS%MODEL_%ALLOCATE                    ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_ALLOCATE_TIME) THIS%TIME_%ALLOCATE                      ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_ALLOCATE_LEVEL) THIS%LEVEL_%ALLOCATE                    ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_ALLOCATE_PARAMID) THIS%PARAMID_%ALLOCATE                ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_ALLOCATE_ENSEMBLE) THIS%ENSEMBLE_%ALLOCATE              ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_ALLOCATE_RANDOM_PATTERNS) THIS%RANDOM_PATTERNS_%ALLOCATE( MSG, GEO, PAR, OPT, METADATA, HOOKS )
...
IMPLICIT NONE
  ...
  ! Allocate time, level and paramId subcomponents of the section
  PP_TRYCALL(ERRFLAG_PRESET_MODEL) THIS%MODEL_%PRESET      ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_PRESET_TIME) THIS%TIME_%PRESET        ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_PRESET_LEVEL) THIS%LEVEL_%PRESET      ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_PRESET_PARAMID) THIS%PARAMID_%PRESET  ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_PRESET_ENSEMBLE) THIS%ENSEMBLE_%PRESET( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_PRESET_RANDOM_PATTERNS) THIS%RANDOM_PATTERNS_%PRESET( MSG, GEO, PAR, OPT, METADATA, HOOKS )
...
IMPLICIT NONE
  ...
  ! Allocate time, level and paramId subcomponents of the section
  PP_TRYCALL(ERRFLAG_RUNTIME_MODEL) THIS%MODEL_%RUNTIME                    ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_RUNTIME_TIME) THIS%TIME_%RUNTIME                      ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_RUNTIME_LEVEL) THIS%LEVEL_%RUNTIME                    ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_RUNTIME_PARAMID) THIS%PARAMID_%RUNTIME                ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_RUNTIME_ENSEMBLE) THIS%ENSEMBLE_%RUNTIME              ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_RUNTIME_RANDOM_PATTERNS) THIS%RANDOM_PATTERNS_%RUNTIME( MSG, GEO, PAR, OPT, METADATA, HOOKS )
