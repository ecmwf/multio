...
PP_THREAD_SAFE FUNCTION MULTIO_GRIB2_ENCODER_ENCODE( MULTIO_GRIB2, C_MARS_DICT, C_PAR_DICT, C_CODES_HANDLE_LOC ) &
 BIND(C,NAME='multio_grib2_encoder_encode_f') RESULT(RET)
  ...
  USE :: API_GENERAL_UTILS_MOD,    ONLY: GRIB_MESSAGE_TO_C_CODES_HANDLE
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_C_CODES_HANDLE_IS_NULL_POINTER=7_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_GET_GRIB_MESSAGE=8_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_GRIB_MESSAGE_TO_C=9_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_DEALLOCATE_BUFFER=10_JPIB_K
  ...
  PP_DEBUG_CRITICAL_COND_THROW( .NOT.C_ASSOCIATED(C_CODES_HANDLE_LOC), ERRFLAG_C_CODES_HANDLE_IS_NULL_POINTER)
  ...
  ! TODO Call the encoder and get a proper value on HANDLE
  HANDLE=0_JPIB_K
