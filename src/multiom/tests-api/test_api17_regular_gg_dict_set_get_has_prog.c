...
int main() {
    ...
    ret = multio_grib2_dict_has(dictionary_01, "number-of-points-along-a-parallel", &has1);
    ret = multio_grib2_dict_set(dictionary_01, "number-of-points-along-a-parallel", "3");
    ret = multio_grib2_dict_has(dictionary_01, "number-of-points-along-a-parallel", &has2);
    ret = multio_grib2_dict_get(dictionary_01, "number-of-points-along-a-parallel", &readVal);
    printf("number-of-points-along-a-parallel': %s, %d, %d, %d\n", readVal, has1, has2, ret);
    ...
    ret = multio_grib2_dict_has(dictionary_01, "iDirectionIncrementInDegrees", &has1);
    ret = multio_grib2_dict_set(dictionary_01, "iDirectionIncrementInDegrees", "4.5");
    ret = multio_grib2_dict_has(dictionary_01, "iDirectionIncrementInDegrees", &has2);
    ret = multio_grib2_dict_get(dictionary_01, "iDirectionIncrementInDegrees", &readVal);
    printf("iDirectionIncrementInDegrees: %s, %d, %d, %d\n", readVal, has1, has2, ret);
    assert(strcmp(readVal, "4.500000e+00") == 0);
    free(readVal);
    readVal = NULL;
