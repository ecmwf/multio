...
TYPE :: GRIB_INFO_T
  ...
  ! Option that needs to be specified per field, but used only by
  ! "grib-header-to-multio" output manager
  LOGICAL :: DIRECT_TO_FDB = .FALSE.

  LOGICAL :: CUSTOM_LEVELS_ENCODING = .FALSE.

  LOGICAL :: HAS_TYPE_OF_FIRST_FIXED_SURFACE = .FALSE.
  LOGICAL :: HAS_SCALE_FACTOR_OF_FIRST_FIXED_SURFACE = .FALSE.
  LOGICAL :: HAS_SCALE_VALUE_OF_FIRST_FIXED_SURFACE = .FALSE.
  LOGICAL :: HAS_TYPE_OF_SECOND_FIXED_SURFACE = .FALSE.
  LOGICAL :: HAS_SCALE_FACTOR_OF_SECOND_FIXED_SURFACE = .FALSE.
  LOGICAL :: HAS_SCALE_VALUE_OF_SECOND_FIXED_SURFACE = .FALSE.
