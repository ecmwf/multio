...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_MAPPING_CACHE_INIT = 18_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_MAPPING_CACHE_FREE = 19_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_DELETE_CONFIGURATIONS = 20_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_MAPPING_CACHE_INIT) MAPPING_CACHE%INIT( OPT, HOOKS )
  ...
  PP_TRYCALL(ERRFLAG_CFG_FILE_DOES_NOT_EXIST) YAML_NEW_CONFIGURATION_FROM_FILE( TRIM(ADJUSTL(FNAME)), &
& CONFIG, HOOKS )
  ...
  &    MAPPING_RULES_COLLECTION, MAPPERS, OPT, FILTER_OPT, HOOKS )
  ...
  &    MAPPING_RULES_COLLECTION, MAPPERS, OPT, FILTER_OPT, HOOKS )
    ...
    !> Get the size of the mapping collection
    PP_TRYCALL(ERRFLAG_MAPPING_COLLECTION_SIZE) MAPPERS%SIZE( SZ, HOOKS )
    ! WRITE(*,*) ' - SIZE: ', SZ
    DO I = 1, SZ
      !> Evaluate the configuration
      PP_TRYCALL(ERRFLAG_MAPPING_COLLECTION_EVAL) MAPPERS%EVAL( I, MSG, PAR, MSG_OUT, PAR_OUT, HOOKS )
  ...
  PP_TRYCALL(ERRFLAG_DELETE_CONFIGURATIONS) YAML_DELETE_CONFIGURATION( CONFIG, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_MAPPING_CACHE_FREE)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unable to free the mapping cache' )
