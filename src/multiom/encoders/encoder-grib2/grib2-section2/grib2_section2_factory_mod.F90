...
&               CFG, OPT, HOOKS ) RESULT(RET)
  ...
  USE :: GRIB2_SECTION2_1001_MOD,   ONLY: GRIB2_SECTION2_1001_T
  USE :: GRIB2_SECTION2_1036_MOD,   ONLY: GRIB2_SECTION2_1036_T
...
IMPLICIT NONE
  ...
  CASE (1001)
    ...
    ALLOCATE( GRIB2_SECTION2_1001_T::GRIB2_SECTION2, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )
    
  CASE (1036)

    ALLOCATE( GRIB2_SECTION2_1036_T::GRIB2_SECTION2, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )
