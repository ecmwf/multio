...
#define PP_FILE_NAME 'packing_record_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'PACKING_RECORD_MOD'
MODULE PACKING_RECORD_MOD
...
!> Record used to wrap a packing value
TYPE, EXTENDS(RECORD_BASE_A) :: PACKING_RECORD_T
...
PUBLIC :: PACKING_RECORD_T

CONTAINS

#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PACKING_INIT'
PP_THREAD_SAFE FUNCTION PACKING_INIT( THIS, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(PACKING_RECORD_T), INTENT(INOUT) :: THIS
...
END FUNCTION PACKING_INIT
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PACKING_HAS'
PP_THREAD_SAFE FUNCTION PACKING_HAS( THIS, HAS, HOOKS ) RESULT(RET)
...
END FUNCTION PACKING_HAS
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PACKING_IS_SCALAR'
PP_THREAD_SAFE FUNCTION PACKING_IS_SCALAR( THIS, IS_SCALAR, HOOKS ) RESULT(RET)
...
END FUNCTION PACKING_IS_SCALAR
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PACKING_IS_RANGE'
PP_THREAD_SAFE FUNCTION PACKING_IS_RANGE( THIS, IS_RANGE, HOOKS ) RESULT(RET)
...
END FUNCTION PACKING_IS_RANGE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PACKING_IS_ARRAY'
PP_THREAD_SAFE FUNCTION PACKING_IS_ARRAY( THIS, IS_ARRAY, HOOKS ) RESULT(RET)
...
END FUNCTION PACKING_IS_ARRAY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PACKING_SET_STRING'
PP_THREAD_SAFE FUNCTION PACKING_SET_STRING( THIS, VALUE, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  P_TRYCALL(ERRFLAG_UNABLE_TO_CONVERT_TO_ENUM) CPACKING2ICLASS(VALUE, THIS%VALUE_, HOOKS)
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_VALUE_WRONG_LENGTH)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Invalid length for "packing"' )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Input value: ' // TRIM(VALUE) )
    CASE (ERRFLAG_UNABLE_TO_CONVERT_TO_ENUM)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unable to convert "packing" to enum' )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Input value: ' // TRIM(VALUE) )
    CASE DEFAULT
...
END FUNCTION PACKING_SET_STRING
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PACKING_SET_BOOL'
PP_THREAD_SAFE FUNCTION PACKING_SET_BOOL( THIS, VALUE, HOOKS ) RESULT(RET)
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_NOT_APPLICABLE)
      ...
      PP_DEBUG_PUSH_MSG_TO_FRAME( '"packing" cannot be converted to bool' )
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PACKING_SET_INT64'
PP_THREAD_SAFE FUNCTION PACKING_SET_INT64( THIS, VALUE, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  P_TRYCALL(ERRFLAG_UNABLE_TO_CONVERT_TO_STRING) IPACKING2CCLASS(VALUE, CVALUE, HOOKS)
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_NOT_APPLICABLE)
      ...
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Invalid enum for "packing"' )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Input value: ' // TRIM(CTMP) )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
END FUNCTION PACKING_SET_INT64
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PACKING_SET_INT64_RANGE'
PP_THREAD_SAFE FUNCTION PACKING_SET_INT64_RANGE( THIS, VALUE1, VALUE2, HOOKS ) RESULT(RET)
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    SELECT CASE(ERRIDX)
    CASE (ERRFLAG_NOT_APPLICABLE)
      PP_DEBUG_PUSH_MSG_TO_FRAME( '"packing" cannot be converted to int64-range' )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Input value: ' // TRIM(VALUE) )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
END FUNCTION PACKING_SET_INT64_RANGE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PACKING_SET_INT64_ARRAY'
PP_THREAD_SAFE FUNCTION PACKING_SET_INT64_ARRAY( THIS, VALUE, HOOKS ) RESULT(RET)
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    SELECT CASE(ERRIDX)
    CASE (ERRFLAG_NOT_APPLICABLE)
      PP_DEBUG_PUSH_MSG_TO_FRAME( '"packing" cannot be converted to int64-array' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
END FUNCTION PACKING_SET_INT64_ARRAY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PACKING_SET_REAL64'
PP_THREAD_SAFE FUNCTION PACKING_SET_REAL64( THIS, VALUE, HOOKS ) RESULT(RET)
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    SELECT CASE(ERRIDX)
    CASE (ERRFLAG_NOT_APPLICABLE)
      PP_DEBUG_PUSH_MSG_TO_FRAME( '"packing" cannot be converted to real64' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
END FUNCTION PACKING_SET_REAL64
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PACKING_SET_REAL64_ARRAY'
PP_THREAD_SAFE FUNCTION PACKING_SET_REAL64_ARRAY( THIS, VALUE, HOOKS ) RESULT(RET)
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    SELECT CASE(ERRIDX)
    CASE (ERRFLAG_NOT_APPLICABLE)
      PP_DEBUG_PUSH_MSG_TO_FRAME( '"packing" cannot be converted to real64-array' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
END FUNCTION PACKING_SET_REAL64_ARRAY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PACKING_GET_STRING'
PP_THREAD_SAFE FUNCTION PACKING_GET_STRING( THIS, VALUE, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  P_TRYCALL(ERRFLAG_UNABLE_TO_CONVERT_TO_STRING) IPACKING2CCLASS(THIS%VALUE_, VALUE, HOOKS)
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_VALUE_NOT_INITIALIZED)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Value for "packing" is not initialized' )
    CASE (ERRFLAG_VALUE_UNDEFINED)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Value for "packing" is not defined' )
    CASE (ERRFLAG_VALUE_WRONG_LENGTH)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Value for "packing" has wrong length' )
    CASE (ERRFLAG_UNABLE_TO_CONVERT_TO_STRING)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unable to convert "packing" to string' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
END FUNCTION PACKING_GET_STRING
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PACKING_GET_BOOL'
PP_THREAD_SAFE FUNCTION PACKING_GET_BOOL( THIS, VALUE, HOOKS ) RESULT(RET)
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PACKING_GET_INT64'
PP_THREAD_SAFE FUNCTION PACKING_GET_INT64( THIS, VALUE, HOOKS ) RESULT(RET)
...
END FUNCTION PACKING_GET_INT64
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PACKING_GET_INT64_RANGE'
PP_THREAD_SAFE FUNCTION PACKING_GET_INT64_RANGE( THIS, VALUE1, VALUE2, HOOKS ) RESULT(RET)
...
END FUNCTION PACKING_GET_INT64_RANGE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PACKING_GET_INT64_ARRAY'
PP_THREAD_SAFE FUNCTION PACKING_GET_INT64_ARRAY( THIS, VALUE, HOOKS ) RESULT(RET)
...
END FUNCTION PACKING_GET_INT64_ARRAY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PACKING_GET_REAL64'
PP_THREAD_SAFE FUNCTION PACKING_GET_REAL64( THIS, VALUE, HOOKS ) RESULT(RET)
...
END FUNCTION PACKING_GET_REAL64
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PACKING_GET_REAL64_ARRAY'
PP_THREAD_SAFE FUNCTION PACKING_GET_REAL64_ARRAY( THIS, VALUE, HOOKS ) RESULT(RET)
...
END FUNCTION PACKING_GET_REAL64_ARRAY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PACKING_TO_STRING'
PP_THREAD_SAFE FUNCTION PACKING_TO_STRING( THIS, VALUE, HOOKS ) RESULT(RET)
...
END FUNCTION PACKING_TO_STRING
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PACKING_IS_EQUAL_TO'
PP_THREAD_SAFE FUNCTION PACKING_IS_EQUAL_TO( THIS, OTHER, IS_EQUAL_TO, HOOKS ) RESULT(RET)
...
END FUNCTION PACKING_IS_EQUAL_TO
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PACKING_IS_LOWER_THAN'
PP_THREAD_SAFE FUNCTION PACKING_IS_LOWER_THAN( THIS, OTHER, IS_LOWER_THAN, HOOKS ) RESULT(RET)
...
END FUNCTION PACKING_IS_LOWER_THAN
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PACKING_COPY_FROM'
PP_THREAD_SAFE FUNCTION PACKING_COPY_FROM( THIS, OTHER, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_OTHER_UNABLE_TO_CHECK=1_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_OTHER_UNABLE_TO_GET=2_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_WRONG_OTHER_PACKING=3_JPIB_K
  ...
  CLASS IS (O => PACKING_RECORD_T)
    ...
    END IF
  CLASS DEFAULT
    PP_DEBUG_CRITICAL_THROW( ERRFLAG_WRONG_OTHER_PACKING )
  END SELECT
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_OTHER_UNABLE_TO_GET)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unable to get the value of "other"' )
    CASE (ERRFLAG_WRONG_OTHER_PACKING)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Wrong packing for "other"' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
END FUNCTION PACKING_COPY_FROM
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PACKING_FREE'
PP_THREAD_SAFE FUNCTION PACKING_FREE( THIS, HOOKS ) RESULT(RET)
...
END FUNCTION PACKING_FREE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE

END MODULE PACKING_RECORD_MOD
