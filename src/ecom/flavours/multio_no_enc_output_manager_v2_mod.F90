...
SUBROUTINE MULTIO_NO_ENC_SETUP( THIS, YAMLFNAME, PROCESSOR_TOPO, MODEL_PARAMS )
  ...
  USE :: OM_MULTIO_UTILS_MOD,  ONLY: MULTIO_FLUSH_BEGIN_OF_SIMULATION
...
IMPLICIT NONE
  ...
  ! Send handshake message to notify multio the start of the simulation
  CALL MULTIO_FLUSH_BEGIN_OF_SIMULATION( THIS%MIO_, MODEL_PARAMS )
