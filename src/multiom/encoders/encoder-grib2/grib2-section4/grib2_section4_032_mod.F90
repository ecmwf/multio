!>
!> @file G2S4_032_mod.F90
!>
!> @brief Module for managing GRIB2 Section 4 operations.
!>
!> The `G2S4_032_MOD` module contains procedures to initialize, allocate,
...
!>   - @see G2S4_032_INIT
!>   - @see G2S4_032_ALLOCATE
!>   - @see G2S4_032_PRESET
!>   - @see G2S4_032_RUNTIME
!>   - @see G2S4_032_TO_BE_ENCODED
!>   - @see G2S4_032_FREE
!>
...
CHARACTER(LEN=*), PARAMETER :: G2S4_032_NAME = 'g2s4::032'

!>
!> @brief Type definition for GRIB2 Section 4 handler.
!>
!> The `G2S4_032_T` type extends the base class `GRIB_SECTION_BASE_A` and
...
!> environments.
!>
TYPE, EXTENDS(GRIB_SECTION_BASE_A) :: G2S4_032_T
  ...
  CHARACTER(LEN=64) :: SATELLITE_SUBSECTION_NAME_ = REPEAT( ' ', 64 )
...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_CFG => G2S4_032_INIT_CFG
  ...
  !> the GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_LAZY => G2S4_032_INIT_LAZY
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ALLOCATE => G2S4_032_ALLOCATE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => G2S4_032_PRESET
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => G2S4_032_RUNTIME
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => G2S4_032_TO_BE_ENCODED
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: FREE => G2S4_032_FREE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRINT => G2S4_032_PRINT
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_TIME_CONFIGURATOR_CFG => G2S4_032_BUILD_TIME_HANDLER_CFG
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_PARAM_CONFIGURATOR_CFG => G2S4_032_BUILD_PARAM_HANDLER_CFG
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_SATELLITE_CONFIGURATOR_CFG => G2S4_032_BUILD_SATELLITE_HANDLER_CFG
  ...
  !> This procedure allocates the proper time configurator
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_TIME_CONFIGURATOR_LAZY => G2S4_032_BUILD_TIME_HANDLER_LAZY
  ...
  !> This procedure allocates the proper param configurator
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_PARAM_CONFIGURATOR_LAZY => G2S4_032_BUILD_PARAM_HANDLER_LAZY
  ...
  !> This procedure allocates the proper satellite configurator
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_SATELLITE_CONFIGURATOR_LAZY => G2S4_032_BUILD_SATELLITE_HANDLER_LAZY
...
PUBLIC :: G2S4_032_MAKE
PUBLIC :: G2S4_032_REGISTER
PUBLIC :: G2S4_032_DESTROY

CONTAINS


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_032_REGISTER'
PP_THREAD_SAFE FUNCTION G2S4_032_REGISTER( IDX ) BIND(C, NAME='g2s4_032_register') RESULT(RET)
...
!$omp single
  ...
  IF ( ASSOCIATED(HOOKS) ) THEN
    ...
    PP_TRYCALL(ERRFLAG_UNABLE_TO_REGISTER) REG%REGISTER( G2S4_032_NAME, FA, FD, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_UNABLE_TO_REGISTER )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to register section: '//TRIM(ADJUSTL(G2S4_032_NAME)) )
...
END FUNCTION G2S4_032_REGISTER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_032_MAKE'
PP_THREAD_SAFE FUNCTION G2S4_032_MAKE( GRIB_SECTION, HOOKS ) RESULT(RET)
...
!$omp critical(G2S4_ALLOCATE)
  ALLOCATE( G2S4_032_T::GRIB_SECTION, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_032_DESTROY'
PP_THREAD_SAFE FUNCTION G2S4_032_DESTROY( GRIB_SECTION, HOOKS ) RESULT(RET)
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `G2S4_032_T` representing the GRIB section being initialized.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_032_INIT_CFG'
PP_THREAD_SAFE FUNCTION G2S4_032_INIT_CFG( THIS, &
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(G2S4_032_T),  INTENT(INOUT) :: THIS
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_INIT_SATELLITE_HANDLER) THIS%BUILD_SATELLITE_CONFIGURATOR_CFG( CFG, OPT, HOOKS )
...
END FUNCTION G2S4_032_INIT_CFG
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_032_INIT_LAZY'
PP_THREAD_SAFE FUNCTION G2S4_032_INIT_LAZY( THIS, &
...
END FUNCTION G2S4_032_INIT_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `G2S4_032_T` representing the GRIB section to allocate resources for.
!>   @param [in]    MSG      All the mars keywords needed to describe the field `FORTRAN_MESSAGE_T`.
!>   @param [in]    PAR      All information outside mars keywords needed to describe the field `PARAMETRIZATION_T`.
!>   @param [in]    OPT      The encoder options structure of type `ENCODER_OPTIONS_T`.
...
PP_THREAD_SAFE FUNCTION G2S4_032_ALLOCATE( THIS, &
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `G2S4_032_T` representing the GRIB section to be preset.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_032_PRESET'
PP_THREAD_SAFE FUNCTION G2S4_032_PRESET( THIS, &
&  MSG, PAR, OPT,  METADATA, HOOKS ) RESULT(RET)
...
!>
!> @section interface
!>   @param [in]    THIS      An object of type `G2S4_032_T` representing the GRIB section for runtime execution.
!>   @param [in]    MSG       The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR       The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_032_RUNTIME'
PP_THREAD_SAFE FUNCTION G2S4_032_RUNTIME( THIS, &
...
!>
!> @section interface
!>   @param [inout] THIS          An object of type `G2S4_032_T` representing the GRIB section being checked.
!>   @param [in]    MSG           The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR           The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
!>   @param [in]    TIME_HIST     The time history object of type `TIME_HISTORY_T` providing historical time data.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_032_TO_BE_ENCODED'
PP_THREAD_SAFE FUNCTION G2S4_032_TO_BE_ENCODED( THIS, &
...
END FUNCTION G2S4_032_TO_BE_ENCODED
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `G2S4_032_T` representing the GRIB section to be freed.
!>   @param [in]    OPT   The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_032_FREE'
PP_THREAD_SAFE FUNCTION G2S4_032_FREE( THIS, OPT, HOOKS ) RESULT(RET)
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_032_PRINT'
PP_THREAD_SAFE FUNCTION G2S4_032_PRINT( THIS, &
...
!> @see G2S4_032_ALLOCATE
!> @see G2S4_032_PRESET
!> @see G2S4_032_RUNPARAM
!> @see G2S4_032_TO_BE_ENCODED
!> @see G2S4_032_FREE
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_032_BUILD_PARAM_HANDLER_CFG'
PP_THREAD_SAFE FUNCTION G2S4_032_BUILD_PARAM_HANDLER_CFG( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_032_BUILD_PARAM_HANDLER_CFG
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
!>
!> @brief Builds the param handler for GRIB2 section 4, template 032.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_032_BUILD_PARAM_HANDLER_LAZY'
PP_THREAD_SAFE FUNCTION G2S4_032_BUILD_PARAM_HANDLER_LAZY( THIS, &
&               MSG, PAR, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_032_BUILD_PARAM_HANDLER_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!> @see G2S4_032_ALLOCATE
!> @see G2S4_032_PRESET
!> @see G2S4_032_RUNSATELLITE
!> @see G2S4_032_TO_BE_ENCODED
!> @see G2S4_032_FREE
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_032_BUILD_SATELLITE_HANDLER_CFG'
PP_THREAD_SAFE FUNCTION G2S4_032_BUILD_SATELLITE_HANDLER_CFG( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_032_BUILD_SATELLITE_HANDLER_CFG
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_032_BUILD_SATELLITE_HANDLER_LAZY'
PP_THREAD_SAFE FUNCTION G2S4_032_BUILD_SATELLITE_HANDLER_LAZY( THIS, &
&               MSG, PAR, OPT, HOOKS ) RESULT(RET)
  ...
  USE :: PARAMETRIZATION_MOD,         ONLY: PARAMETRIZATION_T
  USE :: HOOKS_MOD,                   ONLY: HOOKS_T
  USE :: GRIB_ENCODER_LAZY_RULES_MOD, ONLY: SATELLITE_CONFIGURATOR_NAME
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_BUILD_SATELLITE_CONFUGIRATOR_LAZY=2_JPIB_K
  ...
  !> Error handling
  PP_DEBUG_CRITICAL_COND_THROW( ASSOCIATED(THIS%SATELLITE_), ERRFLAG_LEVEL_CONFIGURATOR_ALREADY_ASSOCIATED )

  !> Construct the name of the param configurator form message and parameter
  PP_TRYCALL(ERRFLAG_BUILD_SATELLITE_CONFUGIRATOR_LAZY) SATELLITE_CONFIGURATOR_NAME( MSG, PAR, THIS%SATELLITE_SUBSECTION_NAME_, OPT, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_BUILD_SATELLITE_CONFUGIRATOR_LAZY )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to build satellite configurator' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
END FUNCTION G2S4_032_BUILD_SATELLITE_HANDLER_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_032_BUILD_TIME_HANDLER_CFG'
PP_THREAD_SAFE FUNCTION G2S4_032_BUILD_TIME_HANDLER_CFG( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_032_BUILD_TIME_HANDLER_CFG
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_032_BUILD_TIME_HANDLER_LAZY'
PP_THREAD_SAFE FUNCTION G2S4_032_BUILD_TIME_HANDLER_LAZY( THIS, &
&               MSG, PAR, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_032_BUILD_TIME_HANDLER_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
