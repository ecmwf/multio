...
CHARACTER(LEN=*), PARAMETER :: TYPE_OF_LEVEL = 'lowCloudLayer'
...
INTEGER(KIND=JPIB_K), PARAMETER :: SCALED_VALUE_SECOND_FIXED_SURFACE = 80000_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: SCALE_FACTOR_SECOND_FIXED_SURFACE = 0_JPIB_K
...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => G2S4_LOWCLOUDLAYER_INIT\
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: CHECK => G2S4_LOWCLOUDLAYER_CHECK
...
#define PP_PROCEDURE_NAME 'G2S4_LOWCLOUDLAYER_INIT'
PP_THREAD_SAFE FUNCTION G2S4_LOWCLOUDLAYER_INIT( THIS, &
...
END FUNCTION G2S4_LOWCLOUDLAYER_INIT
...
IMPLICIT NONE
  ...
  ! Logging
  PP_LOG_DEVELOP_STR( 'Allocate: lowCloudLayer' )
...
IMPLICIT NONE
  ...
  ! Logging
  PP_LOG_DEVELOP_STR( 'Preset: lowCloudLayer' )
...
IMPLICIT NONE
  ...
  ! Logging
  PP_LOG_DEVELOP_STR( 'Runtime: lowCloudLayer' )
...
PP_THREAD_SAFE FUNCTION G2S4_LOWCLOUDLAYER_FREE( THIS, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ELSE
    ...
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'scaledValueOfSecondFixedSurface', SCALED_VALUE_SECOND_FIXED_SURFACE )
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'scaleFactorOfSecondFixedSurface', SCALE_FACTOR_SECOND_FIXED_SURFACE )
  ENDIF
...
!&       100_JPIB_K,  &
!&       HOOKS, &
!&       SCALED_VALUE_OF_SECOND_FIXED_SURFACES = 80000_JPIB_K, &
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_LOWCLOUDLAYER_CHECK'
PP_THREAD_SAFE FUNCTION G2S4_LOWCLOUDLAYER_CHECK( THIS, &
&  MSG, PAR, OPT, METADATA, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! According to the options decide where to set the levels (preset or runlevel)
  PP_LOG_INFO( 'check typeOfLevel: lowCloudLayer' )
...
&       HOOKS, &
&       SCALED_VALUE_OF_SECOND_FIXED_SURFACES = SCALED_VALUE_SECOND_FIXED_SURFACE, &
&       SCALE_FACTOR_OF_SECOND_FIXED_SURFACES = SCALE_FACTOR_SECOND_FIXED_SURFACE )
  ENDIF
...
END FUNCTION G2S4_LOWCLOUDLAYER_CHECK
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
