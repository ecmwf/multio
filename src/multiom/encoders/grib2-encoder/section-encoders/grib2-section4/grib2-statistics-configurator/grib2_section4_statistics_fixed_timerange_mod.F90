...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_SECTION4_STATISTICS_FIXED_TIMERANGE_INIT_CFG
...
&        MSG, PAR, OPT, TIME_SINCE_START, HOOKS )
...
! &            TIME_SINCE_START, OPT, METADATA, HOOKS )
