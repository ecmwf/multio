...
ANOFFSET_HAS_ALT = {
    ...
    "filters": [
        ...
        },
        {
            ...
            "operation": "all",
            "filters": [
                {"type": "stream", "operation": "match", "values": ["efas", "wfas"]},
                {"type": "type", "operation": "match", "values": ["sfo", "fu", "go"]},
            ],
        },
    ],
}
...
IS_CHEMICAL = {
    ...
    "operation": "all",
    "filters": [
        {"type": "chem", "operation": "has"},
        {"type": "wavelength", "operation": "lacks"},
        {"type": "chem", "operation": "lower-than", "treshold": 900},
    ],
}
...
IS_AEROSOL = {
    ...
    "filters": [
        {"type": "chem", "operation": "has"},
        {"type": "wavelength", "operation": "lacks"},
        {"type": "chem", "operation": "greater-equal", "treshold": 900},
    ],
}
...
IS_OPTICAL = {
    ...
    "operation": "all",
    "filters": [
        {"type": "chem", "operation": "lacks"},
        {"type": "wavelength", "operation": "has"},
    ],
}
...
def compareRules(lhs: RuleList, rhs: RuleList) -> ComparedRuleLists:
    ...
    for k in sameKeys:
        ...
        if lhsDict[k].rule["encoder"] == rhsDict[k].rule["encoder"]:
            res.matchAndCompareEqual.append(
                (lhsDict[k], rhsDict[k], diffRuleEncoder(lhsDict[k], rhsDict[k]))
            )
        else:
            res.matchedFilters.append(
                (lhsDict[k], rhsDict[k], diffRuleEncoder(lhsDict[k], rhsDict[k]))
            )
