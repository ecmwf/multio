...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_SECTION4_100_INIT_CFG
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_ALLOCATE_DIRFREQ) THIS%DIRFREQ_%ALLOCATE  ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_PRESET_DIRFREQ) THIS%DIRFREQ_%PRESET  ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_RUNTIME_DIRFREQ) THIS%DIRFREQ_%RUNTIME  ( MSG, GEO, PAR, OPT, METADATA, HOOKS )
