...
IMPLICIT NONE
  ...
  !ELSE
    ...
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'scaledValueOfSecondFixedSurface', 80000)
    PP_METADATA_SET_MISSING( METADATA, ERRFLAG_METADATA, 'scaleFactorOfFirstFixedSurface' )
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'scaleFactorOfSecondFixedSurface', 0)
  ! ENDIF
