...
#define PP_FILE_NAME 'spherical_harmonics_dictionary_wrapper_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'SPHERICAL_HARMONICS_DICTIONARY_WRAPPER_MOD'
MODULE SPHERICAL_HARMONICS_DICTIONARY_WRAPPER_MOD
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'CREATE_SPHERICAL_HARMONICS_DICTIONARY'
PP_THREAD_SAFE FUNCTION CREATE_SPHERICAL_HARMONICS_DICTIONARY( WRAPPED_SPHERICAL_HARMONICS_DICTIONARY, DICTIONARY, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Local prameters
  INTEGER(KIND=JPIB_K), PARAMETER :: SPHERICAL_HARMONICS_DICTIONARY_CONTAINER_BYTE_SIZE = &
&   STORAGE_SIZE(DICTIONARY_CONTAINER) / 8_JPIB_K

  ! Local error flags
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_WRAPPER_ALREADY_ASSOCIATED=1_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_SPHERICAL_HARMONICS_DICTIONARY_ALREADY_ASSOCIATED=2_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_ALLOCATE_SPHERICAL_HARMONICS_DICTIONARY=3_JPIB_K
  ...
  ! Error handling
  PP_DEBUG_CRITICAL_COND_THROW( C_ASSOCIATED(WRAPPED_SPHERICAL_HARMONICS_DICTIONARY), ERRFLAG_WRAPPER_ALREADY_ASSOCIATED)
  PP_DEBUG_CRITICAL_COND_THROW( ASSOCIATED(DICTIONARY), ERRFLAG_SPHERICAL_HARMONICS_DICTIONARY_ALREADY_ASSOCIATED)

  ! Allocate the dictionary
  ALLOCATE( DICTIONARY_CONTAINER%DICTIONARY, STAT=ALLOC_STAT, ERRMSG=ERRMSG )
  PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STAT .NE. 0_JPIB_K, ERRFLAG_UNABLE_TO_ALLOCATE_SPHERICAL_HARMONICS_DICTIONARY )

  ! Allocate the wrapper
  WRAPPER => NULL()
  BUFFER => NULL()
  PP_TRYCALL(ERRFLAG_UNABLE_TO_ALLOCATE_WRAPPER) F_C_ALLOCATE_WRAPPER( &
&   WRAPPER, BUFFER, SPHERICAL_HARMONICS_DICTIONARY_IDX_E, SPHERICAL_HARMONICS_DICTIONARY_CONTAINER_BYTE_SIZE, HOOKS )
  ...
  BUFFER = TRANSFER(DICTIONARY_CONTAINER, BUFFER, SPHERICAL_HARMONICS_DICTIONARY_CONTAINER_BYTE_SIZE )

  ! Set the return arguments
  DICTIONARY => DICTIONARY_CONTAINER%DICTIONARY
  WRAPPED_SPHERICAL_HARMONICS_DICTIONARY = C_LOC(WRAPPER)
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_WRAPPER_ALREADY_ASSOCIATED)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Wrapper already associated' )
    CASE (ERRFLAG_SPHERICAL_HARMONICS_DICTIONARY_ALREADY_ASSOCIATED)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Dictionary already associated' )
    CASE (ERRFLAG_UNABLE_TO_ALLOCATE_SPHERICAL_HARMONICS_DICTIONARY)
...
END FUNCTION CREATE_SPHERICAL_HARMONICS_DICTIONARY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
&   STORAGE_SIZE(DICTIONARY_CONTAINER) / 8_JPIB_K
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_SPHERICAL_HARMONICS_DICTIONARY_NOT_ASSOCIATED=7_JPIB_K
  ...
  ! Extract the wrapper
  WRAPPER => NULL()
  CALL C_F_POINTER( WRAPPED_SPHERICAL_HARMONICS_DICTIONARY, WRAPPER )
  PP_DEBUG_CRITICAL_COND_THROW( .NOT.ASSOCIATED(WRAPPER), ERRFLAG_UNABLE_TO_EXTRACT_WRAPPER )
...
&   WRAPPER, BUFFER, DIM, HOOKS )
  ...
  PP_DEBUG_CRITICAL_COND_THROW( DIM .NE. SPHERICAL_HARMONICS_DICTIONARY_CONTAINER_BYTE_SIZE, ERRFLAG_WRONG_BUFFER_SIZE )

  ! Get the Container
  DICTIONARY_CONTAINER = TRANSFER( BUFFER, DICTIONARY_CONTAINER )
  PP_DEBUG_CRITICAL_COND_THROW( .NOT.ASSOCIATED(DICTIONARY_CONTAINER%DICTIONARY), ERRFLAG_SPHERICAL_HARMONICS_DICTIONARY_NOT_ASSOCIATED )
...
END FUNCTION EXTRACT_SPHERICAL_HARMONICS_DICTIONARY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'FREE_SPHERICAL_HARMONICS_DICTIONARY'
PP_THREAD_SAFE FUNCTION FREE_SPHERICAL_HARMONICS_DICTIONARY( WRAPPED_SPHERICAL_HARMONICS_DICTIONARY, HOOKS ) RESULT(RET)
...
&   STORAGE_SIZE(DICTIONARY_CONTAINER) / 8_JPIB_K
  ...
  !> Local error flags
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_WRAPPER_NOT_ASSOCIATED=1_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_EXTRACT_SPHERICAL_HARMONICS_DICTIONARY=2_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_EXTRACT_WRAPPER=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_EXTRACT_BUFFER=4_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_BUFFER_NOT_ASSOCIATED=5_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_WRONG_BUFFER_SIZE=6_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_SPHERICAL_HARMONICS_DICTIONARY_NOT_ASSOCIATED=7_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_FREE_SPHERICAL_HARMONICS_DICTIONARY=8_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_DEALLOCATE_SPHERICAL_HARMONICS_DICTIONARY=9_JPIB_K
...
&   WRAPPER, BUFFER, DIM, HOOKS )
  ...
  ! Free the dictionary
  PP_TRYCALL(ERRFLAG_UNABLE_TO_FREE_SPHERICAL_HARMONICS_DICTIONARY) DICTIONARY%FREE( HOOKS )

  ! Deallocate the dictionary
  DEALLOCATE( DICTIONARY_CONTAINER%DICTIONARY, STAT=ALLOC_STAT, ERRMSG=ERRMSG )
  PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STAT .NE. 0_JPIB_K, ERRFLAG_UNABLE_TO_DEALLOCATE_SPHERICAL_HARMONICS_DICTIONARY )
