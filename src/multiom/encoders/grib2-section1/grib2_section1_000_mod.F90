...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_SECTION1_000_INIT
...
#define PP_PROCEDURE_NAME 'GRIB2_SECTION1_000_INIT'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION1_000_INIT( THIS, &
...
END FUNCTION GRIB2_SECTION1_000_INIT
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_RUNTIME_ORIGIN)         THIS%ORIGIN_%RUNTIME(  MSG, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_RUNTIME_TABLES)         THIS%TABLES_%RUNTIME(  MSG, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_RUNTIME_REFERENCE_TIME) THIS%REFERENCE_TIME_%RUNTIME(  MSG, PAR, OPT, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_RUNTIME_DATA_TYPE)      THIS%DATA_TYPE_%RUNTIME(  MSG, PAR, OPT, METADATA, HOOKS )
