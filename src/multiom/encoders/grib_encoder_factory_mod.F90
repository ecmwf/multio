...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_INITIALIZATION_ERROR)  ENCODER%INIT( CFG, OPT, FACTORIES, HOOKS )
...
IMPLICIT NONE
  ...
  !> Initialization of the section
  PP_TRYCALL(ERRFLAG_INITIALIZATION_ERROR)  ENCODER%INIT( MSG, CFG, OPT, FACTORIES, HOOKS )
#else
...
PP_THREAD_SAFE FUNCTION DESTROY_ENCODER( ENCODER, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Free the section
  PP_TRYCALL(ERRFLAG_FREE_ERROR)  ENCODER%FREE( OPT, DESTRUCTORS, HOOKS )
