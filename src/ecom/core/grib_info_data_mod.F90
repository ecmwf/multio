...
TYPE :: GRIB_INFO_T
  ...
  INTEGER(KIND=JPIB_K), DIMENSION(7,2) :: REQUESTED_ENCODING_ = &
&  RESHAPE( [UNDEF_PARAM_E,UNDEF_PARAM_E,UNDEF_PARAM_E,UNDEF_PARAM_E,UNDEF_PARAM_E,UNDEF_PARAM_E,UNDEF_PARAM_E,&
&            UNDEF_PARAM_E,UNDEF_PARAM_E,UNDEF_PARAM_E,UNDEF_PARAM_E,UNDEF_PARAM_E,UNDEF_PARAM_E,UNDEF_PARAM_E], [7,2])
