...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => G2S4_143_INIT
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_143_INIT'
PP_THREAD_SAFE FUNCTION G2S4_143_INIT( THIS, &
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_RUNTIME_RANDOM_PATTERNS) THIS%RANDOM_PATTERNS_%RUNTIME( MSG, PAR, OPT, METADATA, HOOKS )
