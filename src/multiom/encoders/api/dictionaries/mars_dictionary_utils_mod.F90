...
#define PP_FILE_NAME 'mars_dictionary_utils_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'MARS_DICTIONARY_UTILS_MOD'
MODULE MARS_DICTIONARY_UTILS_MOD
...
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_CHEM = 11_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_PARAM = 12_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_MODEL = 13_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_LEVTYPE = 14_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_LEVELIST = 15_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_DIRECTION = 16_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_FREQUENCY = 17_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_DATE = 18_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_TIME = 19_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_STEP = 20_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_REPRES = 21_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_TRUNCATION = 22_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_TIMESPAN = 23_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_STATTYPE = 24_JPIB_K
...
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_DATASET = 29_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_ACTIVITY = 30_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_EXPERIMENT = 31_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_GENERATION = 32_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_REALIZATION = 33_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_RESOLUTION = 34_JPIB_K

INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_SYSTEM = 35_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_METHOD = 36_JPIB_K

INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_UNDEF = 37_JPIB_K
...
IMPLICIT NONE
  ...
  CASE ( 'timespan' )
    ITERATOR = MARS_ITERATOR_TIMESPAN

  CASE ( 'stattype' )
    ITERATOR = MARS_ITERATOR_STATTYPE
  ...
  CASE ( 'dataset' )
    ITERATOR = MARS_ITERATOR_DATASET

  CASE ( 'activity' )
    ITERATOR = MARS_ITERATOR_ACTIVITY

  CASE ( 'experiment' )
    ITERATOR = MARS_ITERATOR_EXPERIMENT

  CASE ( 'generation' )
    ITERATOR = MARS_ITERATOR_GENERATION

  CASE ( 'realization' )
    ITERATOR = MARS_ITERATOR_REALIZATION

  CASE ( 'resolution' )
    ITERATOR = MARS_ITERATOR_RESOLUTION

  CASE ( 'system' )
    ITERATOR = MARS_ITERATOR_SYSTEM

  CASE ( 'method' )
    ITERATOR = MARS_ITERATOR_METHOD
...
IMPLICIT NONE
  ...
  CASE ( MARS_ITERATOR_TIMESPAN )
    IF ( MARS_DICTIONARY%TIMESPAN .NE. UNDEF_PARAM_E ) THEN
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    END IF

  CASE ( MARS_ITERATOR_STATTYPE )
    IF ( MARS_DICTIONARY%STATTYPE .NE. REPEAT('*',32) ) THEN
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    END IF
  ...
  CASE ( MARS_ITERATOR_DATASET )
    IF ( MARS_DICTIONARY%DATASET .NE. UNDEF_PARAM_E ) THEN
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    END IF

  CASE ( MARS_ITERATOR_ACTIVITY )
    IF ( MARS_DICTIONARY%ACTIVITY .NE. UNDEF_PARAM_E ) THEN
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    END IF

  CASE ( MARS_ITERATOR_EXPERIMENT )
    IF ( MARS_DICTIONARY%EXPERIMENT .NE. UNDEF_PARAM_E ) THEN
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    END IF

  CASE ( MARS_ITERATOR_GENERATION )
    IF ( MARS_DICTIONARY%GENERATION .NE. UNDEF_PARAM_E ) THEN
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    END IF

  CASE ( MARS_ITERATOR_REALIZATION )
    IF ( MARS_DICTIONARY%REALIZATION .NE. UNDEF_PARAM_E ) THEN
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    END IF

  CASE ( MARS_ITERATOR_RESOLUTION )
    IF ( MARS_DICTIONARY%RESOLUTION .NE. UNDEF_PARAM_E ) THEN
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    END IF

  CASE ( MARS_ITERATOR_SYSTEM )
    IF ( MARS_DICTIONARY%SYSTEM .NE. UNDEF_PARAM_E ) THEN
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    END IF

  CASE ( MARS_ITERATOR_METHOD )
    IF ( MARS_DICTIONARY%METHOD .NE. UNDEF_PARAM_E ) THEN
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    END IF
...
IMPLICIT NONE
  ...
  CASE ( MARS_ITERATOR_TIMESPAN )
    IF ( MARS_DICTIONARY%TIMESPAN .NE. UNDEF_PARAM_E ) THEN
      PP_TRYCALL(ERRFLAG_CONVERT_ENUM_STRING) CONVERT_TO_C_STRING(MARS_DICTIONARY%TIMESPAN, VALUE, HOOKS )
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    END IF
  ...
  CASE ( MARS_ITERATOR_STATTYPE )
    IF ( MARS_DICTIONARY%STATTYPE .NE. REPEAT('*',32) ) THEN
      TMP_VALUE = TRIM(ADJUSTL(MARS_DICTIONARY%STATTYPE))
      PP_TRYCALL(ERRFLAG_CONVERT_ENUM_STRING) CONVERT_TO_C_STRING(TMP_VALUE, VALUE, HOOKS )
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
  ...
  CASE ( MARS_ITERATOR_DATASET )
    IF ( MARS_DICTIONARY%DATASET .NE. UNDEF_PARAM_E ) THEN
      PP_TRYCALL(ERRFLAG_CONVERT_ENUM_STRING) IDATASET2CDATASET(MARS_DICTIONARY%DATASET, TMP_VALUE, HOOKS)
      PP_TRYCALL(ERRFLAG_CONVERT_ENUM_STRING) CONVERT_TO_C_STRING(TMP_VALUE, VALUE, HOOKS )
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
  ...
  CASE ( MARS_ITERATOR_ACTIVITY )
    IF ( MARS_DICTIONARY%ACTIVITY .NE. UNDEF_PARAM_E ) THEN
      PP_TRYCALL(ERRFLAG_CONVERT_ENUM_STRING) IACTIVITY2CACTIVITY(MARS_DICTIONARY%ACTIVITY, TMP_VALUE, HOOKS)
      PP_TRYCALL(ERRFLAG_CONVERT_ENUM_STRING) CONVERT_TO_C_STRING(TMP_VALUE, VALUE, HOOKS )
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
  ...
  CASE ( MARS_ITERATOR_EXPERIMENT )
    IF ( MARS_DICTIONARY%EXPERIMENT .NE. UNDEF_PARAM_E ) THEN
      PP_TRYCALL(ERRFLAG_CONVERT_ENUM_STRING) IEXPERIMENT2CEXPERIMENT(MARS_DICTIONARY%EXPERIMENT, TMP_VALUE, HOOKS)
      PP_TRYCALL(ERRFLAG_CONVERT_ENUM_STRING) CONVERT_TO_C_STRING(TMP_VALUE, VALUE, HOOKS )
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
  ...
  CASE ( MARS_ITERATOR_RESOLUTION )
    IF ( MARS_DICTIONARY%RESOLUTION .NE. UNDEF_PARAM_E ) THEN
      PP_TRYCALL(ERRFLAG_CONVERT_ENUM_STRING) IRESOLUTION2CRESOLUTION(MARS_DICTIONARY%RESOLUTION, TMP_VALUE, HOOKS)
      PP_TRYCALL(ERRFLAG_CONVERT_ENUM_STRING) CONVERT_TO_C_STRING(TMP_VALUE, VALUE, HOOKS )
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
  ...
  CASE ( MARS_ITERATOR_SYSTEM )
    IF ( MARS_DICTIONARY%SYSTEM .NE. UNDEF_PARAM_E ) THEN
      PP_TRYCALL(ERRFLAG_CONVERT_ENUM_STRING) CONVERT_TO_C_STRING(MARS_DICTIONARY%SYSTEM, VALUE, HOOKS )
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    END IF
  ...
  CASE ( MARS_ITERATOR_METHOD )
    IF ( MARS_DICTIONARY%METHOD .NE. UNDEF_PARAM_E ) THEN
      PP_TRYCALL(ERRFLAG_CONVERT_ENUM_STRING) CONVERT_TO_C_STRING(MARS_DICTIONARY%METHOD, VALUE, HOOKS )
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    END IF
  ...
  CASE ( MARS_ITERATOR_GENERATION )
    IF ( MARS_DICTIONARY%GENERATION .NE. UNDEF_PARAM_E ) THEN
      PP_TRYCALL(ERRFLAG_CONVERT_ENUM_STRING) CONVERT_TO_C_STRING(MARS_DICTIONARY%GENERATION, VALUE, HOOKS )
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    END IF
  ...
  CASE ( MARS_ITERATOR_REALIZATION )
    IF ( MARS_DICTIONARY%REALIZATION .NE. UNDEF_PARAM_E ) THEN
      PP_TRYCALL(ERRFLAG_CONVERT_ENUM_STRING) CONVERT_TO_C_STRING(MARS_DICTIONARY%REALIZATION, VALUE, HOOKS )
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    END IF
...
IMPLICIT NONE
  ...
  CASE ( MARS_ITERATOR_TIMESPAN )
        PP_TRYCALL(ERRFLAG_CONVERT_MARS_TO_ENUM) CINT2IINT(VALUE, ITEMP, HOOKS)
        MARS_DICTIONARY%TIMESPAN=ITEMP

  CASE ( MARS_ITERATOR_STATTYPE )
        MARS_DICTIONARY%STATTYPE = VALUE
  ...
  CASE ( MARS_ITERATOR_DATASET )
        PP_TRYCALL(ERRFLAG_CONVERT_MARS_TO_ENUM) CDATASET2IDATASET(VALUE, ITEMP, HOOKS)
        MARS_DICTIONARY%DATASET=ITEMP

  CASE ( MARS_ITERATOR_ACTIVITY )
        PP_TRYCALL(ERRFLAG_CONVERT_MARS_TO_ENUM) CACTIVITY2IACTIVITY(VALUE, ITEMP, HOOKS)
        MARS_DICTIONARY%ACTIVITY=ITEMP

  CASE ( MARS_ITERATOR_EXPERIMENT )
        PP_TRYCALL(ERRFLAG_CONVERT_MARS_TO_ENUM) CEXPERIMENT2IEXPERIMENT(VALUE, ITEMP, HOOKS)
        MARS_DICTIONARY%EXPERIMENT=ITEMP

  CASE ( MARS_ITERATOR_RESOLUTION )
        PP_TRYCALL(ERRFLAG_CONVERT_MARS_TO_ENUM) CRESOLUTION2IRESOLUTION(VALUE, ITEMP, HOOKS)
        MARS_DICTIONARY%RESOLUTION=ITEMP

  CASE ( MARS_ITERATOR_GENERATION )
        PP_TRYCALL(ERRFLAG_CONVERT_MARS_TO_ENUM) CINT2IINT(VALUE, ITEMP, HOOKS)
        MARS_DICTIONARY%GENERATION=ITEMP

  CASE ( MARS_ITERATOR_REALIZATION )
        PP_TRYCALL(ERRFLAG_CONVERT_MARS_TO_ENUM) CINT2IINT(VALUE, ITEMP, HOOKS)
        MARS_DICTIONARY%REALIZATION=ITEMP

  CASE ( MARS_ITERATOR_SYSTEM )
        PP_TRYCALL(ERRFLAG_CONVERT_MARS_TO_ENUM) CINT2IINT(VALUE, ITEMP, HOOKS)
        MARS_DICTIONARY%SYSTEM=ITEMP

  CASE ( MARS_ITERATOR_METHOD )
        PP_TRYCALL(ERRFLAG_CONVERT_MARS_TO_ENUM) CINT2IINT(VALUE, ITEMP, HOOKS)
        MARS_DICTIONARY%METHOD=ITEMP
...
IMPLICIT NONE
  ...
  CASE ( MARS_ITERATOR_TIMESPAN )
        MARS_DICTIONARY%TIMESPAN=VALUE

  CASE ( MARS_ITERATOR_GENERATION )
        MARS_DICTIONARY%GENERATION=VALUE

  CASE ( MARS_ITERATOR_REALIZATION )
        MARS_DICTIONARY%REALIZATION=VALUE
        
  CASE ( MARS_ITERATOR_SYSTEM )
        MARS_DICTIONARY%SYSTEM=VALUE
        
  CASE ( MARS_ITERATOR_METHOD )
        MARS_DICTIONARY%METHOD=VALUE
...
END MODULE MARS_DICTIONARY_UTILS_MOD
