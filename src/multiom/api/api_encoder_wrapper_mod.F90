...
IMPLICIT NONE
  ...
  CHARACTER(LEN=256) :: SAMPLE_FNAME
...
!$omp critical(API_ENCODER_MAP_INSERT)
  ...
  !> TODO: the following values should be extracted from the options. Option are still unimplemented, hence some relevant default is used
  ENCODER_FNAME = 'encoder-rules.yaml'
  MAPPING_FNAME = 'mapping-rules.yaml'
  SAMPLE_FNAME   = 'multio_output_manager.grib'
