...
#define PP_FILE_NAME 'keyset_int64_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'KEYSET_INT64_MOD'
MODULE KEYSET_INT64_MOD
...
INTERFACE
  PP_THREAD_SAFE FUNCTION KEYSET_FUNCTION_INT64_IF( KEY, HOOKS ) RESULT(RET)
    ! Symbols imported from other modules within the project.
    USE :: DATAKINDS_DEF_MOD, ONLY: JPIB_K
  ...
  END FUNCTION KEYSET_FUNCTION_INT64_IF
END INTERFACE

TYPE, ABSTRACT :: KEYSET_FUNCTOR_INT64_A
CONTAINS
PROCEDURE(KEYSET_FUNCTOR_INT64_IF), DEFERRED, PUBLIC, PASS :: APPLY
END TYPE

ABSTRACT INTERFACE
  PP_THREAD_SAFE FUNCTION KEYSET_FUNCTOR_INT64_IF( THIS, KEY, HOOKS ) RESULT(RET)
    ! Symbols imported from other modules within the project.
    USE :: DATAKINDS_DEF_MOD, ONLY: JPIB_K
    USE :: HOOKS_MOD,         ONLY: HOOKS_T
    !> Templated use
    USE, INTRINSIC :: ISO_FORTRAN_ENV, ONLY: INT64
    IMPORT :: KEYSET_FUNCTOR_INT64_A
  IMPLICIT NONE
    CLASS(KEYSET_FUNCTOR_INT64_A), INTENT(INOUT) :: THIS
    INTEGER(KIND=INT64),                   INTENT(IN)    :: KEY
    TYPE(HOOKS_T),                               INTENT(INOUT) :: HOOKS
    INTEGER(KIND=JPIB_K) :: RET
  END FUNCTION KEYSET_FUNCTOR_INT64_IF
END INTERFACE

!> @brief Datatype used to to store a node of the tree
TYPE :: KEYSET_INT64_NODE_T

  !> Key
  INTEGER(KIND=INT64) :: KEY = 0_INT64
  ...
  TYPE(KEYSET_INT64_NODE_T), POINTER :: PARENT => NULL()

  !> Pointer to the lef subtree
  TYPE(KEYSET_INT64_NODE_T), POINTER :: LEFT   => NULL()

  !> Pointer to the right subtree
  TYPE(KEYSET_INT64_NODE_T), POINTER :: RIGHT  => NULL()
...
TYPE :: KEYSET_INT64_T
  ...
  TYPE(KEYSET_INT64_NODE_T), POINTER :: ROOT => NULL()
...
TYPE(KEYSET_INT64_NODE_T), TARGET :: NIL

!> Whitelist of public symbols
PUBLIC :: KEYSET_INT64_T
PUBLIC :: KEYSET_FUNCTION_INT64_IF
PUBLIC :: KEYSET_FUNCTOR_INT64_A
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(KEYSET_INT64_NODE_T), POINTER, INTENT(INOUT) :: ROOT
  INTEGER(KIND=INT64),                        INTENT(IN)    :: KEY
  ...
  ! Local variables
  TYPE(KEYSET_INT64_NODE_T), POINTER :: INSERTION_POINT
  LOGICAL :: FOUND
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  TYPE(KEYSET_INT64_NODE_T), POINTER, INTENT(INOUT) :: CURRENT
  TYPE(HOOKS_T),                                 INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  TYPE(KEYSET_INT64_NODE_T), POINTER, INTENT(IN)    :: ROOT
  TYPE(KEYSET_INT64_NODE_T), POINTER, INTENT(INOUT) :: CURRENT
  INTEGER(KIND=INT64),                        INTENT(IN)    :: KEY
  LOGICAL,                                          INTENT(OUT)   :: FOUND
  TYPE(HOOKS_T),                                    INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(KEYSET_INT64_NODE_T),          INTENT(INOUT) :: THIS
  TYPE(KEYSET_INT64_NODE_T), POINTER, INTENT(IN)    :: PARENT
  INTEGER(KIND=INT64),                        INTENT(IN)    :: KEY
  TYPE(HOOKS_T),                                    INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(KEYSET_INT64_NODE_T), POINTER, INTENT(INOUT) :: X
  TYPE(HOOKS_T),                                 INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(KEYSET_INT64_NODE_T), POINTER, INTENT(INOUT) :: ROOT
  TYPE(KEYSET_INT64_NODE_T), POINTER, INTENT(INOUT) :: CUR
  TYPE(HOOKS_T),                                 INTENT(INOUT) :: HOOKS
  ...
  ! Local variables
  TYPE(KEYSET_INT64_NODE_T), POINTER :: Y
  TYPE(KEYSET_INT64_NODE_T), POINTER :: X
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(KEYSET_INT64_NODE_T), POINTER, INTENT(INOUT) :: ROOT
  TYPE(KEYSET_INT64_NODE_T), TARGET,  INTENT(INOUT) :: X_
  TYPE(HOOKS_T),                                 INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(KEYSET_INT64_NODE_T), POINTER,  INTENT(IN)    :: X
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(KEYSET_INT64_NODE_T), POINTER, INTENT(IN)    :: X
  TYPE(KEYSET_INT64_NODE_T), POINTER, INTENT(OUT)   :: Y
  TYPE(HOOKS_T),                                 INTENT(INOUT) :: HOOKS
  ...
  ! Local variables
  LOGICAL :: IS_LEAF
  TYPE(KEYSET_INT64_NODE_T), POINTER :: X_
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(KEYSET_INT64_NODE_T), POINTER, INTENT(INOUT) :: NODE_1
  TYPE(KEYSET_INT64_NODE_T), POINTER, INTENT(INOUT) :: NODE_2
  TYPE(HOOKS_T),                                 INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(KEYSET_INT64_NODE_T), POINTER, INTENT(INOUT) :: ROOT
  TYPE(KEYSET_INT64_NODE_T), POINTER, INTENT(INOUT) :: Z
  TYPE(HOOKS_T),                                 INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Local variables
  LOGICAL :: IS_LEAF
  TYPE(KEYSET_INT64_NODE_T), POINTER :: W
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(KEYSET_INT64_NODE_T), POINTER, INTENT(IN)    :: ROOT
  TYPE(KEYSET_INT64_NODE_T), POINTER, INTENT(IN)    :: CURRENT
...
IMPLICIT NONE
  ...
  TYPE(KEYSET_INT64_NODE_T), POINTER,           INTENT(IN)    :: ROOT
  TYPE(KEYSET_INT64_NODE_T), POINTER,           INTENT(IN)    :: CURRENT
  PROCEDURE(KEYSET_FUNCTION_INT64_IF), POINTER, INTENT(IN)    :: FUNCTION
  TYPE(HOOKS_T),                                              INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  TYPE(KEYSET_INT64_NODE_T),     POINTER, INTENT(IN)    :: ROOT
  TYPE(KEYSET_INT64_NODE_T),     POINTER, INTENT(IN)    :: CURRENT
  CLASS(KEYSET_FUNCTOR_INT64_A), POINTER, INTENT(IN)    :: FUNCTOR
  TYPE(HOOKS_T),                                        INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(KEYSET_INT64_NODE_T),  INTENT(INOUT) :: ROOT
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  CLASS(KEYSET_INT64_NODE_T), INTENT(INOUT) :: ROOT
  INTEGER(KIND=JPIB_K),                  INTENT(IN)    :: UNIT
  TYPE(HOOKS_T),                         INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  CLASS(KEYSET_INT64_T), INTENT(INOUT) :: KEYSET
  TYPE(HOOKS_T),                       INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  CLASS(KEYSET_INT64_T), INTENT(IN)    :: KEYSET
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  CLASS(KEYSET_INT64_T), INTENT(INOUT) :: KEYSET
  INTEGER(KIND=INT64),           INTENT(OUT)   :: KEY
  TYPE(HOOKS_T),                       INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(KEYSET_INT64_NODE_T), POINTER, INTENT(IN)    :: NODE
  INTEGER(KIND=INT64), DIMENSION(:),          INTENT(INOUT) :: SORTED_KEYS
  INTEGER(KIND=JPIB_K),                             INTENT(INOUT) :: CNT
  TYPE(HOOKS_T),                                    INTENT(INOUT) :: HOOKS
  ...
  ! Local variables
  TYPE(KEYSET_INT64_NODE_T), POINTER :: Y
  TYPE(KEYSET_INT64_NODE_T), POINTER :: PREV
  LOGICAL :: IS_LEAF
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  CLASS(KEYSET_INT64_T), INTENT(INOUT) :: THIS
  INTEGER(KIND=INT64),           INTENT(IN)    :: KEY
  TYPE(HOOKS_T),                       INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  CLASS(KEYSET_INT64_T), INTENT(IN)    :: THIS
  INTEGER(KIND=INT64),           INTENT(IN)    :: KEY
  ...
  TYPE(KEYSET_INT64_NODE_T), POINTER :: SEARCHED_NODE
