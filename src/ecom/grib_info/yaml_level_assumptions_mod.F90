...
IMPLICIT NONE
  ...
  IF ( ALL(CHECKS) ) THEN
    ...
    EX = CFG%HAS( 'type-of-first-fixed-surface', CUSTOM_LEVELS_ENCODING%TYPE_OF_FIRST_FIXED_SURFACE )
    EX = CFG%HAS( 'scale-factor-of-first-fixed-surface', CUSTOM_LEVELS_ENCODING%SCALE_FACTOR_OF_FIRST_FIXED_SURFACE )
    EX = CFG%HAS( 'scale-value-of-first-fixed-surface', CUSTOM_LEVELS_ENCODING%SCALE_VALUE_OF_FIRST_FIXED_SURFACE )
    EX = CFG%HAS( 'type-of-second-fixed-surface', CUSTOM_LEVELS_ENCODING%TYPE_OF_SECOND_FIXED_SURFACE )
    EX = CFG%HAS( 'scale-factor-of-second-fixed-surface', CUSTOM_LEVELS_ENCODING%SCALE_FACTOR_OF_SECOND_FIXED_SURFACE )
    EX = CFG%HAS( 'scale-value-of-second-fixed-surface', CUSTOM_LEVELS_ENCODING%SCALE_VALUE_OF_SECOND_FIXED_SURFACE )
