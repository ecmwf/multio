...
INTERFACE MARS_DICTIONARY_GET_VALUE_AS_STRING
  MODULE PROCEDURE MARS_DICTIONARY_GET_VALUE_AS_CSTRING
  MODULE PROCEDURE MARS_DICTIONARY_GET_VALUE_AS_FSTRING
END INTERFACE
...
!PUBLIC :: MARS_DICTIONARY_GET_VALUE_AS_BOOL
!PUBLIC :: MARS_DICTIONARY_GET_VALUE_AS_INT64
!PUBLIC :: MARS_DICTIONARY_GET_VALUE_AS_REAL64
!PUBLIC :: MARS_DICTIONARY_GET_VALUE_AS_STRING_ARRAY
!PUBLIC :: MARS_DICTIONARY_GET_VALUE_AS_BOOL_ARRAY
!PUBLIC :: MARS_DICTIONARY_GET_VALUE_AS_INT64_ARRAY
!PUBLIC :: MARS_DICTIONARY_GET_VALUE_AS_REAL64_ARRAY



PUBLIC :: MARS_DICTIONARY_SET_VALUE_FROM_STRING
!PUBLIC :: MARS_DICTIONARY_SET_VALUE_FROM_BOOL
PUBLIC :: MARS_DICTIONARY_SET_VALUE_FROM_INT64
PUBLIC :: MARS_DICTIONARY_SET_VALUE_FROM_REAL64


!PUBLIC :: MARS_DICTIONARY_SET_VALUE_FROM_STRING_ARRAY
!PUBLIC :: MARS_DICTIONARY_SET_VALUE_FROM_BOOL_ARRAY
PUBLIC :: MARS_DICTIONARY_SET_VALUE_FROM_INT64_ARRAY
PUBLIC :: MARS_DICTIONARY_SET_VALUE_FROM_REAL64_ARRAY

! General utils
PUBLIC :: MARS_DICTIONARY_IS_ALLOWED
PUBLIC :: MARS_DICTIONARY_RANK
PUBLIC :: MARS_DICTIONARY_SIZE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'MARS_DICTIONARY_IS_ALLOWED'
PP_THREAD_SAFE FUNCTION MARS_DICTIONARY_IS_ALLOWED( MARS_DICTIONARY, KEY, IS_ALLOWED, HOOKS ) RESULT(RET)
...
END FUNCTION MARS_DICTIONARY_IS_ALLOWED
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'MARS_DICTIONARY_RANK'
PP_THREAD_SAFE FUNCTION MARS_DICTIONARY_RANK( MARS_DICTIONARY, ITERATOR, RANK, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Local error flags
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNKNOWN_KEY=1_JPIB_K
  ...
  CASE ( MARS_ITERATOR_GRID )
    RANK = 0_JPIB_K
  CASE DEFAULT
    PP_DEBUG_CRITICAL_THROW( ERRFLAG_UNKNOWN_KEY )
  END SELECT
...
END FUNCTION MARS_DICTIONARY_RANK
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'MARS_DICTIONARY_SIZE'
PP_THREAD_SAFE FUNCTION MARS_DICTIONARY_SIZE( MARS_DICTIONARY, ITERATOR, SZ, HOOKS ) RESULT(RET)
...
END FUNCTION MARS_DICTIONARY_SIZE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'MARS_DICTIONARY_GET_VALUE_AS_CSTRING'
PP_THREAD_SAFE FUNCTION MARS_DICTIONARY_GET_VALUE_AS_CSTRING( MARS_DICTIONARY, ITERATOR, VALUE, HAS, HOOKS ) RESULT(RET)
...
END FUNCTION MARS_DICTIONARY_GET_VALUE_AS_CSTRING
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'MARS_DICTIONARY_GET_VALUE_AS_FSTRING'
PP_THREAD_SAFE FUNCTION MARS_DICTIONARY_GET_VALUE_AS_FSTRING( MARS_DICTIONARY, ITERATOR, VALUE, HAS, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  CASE ( MARS_ITERATOR_ANOFFSET )
    IF ( MARS_DICTIONARY%ANOFFSET .NE. UNDEF_PARAM_E ) THEN
      WRITE(TMP_VALUE,'(I64)') MARS_DICTIONARY%ANOFFSET
      VALUE = TRIM(ADJUSTL(TMP_VALUE))
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    END IF
...
END FUNCTION MARS_DICTIONARY_GET_VALUE_AS_FSTRING
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE

#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'MARS_DICTIONARY_GET_VALUE_AS_STRING_BY_ID'
PP_THREAD_SAFE FUNCTION MARS_DICTIONARY_GET_VALUE_AS_STRING_BY_ID( MARS_DICTIONARY, ITERATOR, ID, VALUE, HAS, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Local error flags
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_INDEX_OUT_OF_BOUNDS=1_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CONVERT_ENUM_STRING=2_JPIB_K
  ...
  ! Check teh index (in mars everything is a scalar)
  PP_DEBUG_CRITICAL_COND_THROW( ID .NE. 1_JPIB_K, ERRFLAG_INDEX_OUT_OF_BOUNDS )

  ! Get the value
  PP_TRYCALL(ERRFLAG_CONVERT_ENUM_STRING) MARS_DICTIONARY_GET_VALUE_AS_FSTRING( MARS_DICTIONARY, ITERATOR, VALUE, HAS, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE(ERRFLAG_INDEX_OUT_OF_BOUNDS)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Invalid index found' )
    CASE(ERRFLAG_CONVERT_ENUM_STRING)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unable to convert enumerator to string' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unhandled error' )
