!>
!> @file grib2_sECTION4_STATISTICS_SINCE_LASTPP_mod.F90
!>
!> @brief Module for managing GRIB2 Section 4 time configuration operations.
!>
!> The `GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_MOD` module contains procedures to initialize, allocate,
...
#define PP_FILE_NAME 'grib2_section4_statistics_since_lastpp_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_MOD'
MODULE GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_MOD
...
!>
!> The `GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_T` type extends the base class `GRIB_SECTION_BASE_A` and
...
!> environments.
!>
TYPE, EXTENDS(GRIB_SECTION_BASE_A) :: GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_T
...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_CFG => GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_INIT_CFG
  ...
  !> the GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_LAZY => GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_INIT_LAZY
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ALLOCATE => GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_ALLOCATE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_PRESET
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_RUNTIME
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_TO_BE_ENCODED
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRINT => GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_PRINT
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: FREE => GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_FREE
...
PUBLIC :: GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_T
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_T` representing the GRIB section being initialized.
...
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_INIT_CFG'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_INIT_CFG( THIS, &
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_T),  INTENT(INOUT) :: THIS
...
END FUNCTION GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_INIT_CFG
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_INIT_LAZY'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_INIT_LAZY( THIS, &
...
#if defined( PP_HAS_GET_GRIB2_SINCE_LASTPP_CONFIGURATION_ID_FROM_MESSAGE )
  !> Symbols imported from the mapping module
  USE :: MARS2GRIB_MAPPING_MOD, ONLY: GET_GRIB2_SINCE_LASTPP_CONFIGURATION_ID_FROM_MESSAGE
#endif
...
#if defined( PP_HAS_GET_GRIB2_SINCE_LASTPP_CONFIGURATION_ID_FROM_MESSAGE )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ) GET_GRIB2_SINCE_LASTPP_CONFIGURATION_ID_FROM_MESSAGE( &
...
END FUNCTION GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_INIT_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_T` representing the GRIB section to allocate resources for.
!>   @param [in]    MSG      All the mars keywords needed to describe the field `FORTRAN_MESSAGE_T`.
!>   @param [in]    PAR      All information outside mars keywords needed to describe the field `PARAMETRIZATION_T`.
!>   @param [in]    OPT      The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_ALLOCATE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_ALLOCATE( THIS, &
&  MSG, PAR, OPT,  METADATA, HOOKS ) RESULT(RET)
  ...
  USE :: HOOKS_MOD,                         ONLY: HOOKS_T
  USE :: GRIB2_SECTION4_STATTYPE_UTILS_MOD, ONLY: GET_NUMBER_OF_TIMELOOPS_FROM_MARS
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_COMPUTE_NTIMELOOPS=4_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_COMPUTE_NTIMELOOPS ) GET_NUMBER_OF_TIMELOOPS_FROM_MARS( &
&   MSG, THIS%NUMBER_OF_TIME_RANGES_, HOOKS )
  ...
  IF ( THIS%NUMBER_OF_TIME_RANGES_ .EQ. 1_JPIB_K ) THEN
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_UNABLE_TO_COMPUTE_NTIMELOOPS )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to compute number of time loops from message' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
END FUNCTION GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_ALLOCATE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_T` representing the GRIB section to be preset.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_PRESET'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_PRESET( THIS, &
&  MSG, PAR, OPT,  METADATA, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_PRESET
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS      An object of type `GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_T` representing the GRIB section for runtime execution.
!>   @param [in]    MSG       The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR       The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_RUNTIME'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_RUNTIME( THIS, &
&  MSG, PAR, TIME_HIST, CURR_TIME, OPT, METADATA, HOOKS ) RESULT(RET)
  ...
  USE :: HOOKS_MOD,                         ONLY: HOOKS_T
  USE :: ENUMERATORS_MOD,                   ONLY: UNDEF_PARAM_E
  USE :: GRIB2_SECTION4_STATTYPE_UTILS_MOD, ONLY: STATISTICAL_PROCESSING_T
  USE :: GRIB2_SECTION4_STATTYPE_UTILS_MOD, ONLY: GET_GRIB2_TIME_DESCRIPTION_FROM_MARS
  USE :: GRIB2_SECTION4_STATTYPE_UTILS_MOD, ONLY: COMPUTE_END_DATETIME
...
IMPLICIT NONE
  ...
  !> Local variables
  TYPE(STATISTICAL_PROCESSING_T) :: TIME_DESC
  ...
  INTEGER(KIND=JPIB_K) :: END_DAY
  INTEGER(KIND=JPIB_K) :: END_HOUR
  INTEGER(KIND=JPIB_K) :: END_MINUTE
  INTEGER(KIND=JPIB_K) :: END_SECOND
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_EXPECTED_TIMESPAN=10_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_COMPUTE_END_DATETIME=11_JPIB_K
  ...
  ELSE
    ...
    ! Get time description from MARS
    PP_TRYCALL(ERRFLAG_UNABLE_TO_TO_COMPUTE_END_OF_TIME_INTERVAL) GET_GRIB2_TIME_DESCRIPTION_FROM_MARS( &
&      MSG, PAR, THIS%OUTER_TYPE_OF_STATISTICAL_PROCESS_, TIME_DESC, HOOKS )

    ! Limits of the time ranges
    LO = 1_JPIB_K
    HI = TIME_DESC%NUMBER_OF_TIME_RANGES

    ! Set to grib the time description
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'typeOfStatisticalProcessing', TIME_DESC%TYPE_OF_STATISTICAL_PROCESSING(LO:HI) )
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'typeOfTimeIncrement', TIME_DESC%TYPE_OF_TIME_INCREMENT(LO:HI) )
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'indicatorOfUnitForTimeRange', TIME_DESC%INDICATOR_OF_UNIT_FOR_TIME_RANGE(LO:HI) )
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'lengthOfTimeRange', TIME_DESC%LENGTH_OF_TIME_RANGE(LO:HI) )
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'indicatorOfUnitForTimeIncrement', TIME_DESC%INDICATOR_OF_UNIT_FOR_TIME_INCREMENT(LO:HI) )
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'timeIncrement', TIME_DESC%LENGTH_OF_TIME_INCREMENT(LO:HI) )

    ! Compute END of time interval
    PP_TRYCALL(ERRFLAG_COMPUTE_END_DATETIME) COMPUTE_END_DATETIME( &
&     MSG, END_DATE, END_TIME, HOOKS, &
&     YEAR=END_YEAR, MONTH=END_MONTH, DAY=END_DAY, HOUR=END_HOUR, MINUTE=END_MINUTE, SECOND=END_SECOND )

    ! Configure the date_time array
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'yearOfEndOfOverallTimeInterval', END_YEAR )
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'monthOfEndOfOverallTimeInterval', END_MONTH )
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'dayOfEndOfOverallTimeInterval', END_DAY )
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'hourOfEndOfOverallTimeInterval', END_HOUR )
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'minuteOfEndOfOverallTimeInterval', END_MINUTE )
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'secondOfEndOfOverallTimeInterval', END_SECOND )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_EXPECTED_TIMESPAN )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'expected timespan in mars dictionary' )
    CASE ( ERRFLAG_COMPUTE_END_DATETIME )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to compute end datetime' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
END FUNCTION GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_RUNTIME
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS          An object of type `GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_T` representing the GRIB section being checked.
!>   @param [in]    MSG           The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR           The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
!>   @param [in]    TIME_HIST     The time history object of type `TIME_HISTORY_T` providing historical time data.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_TO_BE_ENCODED'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_TO_BE_ENCODED( THIS, &
...
END FUNCTION GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_TO_BE_ENCODED
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS   An object of type `GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_T` representing the GRIB section to be freed.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_PRINT'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_PRINT( THIS, &
...
END FUNCTION GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_PRINT
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_FREE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_FREE( THIS, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_FREE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UDEFINED_TYPE_OF_STATISTICAL_PROCESSING=2_JPIB_K
  ...
  !> Read configuration of the outer loop
