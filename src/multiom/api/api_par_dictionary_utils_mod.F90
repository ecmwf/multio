...
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_DIR = 19_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_FREQ = 20_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_SATELLITE_SERIES = 21_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_SCALED_FACTOR_OF_CENTRAL_WAVE_NUMBER = 22_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_SCALED_VALUE_OF_CENTRAL_WAVE_NUMBER = 23_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_GEOMETRY = 24_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_DESTINE_LOCAL_VERSION = 25_JPIB_K
