...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_INITIALIZATION_ERROR)  GRIB2_REFERENCE_TIME_CONFIGURATOR%INIT( CFG, OPT, HOOKS )
...
IMPLICIT NONE
  ...
  !> Initialization of the section
  PP_TRYCALL(ERRFLAG_INITIALIZATION_ERROR)  GRIB2_REFERENCE_TIME_CONFIGURATOR%INIT( MSG, PAR, OPT, HOOKS )
...
PP_THREAD_SAFE FUNCTION DESTROY_GRIB2_REFERENCE_TIME_CONFIGURATOR( GRIB2_REFERENCE_TIME_CONFIGURATOR, OPT, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Free the section
  PP_TRYCALL(ERRFLAG_FREE_ERROR)  GRIB2_REFERENCE_TIME_CONFIGURATOR%FREE( OPT, HOOKS )
