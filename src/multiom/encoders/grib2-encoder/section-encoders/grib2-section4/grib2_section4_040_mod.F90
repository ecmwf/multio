...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_SECTION4_040_INIT_CFG
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_ALLOCATE_CHEM) THIS%CHEM_%ALLOCATE( MSG, GEO, PAR, OPT, METADATA, HOOKS )
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_PRESET_CHEM) THIS%CHEM_%PRESET( MSG, GEO, PAR, OPT, METADATA, HOOKS )
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_RUNTIME_CHEM) THIS%CHEM_%RUNTIME( MSG, GEO, PAR, OPT, METADATA, HOOKS )
