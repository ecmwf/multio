...
CONTAINS
  ...
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRINT          => CACHED_ENCODER_COLLECTION_PRINT
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRINT_RULES    => CACHED_ENCODER_COLLECTION_PRINT_RULES
...
IMPLICIT NONE
  ...
  PP_LOG_STRICT_DEVELOP( 'ALLOCATING/PRESET ENCODERS' )
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'CACHED_ENCODER_COLLECTION_PRINT'
PP_THREAD_SAFE FUNCTION  CACHED_ENCODER_COLLECTION_PRINT( THIS, ID, &
&       MSG, PAR, UNIT, OFFSET, OPT, HOOKS, SEPARATOR ) RESULT(RET)
...
IMPLICIT NONE
  ...
  IF ( PRESENT(SEPARATOR) ) THEN
    PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT) THIS%ENCODERS_(ID)%PRINT( MSG, PAR, UNIT, OFFSET+2_JPIB_K, OPT, HOOKS )
  ELSE
    PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT) THIS%ENCODERS_(ID)%PRINT( MSG, PAR, UNIT, OFFSET+2_JPIB_K, OPT, HOOKS )
  ENDIF
...
END FUNCTION  CACHED_ENCODER_COLLECTION_PRINT
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'CACHED_ENCODER_COLLECTION_PRINT_RULES'
PP_THREAD_SAFE FUNCTION  CACHED_ENCODER_COLLECTION_PRINT_RULES( THIS, UNIT, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  DO I = 1, SIZE(THIS%ENCODERS_)
    ! Print the encoder
    PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT) THIS%ENCODERS_(I)%PRINT_RULE( UNIT, HOOKS )
  ENDDO
...
END FUNCTION  CACHED_ENCODER_COLLECTION_PRINT_RULES
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
