...
public:
    ...
    StatisticsOperationTest(
        ...
        const ElemType tollerance = 10 * std::numeric_limits<ElemType>::epsilon()
    ) : name_{name}, tollerance_{tollerance} {};
    ...
    void runSingle() {
        ...
        EXPECT(res.isApproximatelyEqual(ref, tollerance_));
    }
