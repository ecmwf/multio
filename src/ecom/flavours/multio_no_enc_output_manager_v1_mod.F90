...
IMPLICIT NONE
  ...
  IF ( CFG%GET( MULTIO_NO_ENC_OMNAME, MULTIO_NO_ENC_CFG ) ) THEN
...
IMPLICIT NONE
  ...
  IF ( THIS%VERBOSE_ ) THEN
    ...
    WRITE(THIS%LOG_FNAME_,'(A,I8.8,A)', IOSTAT=STAT) MULTIO_NO_ENC_OMNAME//'-output-manager-', PROCESSOR_TOPO%MYPROC_IO, '.log'
