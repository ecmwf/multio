...
#define PP_FILE_NAME 'regular_gg_dictionary_utils_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'REGULAR_GG_DICTIONARY_UTILS_MOD'
MODULE REGULAR_GG_DICTIONARY_UTILS_MOD
...
END MODULE REGULAR_GG_DICTIONARY_UTILS_MOD
