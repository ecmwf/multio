...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_DESTINE_LOCAL_VERSION_UNDEFINED=12_JPIB_K
  ...
  PP_DEBUG_CRITICAL_COND_THROW( PAR%DESTINE_LOCAL_VERSION.EQ.UNDEF_PARAM_E, ERRFLAG_DESTINE_LOCAL_VERSION_UNDEFINED )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_DESTINE_LOCAL_VERSION_UNDEFINED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'destine local tables version is undefined' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
