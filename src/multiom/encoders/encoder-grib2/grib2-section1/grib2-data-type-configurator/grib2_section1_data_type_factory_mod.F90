...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_INITIALIZATION_ERROR)  GRIB2_DATA_TYPE_CONFIGURATOR%INIT( CFG, OPT, HOOKS )
...
IMPLICIT NONE
  ...
  !> Initialization of the section
  PP_TRYCALL(ERRFLAG_INITIALIZATION_ERROR)  GRIB2_DATA_TYPE_CONFIGURATOR%INIT( MSG, PAR, OPT, HOOKS )
