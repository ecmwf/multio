...
PP_THREAD_SAFE FUNCTION NESTED_RULES_TREE_LOADER_COUNT_MATCHES( THIS, MSG, PAR, NUM_MATCHES, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION NESTED_RULES_TREE_LOADER_MATCH_SINGLE( THIS, MSG, PAR, RULE, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Match the rules
  PP_TRYCALL(ERRFLAG_MATCH_RULES) THIS%HEAD%MATCH_SINGLE( MSG, PAR, RULE, HOOKS )
...
PP_THREAD_SAFE FUNCTION NESTED_RULES_TREE_LOADER_MATCH_MULTIPLE( THIS, MSG, PAR, RULES, IRULE, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Match the rules
  IRULE = 0_JPIB_K
  PP_TRYCALL(ERRFLAG_MATCH_RULES) THIS%HEAD%MATCH( MSG, PAR, RULES, IRULE, HOOKS )
...
RECURSIVE FUNCTION NESTED_RULES_TREE_LOADER_NODE_COUNT_MATCHES( THIS, MSG, PAR, NUM_MATCHES, HOOKS ) RESULT(RET)
...
RECURSIVE FUNCTION NESTED_RULES_TREE_LOADER_NODE_MATCH_SINGLE( THIS, MSG, PAR, RULE, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  IF ( CONDITIONS(1) ) THEN
    DO I = 1, SIZE(THIS%FILTERS)
      ...
      IF ( LMATCH ) THEN
        ! Recursive call to the children
        PP_TRYCALL(ERRFLAG_UNABLE_TO_GET_ENCODERS) THIS%CHILDREN(I)%MATCH_SINGLE( MSG, PAR, RULE, HOOKS )
      ENDIF
    ENDDO
  ELSEIF ( CONDITIONS(2) ) THEN
    ...
    ! Count the number of matches in the rules collections
    PP_TRYCALL(ERRFLAG_UNABLE_MATCHES_RULE) THIS%RULES_COLLECTION%MATCH( MSG, PAR, RULE, HOOKS )
...
RECURSIVE FUNCTION NESTED_RULES_TREE_LOADER_NODE_MATCH_MULTIPLE( THIS, MSG, PAR, RULES, IRULE, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  IF ( CONDITIONS(1) ) THEN
    DO I = 1, SIZE(THIS%FILTERS)
      ...
      IF ( LMATCH ) THEN
        ! Recursive call to the children
        PP_TRYCALL(ERRFLAG_UNABLE_TO_GET_ENCODERS) THIS%CHILDREN(I)%MATCH_MULTIPLE( MSG, PAR, RULES, IRULE, HOOKS )
      ENDIF
    ENDDO
  ELSEIF ( CONDITIONS(2) ) THEN
    ...
    ! MIVAL: Count the number of matches in the rules collections
    ! Count the number of matches in the rules collections
    PP_TRYCALL(ERRFLAG_UNABLE_TO_MATCH_RULES) THIS%RULES_COLLECTION%MATCH( MSG, PAR, RULES, IRULE, HOOKS )
