...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_SECTION4_042_INIT_CFG
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ALLOCATE => GRIB2_SECTION4_042_ALLOCATE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => GRIB2_SECTION4_042_PRESET
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => GRIB2_SECTION4_042_RUNTIME
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: FREE => GRIB2_SECTION4_042_FREE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRINT => GRIB2_SECTION4_042_PRINT
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_TIME_CONFIGURATOR => GRIB2_SECTION4_042_BUILD_TIME_HANDLER
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_MODEL_CONFIGURATOR => GRIB2_SECTION4_042_BUILD_MODEL_HANDLER
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_PARAM_CONFIGURATOR => GRIB2_SECTION4_042_BUILD_PARAM_HANDLER
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_LEVEL_CONFIGURATOR => GRIB2_SECTION4_042_BUILD_LEVEL_HANDLER
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_CHEM_CONFIGURATOR => GRIB2_SECTION4_042_BUILD_CHEM_HANDLER
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION4_042_T` representing the GRIB section being initialized.
...
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_042_INIT_CFG'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_042_INIT_CFG( THIS, &
...
END FUNCTION GRIB2_SECTION4_042_INIT_CFG
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION4_042_T` representing the GRIB section to allocate resources for.
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_042_ALLOCATE( THIS, &
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION4_042_T` representing the GRIB section to be preset.
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_042_PRESET( THIS, &
&  MSG, GEO, PAR, OPT,  METADATA, HOOKS ) RESULT(RET)
...
!>
!> @section interface
!>   @param [in]    THIS      An object of type `GRIB2_SECTION4_042_T` representing the GRIB section for runtime execution.
!>   @param [in]    MSG       The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR       The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_042_RUNTIME( THIS, &
&  MSG, GEO, PAR, OPT, METADATA, HOOKS ) RESULT(RET)
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION4_042_T` representing the GRIB section to be freed.
!>   @param [in]    OPT   The encoder options structure of type `ENCODER_OPTIONS_T`.
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_042_FREE( THIS, OPT, HOOKS ) RESULT(RET)
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_042_PRINT'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_042_PRINT( THIS, &
...
END FUNCTION GRIB2_SECTION4_042_PRINT
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


!>
!> @brief Builds the time handler for GRIB2 section 4, template 042.
!>
!> This function constructs the time handler for GRIB2 section 4, template 042,
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_042_BUILD_TIME_HANDLER'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_042_BUILD_TIME_HANDLER( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_042_BUILD_TIME_HANDLER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE

#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_042_BUILD_MODEL_HANDLER'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_042_BUILD_MODEL_HANDLER( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_042_BUILD_MODEL_HANDLER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @brief Builds the param handler for GRIB2 section 4, template 042.
!>
!> This function constructs the param handler for GRIB2 section 4, template 042,
!> based on the provided configuration (`CFG`), options (`OPT`).
!> It modifies the `THIS` structure accordingly and returns an error code if the operation fails.
!> The function is thread-safe and uses preprocessor directives for debugging, logging, and tracing.
!>
...
!> @see GRIB2_SECTION4_042_ALLOCATE
!> @see GRIB2_SECTION4_042_PRESET
!> @see GRIB2_SECTION4_042_RUNPARAM
!> @see GRIB2_SECTION4_042_TO_BE_ENCODED
!> @see GRIB2_SECTION4_042_FREE
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_042_BUILD_PARAM_HANDLER'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_042_BUILD_PARAM_HANDLER( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_042_BUILD_PARAM_HANDLER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @brief Builds the level handler for GRIB2 section 4, template 042.
!>
!> This function constructs the level handler for GRIB2 section 4, template 042,
!> based on the provided configuration (`CFG`), options (`OPT`).
!> It modifies the `THIS` structure accordingly and returns an error code if the operation fails.
!> The function is thread-safe and uses preprocessor directives for debugging, logging, and tracing.
!>
...
!> @see GRIB2_SECTION4_042_ALLOCATE
!> @see GRIB2_SECTION4_042_PRESET
!> @see GRIB2_SECTION4_042_RUNLEVEL
!> @see GRIB2_SECTION4_042_TO_BE_ENCODED
!> @see GRIB2_SECTION4_042_FREE
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_042_BUILD_LEVEL_HANDLER'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_042_BUILD_LEVEL_HANDLER( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_042_BUILD_LEVEL_HANDLER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_042_BUILD_CHEM_HANDLER'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_042_BUILD_CHEM_HANDLER( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_042_BUILD_CHEM_HANDLER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
