...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_INIT_PERIOD_HANDLER) THIS%BUILD_PERIOD_CONFIGURATOR( CFG, OPT, FACTORIES, HOOKS )
...
&  THIS%PARAMID_, THIS%TEMPLATE_NUMBER_, MSG, PAR, OPT, FACTORIES, HOOKS )
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_BUILD_PERIOD_CONFIGURATOR) FACTORIES%MAKE_GRIB2_PERIOD_CONFIGURATOR_LAZY( &
&  THIS%PARAMID_, THIS%TEMPLATE_NUMBER_, MSG, PAR, OPT, FACTORIES, HOOKS )
...
IMPLICIT NONE
  ...
  !> Make the indicator-section
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_PERIOD_CONFIGURATOR) FACTORIES%MAKE_GRIB2_PERIOD_CONFIGURATOR_CFG( &
&    THIS%PERIOD_, THIS%TEMPLATE_NUMBER_, PERIOD_CONFIGURATOR_CFG, OPT, FACTORIES, HOOKS )
