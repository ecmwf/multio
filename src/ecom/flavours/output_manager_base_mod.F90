...
!>
SUBROUTINE WRITE_ATM_DP_IF( THIS, YDMSG, VALUES )
...
!> @param [inout] ydmsg Message to be encoded
!>
SUBROUTINE WRITE_ATM_SP_IF( THIS, YDMSG, VALUES )
...
!> @param [inout] ydmsg Message to be encoded
!>
SUBROUTINE WRITE_WAM_DP_IF( THIS, YDMSG, VALUES )
  USE :: OM_CORE_MOD, ONLY: JPRD_K
...
!> @param [inout] ydmsg Message to be encoded
!>
SUBROUTINE WRITE_WAM_SP_IF( THIS, YDMSG, VALUES )
  USE :: OM_CORE_MOD, ONLY: JPRM_K
  USE :: OM_CORE_MOD, ONLY: OM_WAM_MSG_T
  IMPORT :: OUTPUT_MANAGER_BASE_A
IMPLICIT NONE
