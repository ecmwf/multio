!>
!> @file grib2_section3_150_mod.F90
!>
!> @brief Module for managing GRIB2 Section 3 operations.
!>
!> The `GRIB2_SECTION3_150_MOD` module contains procedures to initialize, allocate,
...
!>   - @see GRIB2_SECTION3_150_ALLOCATE
!>   - @see GRIB2_SECTION3_150_PRESET
!>   - @see GRIB2_SECTION3_150_RUNTIME
!>   - @see GRIB2_SECTION3_150_TO_BE_ENCODED
...
#define PP_FILE_NAME 'grib2_section3_150_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'GRIB2_SECTION3_150_MOD'
MODULE GRIB2_SECTION3_150_MOD
...
!>
!> The `GRIB2_SECTION3_150_T` type extends the base class `GRIB_SECTION_BASE_A` and
...
!> environments.
!>
TYPE, EXTENDS(GRIB_SECTION_BASE_A) :: GRIB2_SECTION3_150_T
...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_CFG => GRIB2_SECTION3_150_INIT_CFG
  ...
  !> the GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_LAZY => GRIB2_SECTION3_150_INIT_LAZY
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ALLOCATE => GRIB2_SECTION3_150_ALLOCATE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => GRIB2_SECTION3_150_PRESET
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => GRIB2_SECTION3_150_RUNTIME
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => GRIB2_SECTION3_150_TO_BE_ENCODED
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: FREE => GRIB2_SECTION3_150_FREE
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION3_150_T` representing the GRIB section being initialized.
...
#define PP_PROCEDURE_NAME 'GRIB2_SECTION3_150_INIT_CFG'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_150_INIT_CFG( THIS, &
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(GRIB2_SECTION3_150_T),  INTENT(INOUT) :: THIS
...
END FUNCTION GRIB2_SECTION3_150_INIT_CFG
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION3_150_INIT_LAZY'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_150_INIT_LAZY( THIS, &
...
END FUNCTION GRIB2_SECTION3_150_INIT_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION3_150_T` representing the GRIB section to allocate resources for.
!>   @param [in]    MSG      All the mars keywords needed to describe the field `FORTRAN_MESSAGE_T`.
!>   @param [in]    PAR      All information outside mars keywords needed to describe the field `PARAMETRIZATION_T`.
!>   @param [in]    OPT      The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION3_150_ALLOCATE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_150_ALLOCATE( THIS, &
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CONVERT_TO_STRING=6_JPIB_K
  ...
  ! Enable section 3
  PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'gridDefinitionTemplateNumber', 150_JPIB_K )
  ...
  CLASS IS (HEALPIX_T)
    ...
    PP_TRYCALL(ERRFLAG_CONVERT_TO_STRING) IORDERING_CONVENTION2CORDERING_CONVENTION( R%ORDERING_CONVENTION, VALUE_STR, HOOKS )

    ! Set the specific metadata for a regular_gg grid
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'gridType','healpix' )
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'nside', R%NSIDE )
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'orderingConvention', TRIM(ADJUSTL(VALUE_STR)) )
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'longitudeOfFirstGridPointInDegrees', R%LONGITUDE_OF_FIRST_GRID_POINT_IN_DEGREES )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_CONVERT_TO_STRING)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'error converting to string HEALPix ordering convention' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
END FUNCTION GRIB2_SECTION3_150_ALLOCATE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION3_150_T` representing the GRIB section to be preset.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION3_150_PRESET'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_150_PRESET( THIS, &
&  MSG, PAR, OPT,  METADATA, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION3_150_PRESET
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS      An object of type `GRIB2_SECTION3_150_T` representing the GRIB section for runtime execution.
!>   @param [in]    MSG       The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR       The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION3_150_RUNTIME'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_150_RUNTIME( THIS, &
...
END FUNCTION GRIB2_SECTION3_150_RUNTIME
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS          An object of type `GRIB2_SECTION3_150_T` representing the GRIB section being checked.
!>   @param [in]    MSG           The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR           The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
!>   @param [in]    TIME_HIST     The time history object of type `TIME_HISTORY_T` providing historical time data.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION3_150_TO_BE_ENCODED'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_150_TO_BE_ENCODED( THIS, &
...
END FUNCTION GRIB2_SECTION3_150_TO_BE_ENCODED
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION3_150_T` representing the GRIB section to be freed.
!>   @param [in]    OPT   The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION3_150_FREE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_150_FREE( THIS, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION3_150_FREE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
