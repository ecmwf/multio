...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: N_INTEGER_SCALAR=71
...
IMPLICIT NONE
  ...
  PP_DEBUG_CRITICAL_COND_THROW( .NOT.ALLOCATED( DATA_RAW%GEO_%NSFLEVS ), ERRFLAG_NOT_ALLOCATED )
  ...
  BUF( 9) = INT( DATA_RAW%SIM_%NWINSIZE, JPIB_K )
  BUF(10) = INT( DATA_RAW%SIM_%NWINOFF, JPIB_K )
  BUF(11) = INT( DATA_RAW%SIM_%NJDIAG, JPIB_K )
  BUF(12) = INT( DATA_RAW%SIM_%NJDOMAI, JPIB_K )
  BUF(13) = INT( DATA_RAW%SIM_%NJITER, JPIB_K )
  BUF(14) = INT( DATA_RAW%SIM_%NSTREAM, JPIB_K )
  BUF(15) = INT( DATA_RAW%SIM_%NSYSTEM, JPIB_K )
  BUF(16) = INT( DATA_RAW%SIM_%NMETHOD, JPIB_K )
  BUF(17) = INT( DATA_RAW%SIM_%NREFERENCE, JPIB_K )
  BUF(18) = INT( DATA_RAW%SIM_%NCONSENSUS, JPIB_K )
  BUF(19) = INT( DATA_RAW%SIM_%NDWD, JPIB_K )
  BUF(20) = INT( DATA_RAW%SIM_%NMFR, JPIB_K )
  BUF(21) = INT( DATA_RAW%SIM_%NNCEP, JPIB_K )
  BUF(22) = INT( DATA_RAW%SIM_%NUKM, JPIB_K )
  BUF(23) = INT( DATA_RAW%SIM_%NINDAT, JPIB_K )
  BUF(24) = INT( DATA_RAW%SIM_%NSSSSS, JPIB_K )
  BUF(25) = INT( DATA_RAW%SIM_%NCONF, JPIB_K )
  BUF(26) = INT( DATA_RAW%SIM_%NSTEPINI, JPIB_K )
  BUF(27) = INT( DATA_RAW%SIM_%NFCHO_TRUNC_INI, JPIB_K )
  BUF(28) = INT( DATA_RAW%GEO_%JPMXLE, JPIB_K )
  BUF(29) = INT( DATA_RAW%GEO_%JPMXGL, JPIB_K )
  BUF(30) = INT( DATA_RAW%GEO_%ISMAX, JPIB_K )
  BUF(31) = INT( DATA_RAW%GEO_%ILATS, JPIB_K )
  BUF(32) = INT( DATA_RAW%GEO_%ILONS, JPIB_K )
  BUF(33) = INT( DATA_RAW%GEO_%IDGNH, JPIB_K )
  BUF(34) = INT( DATA_RAW%GEO_%IFLEV, JPIB_K )
  BUF(35) = INT( DATA_RAW%GEO_%NHTYP, JPIB_K )
  BUF(36) = INT( DATA_RAW%GEO_%NSTTYP, JPIB_K )
  BUF(37) = INT( DATA_RAW%WAM_%NGX, JPIB_K )
  BUF(38) = INT( DATA_RAW%WAM_%NGY, JPIB_K )
  BUF(39) = INT( DATA_RAW%WAM_%NANG, JPIB_K )
  BUF(40) = INT( DATA_RAW%WAM_%NFRE_RED, JPIB_K )
  BUF(41) = INT( DATA_RAW%WAM_%IMDLGRBID_G, JPIB_K )
  BUF(42) = INT( DATA_RAW%WAM_%IMDLGRBID_M, JPIB_K )
  BUF(43) = INT( DATA_RAW%WAM_%NDATE_TIME_WINDOW_END, JPIB_K )
  BUF(44) = INT( DATA_RAW%WAM_%NWINOFF, JPIB_K )
  BUF(45) = INT( DATA_RAW%WAM_%NGRIB_VERSION, JPIB_K )
  BUF(46) = INT( DATA_RAW%WAM_%NTENCODE, JPIB_K )
  BUF(47) = INT( DATA_RAW%WAM_%NGRBRESI, JPIB_K )
  BUF(48) = INT( DATA_RAW%WAM_%NGRBRESS, JPIB_K )
  BUF(49) = INT( DATA_RAW%WAM_%IRGG, JPIB_K )
  BUF(50) = INT( DATA_RAW%WAM_%IQGAUSS, JPIB_K )
  BUF(51) = INT( DATA_RAW%WAM_%NENSFNB, JPIB_K )
  BUF(52) = INT( DATA_RAW%WAM_%NTOTENS, JPIB_K )
  BUF(53) = INT( DATA_RAW%WAM_%NSYSNB, JPIB_K )
  BUF(54) = INT( DATA_RAW%WAM_%NMETNB, JPIB_K )
  BUF(55) = INT( DATA_RAW%WAM_%ISTREAM, JPIB_K )
  BUF(56) = INT( DATA_RAW%WAM_%NLOCGRB, JPIB_K )
  BUF(57) = INT( DATA_RAW%WAM_%NCONSENSUS, JPIB_K )
  BUF(58) = INT( DATA_RAW%WAM_%NDWD, JPIB_K )
  BUF(59) = INT( DATA_RAW%WAM_%NMFR, JPIB_K )
  BUF(60) = INT( DATA_RAW%WAM_%NNCEP, JPIB_K )
  BUF(61) = INT( DATA_RAW%WAM_%NUKM, JPIB_K )
  BUF(62) = INT( DATA_RAW%WAM_%IREFDATE, JPIB_K )
  BUF(63) = INT( DATA_RAW%WAM_%NSPEC2TAB, JPIB_K )
  BUF(64) = INT( DATA_RAW%WAM_%NSPEC2TMPD, JPIB_K )
  BUF(65) = INT( DATA_RAW%WAM_%NSPEC2TMPP, JPIB_K )
  BUF(66) = INT( DATA_RAW%WAM_%NTRG2TMPD, JPIB_K )
  BUF(67) = INT( DATA_RAW%WAM_%NTRG2TMPP, JPIB_K )
  BUF(68) = INT( DATA_RAW%WAM_%ITMIN, JPIB_K )
  BUF(69) = INT( DATA_RAW%WAM_%ITMAX, JPIB_K )
  BUF(70) = INT( DATA_RAW%SAT_%NSATSIM, JPIB_K )
  BUF(71) = INT( DATA_RAW%SIM_%NPROC_IO, JPIB_K )
  BUF(72) = L2I( DATA_RAW%SIM_%LPPSTEPS )
  BUF(73) = L2I( DATA_RAW%SIM_%LOBSC1 )
  BUF(74) = L2I( DATA_RAW%SIM_%LVAREPS )
  BUF(75) = L2I( DATA_RAW%SIM_%LDMCC04 )
  BUF(76) = L2I( DATA_RAW%WAM_%LWCOUSAMEGRID )
  BUF(77) = L2I( DATA_RAW%WAM_%LGRHDIFS )
  BUF(78) = L2I( DATA_RAW%WAM_%LNEWLVTP )
  BUF(79) = L2I( DATA_RAW%WAM_%LPADPOLES )
  BUF(80) = L2I( DATA_RAW%WAM_%LL_GRID_SIMPLE_MATRIX )
  CNT = 80
...
IMPLICIT NONE
  ...
  DATA_RAW%SIM_%NWINSIZE                     = INT( BUF(9),  JPIB_K )
  DATA_RAW%SIM_%NWINOFF                      = INT( BUF(10), JPIB_K )
  DATA_RAW%SIM_%NJDIAG                       = INT( BUF(11), JPIB_K )
  DATA_RAW%SIM_%NJDOMAI                      = INT( BUF(12), JPIB_K )
  DATA_RAW%SIM_%NJITER                       = INT( BUF(13), JPIB_K )
  DATA_RAW%SIM_%NSTREAM                      = INT( BUF(14), JPIB_K )
  DATA_RAW%SIM_%NSYSTEM                      = INT( BUF(15), JPIB_K )
  DATA_RAW%SIM_%NMETHOD                      = INT( BUF(16), JPIB_K )
  DATA_RAW%SIM_%NREFERENCE                   = INT( BUF(17), JPIB_K )
  DATA_RAW%SIM_%NCONSENSUS                   = INT( BUF(18), JPIB_K )
  DATA_RAW%SIM_%NDWD                         = INT( BUF(19), JPIB_K )
  DATA_RAW%SIM_%NMFR                         = INT( BUF(20), JPIB_K )
  DATA_RAW%SIM_%NNCEP                        = INT( BUF(21), JPIB_K )
  DATA_RAW%SIM_%NUKM                         = INT( BUF(22), JPIB_K )
  DATA_RAW%SIM_%NINDAT                       = INT( BUF(23), JPIB_K )
  DATA_RAW%SIM_%NSSSSS                       = INT( BUF(24), JPIB_K )
  DATA_RAW%SIM_%NCONF                        = INT( BUF(25), JPIB_K )
  DATA_RAW%SIM_%NSTEPINI                     = INT( BUF(26), JPIB_K )
  DATA_RAW%SIM_%NFCHO_TRUNC_INI              = INT( BUF(27), JPIB_K )
  DATA_RAW%GEO_%JPMXLE                       = INT( BUF(28), JPIB_K )
  DATA_RAW%GEO_%JPMXGL                       = INT( BUF(29), JPIB_K )
  DATA_RAW%GEO_%ISMAX                        = INT( BUF(30), JPIB_K )
  DATA_RAW%GEO_%ILATS                        = INT( BUF(31), JPIB_K )
  DATA_RAW%GEO_%ILONS                        = INT( BUF(32), JPIB_K )
  DATA_RAW%GEO_%IDGNH                        = INT( BUF(33), JPIB_K )
  DATA_RAW%GEO_%IFLEV                        = INT( BUF(34), JPIB_K )
  DATA_RAW%GEO_%NHTYP                        = INT( BUF(35), JPIB_K )
  DATA_RAW%GEO_%NSTTYP                       = INT( BUF(36), JPIB_K )
  DATA_RAW%WAM_%NGX                          = INT( BUF(37), JPIB_K )
  DATA_RAW%WAM_%NGY                          = INT( BUF(38), JPIB_K )
  DATA_RAW%WAM_%NANG                         = INT( BUF(39), JPIB_K )
  DATA_RAW%WAM_%NFRE_RED                     = INT( BUF(40), JPIB_K )
  DATA_RAW%WAM_%IMDLGRBID_G                  = INT( BUF(41), JPIB_K )
  DATA_RAW%WAM_%IMDLGRBID_M                  = INT( BUF(42), JPIB_K )
  DATA_RAW%WAM_%NDATE_TIME_WINDOW_END        = INT( BUF(43), JPIB_K )
  DATA_RAW%WAM_%NWINOFF                      = INT( BUF(44), JPIB_K )
  DATA_RAW%WAM_%NGRIB_VERSION                = INT( BUF(45), JPIB_K )
  DATA_RAW%WAM_%NTENCODE                     = INT( BUF(46), JPIB_K )
  DATA_RAW%WAM_%NGRBRESI                     = INT( BUF(47), JPIB_K )
  DATA_RAW%WAM_%NGRBRESS                     = INT( BUF(48), JPIB_K )
  DATA_RAW%WAM_%IRGG                         = INT( BUF(49), JPIB_K )
  DATA_RAW%WAM_%IQGAUSS                      = INT( BUF(50), JPIB_K )
  DATA_RAW%WAM_%NENSFNB                      = INT( BUF(51), JPIB_K )
  DATA_RAW%WAM_%NTOTENS                      = INT( BUF(52), JPIB_K )
  DATA_RAW%WAM_%NSYSNB                       = INT( BUF(53), JPIB_K )
  DATA_RAW%WAM_%NMETNB                       = INT( BUF(54), JPIB_K )
  DATA_RAW%WAM_%ISTREAM                      = INT( BUF(55), JPIB_K )
  DATA_RAW%WAM_%NLOCGRB                      = INT( BUF(56), JPIB_K )
  DATA_RAW%WAM_%NCONSENSUS                   = INT( BUF(57), JPIB_K )
  DATA_RAW%WAM_%NDWD                         = INT( BUF(58), JPIB_K )
  DATA_RAW%WAM_%NMFR                         = INT( BUF(59), JPIB_K )
  DATA_RAW%WAM_%NNCEP                        = INT( BUF(60), JPIB_K )
  DATA_RAW%WAM_%NUKM                         = INT( BUF(61), JPIB_K )
  DATA_RAW%WAM_%IREFDATE                     = INT( BUF(62), JPIB_K )
  DATA_RAW%WAM_%NSPEC2TAB                    = INT( BUF(63), JPIB_K )
  DATA_RAW%WAM_%NSPEC2TMPD                   = INT( BUF(64), JPIB_K )
  DATA_RAW%WAM_%NSPEC2TMPP                   = INT( BUF(65), JPIB_K )
  DATA_RAW%WAM_%NTRG2TMPD                    = INT( BUF(66), JPIB_K )
  DATA_RAW%WAM_%NTRG2TMPP                    = INT( BUF(67), JPIB_K )
  DATA_RAW%WAM_%ITMIN                        = INT( BUF(68), JPIB_K )
  DATA_RAW%WAM_%ITMAX                        = INT( BUF(69), JPIB_K )
  DATA_RAW%SAT_%NSATSIM                      = INT( BUF(70), JPIB_K )
  DATA_RAW%SIM_%NPROC_IO                     = INT( BUF(71), JPIB_K )
  DATA_RAW%SIM_%LPPSTEPS                     = I2L( BUF(72) )
  DATA_RAW%SIM_%LOBSC1                       = I2L( BUF(73) )
  DATA_RAW%SIM_%LVAREPS                      = I2L( BUF(74) )
  DATA_RAW%SIM_%LDMCC04                      = I2L( BUF(75) )
  DATA_RAW%WAM_%LWCOUSAMEGRID                = I2L( BUF(76) )
  DATA_RAW%WAM_%LGRHDIFS                     = I2L( BUF(77) )
  DATA_RAW%WAM_%LNEWLVTP                     = I2L( BUF(78) )
  DATA_RAW%WAM_%LPADPOLES                    = I2L( BUF(79) )
  DATA_RAW%WAM_%LL_GRID_SIMPLE_MATRIX        = I2L( BUF(80) )
  CNT = 80
