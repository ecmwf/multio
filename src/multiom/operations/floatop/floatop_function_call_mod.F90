!>
!> @file floatop_function_call_mod.F90
!>
!> @brief Module containing definitions and procedures for function_calleter operations.
!>
!> This module defines the `FLOATOP_FUNCTION_CALL_T` type, along with its associated
...
#define PP_FILE_NAME 'floatop_function_call_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'FLOATOP_FUNCTION_CALL_MOD'
MODULE FLOATOP_FUNCTION_CALL_MOD
...
!>
!> This derived type extends `FLOATOP_BASE_A` and is used for operationing based on function_calleters.
...
!>
TYPE, EXTENDS(FLOATOP_BASE_A) :: FLOATOP_FUNCTION_CALL_T
  ...
  !> First operand
  TYPE(FLOATOP_CONTAINER_T), POINTER, DIMENSION(:) :: OPERANDS_ => NULL()
  REAL(KIND=JPRD_K), POINTER, DIMENSION(:) :: WORKSPACE_ => NULL()


CONTAINS

  !> @brief Initializes the operation function_calleter type.
  !> @details This procedure sets up the `FLOATOP_FUNCTION_CALL_T` type, initializing its components.
  !>
  !> @function_call [in] this The instance of `FLOATOP_FUNCTION_CALL_T` to initialize.
  PROCEDURE, NON_OVERRIDABLE, PUBLIC, PASS :: INIT => FLOATOP_FUNCTION_CALL_INIT
  PROCEDURE, NON_OVERRIDABLE, PUBLIC, PASS :: GET  => FLOATOP_FUNCTION_CALL_GET_OPERANDS
  ...
  !>
  !> @function_call [in] this The instance of `FLOATOP_FUNCTION_CALL_T`.
  PROCEDURE, NON_OVERRIDABLE, PUBLIC, PASS :: EVAL => FLOATOP_FUNCTION_CALL_EVALUATE
  ...
  !>
  !> @function_call [in] this The instance of `FLOATOP_FUNCTION_CALL_T` to print.
  PROCEDURE, NON_OVERRIDABLE, PUBLIC, PASS :: PRINT => FLOATOP_FUNCTION_CALL_PRINT

  !> @brief Frees resources allocated for the operation.
  !> @details Cleans up the `FLOATOP_FUNCTION_CALL_T` type, deallocating any resources used by the operation.
  !>
  !> @function_call [in] this The instance of `FLOATOP_FUNCTION_CALL_T` to free.
  PROCEDURE, NON_OVERRIDABLE, PUBLIC, PASS :: FREE  => FLOATOP_FUNCTION_CALL_FREE
...
PUBLIC :: FLOATOP_FUNCTION_CALL_T

CONTAINS


!>
!> @brief Initializes the `FLOATOP_FUNCTION_CALL_T` operation from a YAML configuration.
!>
!> This function initializes the `FLOATOP_FUNCTION_CALL_T` type based on the provided YAML
...
!>
!> @function_call [inout] THIS The operation object (`FLOATOP_FUNCTION_CALL_T`) that will be initialized.
...
#define PP_PROCEDURE_NAME 'FLOATOP_FUNCTION_CALL_INIT'
FUNCTION FLOATOP_FUNCTION_CALL_INIT( THIS, CFG, HOOKS ) RESULT(RET)

  !> Symbols imported from other modules within the project.
  USE :: DATAKINDS_DEF_MOD,     ONLY: JPIB_K
  USE :: YAML_CORE_UTILS_MOD,   ONLY: YAML_CONFIGURATION_T
  USE :: HOOKS_MOD,             ONLY: HOOKS_T
  USE :: ENUMERATORS_MOD,       ONLY: CFLOATOPFUNCCALL2IFLOATOPFUNCCALL
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(FLOATOP_FUNCTION_CALL_T), INTENT(INOUT) :: THIS
  ...
  !> Local variables
  PROCEDURE(FUN_C2I_IF), POINTER :: P_CFLOATOPFUNCCALL2IFLOATOPFUNCCALL
  ...
  P_CFLOATOPFUNCCALL2IFLOATOPFUNCCALL => CFLOATOPFUNCCALL2IFLOATOPFUNCCALL
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_OPERATION) YAML_READ_INTEGER_WITH_FILTER( CFG, 'operation', THIS%FUNCTION_CALL_TYPE_, P_CFLOATOPFUNCCALL2IFLOATOPFUNCCALL, HOOKS )
...
END FUNCTION FLOATOP_FUNCTION_CALL_INIT
...
!>
!> @function_call [inout] THIS  The operation object (`FLOATOP_FUNCTION_CALL_T`) used for matching.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'FLOATOP_FUNCTION_CALL_EVALUATE'
FUNCTION FLOATOP_FUNCTION_CALL_EVALUATE( THIS, MSG, PAR, RESULT, HOOKS ) RESULT(RET)
  ...
  USE :: HOOKS_MOD,           ONLY: HOOKS_T
  USE :: ENUMERATORS_MOD,     ONLY: FLOATOP_FUNCTION_CALL_ABS_E
  USE :: ENUMERATORS_MOD,     ONLY: FLOATOP_FUNCTION_CALL_SIGN_E
  USE :: ENUMERATORS_MOD,     ONLY: FLOATOP_FUNCTION_CALL_STEPL_E
  USE :: ENUMERATORS_MOD,     ONLY: FLOATOP_FUNCTION_CALL_STEPR_E
...
IMPLICIT NONE
  ...
  CASE( FLOATOP_FUNCTION_CALL_SIGN_E )
    ...
    RESULT = SIGN( 1.0_JPRD_K,THIS%WORKSPACE_(1) )
...
END FUNCTION FLOATOP_FUNCTION_CALL_EVALUATE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'FLOATOP_FUNCTION_CALL_GET_OPERANDS'
FUNCTION FLOATOP_FUNCTION_CALL_GET_OPERANDS( THIS, OPERANDS, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(FLOATOP_FUNCTION_CALL_T),                   INTENT(INOUT) :: THIS
  TYPE(FLOATOP_CONTAINER_T), POINTER, DIMENSION(:), INTENT(INOUT) :: OPERANDS
  TYPE(HOOKS_T),                                    INTENT(INOUT) :: HOOKS
...
END FUNCTION FLOATOP_FUNCTION_CALL_GET_OPERANDS
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @function_call [inout] THIS    The operation object (`FLOATOP_FUNCTION_CALL_T`) whose details are to be printed.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'FLOATOP_FUNCTION_CALL_PRINT'
FUNCTION FLOATOP_FUNCTION_CALL_PRINT( THIS, UNIT, OFFSET, HOOKS, SEPARATOR ) RESULT(RET)

  !> Symbols imported from other modules within the project.
  USE :: DATAKINDS_DEF_MOD, ONLY: JPIB_K
  USE :: HOOKS_MOD,         ONLY: HOOKS_T
  USE :: ENUMERATORS_MOD,   ONLY: IFLOATOPFUNCCALL2CFLOATOPFUNCCALL
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_CONVERT_OPERATION) IFLOATOPFUNCCALL2CFLOATOPFUNCCALL( THIS%FUNCTION_CALL_TYPE_, FLOATOP_TYPE_STR, HOOKS )

  !> Print the function_call operation
  N = SIZE(THIS%OPERANDS_)
  WRITE(UNIT,'(A)') REPEAT(' ',OFFSET)//'function_call::'//TRIM(ADJUSTL(FLOATOP_TYPE_STR))//'('
  IF ( N .GT. 1 ) THEN
    DO I = 1, N-1
...
END FUNCTION FLOATOP_FUNCTION_CALL_PRINT
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @function_call [inout] THIS   The operation object (`FLOATOP_FUNCTION_CALL_T`) whose resources are to be freed.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'FLOATOP_FUNCTION_CALL_FREE'
FUNCTION FLOATOP_FUNCTION_CALL_FREE( THIS, HOOKS ) RESULT(RET)
...
END FUNCTION FLOATOP_FUNCTION_CALL_FREE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE

END MODULE FLOATOP_FUNCTION_CALL_MOD
