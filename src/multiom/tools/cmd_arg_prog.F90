...
#define PP_FILE_NAME 'cmd_arg_prog.F90'
#define PP_SECTION_TYPE 'PROGRAM'
#define PP_SECTION_NAME 'CMD_ARG_PROG'
#define PP_PROCEDURE_TYPE 'PROGRAM'
#define PP_PROCEDURE_NAME 'CMD_ARG_PROG'
PROGRAM CMD_ARG_PROG

  ! Symbolds imported from intrinsic modules
  USE :: MULTIOM_API, ONLY: JPIB_K
  USE :: MULTIOM_API, ONLY: HOOKS_T
  USE :: MULTIOM_LIST_CFG_MOD, ONLY: COMMAND_LINE_ARGS_T
