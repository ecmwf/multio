...
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_EXPVER = 24_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_GRID = 25_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_HDATE = 26_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_WAVELENGTH = 27_JPIB_K

INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_DATASET = 28_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_ACTIVITY = 29_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_EXPERIMENT = 30_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_GENERATION = 31_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_REALIZATION = 32_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_RESOLUTION = 33_JPIB_K

INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_SYSTEM = 34_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_METHOD = 35_JPIB_K

INTEGER(KIND=JPIB_K), PARAMETER :: MARS_ITERATOR_UNDEF = 36_JPIB_K
