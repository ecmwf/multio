...
PP_THREAD_SAFE FUNCTION RULE_MATCH_SINGLE( THIS, MSG, PAR, RULE, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION RULE_MATCH_MULTIPLE( THIS, MSG, PAR, RULES, IRULE, HOOKS ) RESULT(RET)
