!>
!> @file grib2_section4_mediumcloudlayer_mod.F90
!>
!> @brief Module for managing GRIB2 Section 4 level configuration operations.
!>
!> The `G2S4_MEDIUMCLOUDLAYER_MOD` module contains procedures to initialize, allocate,
...
!>   - @see G2S4_MEDIUMCLOUDLAYER_INIT
!>   - @see G2S4_MEDIUMCLOUDLAYER_ALLOC
!>   - @see G2S4_MEDIUMCLOUDLAYER_PRESET
!>   - @see G2S4_MEDIUMCLOUDLAYER_RT
!>   - @see G2S4_MEDIUMCLOUDLAYER_TBE
!>   - @see G2S4_MEDIUMCLOUDLAYER_FREE
!>
...
#define PP_FILE_NAME 'grib2_section4_mediumcloudlayer_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'GRIB2_SECTION4_MEDIUMCLOUDLAYER_MOD'
...
!>
!> The `GRIB2_SECTION4_MEDIUMCLOUDLAYER_T` type extends the base class `GRIB_SECTION_BASE_A` and
...
!> environments.
!>
TYPE, EXTENDS(GRIB_SECTION_BASE_A) :: GRIB2_SECTION4_MEDIUMCLOUDLAYER_T
...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_CFG => G2S4_MEDIUMCLOUDLAYER_INIT_CFG
  ...
  !> the GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_LAZY => G2S4_MEDIUMCLOUDLAYER_INIT_LAZY
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ALLOCATE => G2S4_MEDIUMCLOUDLAYER_ALLOC
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => G2S4_MEDIUMCLOUDLAYER_PRESET
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => G2S4_MEDIUMCLOUDLAYER_RT
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => G2S4_MEDIUMCLOUDLAYER_TBE
...
PUBLIC :: GRIB2_SECTION4_MEDIUMCLOUDLAYER_T
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION4_MEDIUMCLOUDLAYER_T` representing the GRIB section being initialized.
...
#define PP_PROCEDURE_NAME 'G2S4_MEDIUMCLOUDLAYER_INIT_CFG'
PP_THREAD_SAFE FUNCTION G2S4_MEDIUMCLOUDLAYER_INIT_CFG( THIS, &
...
END FUNCTION G2S4_MEDIUMCLOUDLAYER_INIT_CFG
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_MEDIUMCLOUDLAYER_INIT_LAZY'
PP_THREAD_SAFE FUNCTION G2S4_MEDIUMCLOUDLAYER_INIT_LAZY( THIS, &
...
END FUNCTION G2S4_MEDIUMCLOUDLAYER_INIT_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION4_MEDIUMCLOUDLAYER_T` representing the GRIB section to allocate resources for.
!>   @param [in]    MSG      All the mars keywords needed to describe the field `FORTRAN_MESSAGE_T`.
!>   @param [in]    PAR      All information outside mars keywords needed to describe the field `PARAMETRIZATION_T`.
!>   @param [in]    OPT      The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_MEDIUMCLOUDLAYER_ALLOC'
PP_THREAD_SAFE FUNCTION G2S4_MEDIUMCLOUDLAYER_ALLOC( THIS, &
...
END FUNCTION G2S4_MEDIUMCLOUDLAYER_ALLOC
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION4_MEDIUMCLOUDLAYER_T` representing the GRIB section to be preset.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_MEDIUMCLOUDLAYER_PRESET'
PP_THREAD_SAFE FUNCTION G2S4_MEDIUMCLOUDLAYER_PRESET( THIS, &
&  MSG, PAR, OPT,  METADATA, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_MEDIUMCLOUDLAYER_PRESET
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS      An object of type `GRIB2_SECTION4_MEDIUMCLOUDLAYER_T` representing the GRIB section for runlevel execution.
!>   @param [in]    MSG       The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR       The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_MEDIUMCLOUDLAYER_RT'
PP_THREAD_SAFE FUNCTION G2S4_MEDIUMCLOUDLAYER_RT( THIS, &
...
END FUNCTION G2S4_MEDIUMCLOUDLAYER_RT
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS          An object of type `GRIB2_SECTION4_MEDIUMCLOUDLAYER_T` representing the GRIB section being checked.
!>   @param [in]    MSG           The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR           The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
!>   @param [in]    TIME_HIST     The time history object of type `TIME_HISTORY_T` providing historical level data.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_MEDIUMCLOUDLAYER_TBE'
PP_THREAD_SAFE FUNCTION G2S4_MEDIUMCLOUDLAYER_TBE( THIS, &
...
END FUNCTION G2S4_MEDIUMCLOUDLAYER_TBE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION4_MEDIUMCLOUDLAYER_T` representing the GRIB section to be freed.
!>   @param [in]    OPT   The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_MEDIUMCLOUDLAYER_FREE'
PP_THREAD_SAFE FUNCTION G2S4_MEDIUMCLOUDLAYER_FREE( THIS, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_MEDIUMCLOUDLAYER_FREE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_MEDIUMCLOUDLAYER_SET_LEVELS'
PP_THREAD_SAFE FUNCTION G2S4_MEDIUMCLOUDLAYER_SET_LEVELS( THIS, &
&  MSG, PAR, OPT, METADATA, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ELSE
    ...
    ! TODO PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'ScaledValueOfFirstFixedSurface', 80000)
    ! TODO PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'ScaledValueOfSecondFixedSurface', 45000)
    ! TODO PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'ScaleFactorOfFirstFixedSurface', 0)
    ! TODO PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'ScaleFactorOfSecondFixedSurface', 0)
  ENDIF
...
END MODULE GRIB2_SECTION4_MEDIUMCLOUDLAYER_MOD
