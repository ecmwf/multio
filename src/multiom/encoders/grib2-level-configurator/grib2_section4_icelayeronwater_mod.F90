...
CHARACTER(LEN=*), PARAMETER :: TYPE_OF_LEVEL = 'iceLayerOnWater'
INTEGER(KIND=JPIB_K), PARAMETER :: TYPE_OF_FIRST_FIXED_SURFACE = 174_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: TYPE_OF_SECOND_FIXED_SURFACE = 176_JPIB_K
...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => G2S4_ICELAYERONWATER_INIT
  ...
  !>
  PROCEDURE, PRIVATE, PASS, NON_OVERRIDABLE :: SET_LEVELS => G2S4_ICELAYERONWATER_SET_LEVELS
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: CHECK => G2S4_ICELAYERONWATER_CHECK
...
#define PP_PROCEDURE_NAME 'G2S4_ICELAYERONWATER_INIT'
PP_THREAD_SAFE FUNCTION G2S4_ICELAYERONWATER_INIT( THIS, &
...
END FUNCTION G2S4_ICELAYERONWATER_INIT
...
IMPLICIT NONE
  ...
  ! Logging
  PP_LOG_DEVELOP_STR( 'Allocate iceLayerOnWater' )
...
IMPLICIT NONE
  ...
  ! Logging
  PP_LOG_DEVELOP_STR( 'Preset iceLayerOnWater' )
...
IMPLICIT NONE
  ...
  PP_LOG_DEVELOP_STR( 'Runtime iceLayerOnWater' )
...
PP_THREAD_SAFE FUNCTION G2S4_ICELAYERONWATER_FREE( THIS, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_ICELAYERONWATER_CHECK'
PP_THREAD_SAFE FUNCTION G2S4_ICELAYERONWATER_CHECK( THIS, &
&  MSG, PAR, OPT, METADATA, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! According to the options decide where to set the levels (preset or runlevel)
  PP_LOG_INFO( 'check typeOfLevel: iceLayerOnWater' )
...
END FUNCTION G2S4_ICELAYERONWATER_CHECK
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
