...
#define PP_FILE_NAME 'options_dictionary_wrapper_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'OPTIONS_DICTIONARY_WRAPPER_MOD'
MODULE OPTIONS_DICTIONARY_WRAPPER_MOD
...
&   STORAGE_SIZE(DICTIONARY_CONTAINER) / 8_JPIB_K
  ...
  ! Extract the wrapper
  WRAPPER => NULL()
  CALL C_F_POINTER( WRAPPED_API_OPTIONS_DICTIONARY, WRAPPER, [1] )
  PP_DEBUG_CRITICAL_COND_THROW( .NOT.ASSOCIATED(WRAPPER), ERRFLAG_UNABLE_TO_EXTRACT_WRAPPER )
...
PP_THREAD_SAFE FUNCTION IS_ALLOWED_API_OPTIONS_DICTIONARY( WRAPPED_API_OPTIONS_DICTIONARY, KEY, IS_ALLOWED, HOOKS ) RESULT(RET)
  ...
  USE :: HOOKS_MOD,                    ONLY: HOOKS_T
  USE :: OPTIONS_DICTIONARY_UTILS_MOD, ONLY: API_OPTIONS_T
  USE :: OPTIONS_DICTIONARY_UTILS_MOD, ONLY: OPTIONS_DICTIONARY_IS_ALLOWED
...
PP_THREAD_SAFE FUNCTION HAS_API_OPTIONS_DICTIONARY( WRAPPED_API_OPTIONS_DICTIONARY, KEY, HAS, HOOKS ) RESULT(RET)
  ...
  USE :: OPTIONS_DICTIONARY_UTILS_MOD, ONLY: OPTIONS_DICTIONARY_HAS
...
PP_THREAD_SAFE FUNCTION RANK_API_OPTIONS_DICTIONARY( WRAPPED_API_OPTIONS_DICTIONARY, KEY, RANK, HOOKS ) RESULT(RET)
  ...
  USE :: OPTIONS_DICTIONARY_UTILS_MOD, ONLY: API_OPTIONS_T
  USE :: OPTIONS_DICTIONARY_UTILS_MOD, ONLY: OPTIONS_DICTIONARY_NAME2ITERATOR
  USE :: OPTIONS_DICTIONARY_UTILS_MOD, ONLY: OPTIONS_DICTIONARY_RANK
...
PP_THREAD_SAFE FUNCTION SIZE_API_OPTIONS_DICTIONARY( WRAPPED_API_OPTIONS_DICTIONARY, KEY, SIZE, HOOKS ) RESULT(RET)
  ...
  USE :: OPTIONS_DICTIONARY_UTILS_MOD, ONLY: API_OPTIONS_T
  USE :: OPTIONS_DICTIONARY_UTILS_MOD, ONLY: OPTIONS_DICTIONARY_NAME2ITERATOR
  USE :: OPTIONS_DICTIONARY_UTILS_MOD, ONLY: OPTIONS_DICTIONARY_SIZE
...
END MODULE OPTIONS_DICTIONARY_WRAPPER_MOD
