...
PP_THREAD_SAFE FUNCTION MAKE_GRIB2_SECTION4_CFG( GRIB2_SECTION4, DUMMY, &
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_INITIALIZATION_ERROR)  GRIB2_SECTION4%INIT( CFG, OPT, FACTORIES, HOOKS )
...
PP_THREAD_SAFE FUNCTION MAKE_GRIB2_SECTION4_LAZY( GRIB2_SECTION4, DUMMY, &
...
IMPLICIT NONE
  ...
  !> Initialization of the section
  PP_TRYCALL(ERRFLAG_INITIALIZATION_ERROR)  GRIB2_SECTION4%INIT( MSG, PAR, OPT, FACTORIES, HOOKS )
#else
...
PP_THREAD_SAFE FUNCTION DESTROY_GRIB2_SECTION4( GRIB2_SECTION4, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Free the section
  PP_TRYCALL(ERRFLAG_FREE_ERROR)  GRIB2_SECTION4%FREE( OPT, DESTRUCTORS, HOOKS )
