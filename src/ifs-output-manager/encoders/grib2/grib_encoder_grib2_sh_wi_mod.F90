...
SUBROUTINE MAKE_GRIB2_SH_WI_ENCODER( CFG, MODEL_PARAMS, METADATA_KIND, ENCODER )
...
SUBROUTINE ENCODER_GRIB2_SH_WI_INITIALISE( THIS, MODEL_PARAMS, METADATA_KIND )
...
IMPLICIT NONE
  ...
  CALL GRIB_NEW_FROM_SAMPLES( THIS%SAMPLE_HANDLE_, TRIM(ADJUSTL(SAMPLE_NAME_GRIB2_SH_WI)), STATUS=KRET )
