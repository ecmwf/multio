...
SUBROUTINE MAKE_GRIB2_GG_S_ENCODER( CFG, MODEL_PARAMS, METADATA_KIND, ENCODER )
...
SUBROUTINE ENCODER_GRIB2_GG_S_INITIALISE( THIS, MODEL_PARAMS, METADATA_KIND )
...
IMPLICIT NONE
  ...
  CALL GRIB_NEW_FROM_SAMPLES( THIS%SAMPLE_HANDLE_, TRIM(ADJUSTL(SAMPLE_NAME_GRIB2_GG_S)), STATUS=KRET )
...
IMPLICIT NONE
  ...
  ! Metadata initialisation (clone the sample)
  PP_METADATA_INIT_FROM_SAMPLE( METADATA, SAMPLE_NAME_GRIB2_GG_S, THIS%SAMPLE_HANDLE_ )
