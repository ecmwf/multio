...
#define PP_FILE_NAME 'multiom_list_prog.F90'
#define PP_SECTION_TYPE 'PROGRAM'
#define PP_SECTION_NAME 'MULTIOM_LIST_PROG'
#define PP_PROCEDURE_TYPE 'PROGRAM'
#define PP_PROCEDURE_NAME 'MULTIOM_LIST_PROG'
PROGRAM MULTIOM_LIST_PROG
  ...
  USE :: MULTIOM_TOOLS_UTILS_MOD, ONLY: INITIALIZE_TABLE_OF_CONTENTS
  USE :: MULTIOM_TOOLS_UTILS_MOD, ONLY: FINALIZE_TABLE_OF_CONTENTS
  USE :: MULTIOM_TOOLS_UTILS_MOD, ONLY: PRINT_HEADER
  USE :: MULTIOM_TOOLS_UTILS_MOD, ONLY: PRINT_SIMULATION_INIT
  USE :: MULTIOM_TOOLS_UTILS_MOD, ONLY: PRINT_ATM_MESSAGE
  USE :: MULTIOM_TOOLS_UTILS_MOD, ONLY: PRINT_WAM_MESSAGE
  USE :: MULTIOM_TOOLS_UTILS_MOD, ONLY: PRINT_FLUSH
  USE :: MULTIOM_TOOLS_UTILS_MOD, ONLY: PRINT_FLUSH_AND_RESTART
  USE :: MULTIOM_TOOLS_UTILS_MOD, ONLY: PRINT_FLUSH_LAST_STEP
  USE :: MULTIOM_TOOLS_UTILS_MOD, ONLY: PRINT_SIMULATION_END
  USE :: MULTIOM_TOOLS_UTILS_MOD, ONLY: PRINT_FOOTER
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_PRINT_HEADER = 6_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_PRINT_SIMULATION_INIT = 7_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_PRINT_ATM_MESSAGE = 8_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_PRINT_WAM_MESSAGE = 9_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_PRINT_FLUSH = 10_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_PRINT_FLUSH_AND_RESTART = 11_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_PRINT_FLUSH_LAST_STEP = 12_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_PRINT_SIMULATION_END = 13_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNKNOWN_TOC_TYPE = 14_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_PRINT_FOOTER = 15_JPIB_K
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_CHECK_ENDIANNES = 18_JPIB_K
  ...
  IF ( VERBOSE ) THEN
    PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT_CMD_LINE) CMDARGS%PRINT( OUTPUT_UNIT64, HOOKS )
  ENDIF
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_TABLE_OF_CONTENTS) INITIALIZE_TABLE_OF_CONTENTS( CMDARGS, TOC, BIG_ENDIAN_READ, VERBOSE, HOOKS )

  ! Print the header
  PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT_HEADER) PRINT_HEADER( CMDARGS, OUTPUT_UNIT64, BIG_ENDIAN_READ, VERBOSE, HOOKS )
  ...
  FeederLoop: DO TOCID = 1, SIZE(TOC)
    ...
    CLASS IS ( TOC_SIM_INIT_T )
      ...
      PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT_SIMULATION_INIT) PRINT_SIMULATION_INIT( CMDARGS, OUTPUT_UNIT64, TOC_ENTRY, BIG_ENDIAN_READ, VERBOSE, HOOKS )

    CLASS IS ( TOC_ATM_FIELD_T )

      PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT_ATM_MESSAGE) PRINT_ATM_MESSAGE( CMDARGS, OUTPUT_UNIT64, TOC_ENTRY, BIG_ENDIAN_READ, VERBOSE, HOOKS )

    CLASS IS ( TOC_WAM_FIELD_T )

      PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT_WAM_MESSAGE) PRINT_WAM_MESSAGE( CMDARGS, OUTPUT_UNIT64, TOC_ENTRY, BIG_ENDIAN_READ, VERBOSE, HOOKS )

    CLASS IS ( TOC_FLUSH_STEP_T )

      PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT_FLUSH) PRINT_FLUSH( CMDARGS, OUTPUT_UNIT64, TOC_ENTRY, BIG_ENDIAN_READ, VERBOSE, HOOKS )

    CLASS IS ( TOC_FLUSH_STEP_RST_T )

      PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT_FLUSH_AND_RESTART) PRINT_FLUSH_AND_RESTART( CMDARGS, OUTPUT_UNIT64, TOC_ENTRY, BIG_ENDIAN_READ, VERBOSE, HOOKS )

    CLASS IS ( TOC_FLUSH_LAST_STEP_T )

      PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT_FLUSH_LAST_STEP) PRINT_FLUSH_LAST_STEP( CMDARGS, OUTPUT_UNIT64, TOC_ENTRY, BIG_ENDIAN_READ, VERBOSE, HOOKS )

    CLASS IS ( TOC_SIM_END_T )

      PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT_SIMULATION_END) PRINT_SIMULATION_END( CMDARGS, OUTPUT_UNIT64, TOC_ENTRY, BIG_ENDIAN_READ, VERBOSE, HOOKS )
      EXIT FeederLoop
  ...
  ! Print the footer
  PP_TRYCALL(ERRFLAG_UNABLE_TO_PRINT_HEADER) PRINT_FOOTER( CMDARGS, OUTPUT_UNIT64, BIG_ENDIAN_READ, VERBOSE, HOOKS )

  ! Finalize output manager
  PP_TRYCALL(ERRFLAG_UNABLE_TO_DESTROY_TABLE_OF_CONTENTS) FINALIZE_TABLE_OF_CONTENTS( CMDARGS, TOC, BIG_ENDIAN_READ, VERBOSE, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_UNABLE_TO_PRINT_FOOTER)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Error writing the footer' )
    CASE (ERRFLAG_UNABLE_TO_DESTROY_TABLE_OF_CONTENTS)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Error destroying the table of contents' )
