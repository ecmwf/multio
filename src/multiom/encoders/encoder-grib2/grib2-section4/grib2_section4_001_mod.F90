...
CONTAINS
  ...
  !> This procedure allocates the proper time configurator
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_MODEL_CONFIGURATOR_LAZY => G2S4_001_BUILD_MODEL_HANDLER_LAZY
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_001_BUILD_MODEL_HANDLER_CFG'
PP_THREAD_SAFE FUNCTION G2S4_001_BUILD_MODEL_HANDLER_CFG( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_001_BUILD_MODEL_HANDLER_CFG
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_001_BUILD_MODEL_HANDLER_LAZY'
PP_THREAD_SAFE FUNCTION G2S4_001_BUILD_MODEL_HANDLER_LAZY( THIS, &
&               MSG, PAR, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_001_BUILD_MODEL_HANDLER_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
