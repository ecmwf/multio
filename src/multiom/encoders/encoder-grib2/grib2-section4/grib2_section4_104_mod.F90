...
CONTAINS
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_DIRFREQ_CONFIGURATOR => GRIB2_SECTION4_104_BUILD_FREQDIR_HANDLER
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_DIRFREQ_CONFIGURATOR_NOT_ASSOCIATED=9_JPIB_K
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_DIRFREQ_CONFIGURATOR_NOT_ASSOCIATED=4_JPIB_K
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CALL_PRINT_DIRFREQ=9_JPIB_K
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_104_BUILD_FREQDIR_HANDLER'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_104_BUILD_FREQDIR_HANDLER( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_104_BUILD_FREQDIR_HANDLER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
