...
MODULE GRIB2_SECTION4_033_MOD
  ...
  USE :: GRIB2_SECTION4_TIME_INSTANT_MOD, ONLY: GRIB2_SECTION4_TIME_INSTANT_T
...
TYPE, EXTENDS(GRIB_SECTION_BASE_A) :: GRIB2_SECTION4_033_T
  ...
  INTEGER(KIND=JPIB_K) :: TEMPLATE_NUMBER_ = 033_JPIB_K

  !> Time configuration handler (it is not polymorphic because this section is for an instant field)
  TYPE(GRIB2_SECTION4_TIME_INSTANT_T) :: INSTANT_
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_INIT_MODEL_HANDLER=3_JPIB_K
  ...
  THIS%TEMPLATE_NUMBER_ = 33_JPIB_K
  THIS%TYPE_ = 'SECTION'
  THIS%SUBTYPE_ = 'PRODUCT_DEFINITION_SECTION'
  THIS%KIND_   = '4.33'

  ! Initialize tha time handler
  PP_TRYCALL(ERRFLAG_UNABLE_TO_INIT_TIME_HANDLER)  THIS%INSTANT_%INIT( CFG, OPT, HOOKS )
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_BUILD_MODEL_CONFIGURATOR=3_JPIB_K
  ...
  ! Initialize tha time handler
  PP_TRYCALL(ERRFLAG_UNABLE_TO_INIT_TIME_HANDLER) THIS%INSTANT_%INIT( MSG, PAR, OPT, HOOKS )
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_ALLOCATE_MODEL=5_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_ALLOCATE_TIME) THIS%INSTANT_%ALLOCATE( MSG, PAR, OPT, METADATA, HOOKS )
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PRESET_PARAMID=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PRESET_MODEL=4_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PARAMID_CONFIGURATOR_NOT_ASSOCIATED=5_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_MODEL_CONFIGURATOR_NOT_ASSOCIATED=7_JPIB_K
  ...
  ! Allocate time, and paramId subcomponents of the section
  PP_TRYCALL(ERRFLAG_PRESET_TIME) THIS%INSTANT_%PRESET( MSG, PAR, OPT, METADATA, HOOKS )
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_RUNTIME_PARAMID=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_RUNTIME_MODEL=4_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PARAMID_CONFIGURATOR_NOT_ASSOCIATED=6_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_MODEL_CONFIGURATOR_NOT_ASSOCIATED=7_JPIB_K
  ...
  ! Allocate time, and paramId subcomponents of the section
  PP_TRYCALL(ERRFLAG_RUNTIME_TIME) THIS%INSTANT_%RUNTIME( MSG, PAR, TIME_HIST, CURR_TIME, OPT, METADATA, HOOKS )
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TO_BE_ENCODED_PARAMID=2_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TO_BE_ENCODED_MODEL=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PARAMID_CONFIGURATOR_NOT_ASSOCIATED=5_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_TO_BE_ENCODED_TIME) THIS%INSTANT_%TO_BE_ENCODED( MSG, PAR, TIME_HIST, CURR_TIME, OPT, TO_BE_ENCODED_SUBS(1), HOOKS )
  ...
  PP_TRYCALL(ERRFLAG_TO_BE_ENCODED_MODEL) THIS%MODEL_%TO_BE_ENCODED( MSG, PAR, TIME_HIST, CURR_TIME, OPT, TO_BE_ENCODED_SUBS(3), HOOKS )
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CALL_PRINT_MODEL=7_JPIB_K
...
&     '(', TRIM(ADJUSTL(THIS%KIND_)), '){'
  ...
  PP_TRYCALL(ERRFLAG_CALL_PRINT_TIME) THIS%INSTANT_%PRINT( UNIT, OFFSET+2, OPT, HOOKS, ', ...' )
