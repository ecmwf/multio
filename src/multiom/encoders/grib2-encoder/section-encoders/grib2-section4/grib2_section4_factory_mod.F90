...
&               CFG, OPT, HOOKS ) RESULT(RET)
  ...
  USE :: GRIB2_SECTION4_000_MOD,   ONLY: GRIB2_SECTION4_000_T
  USE :: GRIB2_SECTION4_001_MOD,   ONLY: G2S4_001_T
  USE :: GRIB2_SECTION4_008_MOD,   ONLY: GRIB2_SECTION4_008_T
  USE :: GRIB2_SECTION4_011_MOD,   ONLY: GRIB2_SECTION4_011_T
  USE :: GRIB2_SECTION4_032_MOD,   ONLY: GRIB2_SECTION4_032_T
  USE :: GRIB2_SECTION4_033_MOD,   ONLY: GRIB2_SECTION4_033_T
  USE :: GRIB2_SECTION4_040_MOD,   ONLY: GRIB2_SECTION4_040_T
  USE :: GRIB2_SECTION4_041_MOD,   ONLY: G2S4_041_T
  USE :: GRIB2_SECTION4_042_MOD,   ONLY: GRIB2_SECTION4_042_T
  USE :: GRIB2_SECTION4_043_MOD,   ONLY: GRIB2_SECTION4_043_T
  USE :: GRIB2_SECTION4_045_MOD,   ONLY: G2S4_045_T
  USE :: GRIB2_SECTION4_046_MOD,   ONLY: GRIB2_SECTION4_046_T
  USE :: GRIB2_SECTION4_048_MOD,   ONLY: GRIB2_SECTION4_048_T
  USE :: GRIB2_SECTION4_049_MOD,   ONLY: G2S4_049_T
#if 0
  USE :: GRIB2_SECTION4_050_MOD,   ONLY: GRIB2_SECTION4_050_T
#endif
  USE :: GRIB2_SECTION4_060_MOD,   ONLY: G2S4_060_T
  USE :: GRIB2_SECTION4_061_MOD,   ONLY: GRIB2_SECTION4_061_T
#if 0
  USE :: GRIB2_SECTION4_086_MOD,   ONLY: GRIB2_SECTION4_086_T
  USE :: GRIB2_SECTION4_087_MOD,   ONLY: GRIB2_SECTION4_087_T
#endif
  USE :: GRIB2_SECTION4_099_MOD,   ONLY: GRIB2_SECTION4_099_T
  USE :: GRIB2_SECTION4_100_MOD,   ONLY: GRIB2_SECTION4_100_T
  USE :: GRIB2_SECTION4_103_MOD,   ONLY: GRIB2_SECTION4_103_T
  USE :: GRIB2_SECTION4_104_MOD,   ONLY: GRIB2_SECTION4_104_T
#if 0
...
#endif
  USE :: GRIB2_SECTION4_143_MOD,   ONLY: G2S4_143_T
...
IMPLICIT NONE
  ...
  CASE (0)
    ...
    ALLOCATE( GRIB2_SECTION4_000_T::GRIB2_SECTION4, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )

  CASE (1)

    ALLOCATE( G2S4_001_T::GRIB2_SECTION4, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )

  CASE (8)

    ALLOCATE( GRIB2_SECTION4_008_T::GRIB2_SECTION4, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )

  CASE (11)

    ALLOCATE( GRIB2_SECTION4_011_T::GRIB2_SECTION4, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )

  CASE (32)

    ALLOCATE( GRIB2_SECTION4_032_T::GRIB2_SECTION4, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )

  CASE (33)

    ALLOCATE( GRIB2_SECTION4_033_T::GRIB2_SECTION4, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )

  CASE (40)

    ALLOCATE( GRIB2_SECTION4_040_T::GRIB2_SECTION4, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )

  CASE (41)

    ALLOCATE( G2S4_041_T::GRIB2_SECTION4, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )

  CASE (42)

    ALLOCATE( GRIB2_SECTION4_042_T::GRIB2_SECTION4, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )

  CASE (43)

    ALLOCATE( GRIB2_SECTION4_043_T::GRIB2_SECTION4, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )

  CASE (45)

    ALLOCATE( G2S4_045_T::GRIB2_SECTION4, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )
  ...
  CASE (49)
    ...
    ALLOCATE( G2S4_049_T::GRIB2_SECTION4, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )
  ...
  CASE (60)
    ...
    ALLOCATE( G2S4_060_T::GRIB2_SECTION4, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )

  CASE (61)

    ALLOCATE( GRIB2_SECTION4_061_T::GRIB2_SECTION4, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )
  ...
  CASE (99)
    ...
    ALLOCATE( GRIB2_SECTION4_099_T::GRIB2_SECTION4, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )

  CASE (100)

    ALLOCATE( GRIB2_SECTION4_100_T::GRIB2_SECTION4, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )
  CASE (103)

    ALLOCATE( GRIB2_SECTION4_103_T::GRIB2_SECTION4, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )

  CASE (104)

    ALLOCATE( GRIB2_SECTION4_104_T::GRIB2_SECTION4, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )
  ...
  CASE (143)
    ...
    ALLOCATE( G2S4_143_T::GRIB2_SECTION4, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )
