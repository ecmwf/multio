...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_INIT_RANDOM_PATTERNS_HANDLER) THIS%BUILD_RANDOM_PATTERNS_CONFIGURATOR_CFG( CFG, OPT, FACTORIES, HOOKS )
...
&  THIS%LEVEL_, THIS%TEMPLATE_NUMBER_, MSG, PAR, OPT, FACTORIES, HOOKS )
  ...
  ! Build the level configurator
  PP_TRYCALL(ERRFLAG_UNABLE_TO_BUILD_RANDOM_PATTERNS_CONFIGURATOR) FACTORIES%MAKE_GRIB2_RANDOM_PATTERNS_CONFIGURATOR_LAZY( &
&  THIS%LEVEL_, THIS%TEMPLATE_NUMBER_, MSG, PAR, OPT, FACTORIES, HOOKS )
...
IMPLICIT NONE
  ...
  !> Make the indicator-section
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_RANDOM_PATTERNS_CONFIGURATOR) FACTORIES%MAKE_GRIB2_RANDOM_PATTERNS_CONFIGURATOR_CFG( &
&    THIS%RANDOM_PATTERNS_, THIS%TEMPLATE_NUMBER_, RANDOM_PATTERNS_CONFIGURATOR_CFG, OPT, FACTORIES, HOOKS )
