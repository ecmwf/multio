...
CONTAINS
  ...
  PROCEDURE, PASS, PUBLIC, NON_OVERRIDABLE :: INIT => RAW_RULES_LIST_INIT
  ...
  !> Convert the list of rules to JSON format
  PROCEDURE, PASS, PUBLIC, NON_OVERRIDABLE :: TO_JSON => RAW_RULES_LIST_TO_JSON
