...
FUNCTION WAVE_PAR_FREE( WAVE_PAR, HOOKS ) RESULT(RET)
...
FUNCTION WAVE_PAR_COPY_FROM( WAVE_PAR_TO, WAVE_PAR_FROM, HOOKS ) RESULT(RET)
...
FUNCTION READ_WAVE_PAR_FROM_YAML( WAVE_PAR, CONFIG, HOOKS ) RESULT(RET)
