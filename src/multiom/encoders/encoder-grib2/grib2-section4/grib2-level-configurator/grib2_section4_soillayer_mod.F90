...
IMPLICIT NONE
  ...
  PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'typeOfLevel', 'soilLayer' )
  ...
  ! ELSE
  !   PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'TypeOfFirstFixedSurface', 151_JPIB_K )
  !   PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'TypeOfSecondFixedSurface', 151_JPIB_K )
  !   ! TODO PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'ScaledValueOfFirstFixedSurface', soil level)
  !   ! TODO PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'ScaledValueOfSecondFixedSurface', soil level)
  !   ! TODO PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'ScaleFactorOfFirstFixedSurface', soil level)
