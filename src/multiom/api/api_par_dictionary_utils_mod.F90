...
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_LAPLACIAN_SCALING_FACTOR = 18_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_PERIOD_MIN  = 19_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_PERIOD_MAX = 20_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_DIR = 21_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_FREQ = 22_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_SATELLITE_SERIES = 23_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_SCALED_FACTOR_OF_CENTRAL_WAVE_NUMBER = 24_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_SCALED_VALUE_OF_CENTRAL_WAVE_NUMBER = 25_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_GEOMETRY = 26_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: PAR_ITERATOR_UNDEF = 27_JPIB_K
...
PUBLIC :: PAR_DICTIONARY_SET_VALUE_FROM_INT64
PUBLIC :: PAR_DICTIONARY_SET_VALUE_FROM_REAL64
PUBLIC :: PAR_DICTIONARY_SET_VALUE_FROM_INT64_ARRAY
PUBLIC :: PAR_DICTIONARY_SET_VALUE_FROM_REAL64_ARRAY

! General utils
PUBLIC :: PAR_DICTIONARY_IS_ALLOWED
PUBLIC :: PAR_DICTIONARY_HAS
PUBLIC :: PAR_DICTIONARY_RANK
PUBLIC :: PAR_DICTIONARY_SIZE
...
IMPLICIT NONE
  ...
  CASE ( 'laplacianscalingfactor', 'laplacian-scaling-factor' )
    ITERATOR = PAR_ITERATOR_BITS_PER_VALUE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PAR_DICTIONARY_IS_ALLOWED'
PP_THREAD_SAFE FUNCTION PAR_DICTIONARY_IS_ALLOWED( PAR_DICTIONARY, KEY, IS_ALLOWED, HOOKS ) RESULT(RET)
...
END FUNCTION PAR_DICTIONARY_IS_ALLOWED
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
IMPLICIT NONE
  ...
  CASE (PAR_ITERATOR_BITS_PER_VALUE)
    IF ( PAR_DICTIONARY%DATA_REPRESENTATION%BITS_PER_VALUE_  .NE. UNDEF_PARAM_E ) THEN
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    ENDIF
  ...
  CASE (PAR_ITERATOR_LAPLACIAN_SCALING_FACTOR)
    IF ( PAR_DICTIONARY%DATA_REPRESENTATION%LAPLACIAN_SCALE_FACTOR_  .NE. UNDEF_PARAM_E ) THEN
      HAS = .TRUE.
    ELSE
      HAS = .FALSE.
    ENDIF
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PAR_DICTIONARY_RANK'
PP_THREAD_SAFE FUNCTION PAR_DICTIONARY_RANK( PAR_DICTIONARY, ITERATOR, RANK, HOOKS ) RESULT(RET)
...
END FUNCTION PAR_DICTIONARY_RANK
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PAR_DICTIONARY_SIZE'
PP_THREAD_SAFE FUNCTION PAR_DICTIONARY_SIZE( PAR_DICTIONARY, ITERATOR, SZ, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Local error flags
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_NO_PAR_KEY=1_JPIB_K
  ...
  CASE (PAR_ITERATOR_PV)
    IF ( ASSOCIATED(PAR_DICTIONARY%LEVELS%PV)  ) THEN
      SZ = SIZE(PAR_DICTIONARY%LEVELS%PV)
    ELSE
      PP_DEBUG_CRITICAL_THROW( ERRFLAG_NOT_ASSOCIATED )
    ENDIF
  ...
  CASE (PAR_ITERATOR_DIR)
    IF ( ASSOCIATED(PAR_DICTIONARY%WAVE%DIRS_)  ) THEN
      SZ = SIZE(PAR_DICTIONARY%WAVE%DIRS_)
    ELSE
      PP_DEBUG_CRITICAL_THROW( ERRFLAG_NOT_ASSOCIATED )
    ENDIF
  ...
  CASE (PAR_ITERATOR_FREQ)
    IF ( ASSOCIATED(PAR_DICTIONARY%WAVE%FREQ_)  ) THEN
      SZ = SIZE(PAR_DICTIONARY%WAVE%FREQ_)
    ELSE
      PP_DEBUG_CRITICAL_THROW( ERRFLAG_NOT_ASSOCIATED )
    ENDIF
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE(ERRFLAG_NOT_ASSOCIATED)
      CIT=REPEAT(' ',32)
      WRITE(CIT,'(I32)') ITERATOR
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unable to get the size of the iterator' )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Iterator value is: '//TRIM(ADJUSTL(CIT)) )
    CASE(ERRFLAG_NO_PAR_KEY)
      CIT=REPEAT(' ',32)
      WRITE(CIT,'(I32)') ITERATOR
...
END FUNCTION PAR_DICTIONARY_SIZE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
IMPLICIT NONE
  ...
  CASE (PAR_ITERATOR_LAPLACIAN_SCALING_FACTOR)
    PP_TRYCALL(ERRFLAG_CONVERT_ENUM_STRING) CONVERT_TO_C_STRING( PAR_DICTIONARY%DATA_REPRESENTATION%LAPLACIAN_SCALE_FACTOR_, VALUE, HOOKS )
    HAS = .TRUE.
...
IMPLICIT NONE
  ...
  CASE (PAR_ITERATOR_PV)
    ...
    IF ( ASSOCIATED(PAR_DICTIONARY%LEVELS%PV) ) THEN
        DEALLOCATE(PAR_DICTIONARY%LEVELS%PV, STAT=DEALLOC_STATUS, ERRMSG=ERRMSG)
  ...
  CASE (PAR_ITERATOR_LAPLACIAN_SCALING_FACTOR)
    PP_TRYCALL(ERRFLAG_CONVERT_PAR_TO_ENUM) CINT2IINT(VALUE, ITEMP, HOOKS)
    PAR_DICTIONARY%DATA_REPRESENTATION%LAPLACIAN_SCALE_FACTOR_ = ITEMP
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PAR_DICTIONARY_SET_VALUE_FROM_INT64'
PP_THREAD_SAFE FUNCTION PAR_DICTIONARY_SET_VALUE_FROM_INT64( PAR_DICTIONARY, ITERATOR, VALUE, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  CASE (PAR_ITERATOR_TABLES_VERSION)
    PAR_DICTIONARY%TABLES_VERSION=VALUE

  CASE (PAR_ITERATOR_GENERATING_PROCESS_IDENTIFIER)
    PAR_DICTIONARY%GENERATING_PROCESS_IDENTIFIER=VALUE

  CASE (PAR_ITERATOR_TYPE_OF_PROCESSED_DATA)
    PAR_DICTIONARY%TYPE_OF_PROCESSED_DATA=VALUE

  CASE (PAR_ITERATOR_ENCODE_STEP_ZERO)
    PAR_DICTIONARY%ENCODE_STEP_ZERO=VALUE

  CASE (PAR_ITERATOR_INITIAL_STEP)
    PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_PAR) PAR_DICTIONARY%TIME%SET_INITIAL_STEP(VALUE, HOOKS)

  CASE (PAR_ITERATOR_LENGTH_OF_TIME_STEP)
    PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_PAR) PAR_DICTIONARY%TIME%SET_LENGTH_OF_TIME_STEP_IN_SECONDS(VALUE, HOOKS)

  CASE (PAR_ITERATOR_LENGTH_OF_TIME_RANGE)
    PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_PAR) PAR_DICTIONARY%TIME%SET_LENGTH_OF_TIME_RANGE_IN_SECONDS(VALUE, HOOKS)

  CASE (PAR_ITERATOR_NUMBER_OF_MISSING_VALUES)
    PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_PAR) PAR_DICTIONARY%BITMAP%SET_NUMBER_OF_MISSING_VALUES(VALUE, HOOKS)

  CASE (PAR_ITERATOR_SYSTEM_NUMBER)
    PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_PAR) PAR_DICTIONARY%ENSEMBLE%SET_SYSTEM_NUMBER(VALUE, HOOKS)

  CASE (PAR_ITERATOR_METHOD_NUMBER)
    PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_PAR) PAR_DICTIONARY%ENSEMBLE%SET_METHOD_NUMBER(VALUE, HOOKS)

  CASE (PAR_ITERATOR_TYPE_OF_ENSEMBLE_FORECAST)
    PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_PAR) PAR_DICTIONARY%ENSEMBLE%SET_TYPE_OF_ENSEMBLE_FORECAST(VALUE, HOOKS)

  CASE (PAR_ITERATOR_NUMBER_OF_FORECASTS_IN_ENSEMBLE)
    PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_PAR) PAR_DICTIONARY%ENSEMBLE%SET_NUMBER_OF_FORECASTS_IN_ENSEMBLE(VALUE, HOOKS)

  CASE (PAR_ITERATOR_LENGTH_OF_TIME_WINDOW)
    PAR_DICTIONARY%ANALYSIS%LENGTH_OF_TIME_WINDOW_ = VALUE

  CASE (PAR_ITERATOR_BITS_PER_VALUE)
    PAR_DICTIONARY%DATA_REPRESENTATION%BITS_PER_VALUE_ = VALUE

  CASE (PAR_ITERATOR_LAPLACIAN_SCALING_FACTOR)
    PAR_DICTIONARY%DATA_REPRESENTATION%LAPLACIAN_SCALE_FACTOR_ = VALUE

  CASE (PAR_ITERATOR_PERIOD_MIN)
    PAR_DICTIONARY%WAVE%ITMIN = VALUE

  CASE (PAR_ITERATOR_PERIOD_MAX)
    PAR_DICTIONARY%WAVE%ITMAX = VALUE

  CASE (PAR_ITERATOR_SATELLITE_SERIES)
    PAR_DICTIONARY%SATELLITE%SATELLITE_SERIES = VALUE

  CASE (PAR_ITERATOR_SCALED_FACTOR_OF_CENTRAL_WAVE_NUMBER)
    PAR_DICTIONARY%SATELLITE%SCALED_FACTOR_OF_CENTRAL_VAWENUMBER = VALUE

  CASE (PAR_ITERATOR_SCALED_VALUE_OF_CENTRAL_WAVE_NUMBER)
    PAR_DICTIONARY%SATELLITE%SCALED_VALUE_OF_CENTRAL_VAWENUMBER = VALUE
...
END FUNCTION PAR_DICTIONARY_SET_VALUE_FROM_INT64
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PAR_DICTIONARY_SET_VALUE_FROM_REAL64'
PP_THREAD_SAFE FUNCTION PAR_DICTIONARY_SET_VALUE_FROM_REAL64( PAR_DICTIONARY, ITERATOR, VALUE, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  CASE (PAR_ITERATOR_VALUES_SCALE_FACTOR)
    PAR_DICTIONARY%VALUES_SCALE_FACTOR=VALUE

  CASE (PAR_ITERATOR_VALUE_OF_MISSING_VALUES)
    PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_PAR) PAR_DICTIONARY%BITMAP%SET_VALUE_OF_MISSING_VALUES(VALUE, HOOKS)
...
END FUNCTION PAR_DICTIONARY_SET_VALUE_FROM_REAL64
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PAR_DICTIONARY_SET_VALUE_FROM_INT64_ARRAY'
PP_THREAD_SAFE FUNCTION PAR_DICTIONARY_SET_VALUE_FROM_INT64_ARRAY( PAR_DICTIONARY, ITERATOR, VALUE, HOOKS ) RESULT(RET)
...
END FUNCTION PAR_DICTIONARY_SET_VALUE_FROM_INT64_ARRAY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'PAR_DICTIONARY_SET_VALUE_FROM_REAL64_ARRAY'
PP_THREAD_SAFE FUNCTION PAR_DICTIONARY_SET_VALUE_FROM_REAL64_ARRAY( PAR_DICTIONARY, ITERATOR, VALUE, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  CASE (PAR_ITERATOR_PV)
    ...
    IF ( ASSOCIATED(PAR_DICTIONARY%LEVELS%PV) ) THEN
      DEALLOCATE(PAR_DICTIONARY%LEVELS%PV, STAT=DEALLOC_STATUS, ERRMSG=ERRMSG)
      NULLIFY(PAR_DICTIONARY%LEVELS%PV)
      PP_DEBUG_CRITICAL_COND_THROW( DEALLOC_STATUS.NE.0, ERRFLAG_DEALLOC_FAILURE )
    ENDIF

    ALLOCATE( PAR_DICTIONARY%LEVELS%PV(SIZE(VALUE) ), STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS .NE. 0, ERRFLAG_ALLOC_FAILURE )
    DO ITEMP = 1, SIZE(VALUE)
        PAR_DICTIONARY%LEVELS%PV(ITEMP) = VALUE(ITEMP)
    END DO
    PAR_DICTIONARY%LEVELS%TO_BE_DEALLOCATED=.TRUE.
  ...
  CASE (PAR_ITERATOR_DIR)
    ...
    ALLOCATE( PAR_DICTIONARY%WAVE%DIRS_(SIZE(VALUE) ), STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS .NE. 0, ERRFLAG_ALLOC_FAILURE )
    DO ITEMP = 1, SIZE(VALUE)
        PAR_DICTIONARY%WAVE%DIRS_(ITEMP) = VALUE(ITEMP)
    END DO
    PAR_DICTIONARY%LEVELS%TO_BE_DEALLOCATED=.TRUE.
  ...
  CASE (PAR_ITERATOR_FREQ)
    ...
    ALLOCATE( PAR_DICTIONARY%WAVE%FREQ_(SIZE(VALUE) ), STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS .NE. 0, ERRFLAG_ALLOC_FAILURE )
    DO ITEMP = 1, SIZE(VALUE)
        PAR_DICTIONARY%WAVE%FREQ_(ITEMP) = VALUE(ITEMP)
    END DO
    PAR_DICTIONARY%LEVELS%TO_BE_DEALLOCATED=.TRUE.
...
END FUNCTION PAR_DICTIONARY_SET_VALUE_FROM_REAL64_ARRAY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
