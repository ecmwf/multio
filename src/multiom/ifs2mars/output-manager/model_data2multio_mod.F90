...
#define PP_FILE_NAME 'model_data2multio_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'MODEL_DATA2MULTIO_MOD'
MODULE MODEL_DATA2MULTIO_MOD
...
!> Output manager name
CHARACTER(LEN=*), PARAMETER :: MODEL_DATA2MULTIO_OMNAME='MODEL-DATA-TO-MULTIO'

!>
!> @brief Definition of the `MODEL_DATA2MULTIO_OUTPUT_MANAGER_T` derived type.
!>
!> The `MODEL_DATA2MULTIO_OUTPUT_MANAGER_T` type is a derived type that extends the
...
!>
TYPE, EXTENDS(OUTPUT_MANAGER_BASE_A) :: MODEL_DATA2MULTIO_OUTPUT_MANAGER_T
...
CONTAINS
  ...
  PROCEDURE, NON_OVERRIDABLE, PASS, PUBLIC :: SETUP => MODEL_DATA2MULTIO_SETUP

  !> @brief Write fields for the output manager
  PROCEDURE, NON_OVERRIDABLE, PASS, PUBLIC :: WRITE_ATM_DP => MODEL_DATA2MULTIO_WRITE_ATM_DP
  PROCEDURE, NON_OVERRIDABLE, PASS, PUBLIC :: WRITE_ATM_SP => MODEL_DATA2MULTIO_WRITE_ATM_SP
  PROCEDURE, NON_OVERRIDABLE, PASS, PUBLIC :: WRITE_WAM_DP => MODEL_DATA2MULTIO_WRITE_WAM_DP
  PROCEDURE, NON_OVERRIDABLE, PASS, PUBLIC :: WRITE_WAM_SP => MODEL_DATA2MULTIO_WRITE_WAM_SP

  !> @brief Notify that a step is finished
  PROCEDURE, NON_OVERRIDABLE, PASS, PUBLIC :: FLUSH_STEP => MODEL_DATA2MULTIO_FLUSH_STEP

  !> @brief Notify that a step is finished and it was the last step
  PROCEDURE, NON_OVERRIDABLE, PASS, PUBLIC :: FLUSH_LAST_STEP => MODEL_DATA2MULTIO_FLUSH_LAST_STEP

  !> @brief Notify that a step is finished and it is necessary to dump a restart
  PROCEDURE, NON_OVERRIDABLE, PASS, PUBLIC :: FLUSH_STEP_AND_TRIGGER_RESTART => MODEL_DATA2MULTIO_FLUSH_STEP_AND_TRIGGER_RESTART

  !> @brief Finalise ancd cleanup teh output manager
  PROCEDURE, NON_OVERRIDABLE, PASS, PUBLIC :: FINALISE => MODEL_DATA2MULTIO_FINALISE


  !> @brief Read the configuration from YAML using fckit
  PROCEDURE, NON_OVERRIDABLE, PASS, PRIVATE :: READ_CFG_FROM_YAML => MODEL_DATA2MULTIO_READ_CFG_FROM_YAML

  PROCEDURE, NON_OVERRIDABLE, PASS, PRIVATE :: READ_LOG_PATH_FROM_YAML => MODEL_DATA2MULTIO_READ_LOG_PATH_FROM_YAML
  PROCEDURE, NON_OVERRIDABLE, PASS, PRIVATE :: READ_MULTIO_PLANS_FILE_FROM_YAML => MODEL_DATA2MULTIO_READ_MULTIO_PLANS_FILE_FROM_YAML

  PROCEDURE, NON_OVERRIDABLE, PASS, PRIVATE :: READ_VERBOSE_FROM_YAML => MODEL_DATA2MULTIO_READ_VERBOSE_FROM_YAML
  PROCEDURE, NON_OVERRIDABLE, PASS, PRIVATE :: READ_PROFILE_FROM_YAML => MODEL_DATA2MULTIO_READ_PROFILE_FROM_YAML
  PROCEDURE, NON_OVERRIDABLE, PASS, PRIVATE :: READ_REPORT_FROM_YAML => MODEL_DATA2MULTIO_READ_SAVE_REPORT_FROM_YAML
  PROCEDURE, NON_OVERRIDABLE, PASS, PRIVATE :: INIT_GEOMETRY_MAP => MODEL_DATA2MULTIO_INIT_GEOMETRY_MAP

  !> @brief Extract mar dictionary and context/parametrization from the ifs data-structures
  PROCEDURE, NON_OVERRIDABLE, PASS, PRIVATE :: GET_MARS_FROM_ATM => MODEL_DATA2MULTIO_GET_MARS_FROM_ATM
  PROCEDURE, NON_OVERRIDABLE, PASS, PRIVATE :: GET_MARS_FROM_WAM => MODEL_DATA2MULTIO_GET_MARS_FROM_WAM

  END TYPE

  ! Whitelist of public symbols
  PUBLIC :: MODEL_DATA2MULTIO_OUTPUT_MANAGER_T
  PUBLIC :: MODEL_DATA2MULTIO_OMNAME

CONTAINS


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'MODEL_DATA2MULTIO_READ_CFG_FROM_YAML'
PP_THREAD_SAFE FUNCTION MODEL_DATA2MULTIO_READ_CFG_FROM_YAML( THIS, CFG, HOOKS ) RESULT(RET)
  ...
  USE :: MULTIO_UTILS_MOD,    ONLY: MULTIO_SEND_PARAMETRISATION
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  CLASS(MODEL_DATA2MULTIO_OUTPUT_MANAGER_T), INTENT(INOUT) :: THIS
  ...
  ! Local variables
  TYPE(YAML_CONFIGURATION_T) :: MODEL_DATA2MULTIO_CFG
  CHARACTER(LEN=LEN(MODEL_DATA2MULTIO_OMNAME)) :: MODEL_DATA2MULTIO_OMNAME_LC
  LOGICAL :: HAS_KEY
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_DESTROY_CFG=17_JPIB_K
  ...
  MODEL_DATA2MULTIO_OMNAME_LC = REPEAT(' ',LEN(MODEL_DATA2MULTIO_OMNAME_LC))
  PP_TRYCALL(ERRFLAG_UNABLE_TO_CONVERT_TO_LOWER) TOLOWER( MODEL_DATA2MULTIO_OMNAME, MODEL_DATA2MULTIO_OMNAME_LC, HOOKS )

  ! Get sub-configuration from input file
  PP_TRYCALL(ERRFLAG_HAS_KEY) YAML_CONFIGURATION_HAS_KEY( CFG, MODEL_DATA2MULTIO_OMNAME_LC, HAS_KEY, HOOKS )
  PP_DEBUG_CRITICAL_COND_THROW( .NOT.HAS_KEY, ERRFLAG_HAS_KEY )

  ! Get the specific sub-configuration
  PP_TRYCALL(ERRFLAG_GET_SUBCFG) YAML_GET_SUBCONFIGURATION( CFG, MODEL_DATA2MULTIO_OMNAME_LC, MODEL_DATA2MULTIO_CFG, HOOKS )

  ! Read options from configuration file
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_LOG_PATH) THIS%READ_LOG_PATH_FROM_YAML( MODEL_DATA2MULTIO_CFG, HOOKS )

  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_MULTIO_PLANS_FILE) THIS%READ_MULTIO_PLANS_FILE_FROM_YAML( MODEL_DATA2MULTIO_CFG, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_VERBOSE) THIS%READ_VERBOSE_FROM_YAML( MODEL_DATA2MULTIO_CFG, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_PROFILE) THIS%READ_PROFILE_FROM_YAML( MODEL_DATA2MULTIO_CFG, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_REPORT) THIS%READ_REPORT_FROM_YAML( MODEL_DATA2MULTIO_CFG, HOOKS )

  ! Deallocate the dump-output-manager object
  PP_TRYCALL(ERRFLAG_UNABLE_TO_DESTROY_CFG) YAML_DELETE_CONFIGURATION( MODEL_DATA2MULTIO_CFG, HOOKS )
...
END FUNCTION MODEL_DATA2MULTIO_READ_CFG_FROM_YAML
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'MODEL_DATA2MULTIO_READ_MULTIO_PLANS_FILE_FROM_YAML'
PP_THREAD_SAFE FUNCTION MODEL_DATA2MULTIO_READ_MULTIO_PLANS_FILE_FROM_YAML( THIS, CFG, HOOKS ) RESULT(RET)
...
END FUNCTION MODEL_DATA2MULTIO_READ_MULTIO_PLANS_FILE_FROM_YAML
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'MODEL_DATA2MULTIO_READ_LOG_PATH_FROM_YAML'
PP_THREAD_SAFE FUNCTION MODEL_DATA2MULTIO_READ_LOG_PATH_FROM_YAML( THIS, CFG, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_NOT_ALLOCATED_AFTER_READ=4_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TOO_LONG=5_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PATH_DONT_EXIST=6_JPIB_K
  ...
  IF ( HAS_KEY ) THEN
    ...
    PP_TRYCALL(ERRFLAG_PATH_DONT_EXIST) IS_DIRECTORY( THIS%LOG_PATH_, IS_DIR, HOOKS )
    PP_DEBUG_CRITICAL_COND_THROW( .NOT.IS_DIR, ERRFLAG_PATH_DONT_EXIST )
    IF ( ALLOCATED(LOG_PATH) ) THEN
      DEALLOCATE( LOG_PATH, STAT=STAT )
    ENDIF
  ELSE
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_TOO_LONG)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'The string is too long' )
    CASE (ERRFLAG_PATH_DONT_EXIST)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'The path does not exist' )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Path: "'//TRIM(ADJUSTL(THIS%LOG_PATH_))//'"' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unhandled error' )
    END SELECT
...
END FUNCTION MODEL_DATA2MULTIO_READ_LOG_PATH_FROM_YAML
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'MODEL_DATA2MULTIO_READ_VERBOSE_FROM_YAML'
PP_THREAD_SAFE FUNCTION MODEL_DATA2MULTIO_READ_VERBOSE_FROM_YAML( THIS, CFG, HOOKS ) RESULT(RET)
...
END FUNCTION MODEL_DATA2MULTIO_READ_VERBOSE_FROM_YAML
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'MODEL_DATA2MULTIO_READ_PROFILE_FROM_YAML'
PP_THREAD_SAFE FUNCTION MODEL_DATA2MULTIO_READ_PROFILE_FROM_YAML( THIS, CFG, HOOKS ) RESULT(RET)
...
END FUNCTION MODEL_DATA2MULTIO_READ_PROFILE_FROM_YAML
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE

#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'MODEL_DATA2MULTIO_READ_SAVE_REPORT_FROM_YAML'
PP_THREAD_SAFE FUNCTION MODEL_DATA2MULTIO_READ_SAVE_REPORT_FROM_YAML( THIS, CFG, HOOKS ) RESULT(RET)
...
END FUNCTION MODEL_DATA2MULTIO_READ_SAVE_REPORT_FROM_YAML
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'MODEL_DATA2MULTIO_INIT_GEOMETRY_MAP'
PP_THREAD_SAFE FUNCTION MODEL_DATA2MULTIO_INIT_GEOMETRY_MAP( THIS, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNEXPECTED_CLASS=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_PUSH_TO_REPRESENTATION_MAP=4_JPIB_K
...
END FUNCTION MODEL_DATA2MULTIO_INIT_GEOMETRY_MAP
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'MODEL_DATA2MULTIO_GET_MARS_FROM_ATM'
PP_THREAD_SAFE FUNCTION MODEL_DATA2MULTIO_GET_MARS_FROM_ATM( THIS, YDMSG, MSG, PAR, IS_VALID, HOOKS ) RESULT(RET)
  ...
  USE :: IFS2MARS_MOD,        ONLY: IFS2MARS_SET_SYSTEM_METHOD
  USE :: IFS2MARS_MOD,        ONLY: ATM2MARS_SET_SATELLITE
  ...
  USE :: IFS2MARS_MOD,        ONLY: IFS2MARS_SET_MODEL
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_SET_MODEL=16_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_SET_SATELLITE=17_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_MODEL) IFS2MARS_SET_IDENTIFICATION( YDMSG, THIS%MODEL_PAR_, MSG, PAR, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_IDENTIFICATION) IFS2MARS_SET_MODEL( YDMSG, THIS%MODEL_PAR_, MSG, PAR, HOOKS )
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_ENSEMBLE) IFS2MARS_SET_SYSTEM_METHOD( YDMSG, THIS%MODEL_PAR_, MSG, PAR, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_SATELLITE) ATM2MARS_SET_SATELLITE( YDMSG, THIS%MODEL_PAR_, MSG, PAR, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_PARAM)    ATM2MARS_SET_PARAM   ( YDMSG, THIS%MODEL_PAR_, MSG, PAR, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_DATETIME) IFS2MARS_SET_DATETIME( YDMSG, THIS%MODEL_PAR_, MSG, PAR, HOOKS, IS_VALID )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_UNABLE_TO_SET_MODEL)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unable to set the model' )
    CASE (ERRFLAG_UNABLE_TO_SET_SATELLITE)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unable to set satellite keys (channel, ident, instrument)' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unhandled error' )
    END SELECT
...
END FUNCTION MODEL_DATA2MULTIO_GET_MARS_FROM_ATM
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'MODEL_DATA2MULTIO_GET_MARS_FROM_WAM'
PP_THREAD_SAFE FUNCTION MODEL_DATA2MULTIO_GET_MARS_FROM_WAM( THIS, YDMSG, MSG, PAR, IS_VALID, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Bad hack to fix wam messages with ISTEP=1 instead of 0
  YDMSG_HACK = YDMSG
  IF ( YDMSG_HACK%ISTEP_ .EQ. 1_JPIB_K ) THEN
    YDMSG_HACK%ISTEP_ = 0_JPIB_K
  ENDIF

  ! Extract mars and context from message and parametrization
  PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_IDENTIFICATION) IFS2MARS_SET_IDENTIFICATION( YDMSG_HACK, THIS%MODEL_PAR_, MSG, PAR, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_MODEL)          IFS2MARS_SET_MODEL( YDMSG_HACK, THIS%MODEL_PAR_, MSG, PAR, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_ORIGIN)         IFS2MARS_SET_ORIGIN  ( YDMSG_HACK, THIS%MODEL_PAR_, MSG, PAR, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_STREAM)         IFS2MARS_SET_STREAM  ( YDMSG_HACK, THIS%MODEL_PAR_, MSG, PAR, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_TYPE)           IFS2MARS_SET_TYPE    ( YDMSG_HACK, THIS%MODEL_PAR_, MSG, PAR, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_CLASS)          IFS2MARS_SET_CLASS   ( YDMSG_HACK, THIS%MODEL_PAR_, MSG, PAR, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_EXPVER)         IFS2MARS_SET_EXPVER  ( YDMSG_HACK, THIS%MODEL_PAR_, MSG, PAR, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_PACKING)        IFS2MARS_SET_PACKING ( YDMSG_HACK, THIS%MODEL_PAR_, MSG, PAR, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_ANALYSIS)       IFS2MARS_SET_ANALYSIS( YDMSG_HACK, THIS%MODEL_PAR_, MSG, PAR, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_ENSEMBLE)       IFS2MARS_SET_ENSEMBLE( YDMSG_HACK, THIS%MODEL_PAR_, MSG, PAR, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_ENSEMBLE) IFS2MARS_SET_SYSTEM_METHOD( YDMSG_HACK, THIS%MODEL_PAR_, MSG, PAR, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_PARAM)          WAM2MARS_SET_PARAM   ( YDMSG_HACK, THIS%MODEL_PAR_, MSG, PAR, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_DIRFREQ)        WAM2MARS_SET_DIRFREQ ( YDMSG_HACK, THIS%MODEL_PAR_, MSG, PAR, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_DATETIME)       IFS2MARS_SET_DATETIME( YDMSG_HACK, THIS%MODEL_PAR_, MSG, PAR, HOOKS, IS_VALID )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_TABLES_VERSION) IFS2MARS_SET_TABLES_VERSION( YDMSG_HACK, THIS%MODEL_PAR_, MSG, PAR, HOOKS )


  SELECT CASE (YDMSG_HACK%IREPRES_)

  CASE (REPRES_GAUSSIANGRID_E)
    PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_GEOMETRY) IFS2MARS_SET_GEOMETRY( YDMSG_HACK, THIS%MODEL_PAR_, &
&    THIS%GG_NAME, THIS%REPRES_GG_, &
&    MSG, PAR, HOOKS )
  CASE (REPRES_SPHERICALHARMONICS_E)
    PP_TRYCALL(ERRFLAG_UNABLE_TO_SET_GEOMETRY) IFS2MARS_SET_GEOMETRY( YDMSG_HACK, THIS%MODEL_PAR_, &
...
END FUNCTION MODEL_DATA2MULTIO_GET_MARS_FROM_WAM
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'MODEL_DATA2MULTIO_SETUP'
PP_THREAD_SAFE FUNCTION MODEL_DATA2MULTIO_SETUP( THIS, YAMLFNAME, PROCESSOR_TOPO, MODEL_PARAMS, HOOKS ) RESULT(RET)
  ...
  USE :: MULTIO_UTILS_MOD,    ONLY: MULTIO_NEW_FROM_FILE
  USE :: MULTIO_UTILS_MOD,    ONLY: MULTIO_SEND_PARAMETRISATION
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_OPEN_GRIB_FILE=34_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_SEND_PARAMETRIZATION=35_JPIB_K
...
&                                                       PROCESSOR_TOPO%MYPROC_IO, THIS%TID_, HOOKS )
  ...
  ! Initialize multio
  KRET = MULTIO_INITIALISE()

  ! Initialize multio with specific plan file
  PP_TRYCALL(ERRFLAG_UNABLE_TO_CREATE_MULTIO_HANDLE) MULTIO_NEW_FROM_FILE( THIS%MIO_, TRIM(ADJUSTL(THIS%MULTIO_PLANS_FILE_)), HOOKS )
  ...
  IF ( THIS%VERBOSE_ ) THEN
    ...
    WRITE(THIS%LOG_FNAME_,'(A,I8.8,A)', IOSTAT=STAT) TRIM(ADJUSTL(MODEL_DATA2MULTIO_OMNAME_LC))//'-output-manager-', PROCESSOR_TOPO%MYPROC_IO, '.log'
    ...
    PP_TRYCALL(ERRFLAG_UNABLE_TO_LOG_CURRTIME) LOG_CURR_TIME( THIS%LOG_UNIT_, 'SETUP OF THE MODEL_DATA2MULTIO OUTPUT MANAGER', HOOKS )
  ...
  !> Send parametrization to multio
  PP_TRYCALL(ERRFLAG_SEND_PARAMETRIZATION) MULTIO_SEND_PARAMETRISATION( MODEL_PARAMS, THIS%MIO_, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_UNABLE_TO_CONVERT_TO_LOWER)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unable to convert the output manager name to lowercase' )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Output manager name: "'//TRIM(ADJUSTL(MODEL_DATA2MULTIO_OMNAME))//'"' )
    ...
    CASE (ERRFLAG_UNABLE_TO_OPEN_GRIB_FILE)
      GRIB_ERROR = REPEAT(' ', 4096)
      CALL GRIB_GET_ERROR_STRING( KRET, GRIB_ERROR )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unable to open the file' )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'File name: "'//TRIM(ADJUSTL(SINK_FILE_NAME))//'"' )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'grib error: '//TRIM(ADJUSTL(GRIB_ERROR)) )
    CASE (ERRFLAG_SEND_PARAMETRIZATION)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unable to send the parametrization to multio' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unhandled error' )
    END SELECT
...
END FUNCTION MODEL_DATA2MULTIO_SETUP
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'MODEL_DATA2MULTIO_WRITE_ATM_DP'
PP_THREAD_SAFE FUNCTION MODEL_DATA2MULTIO_WRITE_ATM_DP( THIS, YDMSG, VALUES_DP, HOOKS ) RESULT(RET)
  ...
  USE :: MULTIO_UTILS_MOD,     ONLY: MULTIO_FILL_MARS_METADATA
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  CLASS(MODEL_DATA2MULTIO_OUTPUT_MANAGER_T), TARGET, INTENT(INOUT) :: THIS
  TYPE(OM_ATM_MSG_T),                                INTENT(IN)    :: YDMSG
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_INIT_MSG=4_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_INIT_PAR=5_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CONMVERT_TO_MARS=6_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_FILL_METADATA=7_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_WRITE_MULTIO_METADATA=8_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_WRITE_SIZE=9_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_WRITE_VALUES=10_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_DELETE_MIOMD=11_JPIB_K
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_CREATE_MIOMD=14_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_MARS_TO_JSON=15_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_DEALLOCATE=16_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_CONMVERT_TO_MARS) THIS%GET_MARS_FROM_ATM( YDMSG, IN_MSG, IN_PAR, IS_VALID, HOOKS )

  ! If needed then send the field to multio
  IF ( IS_VALID ) THEN
    ...
    ! Create metadata
    ERR = MIOMD%NEW( THIS%MIO_ )
    PP_DEBUG_DEVELOP_COND_THROW( ERR.NE.MULTIO_SUCCESS,  ERRFLAG_UNABLE_TO_CREATE_MIOMD )

    ! Fill multio metadata
    PP_TRYCALL(ERRFLAG_FILL_METADATA) MULTIO_FILL_MARS_METADATA( IN_MSG, IN_PAR, MIOMD, HOOKS )

    ! If needed handle the missing values
    IF ( YDMSG%NUNDF_ .GT. 0 ) THEN
      ERR = MIOMD%SET( 'misc-bitmapPresent', 1_JPIB_K )
      PP_DEBUG_CRITICAL_COND_THROW(ERR.NE.MULTIO_SUCCESS, ERRFLAG_UNABLE_TO_WRITE_MULTIO_METADATA)
      ERR = MIOMD%SET( 'misc-missingValue', YDMSG%XUNDF_ )
      PP_DEBUG_CRITICAL_COND_THROW(ERR.NE.MULTIO_SUCCESS, ERRFLAG_UNABLE_TO_WRITE_MULTIO_METADATA)
    END IF

    ! Write size
    ERR = MIOMD%SET( 'misc-globalSize', SIZE(VALUES_DP) )
    PP_DEBUG_CRITICAL_COND_THROW(ERR.NE.MULTIO_SUCCESS, ERRFLAG_UNABLE_TO_WRITE_SIZE)

    ! Write to multio
    ERR = THIS%MIO_%WRITE_FIELD( MIOMD, VALUES_DP )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_UNABLE_TO_INIT_MSG)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unable to initialize the message' )
    CASE (ERRFLAG_UNABLE_TO_INIT_PAR)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unable to initialize the parametrization' )
    CASE (ERRFLAG_CONMVERT_TO_MARS)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unable to convert the message to MARS' )
    CASE (ERRFLAG_FILL_METADATA)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unable to fill the metadata' )
    CASE (ERRFLAG_UNABLE_TO_WRITE_MULTIO_METADATA)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unable to write the multio metadata' )
    ...
    CASE (ERRFLAG_UNABLE_TO_WRITE_SIZE)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unable to write the value size into multio metadata' )
      MIO_ERR_STR = MULTIO_ERROR_STRING(ERR)
      IF ( ALLOCATED( MIO_ERR_STR ) ) THEN
        PP_DEBUG_PUSH_MSG_TO_FRAME( 'multio error message: '//TRIM(ADJUSTL(MIO_ERR_STR)) )
        DEALLOCATE( MIO_ERR_STR, STAT=STAT )
    ...
    CASE (ERRFLAG_UNABLE_TO_DELETE_MIOMD)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unable to delete the multio metadata' )
      MIO_ERR_STR = MULTIO_ERROR_STRING(ERR)
      IF ( ALLOCATED( MIO_ERR_STR ) ) THEN
        PP_DEBUG_PUSH_MSG_TO_FRAME( 'multio error message: '//TRIM(ADJUSTL(MIO_ERR_STR)) )
        DEALLOCATE( MIO_ERR_STR, STAT=STAT )
    ...
    CASE (ERRFLAG_UNABLE_TO_CREATE_MIOMD)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unable to create the multio metadata' )
      MIO_ERR_STR = MULTIO_ERROR_STRING(ERR)
      IF ( ALLOCATED( MIO_ERR_STR ) ) THEN
        PP_DEBUG_PUSH_MSG_TO_FRAME( 'multio error message: '//TRIM(ADJUSTL(MIO_ERR_STR)) )
        DEALLOCATE( MIO_ERR_STR, STAT=STAT )
    ...
    CASE (ERRFLAG_MARS_TO_JSON)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unable to convert the MARS message to JSON' )
    CASE (ERRFLAG_UNABLE_TO_DEALLOCATE)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unable to deallocate the JSON string' )
...
END FUNCTION MODEL_DATA2MULTIO_WRITE_ATM_DP
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'MODEL_DATA2MULTIO_WRITE_ATM_SP'
PP_THREAD_SAFE FUNCTION MODEL_DATA2MULTIO_WRITE_ATM_SP( THIS, YDMSG, VALUES_SP, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  IF ( IS_VALID ) THEN
    ...
    ! Write size
    ERR = MIOMD%SET( 'misc-globalSize', SIZE(VALUES_SP) )
    PP_DEBUG_CRITICAL_COND_THROW(ERR.NE.MULTIO_SUCCESS, ERRFLAG_UNABLE_TO_WRITE_SIZE)

    ! Write to multio
    ERR = THIS%MIO_%WRITE_FIELD( MIOMD, VALUES_SP )
    PP_DEBUG_CRITICAL_COND_THROW(ERR.NE.MULTIO_SUCCESS, ERRFLAG_UNABLE_TO_WRITE_VALUES)
...
END FUNCTION MODEL_DATA2MULTIO_WRITE_ATM_SP
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'MODEL_DATA2MULTIO_WRITE_WAM_DP'
PP_THREAD_SAFE FUNCTION MODEL_DATA2MULTIO_WRITE_WAM_DP( THIS, YDMSG, VALUES_DP, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_INIT_MSG) IN_MSG%INIT( HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_INIT_PAR) IN_PAR%INIT( HOOKS )
  PP_TRYCALL(ERRFLAG_CONMVERT_TO_MARS) THIS%GET_MARS_FROM_WAM( YDMSG, IN_MSG, IN_PAR, IS_VALID, HOOKS )
...
END FUNCTION MODEL_DATA2MULTIO_WRITE_WAM_DP
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'MODEL_DATA2MULTIO_WRITE_WAM_SP'
PP_THREAD_SAFE FUNCTION MODEL_DATA2MULTIO_WRITE_WAM_SP( THIS, YDMSG, VALUES_SP, HOOKS ) RESULT(RET)
...
END FUNCTION MODEL_DATA2MULTIO_WRITE_WAM_SP
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'MODEL_DATA2MULTIO_FLUSH_STEP'
PP_THREAD_SAFE FUNCTION MODEL_DATA2MULTIO_FLUSH_STEP( THIS, KSTEP, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K) :: LOCAL_STEP
  ...
  ! Compute local step (step in hours)
  LOCAL_STEP = (KSTEP * INT( THIS%MODEL_PAR_%SIM_%TSTEP, KIND=JPIB_K ) )/ 3600_JPIB_K

  ! Profile
  IF ( THIS%PROFILE_ ) THEN
    PP_TRYCALL(ERRFLAG_PROFILE_FLUSH) PROFILE_FLUSH( THIS%PROFILE_DATA_, LOCAL_STEP, HOOKS )
  ENDIF

  ! If needed log step
  IF ( THIS%VERBOSE_ ) THEN
    CLTMP = REPEAT(' ',128)
    WRITE(CLTMP, '(I10)', IOSTAT=STATUS ) LOCAL_STEP
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_FLUSH_MULTIO) MULTIO_FLUSH( THIS%MIO_, LOCAL_STEP, HOOKS )
...
END FUNCTION MODEL_DATA2MULTIO_FLUSH_STEP
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'MODEL_DATA2MULTIO_FLUSH_LAST_STEP'
PP_THREAD_SAFE FUNCTION MODEL_DATA2MULTIO_FLUSH_LAST_STEP( THIS, KSTEP, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Profile
  IF ( THIS%PROFILE_ ) THEN
    PP_TRYCALL(ERRFLAG_PROFILE_FLUSH) PROFILE_FLUSH_LAST_STEP( THIS%PROFILE_DATA_, LOCAL_STEP, HOOKS )
  ENDIF
  ...
  ! Send to MultIO the flush for the last step
  PP_TRYCALL(ERRFLAG_UNABLE_TO_FLUSH_MULTIO) MULTIO_FLUSH_LAST_STEP( THIS%MIO_, LOCAL_STEP, HOOKS )
...
END FUNCTION MODEL_DATA2MULTIO_FLUSH_LAST_STEP
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'MODEL_DATA2MULTIO_FLUSH_STEP_AND_TRIGGER_RESTART'
PP_THREAD_SAFE FUNCTION MODEL_DATA2MULTIO_FLUSH_STEP_AND_TRIGGER_RESTART( THIS, KSTEP, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Profile
  IF ( THIS%PROFILE_ ) THEN
    PP_TRYCALL(ERRFLAG_PROFILE_FLUSH) PROFILE_FLUSH_AND_RESTART( THIS%PROFILE_DATA_, LOCAL_STEP, HOOKS )
  ENDIF
  ...
  ! Send to MultIO the flush for the last step
  PP_TRYCALL(ERRFLAG_UNABLE_TO_FLUSH_MULTIO) MULTIO_FLUSH_AND_TRIGGER_RESTART( THIS%MIO_, LOCAL_STEP, HOOKS )
...
END FUNCTION MODEL_DATA2MULTIO_FLUSH_STEP_AND_TRIGGER_RESTART
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'MODEL_DATA2MULTIO_FINALISE'
PP_THREAD_SAFE FUNCTION MODEL_DATA2MULTIO_FINALISE( THIS, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_CLOSE_GRIB_FILE=11_JPIB_K
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_UNABLE_TO_CLOSE_GRIB_FILE)
      GRIB_ERROR = REPEAT(' ', 4096)
      CALL GRIB_GET_ERROR_STRING( KRET, GRIB_ERROR )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unable to open the file' )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'grib error: '//TRIM(ADJUSTL(GRIB_ERROR)) )
...
END FUNCTION MODEL_DATA2MULTIO_FINALISE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


END MODULE MODEL_DATA2MULTIO_MOD
