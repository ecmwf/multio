...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_SECTION4_SATELLITE_DEFAULT_INIT
...
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_SATELLITE_DEFAULT_INIT'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_SATELLITE_DEFAULT_INIT( THIS, &
...
END FUNCTION GRIB2_SECTION4_SATELLITE_DEFAULT_INIT
