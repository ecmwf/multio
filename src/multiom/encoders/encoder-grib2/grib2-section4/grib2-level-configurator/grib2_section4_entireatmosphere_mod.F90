!>
!> @file grib2_section4_entireatmosphere_mod.F90
!>
!> @brief Module for managing GRIB2 Section 4 level configuration operations.
!>
!> The `G2S4_ENTIREATMOSPHERE_MOD` module contains procedures to initialize, allocate,
...
!>   - @see G2S4_ENTIREATMOSPHERE_INIT
!>   - @see G2S4_ENTIREATMOSPHERE_ALLOC
!>   - @see G2S4_ENTIREATMOSPHERE_PRESET
!>   - @see G2S4_ENTIREATMOSPHERE_RT
!>   - @see G2S4_ENTIREATMOSPHERE_TBE
!>   - @see G2S4_ENTIREATMOSPHERE_FREE
!>
...
#define PP_FILE_NAME 'grib2_section4_entireatmosphere_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'GRIB2_SECTION4_ENTIREATMOSPHERE_MOD'
...
!>
!> The `GRIB2_SECTION4_ENTIREATMOSPHERE_T` type extends the base class `GRIB_SECTION_BASE_A` and
...
!> environments.
!>
TYPE, EXTENDS(GRIB_SECTION_BASE_A) :: GRIB2_SECTION4_ENTIREATMOSPHERE_T
...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_CFG => G2S4_ENTIREATMOSPHERE_INIT_CFG
  ...
  !> the GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_LAZY => G2S4_ENTIREATMOSPHERE_INIT_LAZY
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ALLOCATE => G2S4_ENTIREATMOSPHERE_ALLOC
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => G2S4_ENTIREATMOSPHERE_PRESET
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => G2S4_ENTIREATMOSPHERE_RT
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => G2S4_ENTIREATMOSPHERE_TBE
...
PUBLIC :: GRIB2_SECTION4_ENTIREATMOSPHERE_T
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION4_ENTIREATMOSPHERE_T` representing the GRIB section being initialized.
...
#define PP_PROCEDURE_NAME 'G2S4_ENTIREATMOSPHERE_INIT_CFG'
PP_THREAD_SAFE FUNCTION G2S4_ENTIREATMOSPHERE_INIT_CFG( THIS, &
...
END FUNCTION G2S4_ENTIREATMOSPHERE_INIT_CFG
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_ENTIREATMOSPHERE_INIT_LAZY'
PP_THREAD_SAFE FUNCTION G2S4_ENTIREATMOSPHERE_INIT_LAZY( THIS, &
...
END FUNCTION G2S4_ENTIREATMOSPHERE_INIT_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION4_ENTIREATMOSPHERE_T` representing the GRIB section to allocate resources for.
!>   @param [in]    MSG      All the mars keywords needed to describe the field `FORTRAN_MESSAGE_T`.
!>   @param [in]    PAR      All information outside mars keywords needed to describe the field `PARAMETRIZATION_T`.
!>   @param [in]    OPT      The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_ENTIREATMOSPHERE_ALLOC'
PP_THREAD_SAFE FUNCTION G2S4_ENTIREATMOSPHERE_ALLOC( THIS, &
...
END FUNCTION G2S4_ENTIREATMOSPHERE_ALLOC
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION4_ENTIREATMOSPHERE_T` representing the GRIB section to be preset.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_ENTIREATMOSPHERE_PRESET'
PP_THREAD_SAFE FUNCTION G2S4_ENTIREATMOSPHERE_PRESET( THIS, &
&  MSG, PAR, OPT,  METADATA, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_ENTIREATMOSPHERE_PRESET
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS      An object of type `GRIB2_SECTION4_ENTIREATMOSPHERE_T` representing the GRIB section for runlevel execution.
!>   @param [in]    MSG       The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR       The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_ENTIREATMOSPHERE_RT'
PP_THREAD_SAFE FUNCTION G2S4_ENTIREATMOSPHERE_RT( THIS, &
...
END FUNCTION G2S4_ENTIREATMOSPHERE_RT
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS          An object of type `GRIB2_SECTION4_ENTIREATMOSPHERE_T` representing the GRIB section being checked.
!>   @param [in]    MSG           The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR           The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
!>   @param [in]    TIME_HIST     The time history object of type `TIME_HISTORY_T` providing historical level data.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_ENTIREATMOSPHERE_TBE'
PP_THREAD_SAFE FUNCTION G2S4_ENTIREATMOSPHERE_TBE( THIS, &
...
END FUNCTION G2S4_ENTIREATMOSPHERE_TBE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION4_ENTIREATMOSPHERE_T` representing the GRIB section to be freed.
!>   @param [in]    OPT   The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_ENTIREATMOSPHERE_FREE'
PP_THREAD_SAFE FUNCTION G2S4_ENTIREATMOSPHERE_FREE( THIS, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_ENTIREATMOSPHERE_FREE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_ENTIREATMOSPHERE_SET_LEVELS'
PP_THREAD_SAFE FUNCTION G2S4_ENTIREATMOSPHERE_SET_LEVELS( THIS, &
&  MSG, PAR, OPT, METADATA, HOOKS ) RESULT(RET)
