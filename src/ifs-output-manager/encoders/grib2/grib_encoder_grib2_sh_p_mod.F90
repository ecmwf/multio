...
#define PP_FILE_NAME 'grib_encoder_grib2_sh_p_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'GRIB_ENCODER_GRIB2_SH_P_MOD'
MODULE GRIB_ENCODER_GRIB2_SH_P_MOD
...
CONTAINS
  ! Virtual procedures
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INITIALISE => ENCODER_GRIB2_SH_P_INITIALISE
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ENCODE_ATM => ENCODER_GRIB2_SH_P_ENCODE_ATM
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ENCODE_WAM => ENCODER_GRIB2_SH_P_ENCODE_WAM
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: FINALISE   => ENCODER_GRIB2_SH_P_FINALISE
END TYPE

! Name of the grib sample to be loaded
CHARACTER(LEN=*), PARAMETER :: SAMPLE_NAME_GRIB2_SH_P='sh_ml'

! Whitelist of public symbols
PUBLIC :: MAKE_GRIB2_SH_P_ENCODER
PUBLIC :: DESTROY_GRIB2_SH_P_ENCODER

CONTAINS


#define PP_PROCEDURE_TYPE 'SUBROUTINE'
#define PP_PROCEDURE_NAME 'MAKE_GRIB2_SH_P_ENCODER'
SUBROUTINE MAKE_GRIB2_SH_P_ENCODER( CFG, MODEL_PARAMS, METADATA_KIND, ENCODER )
...
END SUBROUTINE MAKE_GRIB2_SH_P_ENCODER
...
#define PP_PROCEDURE_TYPE 'SUBROUTINE'
#define PP_PROCEDURE_NAME 'DESTROY_GRIB2_SH_P_ENCODER'
SUBROUTINE DESTROY_GRIB2_SH_P_ENCODER( ENCODER )
...
END SUBROUTINE DESTROY_GRIB2_SH_P_ENCODER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'SUBROUTINE'
#define PP_PROCEDURE_NAME 'ENCODER_GRIB2_SH_P_INITIALISE'
SUBROUTINE ENCODER_GRIB2_SH_P_INITIALISE( THIS, MODEL_PARAMS, METADATA_KIND )
...
IMPLICIT NONE
  ...
  CALL GRIB_NEW_FROM_SAMPLES( THIS%SAMPLE_HANDLE_, TRIM(ADJUSTL(SAMPLE_NAME_GRIB2_SH_P)), STATUS=KRET )
...
END SUBROUTINE ENCODER_GRIB2_SH_P_INITIALISE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'ENCODER_GRIB2_SH_P_ENCODE_ATM'
FUNCTION ENCODER_GRIB2_SH_P_ENCODE_ATM( THIS, MODEL_PARAMS, GRIB_INFO, &
...
IMPLICIT NONE
  ...
  PP_METADATA_INIT_FROM_SAMPLE( METADATA, SAMPLE_NAME_GRIB2_SH_P, THIS%SAMPLE_HANDLE_ )
...
END FUNCTION ENCODER_GRIB2_SH_P_ENCODE_ATM
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'ENCODER_GRIB2_SH_P_ENCODE_WAM'
FUNCTION ENCODER_GRIB2_SH_P_ENCODE_WAM( THIS, MODEL_PARAMS, GRIB_INFO, &
& TIME_HIST, CURR_TIME, MSG, METADATA ) RESULT(EX)
...
END FUNCTION ENCODER_GRIB2_SH_P_ENCODE_WAM
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'SUBROUTINE'
#define PP_PROCEDURE_NAME 'ENCODER_GRIB2_SH_P_FINALISE'
SUBROUTINE ENCODER_GRIB2_SH_P_FINALISE( THIS )
...
END SUBROUTINE ENCODER_GRIB2_SH_P_FINALISE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


END MODULE GRIB_ENCODER_GRIB2_SH_P_MOD
