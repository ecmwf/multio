...
&   RULES_CONFIGURATION, FILTER_OPT, ENCODER_OPT, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  DO I = 1, N_RULES
    ...
    IF ( HAS_RULE .AND. .NOT.HAS_FILE ) THEN
      ...
      PP_TRYCALL(ERRFLAG_READ_RULE_FROM_CFG) MAKE_RULE_FROM_CFG( RULES(I), I, RULE_CONFIGURATION, FILTER_OPT, ENCODER_OPT, HOOKS )
    ...
    ELSE IF ( HAS_FILE .AND. .NOT. HAS_RULE) THEN
      ...
      !> Read rule from file
      PP_TRYCALL(ERRFLAG_READ_RULE_FROM_FILE) MAKE_RULE_FROM_FILE( RULES(I), I, RULE_CONFIGURATION, FILTER_OPT, ENCODER_OPT, HOOKS )
...
RECURSIVE FUNCTION MAKE_RULE_FROM_CFG( RULE, ID, CFG, FILTER_OPT, ENCODER_OPT, HOOKS ) RESULT(RET)
...
RECURSIVE FUNCTION MAKE_RULE_FROM_FILE( RULE, ID, CFG, FILTER_OPT, ENCODER_OPT, HOOKS ) RESULT(RET)
