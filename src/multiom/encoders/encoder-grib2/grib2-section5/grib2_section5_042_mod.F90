...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_CFG => GRIB2_SECTION5_042_INIT_CFG
  ...
  !> the GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_LAZY => GRIB2_SECTION5_042_INIT_LAZY
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => GRIB2_SECTION5_042_TO_BE_ENCODED
...
#define PP_PROCEDURE_NAME 'GRIB2_SECTION5_042_INIT_CFG'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION5_042_INIT_CFG( THIS, &
...
END FUNCTION GRIB2_SECTION5_042_INIT_CFG
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION5_042_INIT_LAZY'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION5_042_INIT_LAZY( THIS, &
...
IMPLICIT NONE
  ...
  ! Logging informations
  PP_LOG_INFO( 'Lazy initialization of GRIB2 Section: '//TRIM(ADJUSTL(THIS%TYPE_))//'::'//TRIM(ADJUSTL(THIS%SUBTYPE_))//'('//TRIM(ADJUSTL(THIS%KIND_))//')' )
...
END FUNCTION GRIB2_SECTION5_042_INIT_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS          An object of type `GRIB2_SECTION5_042_T` representing the GRIB section being checked.
!>   @param [in]    MSG           The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR           The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION5_042_TO_BE_ENCODED( THIS, &
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION5_042_FREE(  THIS, OPT, HOOKS ) RESULT(RET)
