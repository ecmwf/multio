!>
!> @file G2S4_143_mod.F90
!>
!> @brief Module for managing GRIB2 Section 4 operations.
!>
!> The `G2S4_143_MOD` module contains procedures to initialize, allocate,
...
!>   - @see G2S4_143_INIT
!>   - @see G2S4_143_ALLOCATE
!>   - @see G2S4_143_PRESET
!>   - @see G2S4_143_RUNTIME
!>   - @see G2S4_143_TO_BE_ENCODED
!>   - @see G2S4_143_FREE
!>
...
#define PP_FILE_NAME 'grib2_section4_143_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'GRIB2_SECTION4_143_MOD'
MODULE GRIB2_SECTION4_143_MOD
...
CHARACTER(LEN=*), PARAMETER :: G2S4_143_NAME = 'g2s4::143'

!>
!> @brief Type definition for GRIB2 Section 4 handler.
!>
!> The `G2S4_143_T` type extends the base class `GRIB_SECTION_BASE_A` and
...
!> environments.
!>
TYPE, EXTENDS(GRIB_SECTION_BASE_A) :: G2S4_143_T
  ...
  CHARACTER(LEN=64) :: RANDOM_PATTERNS_SUBSECTION_NAME_ = REPEAT( ' ', 64 )
  ...
  CLASS(GRIB_SECTION_BASE_A), POINTER :: RANDOM_PATTERNS_ => NULL()
...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_CFG => G2S4_143_INIT_CFG
  ...
  !> the GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_LAZY => G2S4_143_INIT_LAZY
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ALLOCATE => G2S4_143_ALLOCATE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => G2S4_143_PRESET
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => G2S4_143_RUNTIME
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => G2S4_143_TO_BE_ENCODED
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: FREE => G2S4_143_FREE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRINT => G2S4_143_PRINT
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_MODEL_CONFIGURATOR_CFG => G2S4_143_BUILD_MODEL_HANDLER_CFG
  ...
  !> This procedure allocates the proper time configurator
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_TIME_CONFIGURATOR_CFG => G2S4_143_BUILD_TIME_HANDLER_CFG
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_PARAM_CONFIGURATOR_CFG => G2S4_143_BUILD_PARAM_HANDLER_CFG
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_LEVEL_CONFIGURATOR_CFG => G2S4_143_BUILD_LEVEL_HANDLER_CFG
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_ENSEMBLE_CONFIGURATOR_CFG => G2S4_143_BUILD_ENSEMBLE_HANDLER_CFG

  !>
  !> @brief Build the random patterns configurator object from yaml configuration
  !>
  !> This procedure allocates the proper ensemble configurator
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_RANDOM_PATTERNS_CONFIGURATOR_CFG => G2S4_143_BUILD_RANDOM_PATTERNS_HANDLER_CFG
  ...
  !> This procedure allocates the proper param configurator
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_PARAM_CONFIGURATOR_LAZY => G2S4_143_BUILD_PARAM_HANDLER_LAZY
  ...
  !> This procedure allocates the proper level configurator
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_LEVEL_CONFIGURATOR_LAZY => G2S4_143_BUILD_LEVEL_HANDLER_LAZY
  ...
  !> This procedure allocates the proper time configurator
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_TIME_CONFIGURATOR_LAZY => G2S4_143_BUILD_TIME_HANDLER_LAZY
  ...
  !> This procedure allocates the proper time configurator
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_MODEL_CONFIGURATOR_LAZY => G2S4_143_BUILD_MODEL_HANDLER_LAZY
  ...
  !> This procedure allocates the proper ensemble configurator
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_ENSEMBLE_CONFIGURATOR_LAZY => G2S4_143_BUILD_ENSEMBLE_HANDLER_LAZY

  !>
  !> @brief Build the random patterns configurator object from rules
  !>
  !> This procedure allocates the proper ensemble configurator
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_RANDOM_PATTERNS_CONFIGURATOR_LAZY => G2S4_143_BUILD_RANDOM_PATTERNS_HANDLER_LAZY
...
PUBLIC :: G2S4_143_MAKE
PUBLIC :: G2S4_143_REGISTER
PUBLIC :: G2S4_143_DESTROY

CONTAINS


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_143_REGISTER'
PP_THREAD_SAFE FUNCTION G2S4_143_REGISTER( IDX ) BIND(C, NAME='g2s4_143_register') RESULT(RET)
...
!$omp single
  ...
  IF ( ASSOCIATED(HOOKS) ) THEN
    ...
    PP_TRYCALL(ERRFLAG_UNABLE_TO_REGISTER) REG%REGISTER( G2S4_143_NAME, FA, FD, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_UNABLE_TO_REGISTER )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to register section: '//TRIM(ADJUSTL(G2S4_143_NAME)) )
...
END FUNCTION G2S4_143_REGISTER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_143_MAKE'
PP_THREAD_SAFE FUNCTION G2S4_143_MAKE( GRIB_SECTION, HOOKS ) RESULT(RET)
...
!$omp critical(G2S4_ALLOCATE)
  ALLOCATE( G2S4_143_T::GRIB_SECTION, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_143_DESTROY'
PP_THREAD_SAFE FUNCTION G2S4_143_DESTROY( GRIB_SECTION, HOOKS ) RESULT(RET)
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `G2S4_143_T` representing the GRIB section being initialized.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_143_INIT_CFG'
PP_THREAD_SAFE FUNCTION G2S4_143_INIT_CFG( THIS, &
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(G2S4_143_T),            INTENT(INOUT) :: THIS
  ...
  !> Local error codes
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_INIT_MODEL_HANDLER=1_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_INIT_TIME_HANDLER=2_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_INIT_PARAM_HANDLER=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_INIT_LEVEL_HANDLER=4_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_INIT_ENSEMBLE_HANDLER=5_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_INIT_RANDOM_PATTERNS_HANDLER=6_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_INIT_MODEL_HANDLER)  THIS%BUILD_MODEL_CONFIGURATOR_CFG( CFG, OPT, HOOKS )
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_INIT_RANDOM_PATTERNS_HANDLER) THIS%BUILD_RANDOM_PATTERNS_CONFIGURATOR_CFG( CFG, OPT, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_UNABLE_TO_INIT_RANDOM_PATTERNS_HANDLER )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to initialize random patterns handler' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
END FUNCTION G2S4_143_INIT_CFG
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_143_INIT_LAZY'
PP_THREAD_SAFE FUNCTION G2S4_143_INIT_LAZY( THIS, &
&               MSG, PAR, OPT, HOOKS ) RESULT(RET)
  ...
  USE :: HOOKS_MOD,                                ONLY: HOOKS_T
  USE :: GRIB2_SECTION4_MODEL_FACTORY_MOD,         ONLY: MAKE_GRIB2_MODEL_CONFIGURATOR
  ...
  USE :: GRIB2_SECTION4_RANDOM_PATTERNS_FACTORY_MOD,      ONLY: MAKE_GRIB2_RANDOM_PATTERNS_CONFIGURATOR
...
IMPLICIT NONE
  ...
  !> Local error codes
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_BUILD_MODEL_CONFIGURATOR=1_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_BUILD_TIME_CONFIGURATOR=2_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_BUILD_PARAM_CONFIGURATOR=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_BUILD_LEVEL_CONFIGURATOR=4_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_BUILD_ENSEMBLE_CONFIGURATOR=5_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_BUILD_RANDOM_PATTERNS_CONFIGURATOR=6_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_BUILD_MODEL_CONFIGURATOR) MAKE_GRIB2_MODEL_CONFIGURATOR( &
...
&  THIS%PARAMID_, THIS%TEMPLATE_NUMBER_, MSG, PAR, OPT, HOOKS )
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_BUILD_LEVEL_CONFIGURATOR) MAKE_GRIB2_LEVEL_CONFIGURATOR( &
...
&  THIS%LEVEL_, THIS%TEMPLATE_NUMBER_, MSG, PAR, OPT, HOOKS )
  ...
  ! Build the level configurator
  PP_TRYCALL(ERRFLAG_UNABLE_TO_BUILD_RANDOM_PATTERNS_CONFIGURATOR) MAKE_GRIB2_RANDOM_PATTERNS_CONFIGURATOR( &
&  THIS%LEVEL_, THIS%TEMPLATE_NUMBER_, MSG, PAR, OPT, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_UNABLE_TO_BUILD_RANDOM_PATTERNS_CONFIGURATOR )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to build random patterns configurator' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
END FUNCTION G2S4_143_INIT_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `G2S4_143_T` representing the GRIB section to allocate resources for.
!>   @param [in]    MSG      All the mars keywords needed to describe the field `FORTRAN_MESSAGE_T`.
!>   @param [in]    PAR      All information outside mars keywords needed to describe the field `PARAMETRIZATION_T`.
!>   @param [in]    OPT      The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_143_ALLOCATE'
PP_THREAD_SAFE FUNCTION G2S4_143_ALLOCATE( THIS, &
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_ALLOCATE_MODEL=2_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_ALLOCATE_TIME=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_ALLOCATE_LEVEL=4_JPIB_K
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TIME_CONFIGURATOR_NOT_ASSOCIATED=10_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_MODEL_CONFIGURATOR_NOT_ASSOCIATED=11_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_ALLOCATE_RANDOM_PATTERNS=12_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_RANDOM_PATTERNS_CONFIGURATOR_NOT_ASSOCIATED=13_JPIB_K
  ...
  PP_DEBUG_CRITICAL_COND_THROW( .NOT. ASSOCIATED(THIS%RANDOM_PATTERNS_), ERRFLAG_RANDOM_PATTERNS_CONFIGURATOR_NOT_ASSOCIATED )
  ...
  PP_TRYCALL(ERRFLAG_ALLOCATE_RANDOM_PATTERNS) THIS%RANDOM_PATTERNS_%ALLOCATE( MSG, PAR, OPT, METADATA, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_ALLOCATE_RANDOM_PATTERNS )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to allocate random patterns' )
    ...
    CASE ( ERRFLAG_RANDOM_PATTERNS_CONFIGURATOR_NOT_ASSOCIATED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'random patterns configurator not associated' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
END FUNCTION G2S4_143_ALLOCATE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `G2S4_143_T` representing the GRIB section to be preset.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_143_PRESET'
PP_THREAD_SAFE FUNCTION G2S4_143_PRESET( THIS, &
&  MSG, PAR, OPT,  METADATA, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Error codes
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_METADATA=1_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PRESET_MODEL=2_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PRESET_TIME=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PRESET_LEVEL=4_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PRESET_PARAMID=5_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PRESET_ENSEMBLE=6_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_LEVEL_CONFIGURATOR_NOT_ASSOCIATED=7_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PARAMID_CONFIGURATOR_NOT_ASSOCIATED=8_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TIME_CONFIGURATOR_NOT_ASSOCIATED=10_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_MODEL_CONFIGURATOR_NOT_ASSOCIATED=11_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_ENSEMBLE_CONFIGURATOR_NOT_ASSOCIATED=12_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PRESET_RANDOM_PATTERNS=13_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_RANDOM_PATTERNS_CONFIGURATOR_NOT_ASSOCIATED=14_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_PRESET_RANDOM_PATTERNS) THIS%RANDOM_PATTERNS_%PRESET( MSG, PAR, OPT, METADATA, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_PRESET_RANDOM_PATTERNS )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to preset random patterns' )
    CASE ( ERRFLAG_METADATA )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'error using metadata' )
    CASE ( ERRFLAG_MODEL_CONFIGURATOR_NOT_ASSOCIATED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'model configurator not associated' )
...
!>
!> @section interface
!>   @param [in]    THIS      An object of type `G2S4_143_T` representing the GRIB section for runtime execution.
!>   @param [in]    MSG       The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR       The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_143_RUNTIME'
PP_THREAD_SAFE FUNCTION G2S4_143_RUNTIME( THIS, &
...
IMPLICIT NONE
  ...
  !> Error codes
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_METADATA=1_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_RUNTIME_MODEL=2_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_RUNTIME_TIME=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_RUNTIME_LEVEL=4_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_RUNTIME_PARAMID=5_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_RUNTIME_ENSEMBLE=6_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_LEVEL_CONFIGURATOR_NOT_ASSOCIATED=7_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PARAMID_CONFIGURATOR_NOT_ASSOCIATED=8_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_ENSEMBLE_CONFIGURATOR_NOT_ASSOCIATED=9_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TIME_CONFIGURATOR_NOT_ASSOCIATED=10_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_MODEL_CONFIGURATOR_NOT_ASSOCIATED=11_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_RUNTIME_RANDOM_PATTERNS=12_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_RANDOM_PATTERNS_CONFIGURATOR_NOT_ASSOCIATED=13_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_RUNTIME_RANDOM_PATTERNS) THIS%RANDOM_PATTERNS_%RUNTIME( MSG, PAR, TIME_HIST, CURR_TIME, OPT, METADATA, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_ENSEMBLE_CONFIGURATOR_NOT_ASSOCIATED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'ensemble configurator not associated' )
    CASE ( ERRFLAG_RUNTIME_RANDOM_PATTERNS )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to runtime random patterns' )
    CASE ( ERRFLAG_RANDOM_PATTERNS_CONFIGURATOR_NOT_ASSOCIATED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'random patterns configurator not associated' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
...
!>
!> @section interface
!>   @param [inout] THIS          An object of type `G2S4_143_T` representing the GRIB section being checked.
!>   @param [in]    MSG           The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR           The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
!>   @param [in]    TIME_HIST     The time history object of type `TIME_HISTORY_T` providing historical time data.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_143_TO_BE_ENCODED'
PP_THREAD_SAFE FUNCTION G2S4_143_TO_BE_ENCODED( THIS, &
...
IMPLICIT NONE
  ...
  ! Local error codes
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TO_BE_ENCODED_MODEL=1_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TO_BE_ENCODED_TIME=2_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TO_BE_ENCODED_LEVEL=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TO_BE_ENCODED_PARAMID=4_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TO_BE_ENCODED_ENSEMBLE=5_JPIB_K
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_MODEL_CONFIGURATOR_NOT_ASSOCIATED=10_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TO_BE_ENCODED_RANDOM_PATTERNS=11_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_RANDOM_PATTERNS_CONFIGURATOR_NOT_ASSOCIATED=12_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_TO_BE_ENCODED_MODEL) THIS%MODEL_%TO_BE_ENCODED( MSG, PAR, TIME_HIST, CURR_TIME, OPT, TO_BE_ENCODED_SUBS(1), HOOKS )
  PP_TRYCALL(ERRFLAG_TO_BE_ENCODED_TIME) THIS%TIME_%TO_BE_ENCODED( MSG, PAR, TIME_HIST, CURR_TIME, OPT, TO_BE_ENCODED_SUBS(2), HOOKS )
  PP_TRYCALL(ERRFLAG_TO_BE_ENCODED_LEVEL) THIS%LEVEL_%TO_BE_ENCODED( MSG, PAR, TIME_HIST, CURR_TIME, OPT, TO_BE_ENCODED_SUBS(3), HOOKS )
  PP_TRYCALL(ERRFLAG_TO_BE_ENCODED_PARAMID) THIS%PARAMID_%TO_BE_ENCODED( MSG, PAR, TIME_HIST, CURR_TIME, OPT, TO_BE_ENCODED_SUBS(4), HOOKS )
  PP_TRYCALL(ERRFLAG_TO_BE_ENCODED_ENSEMBLE) THIS%ENSEMBLE_%TO_BE_ENCODED( MSG, PAR, TIME_HIST, CURR_TIME, OPT, TO_BE_ENCODED_SUBS(5), HOOKS )
  PP_TRYCALL(ERRFLAG_TO_BE_ENCODED_RANDOM_PATTERNS) THIS%RANDOM_PATTERNS_%TO_BE_ENCODED( MSG, PAR, TIME_HIST, CURR_TIME, OPT, TO_BE_ENCODED_SUBS(6), HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_ENSEMBLE_CONFIGURATOR_NOT_ASSOCIATED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'ensemble configurator not associated' )
    CASE ( ERRFLAG_TO_BE_ENCODED_RANDOM_PATTERNS )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to check if random patterns is ready to be encoded' )
    CASE ( ERRFLAG_RANDOM_PATTERNS_CONFIGURATOR_NOT_ASSOCIATED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'random patterns configurator not associated' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
...
END FUNCTION G2S4_143_TO_BE_ENCODED
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `G2S4_143_T` representing the GRIB section to be freed.
!>   @param [in]    OPT   The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_143_FREE'
PP_THREAD_SAFE FUNCTION G2S4_143_FREE( THIS, OPT, HOOKS ) RESULT(RET)
  ...
  USE :: GRIB2_SECTION4_RANDOM_PATTERNS_FACTORY_MOD,      ONLY: DESTROY_GRIB2_RANDOM_PATTERNS_CONFIGURATOR
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_DESTROY_MODEL=2_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_DESTROY_PARAM=3_JPIB_K
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TIME_CONFIGURATOR_NOT_ASSOCIATED=9_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_MODEL_CONFIGURATOR_NOT_ASSOCIATED=10_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_DESTROY_RANDOM_PATTERNS=11_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_RANDOM_PATTERNS_CONFIGURATOR_NOT_ASSOCIATED=12_JPIB_K
  ...
  PP_DEBUG_CRITICAL_COND_THROW( .NOT. ASSOCIATED(THIS%ENSEMBLE_), ERRFLAG_ENSEMBLE_CONFIGURATOR_NOT_ASSOCIATED )
  PP_DEBUG_CRITICAL_COND_THROW( .NOT. ASSOCIATED(THIS%TIME_), ERRFLAG_TIME_CONFIGURATOR_NOT_ASSOCIATED )
  PP_DEBUG_CRITICAL_COND_THROW( .NOT. ASSOCIATED(THIS%MODEL_), ERRFLAG_TIME_CONFIGURATOR_NOT_ASSOCIATED )
  PP_DEBUG_CRITICAL_COND_THROW( .NOT. ASSOCIATED(THIS%RANDOM_PATTERNS_), ERRFLAG_RANDOM_PATTERNS_CONFIGURATOR_NOT_ASSOCIATED )

  ! Free all the memory
  PP_TRYCALL(ERRFLAG_DESTROY_MODEL)    DESTROY_GRIB2_MODEL_CONFIGURATOR( THIS%MODEL_, OPT, HOOKS )
  ...
  PP_TRYCALL(ERRFLAG_DESTROY_RANDOM_PATTERNS) DESTROY_GRIB2_RANDOM_PATTERNS_CONFIGURATOR( THIS%RANDOM_PATTERNS_, OPT, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_DESTROY_RANDOM_PATTERNS )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to free random patterns' )
    CASE ( ERRFLAG_MODEL_CONFIGURATOR_NOT_ASSOCIATED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'model configurator not associated' )
    CASE ( ERRFLAG_TIME_CONFIGURATOR_NOT_ASSOCIATED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'time configurator not associated' )
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_143_PRINT'
PP_THREAD_SAFE FUNCTION G2S4_143_PRINT( THIS, &
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PARAMID_CONFIGURATOR_NOT_ASSOCIATED=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_ENSEMBLE_CONFIGURATOR_NOT_ASSOCIATED=4_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_WRITE_ERROR=5_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CALL_PRINT_MODEL=6_JPIB_K
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CALL_PRINT_ENSEMBLE=9_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CALL_PRINT_PARAMID=10_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_RANDOM_PATTERNS_CONFIGURATOR_NOT_ASSOCIATED=11_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CALL_PRINT_RANDOM_PATTERNS=12_JPIB_K
...
&     '(', TRIM(ADJUSTL(THIS%KIND_)), '){'
  ...
  PP_TRYCALL(ERRFLAG_CALL_PRINT_RANDOM_PATTERNS) THIS%RANDOM_PATTERNS_%PRINT( UNIT, OFFSET+2, OPT, HOOKS, ', ...' )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_RANDOM_PATTERNS_CONFIGURATOR_NOT_ASSOCIATED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'random patterns configurator not associated' )
    CASE (ERRFLAG_CALL_PRINT_RANDOM_PATTERNS)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'error calling print random patterns' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
!>
!> @brief Builds the param handler for GRIB2 section 4, template 143.
!>
!> This function constructs the param handler for GRIB2 section 4, template 143,
...
!> @see G2S4_143_ALLOCATE
!> @see G2S4_143_PRESET
!> @see G2S4_143_RUNPARAM
!> @see G2S4_143_TO_BE_ENCODED
!> @see G2S4_143_FREE
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_143_BUILD_PARAM_HANDLER_CFG'
PP_THREAD_SAFE FUNCTION G2S4_143_BUILD_PARAM_HANDLER_CFG( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_143_BUILD_PARAM_HANDLER_CFG
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_143_BUILD_PARAM_HANDLER_LAZY'
PP_THREAD_SAFE FUNCTION G2S4_143_BUILD_PARAM_HANDLER_LAZY( THIS, &
&               MSG, PAR, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_143_BUILD_PARAM_HANDLER_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


!>
!> @brief Builds the level handler for GRIB2 section 4, template 143.
!>
!> This function constructs the level handler for GRIB2 section 4, template 143,
!> based on the provided configuration (`CFG`), options (`OPT`).
!> It modifies the `THIS` structure accordingly and returns an error code if the operation fails.
!> The function is thread-safe and uses preprocessor directives for debugging, logging, and tracing.
!>
...
!> @see G2S4_143_ALLOCATE
!> @see G2S4_143_PRESET
!> @see G2S4_143_RUNLEVEL
!> @see G2S4_143_TO_BE_ENCODED
!> @see G2S4_143_FREE
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_143_BUILD_LEVEL_HANDLER_CFG'
PP_THREAD_SAFE FUNCTION G2S4_143_BUILD_LEVEL_HANDLER_CFG( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Make the indicator-section
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_LEVEL_CONFIGURATOR) MAKE_GRIB2_LEVEL_CONFIGURATOR( THIS%LEVEL_, THIS%TEMPLATE_NUMBER_, LEVEL_CONFIGURATOR_CFG, OPT, HOOKS )
...
END FUNCTION G2S4_143_BUILD_LEVEL_HANDLER_CFG
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_143_BUILD_LEVEL_HANDLER_LAZY'
PP_THREAD_SAFE FUNCTION G2S4_143_BUILD_LEVEL_HANDLER_LAZY( THIS, &
&               MSG, PAR, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_143_BUILD_LEVEL_HANDLER_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_143_BUILD_ENSEMBLE_HANDLER_CFG'
PP_THREAD_SAFE FUNCTION G2S4_143_BUILD_ENSEMBLE_HANDLER_CFG( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Make the indicator-section
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_ENSEMBLE_CONFIGURATOR) MAKE_GRIB2_ENSEMBLE_CONFIGURATOR( THIS%ENSEMBLE_, THIS%TEMPLATE_NUMBER_, ENSEMBLE_CONFIGURATOR_CFG, OPT, HOOKS )
...
END FUNCTION G2S4_143_BUILD_ENSEMBLE_HANDLER_CFG
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_143_BUILD_ENSEMBLE_HANDLER_LAZY'
PP_THREAD_SAFE FUNCTION G2S4_143_BUILD_ENSEMBLE_HANDLER_LAZY( THIS, &
&               MSG, PAR, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_143_BUILD_ENSEMBLE_HANDLER_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE

#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_143_BUILD_TIME_HANDLER_CFG'
PP_THREAD_SAFE FUNCTION G2S4_143_BUILD_TIME_HANDLER_CFG( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_143_BUILD_TIME_HANDLER_CFG
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_143_BUILD_TIME_HANDLER_LAZY'
PP_THREAD_SAFE FUNCTION G2S4_143_BUILD_TIME_HANDLER_LAZY( THIS, &
&               MSG, PAR, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_143_BUILD_TIME_HANDLER_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_143_BUILD_MODEL_HANDLER_CFG'
PP_THREAD_SAFE FUNCTION G2S4_143_BUILD_MODEL_HANDLER_CFG( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Make the indicator-section
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_MODEL_CONFIGURATOR) MAKE_GRIB2_MODEL_CONFIGURATOR( THIS%MODEL_, THIS%TEMPLATE_NUMBER_, MODEL_CONFIGURATOR_CFG, OPT, HOOKS )
...
END FUNCTION G2S4_143_BUILD_MODEL_HANDLER_CFG
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_143_BUILD_MODEL_HANDLER_LAZY'
PP_THREAD_SAFE FUNCTION G2S4_143_BUILD_MODEL_HANDLER_LAZY( THIS, &
&               MSG, PAR, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_143_BUILD_MODEL_HANDLER_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE

#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_143_BUILD_RANDOM_PATTERNS_HANDLER_CFG'
PP_THREAD_SAFE FUNCTION G2S4_143_BUILD_RANDOM_PATTERNS_HANDLER_CFG( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Local variables
  LOGICAL :: HAS_RANDOM_PATTERNS_CONFIGURATOR
  TYPE(YAML_CONFIGURATION_T) :: RANDOM_PATTERNS_CONFIGURATOR_CFG

  !> Local parameters
  CHARACTER(LEN=*), PARAMETER :: RANDOM_PATTERNS_CONFIGURATOR_NAME='random-patterns-configurator'

  ! Local error codes
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_RANDOM_PATTERNS_CONFIGURATOR_ALREADY_ASSOCIATED=1_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_READ_CFG=2_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_RANDOM_PATTERNS_CONFIGURATOR_CFG_NOT_PRESENT=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_READ_SUBCFG=4_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_MAKE_RANDOM_PATTERNS_CONFIGURATOR=5_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_DEALLOCATE=6_JPIB_K
  ...
  !> Error handling
  PP_DEBUG_CRITICAL_COND_THROW( ASSOCIATED(THIS%RANDOM_PATTERNS_), ERRFLAG_RANDOM_PATTERNS_CONFIGURATOR_ALREADY_ASSOCIATED )

  !> Check if a configuration for the indicator-section is available
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_CFG) YAML_CONFIGURATION_HAS_KEY( CFG, RANDOM_PATTERNS_CONFIGURATOR_NAME, HAS_RANDOM_PATTERNS_CONFIGURATOR, HOOKS )
  PP_DEBUG_CRITICAL_COND_THROW( .NOT. HAS_RANDOM_PATTERNS_CONFIGURATOR, ERRFLAG_RANDOM_PATTERNS_CONFIGURATOR_CFG_NOT_PRESENT )

  !> Read the subconfiguration for the indicator-section
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_SUBCFG) YAML_GET_SUBCONFIGURATION( CFG, RANDOM_PATTERNS_CONFIGURATOR_NAME, RANDOM_PATTERNS_CONFIGURATOR_CFG, HOOKS )

  !> Make the indicator-section
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_RANDOM_PATTERNS_CONFIGURATOR) MAKE_GRIB2_RANDOM_PATTERNS_CONFIGURATOR( THIS%RANDOM_PATTERNS_, THIS%TEMPLATE_NUMBER_, RANDOM_PATTERNS_CONFIGURATOR_CFG, OPT, HOOKS )

  !> Deallocate the indicator-section configuration
  PP_TRYCALL( ERRFLAG_UNABLE_TO_DEALLOCATE ) YAML_DELETE_CONFIGURATION( RANDOM_PATTERNS_CONFIGURATOR_CFG, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    ! Handle different errors
    SELECT CASE(ERRIDX)
    CASE ( ERRFLAG_RANDOM_PATTERNS_CONFIGURATOR_ALREADY_ASSOCIATED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'random patterns configurator already associated' )
    CASE ( ERRFLAG_UNABLE_TO_READ_CFG )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to read configuration' )
    CASE ( ERRFLAG_RANDOM_PATTERNS_CONFIGURATOR_CFG_NOT_PRESENT )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'random patterns configurator configuration not present' )
    CASE ( ERRFLAG_UNABLE_TO_READ_SUBCFG )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to read subconfiguration' )
    CASE ( ERRFLAG_UNABLE_TO_MAKE_RANDOM_PATTERNS_CONFIGURATOR )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to make random patterns configurator' )
    CASE ( ERRFLAG_UNABLE_TO_DEALLOCATE )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to deallocate random patterns configurator object' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
END FUNCTION G2S4_143_BUILD_RANDOM_PATTERNS_HANDLER_CFG
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_143_BUILD_RANDOM_PATTERNS_HANDLER_LAZY'
PP_THREAD_SAFE FUNCTION G2S4_143_BUILD_RANDOM_PATTERNS_HANDLER_LAZY( THIS, &
&               MSG, PAR, OPT, HOOKS ) RESULT(RET)
  ...
  USE :: PARAMETRIZATION_MOD,         ONLY: PARAMETRIZATION_T
  USE :: HOOKS_MOD,                   ONLY: HOOKS_T
  USE :: GRIB_ENCODER_LAZY_RULES_MOD, ONLY: RANDOM_PATTERNS_CONFIGURATOR_NAME
...
IMPLICIT NONE
  ...
  ! Local error codes
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_RANDOM_PATTERNS_CONFIGURATOR_ALREADY_ASSOCIATED=1_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_BUILD_RANDOM_PATTERNS_CONFUGIRATOR_LAZY=2_JPIB_K
  ...
  !> Construct the name of the param configurator form message and parameter
  PP_TRYCALL(ERRFLAG_BUILD_RANDOM_PATTERNS_CONFUGIRATOR_LAZY) RANDOM_PATTERNS_CONFIGURATOR_NAME( MSG, PAR, THIS%RANDOM_PATTERNS_SUBSECTION_NAME_, OPT, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_RANDOM_PATTERNS_CONFIGURATOR_ALREADY_ASSOCIATED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'random patterns configurator already associated' )
    CASE ( ERRFLAG_BUILD_RANDOM_PATTERNS_CONFUGIRATOR_LAZY )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to build random patterns configurator' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
END FUNCTION G2S4_143_BUILD_RANDOM_PATTERNS_HANDLER_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


END MODULE GRIB2_SECTION4_143_MOD
