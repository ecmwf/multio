...
PRIVATE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: MSGINTFLD_TRUNCATION_E=23_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MSGINTFLD_HDATE_E=24_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MSGINTFLD_WAVELENGTH_E=25_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MSGINTFLD_DATASET_E=26_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MSGINTFLD_ACTIVITY_E=27_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MSGINTFLD_EXPERIMENT_E=28_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MSGINTFLD_GENERATION_E=29_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MSGINTFLD_REALIZATION_E=30_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MSGINTFLD_RESOLUTION_E=31_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MSGINTFLD_METHOD_E=32_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: MSGINTFLD_SYSTEM_E=33_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: N_MSGINTFLDS=33_JPIB_K
