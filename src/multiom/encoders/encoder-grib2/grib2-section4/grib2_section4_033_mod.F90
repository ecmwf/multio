...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_INIT_SATELLITE_HANDLER) THIS%BUILD_SATELLITE_CONFIGURATOR( CFG, OPT, FACTORIES, HOOKS )
...
&  THIS%ENSEMBLE_, THIS%TEMPLATE_NUMBER_, MSG, PAR, OPT, FACTORIES, HOOKS )
  ...
  ! Build the param configurator
  PP_TRYCALL(ERRFLAG_UNABLE_TO_BUILD_SATELLITE_CONFIGURATOR) FACTORIES%MAKE_GRIB2_SATELLITE_CONFIGURATOR_LAZY( &
&  THIS%SATELLITE_, THIS%TEMPLATE_NUMBER_, MSG, PAR, OPT, FACTORIES, HOOKS )
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_033_FREE( THIS, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_DESTROY_SATELLITE) DESTRUCTORS%DESTROY_GRIB2_PARAM_CONFIGURATOR( THIS%SATELLITE_, OPT, DESTRUCTORS, HOOKS )
...
IMPLICIT NONE
  ...
  !> Make the indicator-section
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_SATELLITE_CONFIGURATOR) FACTORIES%MAKE_GRIB2_SATELLITE_CONFIGURATOR_CFG( &
&     THIS%SATELLITE_, THIS%TEMPLATE_NUMBER_, SATELLITE_CONFIGURATOR_CFG, OPT, FACTORIES, HOOKS )
