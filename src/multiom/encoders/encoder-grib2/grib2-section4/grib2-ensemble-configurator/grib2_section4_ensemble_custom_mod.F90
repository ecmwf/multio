!>
!> @file grib2_section4_ensemble_custom_mod.F90
!>
!> @brief Module for managing GRIB2 Section 4 time configuration operations.
!>
!> The `GRIB2_SECTION4_ENSEMBLE_CUSTOM_MOD` module contains procedures to initialize, allocate,
...
!>   - @see GRIB2_SECTION4_ENSEMBLE_CUSTOM_PRESET
!>   - @see GRIB2_SECTION4_ENSEMBLE_CUSTOM_RUNTIME
!>   - @see GRIB2_SECTION4_ENSEMBLE_CUSTOM_TO_BE_ENCODED
!>   - @see GRIB2_SECTION4_ENSEMBLE_CUSTOM_FREE
!>
...
#define PP_FILE_NAME 'grib2_section4_ensemble_custom_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'GRIB2_SECTION4_ENSEMBLE_CUSTOM_MOD'
MODULE GRIB2_SECTION4_ENSEMBLE_CUSTOM_MOD
...
!>
!> The `GRIB2_SECTION4_ENSEMBLE_CUSTOM_T` type extends the base class `GRIB_SECTION_BASE_A` and
...
!> environments.
!>
TYPE, EXTENDS(GRIB_SECTION_BASE_A) :: GRIB2_SECTION4_ENSEMBLE_CUSTOM_T
  ...
  INTEGER(KIND=JPIB_K) :: NUMBER_OF_FORECASTS_IN_ENSEMBLE_ = -1_JPIB_K
...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_CFG => GRIB2_SECTION4_ENSEMBLE_CUSTOM_INIT_CFG
  ...
  !> the GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_LAZY => GRIB2_SECTION4_ENSEMBLE_CUSTOM_INIT_LAZY
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ALLOCATE => GRIB2_SECTION4_ENSEMBLE_CUSTOM_ALLOCATE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => GRIB2_SECTION4_ENSEMBLE_CUSTOM_PRESET
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => GRIB2_SECTION4_ENSEMBLE_CUSTOM_RUNTIME
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => GRIB2_SECTION4_ENSEMBLE_CUSTOM_TO_BE_ENCODED
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: FREE => GRIB2_SECTION4_ENSEMBLE_CUSTOM_FREE
  ...
  !> the object has been used.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: READ_FROM_CFG => GRIB2_SECTION4_ENSEMBLE_READ_FROM_CFG
...
PUBLIC :: GRIB2_SECTION4_ENSEMBLE_CUSTOM_T
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION4_ENSEMBLE_CUSTOM_T` representing the GRIB section being initialized.
...
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_ENSEMBLE_CUSTOM_INIT_CFG'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_ENSEMBLE_CUSTOM_INIT_CFG( THIS, &
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(GRIB2_SECTION4_ENSEMBLE_CUSTOM_T),  INTENT(INOUT) :: THIS
...
END FUNCTION GRIB2_SECTION4_ENSEMBLE_CUSTOM_INIT_CFG
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_ENSEMBLE_CUSTOM_INIT_LAZY'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_ENSEMBLE_CUSTOM_INIT_LAZY( THIS, &
...
#if defined( PP_HAS_GET_GRIB2_ENSEMBLE_CONFIGURATION_FROM_MESSAGE )
  !> Symbols imported from the mapping module
  USE :: MARS2GRIB_MAPPING_MOD, ONLY: GET_GRIB2_ENSEMBLE_CONFIGURATION_FROM_MESSAGE
#endif
...
&       MSG, PAR, OPT, THIS%TYPE_OF_ENSEMBLE_FORECAST_, THIS%PERTURBATION_NUMBER_, &
&       THIS%NUMBER_OF_FORECASTS_IN_ENSEMBLE_, HOOKS )
#else
...
END FUNCTION GRIB2_SECTION4_ENSEMBLE_CUSTOM_INIT_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION4_ENSEMBLE_CUSTOM_T` representing the GRIB section to allocate resources for.
!>   @param [in]    MSG      All the mars keywords needed to describe the field `FORTRAN_MESSAGE_T`.
!>   @param [in]    PAR      All information outside mars keywords needed to describe the field `PARAMETRIZATION_T`.
!>   @param [in]    OPT      The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_ENSEMBLE_CUSTOM_ALLOCATE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_ENSEMBLE_CUSTOM_ALLOCATE( THIS, &
...
END FUNCTION GRIB2_SECTION4_ENSEMBLE_CUSTOM_ALLOCATE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION4_ENSEMBLE_CUSTOM_T` representing the GRIB section to be preset.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_ENSEMBLE_CUSTOM_PRESET'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_ENSEMBLE_CUSTOM_PRESET( THIS, &
&  MSG, PAR, OPT,  METADATA, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'typeOfEnsembleForecast', THIS%TYPE_OF_ENSEMBLE_FORECAST_ )
  ...
  PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'numberOfForecastsInEnsemble', THIS%NUMBER_OF_FORECASTS_IN_ENSEMBLE_ )
...
END FUNCTION GRIB2_SECTION4_ENSEMBLE_CUSTOM_PRESET
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS      An object of type `GRIB2_SECTION4_ENSEMBLE_CUSTOM_T` representing the GRIB section for runtime execution.
!>   @param [in]    MSG       The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR       The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_ENSEMBLE_CUSTOM_RUNTIME'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_ENSEMBLE_CUSTOM_RUNTIME( THIS, &
...
END FUNCTION GRIB2_SECTION4_ENSEMBLE_CUSTOM_RUNTIME
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS          An object of type `GRIB2_SECTION4_ENSEMBLE_CUSTOM_T` representing the GRIB section being checked.
!>   @param [in]    MSG           The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR           The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
!>   @param [in]    TIME_HIST     The time history object of type `TIME_HISTORY_T` providing historical time data.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_ENSEMBLE_CUSTOM_TO_BE_ENCODED'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_ENSEMBLE_CUSTOM_TO_BE_ENCODED( THIS, &
...
END FUNCTION GRIB2_SECTION4_ENSEMBLE_CUSTOM_TO_BE_ENCODED
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION4_ENSEMBLE_CUSTOM_T` representing the GRIB section to be freed.
!>   @param [in]    OPT   The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_ENSEMBLE_CUSTOM_FREE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_ENSEMBLE_CUSTOM_FREE( THIS, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_ENSEMBLE_CUSTOM_FREE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_ENSEMBLE_READ_FROM_CFG'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_ENSEMBLE_READ_FROM_CFG( THIS, CFG, OPT, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Local variables
  LOGICAL :: HAS_TYPE_OF_ENSEMBLE_FORECAST
  LOGICAL :: HAS_PERTURBATION_NUMBER
  LOGICAL :: HAS_NUMBER_OF_FORECASTS_IN_ENSEMBLE

  !> Local error flags
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_READ_CFG=1_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TYPE_OF_ENSEMBLE_FORECAST_NOT_PRESENT=2_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PERTURBATION_NUMBER_NOT_PRESENT=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_NUMBER_OF_FORECASTS_IN_ENSEMBLE_NOT_PRESENT=4_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_CFG) YAML_CONFIGURATION_HAS_KEY( CFG, 'type-of-ensemble-forecast', HAS_TYPE_OF_ENSEMBLE_FORECAST, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_CFG) YAML_CONFIGURATION_HAS_KEY( CFG, 'perturbation-number', HAS_PERTURBATION_NUMBER, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_CFG) YAML_CONFIGURATION_HAS_KEY( CFG, 'number-of-forecasts-in-ensemble', HAS_NUMBER_OF_FORECASTS_IN_ENSEMBLE, HOOKS )

  !> Error handling
  PP_DEBUG_CRITICAL_COND_THROW( .NOT. HAS_TYPE_OF_ENSEMBLE_FORECAST,       ERRFLAG_TYPE_OF_ENSEMBLE_FORECAST_NOT_PRESENT )
  PP_DEBUG_CRITICAL_COND_THROW( .NOT. HAS_PERTURBATION_NUMBER,             ERRFLAG_PERTURBATION_NUMBER_NOT_PRESENT )
  PP_DEBUG_CRITICAL_COND_THROW( .NOT. HAS_NUMBER_OF_FORECASTS_IN_ENSEMBLE, ERRFLAG_NUMBER_OF_FORECASTS_IN_ENSEMBLE_NOT_PRESENT )

  !> Read the encoder configuration
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_CFG) YAML_READ_INTEGER( CFG, 'type-of-ensemble-forecast',       THIS%TYPE_OF_ENSEMBLE_FORECAST_, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_CFG) YAML_READ_INTEGER( CFG, 'perturbation-number',             THIS%PERTURBATION_NUMBER_, HOOKS )
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_CFG) YAML_READ_INTEGER( CFG, 'number-of-forecasts-in-ensemble', THIS%NUMBER_OF_FORECASTS_IN_ENSEMBLE_, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_TYPE_OF_ENSEMBLE_FORECAST_NOT_PRESENT)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'type-of-ensemble-forecast not present' )
    CASE (ERRFLAG_PERTURBATION_NUMBER_NOT_PRESENT)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'perturbation-number not present' )
    CASE (ERRFLAG_NUMBER_OF_FORECASTS_IN_ENSEMBLE_NOT_PRESENT)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'number-of-forecasts-in-ensemble not present' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
END FUNCTION GRIB2_SECTION4_ENSEMBLE_READ_FROM_CFG
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


END MODULE GRIB2_SECTION4_ENSEMBLE_CUSTOM_MOD
