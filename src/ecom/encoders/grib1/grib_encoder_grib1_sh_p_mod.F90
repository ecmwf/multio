...
SUBROUTINE MAKE_GRIB1_SH_P_ENCODER( CFG, MODEL_PARAMS, METADATA_KIND, ENCODER, MIOH )
...
SUBROUTINE ENCODER_GRIB1_SH_P_INITIALISE( THIS, MODEL_PARAMS, METADATA_KIND, MIOH )
...
IMPLICIT NONE
  ...
  ! Load the sample
  PP_METADATA_INIT_FROM_SAMPLE_NAME( THIS%SAMPLE_, TRIM(ADJUSTL(SAMPLE_NAME_GRIB1_SH_P)) )
...
IMPLICIT NONE
  ...
  PP_LOG_DEVELOP_STR( 'ENCODER: grib1, spherical harmonics, pressure_level, runtime' )
