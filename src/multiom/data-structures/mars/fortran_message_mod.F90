...
IMPLICIT NONE
  ...
  !  IS_EQUAL = IS_EQUAL .AND. ( THIS%TIMEPROC .EQ. OTHER%TIMEPROC )
  !ENDIF
  ...
  !IF ( OPT%CACHE_GRID_DEFINITION_INFO ) THEN
    ...
    IS_EQUAL = IS_EQUAL .AND. ( THIS%TRUNCATION .EQ. OTHER%TRUNCATION )
  !ENDIF
...
IMPLICIT NONE
  ...
  !  IS_LOWER_THAN = IS_LOWER_THAN .AND. ( THIS%TIMEPROC .LT. OTHER%TIMEPROC )
  ! ENDIF

  ! IF ( OPT%CACHE_GRID_DEFINITION_INFO ) THEN
    IS_LOWER_THAN = IS_LOWER_THAN .AND. ( THIS%REPRES .LT. OTHER%REPRES )
    IS_LOWER_THAN = IS_LOWER_THAN .AND. ( THIS%GRID .LT. OTHER%GRID )
    IS_LOWER_THAN = IS_LOWER_THAN .AND. ( THIS%TRUNCATION .LT. OTHER%TRUNCATION )
  ! ENDIF
