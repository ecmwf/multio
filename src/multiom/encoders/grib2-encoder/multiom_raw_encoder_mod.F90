...
& THIS%ENCODER_%ALLOCATE( MSG, PAR, THIS%ENCODER_OPT_, P_METADATA, HOOKS )
...
& THIS%ENCODER_%PRESET( MSG, PAR, THIS%ENCODER_OPT_, P_METADATA, HOOKS )
...
&   MSG, PAR, THIS%ENCODER_OPT_, P_METADATA, HOOKS )
