...
IMPLICIT NONE
  ...
  IF ( CFG%GET( 'multio-no-enc-output-manager', MULTIO_NO_ENC_CFG ) ) THEN
...
IMPLICIT NONE
  ...
  IF ( THIS%VERBOSE_ ) THEN
    ...
    WRITE(THIS%LOG_FNAME_,'(A,I8.8,A)', IOSTAT=STAT) 'multio_no_enc_output_manager_', PROCESSOR_TOPO%MYPROC_IO, '.log'
...
SUBROUTINE MULTIO_NO_ENC_WRITE_ATM_DP( THIS, YDMSG, VALUES )
...
IMPLICIT NONE
  ...
  ! Get grib informations for the current message
  CALL GRIB_INFO_GET( YDMSG%PARAM_ID_, GRIB_INFO )

  ! Get the last step the same message arrived
  ...
  CERR = MIOMD%SET_STRING( "model", "atmosphere" )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )

  CERR = MIOMD%SET_LONG( "paramID", INT(YDMSG%PARAM_ID_, C_LONG) )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )

  CERR = MIOMD%SET_LONG( "curr_step", INT(YDMSG%ISTEP_, C_LONG) )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )

  ! CERR = MIOMD%SET_LONG( "prev_step", INT(PREV_STEP, C_LONG)  )
  ! PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )

  CERR = MIOMD%SET_LONG( "prev_pp",  INT(YDMSG%IPREVPP_, C_LONG) )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )

  CERR = MIOMD%SET_LONG( "prefix", INT(YDMSG%IPREF_, C_LONG)   )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )

  CERR = MIOMD%SET_LONG( "repres", INT(YDMSG%IREPRES_, C_LONG)   )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )

  CERR = MIOMD%SET_LONG( "level",  INT(YDMSG%ILEVG_, C_LONG)   )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )

  CERR = MIOMD%SET_LONG( "nvalues", INT(YDMSG%NVALUES_, C_LONG) )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )

  CERR = MIOMD%SET_LONG( "nmissing", INT(YDMSG%NUNDF_, C_LONG) )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )

  CERR = MIOMD%SET_DOUBLE( "missing_value", REAL(YDMSG%XUNDF_, C_DOUBLE)  )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )

  ! Write to multIO
  CERR = THIS%MIO_%WRITE_FIELD(MIOMD, VALUES )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )
...
SUBROUTINE MULTIO_NO_ENC_WRITE_ATM_SP( THIS, YDMSG, VALUES )
...
SUBROUTINE MULTIO_NO_ENC_WRITE_WAM_DP( THIS, YDMSG, VALUES )
...
IMPLICIT NONE
  ...
  ! Depending on the type of message write info to multIO
  CERR = MIOMD%SET_STRING( "model", "wave" )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )
  ...
  CERR = MIOMD%SET_LONG( "angle", INT(YDMSG%IANGLE, C_LONG)   )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )

  CERR = MIOMD%SET_LONG( "frequency", INT(YDMSG%IFREQ, C_LONG)   )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )

  CERR = MIOMD%SET_LONG( "ndate_time_win_end", INT(YDMSG%NDATE_TIME_WINDOW_END, C_LONG)   )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )

  CERR = MIOMD%SET_LONG( "kcoupstep", INT(YDMSG%KCOUSTEP, C_LONG) )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )

  CERR = MIOMD%SET_LONG( "lrstst0", L2I(YDMSG%LRSTST0)  )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )

  CERR = MIOMD%SET_LONG( "itable", INT(YDMSG%ITABLE, C_LONG)  )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )

  CERR = MIOMD%SET_LONG( "iparam", INT(YDMSG%IPARAM, C_LONG)  )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )

  CERR = MIOMD%SET_LONG( "klev", INT(YDMSG%KLEV, C_LONG)  )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )

  CERR = MIOMD%SET_LONG( "ifcst", INT(YDMSG%IFCST, C_LONG)  )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )

  CERR = MIOMD%SET_LONG( "nstep", INT(YDMSG%NSTEP, C_LONG)  )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )

  CERR = MIOMD%SET_STRING( "marstype", YDMSG%MARSTYPE  )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )

  CERR = MIOMD%SET_STRING( "cdate", YDMSG%CDATE  )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )


  ! Write to multIO
  CERR = THIS%MIO_%WRITE_FIELD(MIOMD, VALUES(1:YDMSG%NVALUES_) )
  PP_DEBUG_DEVELOP_COND_THROW( CERR.NE.MULTIO_SUCCESS,  2 )
...
SUBROUTINE MULTIO_NO_ENC_WRITE_WAM_SP( THIS, YDMSG, VALUES )
