...
#define PP_FILE_NAME 'grib_encoder_grib1_gg_t_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'GRIB_ENCODER_GRIB1_GG_T_MOD'
MODULE GRIB_ENCODER_GRIB1_GG_T_MOD
...
CONTAINS
  ! Virtual procedures
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INITIALISE => ENCODER_GRIB1_GG_T_INITIALISE
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ENCODE_ATM => ENCODER_GRIB1_GG_T_ENCODE_ATM
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ENCODE_WAM => ENCODER_GRIB1_GG_T_ENCODE_WAM
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: FINALISE   => ENCODER_GRIB1_GG_T_FINALISE
END TYPE

! Name of the grib sample to be loaded
CHARACTER(LEN=*), PARAMETER :: SAMPLE_NAME_GRIB1_GG_T='gg_sfc_grib1'

! Whitelist of public symbols
PUBLIC :: MAKE_GRIB1_GG_T_ENCODER
PUBLIC :: DESTROY_GRIB1_GG_T_ENCODER

CONTAINS


#define PP_PROCEDURE_TYPE 'SUBROUTINE'
#define PP_PROCEDURE_NAME 'MAKE_GRIB1_GG_T_ENCODER'
SUBROUTINE MAKE_GRIB1_GG_T_ENCODER( CFG, MODEL_PARAMS, METADATA_KIND, ENCODER )
...
END SUBROUTINE MAKE_GRIB1_GG_T_ENCODER
...
#define PP_PROCEDURE_TYPE 'SUBROUTINE'
#define PP_PROCEDURE_NAME 'DESTROY_GRIB1_GG_T_ENCODER'
SUBROUTINE DESTROY_GRIB1_GG_T_ENCODER( ENCODER )
...
END SUBROUTINE DESTROY_GRIB1_GG_T_ENCODER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'SUBROUTINE'
#define PP_PROCEDURE_NAME 'ENCODER_GRIB1_GG_T_INITIALISE'
SUBROUTINE ENCODER_GRIB1_GG_T_INITIALISE( THIS, MODEL_PARAMS, METADATA_KIND )
...
IMPLICIT NONE
  ...
  CALL GRIB_NEW_FROM_SAMPLES( THIS%SAMPLE_HANDLE_, TRIM(ADJUSTL(SAMPLE_NAME_GRIB1_GG_T)), STATUS=KRET )
...
END SUBROUTINE ENCODER_GRIB1_GG_T_INITIALISE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'ENCODER_GRIB1_GG_T_ENCODE_ATM'
FUNCTION ENCODER_GRIB1_GG_T_ENCODE_ATM( THIS, MODEL_PARAMS, GRIB_INFO, &
...
IMPLICIT NONE
  ...
  PP_LOG_DEVELOP_STR( 'Grib1 THETA_LEVEL encoder' )

  ! Metadata initialisation (clone the sample)
  PP_METADATA_INIT_FROM_SAMPLE( METADATA, SAMPLE_NAME_GRIB1_GG_T, THIS%SAMPLE_HANDLE_ )
...
END FUNCTION ENCODER_GRIB1_GG_T_ENCODE_ATM
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'ENCODER_GRIB1_GG_T_ENCODE_WAM'
FUNCTION ENCODER_GRIB1_GG_T_ENCODE_WAM( THIS, MODEL_PARAMS, GRIB_INFO, &
& TIME_HIST, CURR_TIME, MSG, METADATA ) RESULT(EX)
...
END FUNCTION ENCODER_GRIB1_GG_T_ENCODE_WAM
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'SUBROUTINE'
#define PP_PROCEDURE_NAME 'ENCODER_GRIB1_GG_T_FINALISE'
SUBROUTINE ENCODER_GRIB1_GG_T_FINALISE( THIS )
...
END SUBROUTINE ENCODER_GRIB1_GG_T_FINALISE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE

END MODULE GRIB_ENCODER_GRIB1_GG_T_MOD
