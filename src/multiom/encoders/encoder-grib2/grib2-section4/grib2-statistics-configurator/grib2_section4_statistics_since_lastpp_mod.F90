...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_EXPECTED_TIMEPROC=10_JPIB_K
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_EXPECTED_TIMEPROC )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'expected timeproc in mars dictionary' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_STATISTICS_SINCE_LASTPP_FREE( THIS, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
