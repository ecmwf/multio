...
IMPLICIT NONE
  ...
  !   PP_TRYCALL(ERRFLAG_ALLOCATION_ERROR) G2S4_045_ALLOCATE( GRIB2_SECTION4, HOOKS )
  ...
  !   PP_TRYCALL(ERRFLAG_ALLOCATION_ERROR) G2S4_049_ALLOCATE( GRIB2_SECTION4, HOOKS )
  ...
  CASE (60)
    ...
    PP_TRYCALL(ERRFLAG_ALLOCATION_ERROR) G2S4_060_ALLOCATE( GRIB2_SECTION4, HOOKS )
