...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_GET_INFO=9_JPIB_K
...
&     C_ENCODER_MTG2_PP, 1_JPIB_K, C_ENCODER_MTG2_P, HOOKS )
  ...
  IF ( HAS_OPTIONS ) THEN
    ...
    PP_TRYCALL(ERRFLAG_UNABLE_TO_GET_INFO) F_C_GET_INFO_WRAPPER( C_OPTIONS_P, &
&     OBJ_ID, OBJ_SIZE, BUF_SIZE, HASH, HOOKS, VERIFY_CHECKSUM=.FALSE. )
    ...
    CASE ( OPT_DICTIONARY_IDX_E )
      BLOCK
        ...
        OPT_DICT => NULL()
        PP_TRYCALL(ERRFLAG_EXTRACT_DICTIONARY) EXTRACT_OPT_DICTIONARY( C_OPTIONS_P, OPT_DICT, HOOKS )
        F_ENCODER_OPTIONS%PRINT_WHOLE_ERROR_STACK = OPT_DICT%PRINT_WHOLE_ERROR_STACK
        F_ENCODER_OPTIONS%PRINT_DICTIONARIES = OPT_DICT%PRINT_DICTIONARIES
        OPT_DICT => NULL()
      END BLOCK
...
IMPLICIT NONE
  ...
  !> Local error flags
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CMARS_DICT_NOT_ASSOCIATED=1_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CPAR_DICT_NOT_ASSOCIATED=2_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CGEO_DICT_NOT_ASSOCIATED=3_JPIB_K
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNKNOWN_DICTIONARY=6_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_FMARS_DICT_NOT_ASSOCIATED=7_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_FPAR_DICT_NOT_ASSOCIATED=8_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_FGEO_DICT_NOT_ASSOCIATED=9_JPIB_K
  ...
  !> Extract mars from the dictionary
  PP_TRYCALL(ERRFLAG_UNABLE_TO_GET_INFO) F_C_GET_INFO_WRAPPER( C_MARS_DICT_P, &
&   OBJ_ID, OBJ_SIZE, BUF_SIZE, HASH, HOOKS, VERIFY_CHECKSUM=.FALSE. )
  PP_TRYCALL(ERRFLAG_EXTRACT_DICTIONARY) EXTRACT_MARS_DICTIONARY( C_MARS_DICT_P, F_MARS_DICT_P, HOOKS )

  !> Extract parametrization from the dictionary
  PP_TRYCALL(ERRFLAG_UNABLE_TO_GET_INFO) F_C_GET_INFO_WRAPPER( C_PAR_DICT_P, &
&   OBJ_ID, OBJ_SIZE, BUF_SIZE, HASH, HOOKS, VERIFY_CHECKSUM=.FALSE. )
  PP_TRYCALL(ERRFLAG_EXTRACT_DICTIONARY) EXTRACT_PAR_DICTIONARY( C_PAR_DICT_P, F_PAR_DICT_P, HOOKS )

  !> Extract geometry from the dictionary
  PP_TRYCALL(ERRFLAG_UNABLE_TO_GET_INFO) F_C_GET_INFO_WRAPPER( C_GEO_DICT_P, &
&   OBJ_ID, OBJ_SIZE, BUF_SIZE, HASH, HOOKS, VERIFY_CHECKSUM=.FALSE. )
  SELECT CASE ( OBJ_ID )
  CASE (HEALPIX_DICTIONARY_IDX_E)
    BLOCK
      ...
      HEALPIX_DICT => NULL()
      PP_TRYCALL(ERRFLAG_EXTRACT_DICTIONARY) EXTRACT_HEALPIX_DICTIONARY( C_GEO_DICT_P, HEALPIX_DICT, HOOKS )
      F_GEO_DICT_P => HEALPIX_DICT
      HEALPIX_DICT => NULL()
    END BLOCK
  CASE (REDUCED_GG_DICTIONARY_IDX_E)
    BLOCK
      ...
      PP_TRYCALL(ERRFLAG_EXTRACT_DICTIONARY) EXTRACT_REDUCED_GG_DICTIONARY( C_GEO_DICT_P, REDUCED_GG_DICT, HOOKS )
      F_GEO_DICT_P => REDUCED_GG_DICT
      REDUCED_GG_DICT => NULL()
    END BLOCK
  CASE (REGULAR_GG_DICTIONARY_IDX_E)
    BLOCK
      ...
      PP_TRYCALL(ERRFLAG_EXTRACT_DICTIONARY) EXTRACT_REGULAR_GG_DICTIONARY( C_GEO_DICT_P, REGULAR_GG_DICT, HOOKS )
      F_GEO_DICT_P => REGULAR_GG_DICT
      REGULAR_GG_DICT => NULL()
    END BLOCK
  CASE (REGULAR_LL_DICTIONARY_IDX_E)
    BLOCK
      ...
      PP_TRYCALL(ERRFLAG_EXTRACT_DICTIONARY) EXTRACT_REGULAR_LL_DICTIONARY( C_GEO_DICT_P, REGULAR_LL_DICT, HOOKS )
      F_GEO_DICT_P => REGULAR_LL_DICT
      REGULAR_LL_DICT => NULL()
    END BLOCK
  CASE (SH_DICTIONARY_IDX_E)
    BLOCK
      ...
      SH_DICT => NULL()
      PP_TRYCALL(ERRFLAG_EXTRACT_DICTIONARY) EXTRACT_SH_DICTIONARY( C_GEO_DICT_P, SH_DICT, HOOKS )
      F_GEO_DICT_P => SH_DICT
      SH_DICT => NULL()
    END BLOCK
  CASE DEFAULT
    PP_DEBUG_CRITICAL_THROW( ERRFLAG_UNKNOWN_DICTIONARY )
  END SELECT
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_CMARS_DICT_NOT_ASSOCIATED)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'C MARS dictionary not associated' )
    CASE (ERRFLAG_CPAR_DICT_NOT_ASSOCIATED)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'C Parametrization dictionary not associated' )
    CASE (ERRFLAG_CGEO_DICT_NOT_ASSOCIATED)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'C Geometry dictionary not associated' )
    CASE (ERRFLAG_UNABLE_TO_GET_INFO)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unable to get info' )
    CASE (ERRFLAG_EXTRACT_DICTIONARY)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unable to extract dictionary' )
    CASE (ERRFLAG_UNKNOWN_DICTIONARY)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unknown dictionary type' )
    CASE (ERRFLAG_FMARS_DICT_NOT_ASSOCIATED)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Fortran MARS dictionary not associated' )
    CASE (ERRFLAG_FPAR_DICT_NOT_ASSOCIATED)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Fortran Parametrization dictionary not associated' )
    CASE (ERRFLAG_FGEO_DICT_NOT_ASSOCIATED)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Fortran Geometry dictionary not associated' )
    CASE DEFAULT
