...
#define PP_FILE_NAME 'reduced_gg_map_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'REDUCED_GG_MAP_MOD'
MODULE REDUCED_GG_MAP_MOD
...
TYPE :: REDUCED_GG_GEOM_NODE_T

  !> Key
  CHARACTER(LEN=8) :: KEY=REPEAT(' ', 8)

  !> Value
  TYPE(REDUCED_GG_GEOMETRY_T), POINTER :: GEOMETRY_ => NULL()
  ...
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER :: PARENT => NULL()

  !> Pointer to the lef subtree
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER :: LEFT   => NULL()

  !> Pointer to the right subtree
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER :: RIGHT  => NULL()

END TYPE


!> @brief Datatype used to to store the entire map
TYPE :: REDUCED_GG_GEOM_MAP_T

  !> Pointer to the class
  PRIVATE

  !> Pointer to the root node
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER :: ROOT => NULL()
...
TYPE(REDUCED_GG_GEOM_NODE_T), TARGET :: NIL

!> Whitelist of public symbols
PUBLIC :: REDUCED_GG_GEOM_MAP_T
PUBLIC :: REDUCED_GG_GEOMETRY_T
...
PP_THREAD_SAFE FUNCTION INSERT_NODE( ROOT, KEY, GEOM, INSERTED, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER, INTENT(INOUT) :: ROOT
  CHARACTER(LEN=8),                      INTENT(IN)    :: KEY
  TYPE(REDUCED_GG_GEOMETRY_T), POINTER,  INTENT(IN)    :: GEOM
  ...
  ! Local variables
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER :: INSERTION_POINT
  LOGICAL :: FOUND
  LOGICAL :: KEY_LT
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER, INTENT(INOUT) :: CURRENT
  TYPE(HOOKS_T),                         INTENT(INOUT) :: HOOKS
...
PP_THREAD_SAFE FUNCTION NODE_INIT( THIS, PARENT, KEY, GEOM, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(REDUCED_GG_GEOM_NODE_T),          INTENT(INOUT) :: THIS
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER, INTENT(IN)    :: PARENT
  CHARACTER(LEN=8),                      INTENT(IN)    :: KEY
  TYPE(REDUCED_GG_GEOMETRY_T), POINTER,  INTENT(IN)    :: GEOM
  TYPE(HOOKS_T),                         INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER, INTENT(INOUT) :: X
  TYPE(HOOKS_T),                         INTENT(INOUT) :: HOOKS
  ...
  IF ( ASSOCIATED( X ) ) THEN
    ...
    ! Free mappers
    IF ( ASSOCIATED( X%GEOMETRY_ ) ) THEN
      IF ( X%GEOMETRY_%TO_BE_DEALLOCATED .AND. ASSOCIATED(X%GEOMETRY_%PL) ) THEN
        DEALLOCATE( X%GEOMETRY_%PL, STAT=DEALLOC_STATUS, ERRMSG=ERRMSG )
        PP_DEBUG_CRITICAL_COND_THROW( DEALLOC_STATUS.NE.0, ERRFLAG_UNABLE_TO_DEALLOCATE_NODE )
      ENDIF
      X%GEOMETRY_%PL => NULL()
      DEALLOCATE( X%GEOMETRY_, STAT=DEALLOC_STATUS, ERRMSG=ERRMSG )
      PP_DEBUG_CRITICAL_COND_THROW( DEALLOC_STATUS.NE.0, ERRFLAG_UNABLE_TO_DEALLOCATE_NODE )
      NULLIFY(  X%GEOMETRY_ )
    ENDIF
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER, INTENT(INOUT) :: ROOT
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER, INTENT(INOUT) :: CUR
  TYPE(HOOKS_T),                         INTENT(INOUT) :: HOOKS
  ...
  ! Local variables
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER :: Y
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER :: X
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER, INTENT(INOUT) :: ROOT
  TYPE(REDUCED_GG_GEOM_NODE_T), TARGET,  INTENT(INOUT) :: X_
  TYPE(HOOKS_T),                         INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER, INTENT(IN)    :: X
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER, INTENT(IN)    :: X
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER, INTENT(OUT)   :: Y
  TYPE(HOOKS_T),                         INTENT(INOUT) :: HOOKS
  ...
  ! Local variables
  LOGICAL :: IS_LEAF
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER :: X_
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER, INTENT(INOUT) :: NODE_1
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER, INTENT(INOUT) :: NODE_2
  TYPE(HOOKS_T),                         INTENT(INOUT) :: HOOKS
  ...
  ! Local variables
  CHARACTER(LEN=8) :: KEY
  TYPE(REDUCED_GG_GEOMETRY_T), POINTER :: GEOM
  ...
  GEOM => NODE_1%GEOMETRY_
  NODE_1%GEOMETRY_ => NODE_2%GEOMETRY_
  NODE_2%GEOMETRY_ => GEOM
  GEOM => NULL()
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER, INTENT(INOUT) :: ROOT
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER, INTENT(INOUT) :: Z
  TYPE(HOOKS_T),                         INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Local variables
  LOGICAL :: IS_LEAF
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER :: W
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER, INTENT(IN)    :: ROOT
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER, INTENT(IN)    :: CURRENT
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(REDUCED_GG_GEOM_NODE_T), INTENT(INOUT) :: ROOT
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  CLASS(REDUCED_GG_GEOM_NODE_T), INTENT(INOUT) :: ROOT
  INTEGER(KIND=JPIB_K),          INTENT(IN)    :: UNIT
  TYPE(HOOKS_T),                 INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER, INTENT(INOUT) :: NODE
  ...
  ! Local variables
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER :: Y
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER :: PREV
  LOGICAL :: IS_LEAF
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  CLASS(REDUCED_GG_GEOM_MAP_T), INTENT(INOUT) :: ENCODERS_MAP
  TYPE(HOOKS_T),                INTENT(INOUT) :: HOOKS
...
PP_THREAD_SAFE FUNCTION MAPPING_CACHE_PUSH( THIS, KEY, GEOM, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  CLASS(REDUCED_GG_GEOM_MAP_T),         INTENT(INOUT) :: THIS
  CHARACTER(LEN=8),                     INTENT(IN)    :: KEY
  TYPE(REDUCED_GG_GEOMETRY_T), POINTER, INTENT(IN)    :: GEOM
  TYPE(HOOKS_T),                        INTENT(INOUT) :: HOOKS
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_CALL_INSERT_NODE) INSERT_NODE( &
     THIS%ROOT, KEY, GEOM, INSERTED, HOOKS )
...
IMPLICIT NONE
  ...
  ! Local variables
  LOGICAL :: ROOT_IS_LEAF
  TYPE(REDUCED_GG_GEOM_NODE_T), POINTER :: SEARCHED_NODE
...
PP_THREAD_SAFE FUNCTION MAPPING_CACHE_GET( THIS, KEY, GEOM, LMATCH, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  CLASS(REDUCED_GG_GEOM_MAP_T),         INTENT(INOUT) :: THIS
  CHARACTER(LEN=8),                     INTENT(IN)    :: KEY
  TYPE(REDUCED_GG_GEOMETRY_T), POINTER, INTENT(OUT)   :: GEOM
  LOGICAL,                              INTENT(OUT)   :: LMATCH
  TYPE(HOOKS_T),                        INTENT(INOUT) :: HOOKS
