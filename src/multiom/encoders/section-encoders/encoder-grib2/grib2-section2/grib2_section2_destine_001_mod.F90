...
!>
!> The `GRIB2_SECTION2_DESTINE_001_MOD` module contains procedures to initialize, allocate,
...
!>   - @see GRIB2_SECTION2_DESTINE_001_INIT
!>   - @see GRIB2_SECTION2_DESTINE_001_ALLOCATE
!>   - @see GRIB2_SECTION2_DESTINE_001_PRESET
!>   - @see GRIB2_SECTION2_DESTINE_001_RUNTIME
!>   - @see GRIB2_SECTION2_DESTINE_001_TO_BE_ENCODED
...
#define PP_FILE_NAME 'grib2_section2_destine_001_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'GRIB2_SECTION2_DESTINE_001_MOD'
MODULE GRIB2_SECTION2_DESTINE_001_MOD
...
!>
!> The `GRIB2_SECTION2_DESTINE_001_T` type extends the base class `GRIB_SECTION_BASE_A` and
...
!> environments.
!>
TYPE, EXTENDS(GRIB_SECTION_BASE_A) :: GRIB2_SECTION2_DESTINE_001_T
...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_CFG => GRIB2_SECTION2_DESTINE_001_INIT_CFG
  ...
  !> the GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_LAZY => GRIB2_SECTION2_DESTINE_001_INIT_LAZY
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ALLOCATE => GRIB2_SECTION2_DESTINE_001_ALLOCATE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => GRIB2_SECTION2_DESTINE_001_PRESET
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => GRIB2_SECTION2_DESTINE_001_RUNTIME
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => GRIB2_SECTION2_DESTINE_001_TO_BE_ENCODED
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: FREE => GRIB2_SECTION2_DESTINE_001_FREE
...
PUBLIC :: GRIB2_SECTION2_DESTINE_001_T
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION2_DESTINE_001_T` representing the GRIB section being initialized.
...
#define PP_PROCEDURE_NAME 'GRIB2_SECTION2_DESTINE_001_INIT_CFG'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION2_DESTINE_001_INIT_CFG( THIS, &
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(GRIB2_SECTION2_DESTINE_001_T),  INTENT(INOUT) :: THIS
...
END FUNCTION GRIB2_SECTION2_DESTINE_001_INIT_CFG
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION2_DESTINE_001_INIT_LAZY'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION2_DESTINE_001_INIT_LAZY( THIS, &
...
END FUNCTION GRIB2_SECTION2_DESTINE_001_INIT_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION2_DESTINE_001_T` representing the GRIB section to allocate resources for.
!>   @param [in]    MSG      All the mars keywords needed to describe the field `FORTRAN_MESSAGE_T`.
!>   @param [in]    PAR      All information outside mars keywords needed to describe the field `PARAMETRIZATION_T`.
!>   @param [in]    OPT      The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION2_DESTINE_001_ALLOCATE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION2_DESTINE_001_ALLOCATE( THIS, &
...
END FUNCTION GRIB2_SECTION2_DESTINE_001_ALLOCATE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION2_DESTINE_001_T` representing the GRIB section to be preset.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION2_DESTINE_001_PRESET'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION2_DESTINE_001_PRESET( THIS, &
&  MSG, PAR, OPT,  METADATA, HOOKS ) RESULT(RET)
  ...
  USE :: ENUMERATORS_MOD,          ONLY: DATASET_CLIMATE_DT_E
  USE :: ENUMERATORS_MOD,          ONLY: DATASET_EXTREMES_DT_E
  USE :: ENUMERATORS_MOD,          ONLY: DATASET_ON_DEMAND_CLIMATE_DT_E
  USE :: ENUMERATORS_MOD,          ONLY: DATASET_ON_DEMAND_EXTREMES_DT_E
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CLASS_UNDEFINED=4_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_EXPVER_UNDEFINED=5_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_DATASET_UNDEFINED=6_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_ACTIVITY_UNDEFINED=7_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_EXPERIMENT_UNDEFINED=8_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_RESOLUTION_UNDEFINED=9_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_GENERATION_UNDEFINED=10_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_REALIZATION_UNDEFINED=11_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_ACTIVITY_UNEXPECTED=12_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_EXPERIMENT_UNEXPECTED=13_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_RESOLUTION_UNEXPECTED=14_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_GENERATION_UNEXPECTED=15_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_REALIZATION_UNEXPECTED=16_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_NOT_IMPLEMENTED=17_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNEXPECTED_VALUE_OF_DATASET=18_JPIB_K
  ...
  ! Error handling
  PP_DEBUG_CRITICAL_COND_THROW( .NOT. ASSOCIATED(METADATA), ERRFLAG_METADATA )
  PP_DEBUG_CRITICAL_COND_THROW( MSG%STREAM.EQ.UNDEF_PARAM_E, ERRFLAG_STREAM_UNDEFINED )
  PP_DEBUG_CRITICAL_COND_THROW( MSG%TYPE.EQ.UNDEF_PARAM_E, ERRFLAG_TYPE_UNDEFINED )
  PP_DEBUG_CRITICAL_COND_THROW( MSG%CLASS.EQ.UNDEF_PARAM_E, ERRFLAG_CLASS_UNDEFINED )
  PP_DEBUG_CRITICAL_COND_THROW( MSG%EXPVER.EQ.REPEAT('*',4), ERRFLAG_EXPVER_UNDEFINED )

  ! Dataset must always be present in Destine
  PP_DEBUG_CRITICAL_COND_THROW( MSG%DATASET.EQ.UNDEF_PARAM_E, ERRFLAG_DATASET_UNDEFINED )
  ...
  ! Destine related metadata
  PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'dataset', MSG%DATASET )

  SELECT CASE (MSG%DATASET)

  CASE (DATASET_CLIMATE_DT_E) ! ClimateDT

    PP_DEBUG_CRITICAL_COND_THROW( MSG%ACTIVITY.EQ.UNDEF_PARAM_E, ERRFLAG_ACTIVITY_UNDEFINED )
    PP_DEBUG_CRITICAL_COND_THROW( MSG%EXPERIMENT.EQ.UNDEF_PARAM_E, ERRFLAG_EXPERIMENT_UNDEFINED )
    PP_DEBUG_CRITICAL_COND_THROW( MSG%RESOLUTION.EQ.UNDEF_PARAM_E, ERRFLAG_RESOLUTION_UNDEFINED )
    PP_DEBUG_CRITICAL_COND_THROW( MSG%GENERATION.EQ.UNDEF_PARAM_E .OR. MSG%GENERATION.LT.0_JPIB_K, ERRFLAG_GENERATION_UNDEFINED )
    PP_DEBUG_CRITICAL_COND_THROW( MSG%REALIZATION.EQ.UNDEF_PARAM_E .OR.  MSG%REALIZATION.LT.0_JPIB_K, ERRFLAG_REALIZATION_UNDEFINED )

    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'activity', MSG%ACTIVITY )
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'experiment', MSG%EXPERIMENT )
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'resolution', MSG%RESOLUTION )
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'generation', MSG%GENERATION )
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'realization', MSG%REALIZATION )

  CASE (DATASET_EXTREMES_DT_E) ! ExtremesDT

    ! For extremesDT only "dataset" is needed, other parameters are not needed
    PP_DEBUG_CRITICAL_COND_THROW( MSG%ACTIVITY.NE.UNDEF_PARAM_E, ERRFLAG_ACTIVITY_UNEXPECTED )
    PP_DEBUG_CRITICAL_COND_THROW( MSG%EXPERIMENT.NE.UNDEF_PARAM_E, ERRFLAG_EXPERIMENT_UNEXPECTED )
    PP_DEBUG_CRITICAL_COND_THROW( MSG%RESOLUTION.NE.UNDEF_PARAM_E, ERRFLAG_RESOLUTION_UNEXPECTED )
    PP_DEBUG_CRITICAL_COND_THROW( MSG%GENERATION.NE.UNDEF_PARAM_E, ERRFLAG_GENERATION_UNEXPECTED )
    PP_DEBUG_CRITICAL_COND_THROW( MSG%REALIZATION.NE.UNDEF_PARAM_E, ERRFLAG_REALIZATION_UNEXPECTED )

  CASE (DATASET_ON_DEMAND_EXTREMES_DT_E) ! OnDemandExtremesDT

    ! On demand requires the keyword "geoRef" still not defined in the "datamod"
    PP_DEBUG_CRITICAL_THROW( ERRFLAG_NOT_IMPLEMENTED )

  CASE (DATASET_ON_DEMAND_CLIMATE_DT_E) ! OnDemandClimateDT
  ...
  CASE DEFAULT
    ...
    PP_DEBUG_CRITICAL_THROW( ERRFLAG_UNEXPECTED_VALUE_OF_DATASET )

  END SELECT

  ! Destine related parametrization
  IF (PAR%DESTINE_LOCAL_VERSION.EQ.UNDEF_PARAM_E) THEN
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'destineLocalVersion', 1_JPIB_K )
  ELSE
    PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'destineLocalVersion', PAR%DESTINE_LOCAL_VERSION )
  ENDIF
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_METADATA )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'error using metadata' )
    CASE ( ERRFLAG_STREAM_UNDEFINED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'stream is undefined' )
    CASE ( ERRFLAG_TYPE_UNDEFINED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'type is undefined' )
    CASE ( ERRFLAG_CLASS_UNDEFINED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'class is undefined' )
    CASE ( ERRFLAG_EXPVER_UNDEFINED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'expver is undefined' )
    CASE ( ERRFLAG_DATASET_UNDEFINED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'dataset is undefined' )
    CASE ( ERRFLAG_ACTIVITY_UNDEFINED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'activity is undefined' )
    CASE ( ERRFLAG_EXPERIMENT_UNDEFINED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'experiment is undefined' )
    CASE ( ERRFLAG_RESOLUTION_UNDEFINED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'resolution is undefined' )
    CASE ( ERRFLAG_GENERATION_UNDEFINED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'generation is undefined' )
    CASE ( ERRFLAG_REALIZATION_UNDEFINED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'realization is undefined' )
    CASE ( ERRFLAG_ACTIVITY_UNEXPECTED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'activity is unexpected' )
    CASE ( ERRFLAG_EXPERIMENT_UNEXPECTED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'experiment is unexpected' )
    CASE ( ERRFLAG_RESOLUTION_UNEXPECTED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'resolution is unexpected' )
    CASE ( ERRFLAG_GENERATION_UNEXPECTED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'generation is unexpected' )
    CASE ( ERRFLAG_REALIZATION_UNEXPECTED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'realization is unexpected' )
    CASE ( ERRFLAG_NOT_IMPLEMENTED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'functionality not implemented' )
    CASE ( ERRFLAG_UNEXPECTED_VALUE_OF_DATASET )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unexpected value of dataset' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
END FUNCTION GRIB2_SECTION2_DESTINE_001_PRESET
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS      An object of type `GRIB2_SECTION2_DESTINE_001_T` representing the GRIB section for runtime execution.
!>   @param [in]    MSG       The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR       The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION2_DESTINE_001_RUNTIME'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION2_DESTINE_001_RUNTIME( THIS, &
...
END FUNCTION GRIB2_SECTION2_DESTINE_001_RUNTIME
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS          An object of type `GRIB2_SECTION2_DESTINE_001_T` representing the GRIB section being checked.
!>   @param [in]    MSG           The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR           The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
!>   @param [in]    TIME_HIST     The time history object of type `TIME_HISTORY_T` providing historical time data.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION2_DESTINE_001_TO_BE_ENCODED'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION2_DESTINE_001_TO_BE_ENCODED( THIS, &
...
END FUNCTION GRIB2_SECTION2_DESTINE_001_TO_BE_ENCODED
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION2_DESTINE_001_T` representing the GRIB section to be freed.
!>   @param [in]    OPT   The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION2_DESTINE_001_FREE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION2_DESTINE_001_FREE( THIS, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION2_DESTINE_001_FREE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE

END MODULE GRIB2_SECTION2_DESTINE_001_MOD
