...
IMPLICIT NONE
  ...
  ! Error handling
  PP_DEBUG_DEVELOP_COND_THROW( GRIB_INFO%REQUESTED_ENCODING.LT.1, 1 )
  PP_DEBUG_DEVELOP_COND_THROW( GRIB_INFO%REQUESTED_ENCODING.GT.2, 2 )

  ! Create the index of the encoder to be used
  IDX = ENCODER_ID_PRE( MSG%IPREF_, MSG%IREPRES_, GRIB_INFO%REQUESTED_ENCODING )
