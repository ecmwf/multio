...
&               CFG, OPT, HOOKS ) RESULT(RET)
  ...
  USE :: GRIB2_SECTION4_000_MOD,   ONLY: G2S4_000_MAKE
  USE :: GRIB2_SECTION4_001_MOD,   ONLY: G2S4_001_MAKE
  USE :: GRIB2_SECTION4_008_MOD,   ONLY: G2S4_008_MAKE
  USE :: GRIB2_SECTION4_011_MOD,   ONLY: G2S4_011_MAKE
  USE :: GRIB2_SECTION4_032_MOD,   ONLY: G2S4_032_MAKE
...
IMPLICIT NONE
  ...
  CASE (0)
    ...
    PP_TRYCALL(ERRFLAG_ALLOCATION_ERROR) G2S4_000_MAKE( GRIB2_SECTION4, HOOKS )
  ...
  CASE (8)
    ...
    PP_TRYCALL(ERRFLAG_ALLOCATION_ERROR) G2S4_008_MAKE( GRIB2_SECTION4, HOOKS )

  CASE (11)

    PP_TRYCALL(ERRFLAG_ALLOCATION_ERROR) G2S4_011_MAKE( GRIB2_SECTION4, HOOKS )

  CASE (32)

    PP_TRYCALL(ERRFLAG_ALLOCATION_ERROR) G2S4_032_MAKE( GRIB2_SECTION4, HOOKS )
