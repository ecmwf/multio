...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_103_FREE( THIS, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Free all the memory
  PP_TRYCALL(ERRFLAG_DESTROY_TIME)   DESTRUCTORS%DESTROY_GRIB2_POINT_IN_TIME_CONFIGURATOR( THIS%TIME_, OPT, DESTRUCTORS, HOOKS )
  ...
  PP_TRYCALL(ERRFLAG_DESTROY_PERIOD) DESTRUCTORS%DESTROY_GRIB2_PERIOD_CONFIGURATOR( THIS%PERIOD_, OPT, DESTRUCTORS, HOOKS )
