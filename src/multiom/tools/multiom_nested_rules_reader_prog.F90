...
IMPLICIT NONE
  ...
  ENCODER_OPT%LOG_RULES_TREE = .TRUE.
  ENCODER_OPT%LOG_RULES_FILES = .TRUE.
  ...
  PP_TRYCALL(ERRFLAG_RULES_PRINT) ENCODING_RULES_TREE_LOADER%SIZE( SZ, MAX_SZ, MAX_LEVELS, HOOKS )
