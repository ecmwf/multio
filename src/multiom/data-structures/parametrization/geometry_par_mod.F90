...
TYPE :: GEOMETRY_PAR_T
  TYPE(REPRES_MAP_T), POINTER :: REPRESENTATIONS => NULL()
CONTAINS
...
IMPLICIT NONE
  ...
  GEOMETRY_PAR%REPRESENTATIONS => NULL()
...
IMPLICIT NONE
  ...
  ! Copy the data
  GEOMETRY_PAR_TO%REPRESENTATIONS => GEOMETRY_PAR_FROM%REPRESENTATIONS
...
PP_THREAD_SAFE FUNCTION DEFINITION_GG_READ_FROM_YAML( CONFIG, GEOMETRY_PAR, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION DEFINITION_LL_READ_FROM_YAML( CONFIG, GEOMETRY_PAR, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION DEFINITION_SH_READ_FROM_YAML( CONFIG, GEOMETRY_PAR, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION READ_GG_GEOMETRY( CONFIG, GG_MAP, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION READ_SH_GEOMETRY( CONFIG, SH_MAP, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION READ_LL_GEOMETRY( CONFIG, LL_MAP, HOOKS ) RESULT(RET)
