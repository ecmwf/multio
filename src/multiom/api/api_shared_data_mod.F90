...
MODULE API_SHARED_DATA_MOD
  ...
  USE :: MAP_INT64_HEALPIX_DICT_MOD,    ONLY: MAP_INT64_HEALPIX_DICT_T
  USE :: MAP_INT64_REDUCED_GG_DICT_MOD, ONLY: MAP_INT64_REDUCED_GG_DICT_T
  USE :: MAP_INT64_REGULAR_GG_DICT_MOD, ONLY: MAP_INT64_REGULAR_GG_DICT_T
  USE :: MAP_INT64_REGULAR_LL_DICT_MOD, ONLY: MAP_INT64_REGULAR_LL_DICT_T
...
INTEGER(KIND=JPIB_K), PARAMETER :: REGULAR_GG_DICT_TYPE_E=40_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: REGULAR_LL_DICT_TYPE_E=45_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: HEALPIX_DICT_TYPE_E=60_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: SH_DICT_TYPE_E=50_JPIB_K
...
TYPE(MAP_INT64_HEALPIX_DICT_T)    :: SHARED_HEALPIX_DICT_MAP
TYPE(MAP_INT64_REDUCED_GG_DICT_T) :: SHARED_REDUCED_GG_DICT_MAP
TYPE(MAP_INT64_REGULAR_GG_DICT_T) :: SHARED_REGULAR_GG_DICT_MAP
TYPE(MAP_INT64_REGULAR_LL_DICT_T) :: SHARED_REGULAR_LL_DICT_MAP
...
PUBLIC :: SHARED_HEALPIX_DICT_MAP
PUBLIC :: SHARED_REDUCED_GG_DICT_MAP
PUBLIC :: SHARED_REGULAR_GG_DICT_MAP
PUBLIC :: SHARED_REGULAR_LL_DICT_MAP
...
PUBLIC :: FREE_HEALPIX_DICT
PUBLIC :: FREE_REDUCED_GG_DICT
PUBLIC :: FREE_REGULAR_GG_DICT
PUBLIC :: FREE_REGULAR_LL_DICT
PUBLIC :: FREE_SH_DICT
PUBLIC :: FREE_OPTIONS
...
PUBLIC :: EXTRACT_REGULAR_GG_DICTIONARY
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'FREE_HEALPIX_DICT'
PP_THREAD_SAFE FUNCTION FREE_HEALPIX_DICT( KEY, VALUE, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  INTEGER(KIND=C_LONG_LONG), POINTER, DIMENSION(:), INTENT(INOUT) :: KEY
  TYPE(HEALPIX_T), POINTER,                         INTENT(INOUT) :: VALUE
  TYPE(HOOKS_T),                                    INTENT(INOUT) :: HOOKS
  ...
  PP_DEBUG_CRITICAL_COND_THROW( .NOT.ASSOCIATED(KEY),   ERRFLAG_KEY_NOT_ASSOCIATED )
  PP_DEBUG_CRITICAL_COND_THROW( .NOT.ASSOCIATED(VALUE), ERRFLAG_DICTIONARY_NOT_ASSOCIATED )
  PP_DEBUG_CRITICAL_COND_THROW( KEY(1).NE.HEALPIX_DICT_TYPE_E, ERRFLAG_WRONG_HANDLE )
...
END FUNCTION FREE_HEALPIX_DICT
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'FREE_REGULAR_GG_DICT'
PP_THREAD_SAFE FUNCTION FREE_REGULAR_GG_DICT( KEY, VALUE, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  INTEGER(KIND=C_LONG_LONG), POINTER, DIMENSION(:), INTENT(INOUT) :: KEY
  TYPE(REGULAR_GG_T), POINTER,                      INTENT(INOUT) :: VALUE
  TYPE(HOOKS_T),                                    INTENT(INOUT) :: HOOKS
  ...
  PP_DEBUG_CRITICAL_COND_THROW( .NOT.ASSOCIATED(KEY),   ERRFLAG_KEY_NOT_ASSOCIATED )
  PP_DEBUG_CRITICAL_COND_THROW( .NOT.ASSOCIATED(VALUE), ERRFLAG_DICTIONARY_NOT_ASSOCIATED )
  PP_DEBUG_CRITICAL_COND_THROW( KEY(1).NE.REGULAR_GG_DICT_TYPE_E, ERRFLAG_WRONG_HANDLE )
...
END FUNCTION FREE_REGULAR_GG_DICT
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE

#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'FREE_REGULAR_LL_DICT'
PP_THREAD_SAFE FUNCTION FREE_REGULAR_LL_DICT( KEY, VALUE, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  INTEGER(KIND=C_LONG_LONG), POINTER, DIMENSION(:), INTENT(INOUT) :: KEY
  TYPE(REGULAR_LL_T), POINTER,                      INTENT(INOUT) :: VALUE
  TYPE(HOOKS_T),                                    INTENT(INOUT) :: HOOKS
  ...
  PP_DEBUG_CRITICAL_COND_THROW( .NOT.ASSOCIATED(KEY),   ERRFLAG_KEY_NOT_ASSOCIATED )
  PP_DEBUG_CRITICAL_COND_THROW( .NOT.ASSOCIATED(VALUE), ERRFLAG_DICTIONARY_NOT_ASSOCIATED )
  PP_DEBUG_CRITICAL_COND_THROW( KEY(1).NE.REGULAR_LL_DICT_TYPE_E, ERRFLAG_WRONG_HANDLE )
...
END FUNCTION FREE_REGULAR_LL_DICT
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
PP_THREAD_SAFE FUNCTION EXTRACT_HEALPIX_DICTIONARY( F_KEY, F_DICTIONARY, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  TYPE(HEALPIX_T), POINTER,                INTENT(OUT)   :: F_DICTIONARY
  TYPE(HOOKS_T),                           INTENT(INOUT) :: HOOKS
...
!$omp critical(API_ENCODER_MAP_GET)
  !> Check if the dictionary is already in the dictionarys map
  PP_TRYCALL(ERRFLAG_MAP_NOT_INITIALIZED) SHARED_HEALPIX_DICT_MAP%INITIALIZED( MAP_INITIALIZED, HOOKS )
  PP_DEBUG_CRITICAL_COND_THROW( .NOT. MAP_INITIALIZED, ERRFLAG_MAP_NOT_INITIALIZED )

  !> Check that the handle is a proper dictionary handle
  PP_DEBUG_CRITICAL_COND_THROW( F_KEY(1).NE.HEALPIX_DICT_TYPE_E, ERRFLAG_WRONG_HANDLE )

  !> Check if the handle is associated to an dictionary
  PP_TRYCALL(ERRFLAG_MATCH_DICTIONARY) SHARED_HEALPIX_DICT_MAP%HAS( F_KEY, MAP_HAS_DICTIONARY, HOOKS )
  PP_DEBUG_CRITICAL_COND_THROW( .NOT. MAP_HAS_DICTIONARY, ERRFLAG_MATCH_DICTIONARY )

  !> Get the dictionary from the map
  F_DICTIONARY => NULL()
  PP_TRYCALL(ERRFLAG_GET_DICTIONARY) SHARED_HEALPIX_DICT_MAP%GET( F_KEY, F_DICTIONARY, HOOKS )
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'EXTRACT_REGULAR_GG_DICTIONARY'
PP_THREAD_SAFE FUNCTION EXTRACT_REGULAR_GG_DICTIONARY( F_KEY, F_DICTIONARY, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  INTEGER(KIND=C_LONG_LONG), DIMENSION(2), INTENT(IN)    :: F_KEY
  TYPE(REGULAR_GG_T), POINTER,             INTENT(OUT)   :: F_DICTIONARY
  TYPE(HOOKS_T),                           INTENT(INOUT) :: HOOKS
...
!$omp critical(API_ENCODER_MAP_GET)
  !> Check if the dictionary is already in the dictionarys map
  PP_TRYCALL(ERRFLAG_MAP_NOT_INITIALIZED) SHARED_REGULAR_GG_DICT_MAP%INITIALIZED( MAP_INITIALIZED, HOOKS )
  PP_DEBUG_CRITICAL_COND_THROW( .NOT. MAP_INITIALIZED, ERRFLAG_MAP_NOT_INITIALIZED )

  !> Check that the handle is a proper dictionary handle
  PP_DEBUG_CRITICAL_COND_THROW( F_KEY(1).NE.REGULAR_GG_DICT_TYPE_E, ERRFLAG_WRONG_HANDLE )

  !> Check if the handle is associated to an dictionary
  PP_TRYCALL(ERRFLAG_MATCH_DICTIONARY) SHARED_REGULAR_GG_DICT_MAP%HAS( F_KEY, MAP_HAS_DICTIONARY, HOOKS )
  PP_DEBUG_CRITICAL_COND_THROW( .NOT. MAP_HAS_DICTIONARY, ERRFLAG_MATCH_DICTIONARY )

  !> Get the dictionary from the map
  F_DICTIONARY => NULL()
  PP_TRYCALL(ERRFLAG_GET_DICTIONARY) SHARED_REGULAR_GG_DICT_MAP%GET( F_KEY, F_DICTIONARY, HOOKS )
  PP_DEBUG_CRITICAL_COND_THROW( .NOT.ASSOCIATED(F_DICTIONARY), ERRFLAG_GET_DICTIONARY )
...
END FUNCTION EXTRACT_REGULAR_GG_DICTIONARY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE

#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'EXTRACT_REGULAR_LL_DICTIONARY'
PP_THREAD_SAFE FUNCTION EXTRACT_REGULAR_LL_DICTIONARY( F_KEY, F_DICTIONARY, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  INTEGER(KIND=C_LONG_LONG), DIMENSION(2), INTENT(IN)    :: F_KEY
  TYPE(REGULAR_LL_T), POINTER,             INTENT(OUT)   :: F_DICTIONARY
  TYPE(HOOKS_T),                           INTENT(INOUT) :: HOOKS
...
!$omp critical(API_ENCODER_MAP_GET)
  !> Check if the dictionary is already in the dictionarys map
  PP_TRYCALL(ERRFLAG_MAP_NOT_INITIALIZED) SHARED_REGULAR_LL_DICT_MAP%INITIALIZED( MAP_INITIALIZED, HOOKS )
  PP_DEBUG_CRITICAL_COND_THROW( .NOT. MAP_INITIALIZED, ERRFLAG_MAP_NOT_INITIALIZED )

  !> Check that the handle is a proper dictionary handle
  PP_DEBUG_CRITICAL_COND_THROW( F_KEY(1).NE.REGULAR_LL_DICT_TYPE_E, ERRFLAG_WRONG_HANDLE )

  !> Check if the handle is associated to an dictionary
  PP_TRYCALL(ERRFLAG_MATCH_DICTIONARY) SHARED_REGULAR_LL_DICT_MAP%HAS( F_KEY, MAP_HAS_DICTIONARY, HOOKS )
  PP_DEBUG_CRITICAL_COND_THROW( .NOT. MAP_HAS_DICTIONARY, ERRFLAG_MATCH_DICTIONARY )

  !> Get the dictionary from the map
  F_DICTIONARY => NULL()
  PP_TRYCALL(ERRFLAG_GET_DICTIONARY) SHARED_REGULAR_LL_DICT_MAP%GET( F_KEY, F_DICTIONARY, HOOKS )
  PP_DEBUG_CRITICAL_COND_THROW( .NOT.ASSOCIATED(F_DICTIONARY), ERRFLAG_GET_DICTIONARY )
