...
&     C_ENCODER_MTG2_PP, 1_JPIB_K, C_ENCODER_MTG2_P, HOOKS )
  ...
  !> Error handling
  PP_DEBUG_CRITICAL_COND_THROW( .NOT.C_ASSOCIATED(C_ENCODER_MTG2_P(1)), ERRFLAG_ENCODER_ALREADY_ASSOCIATED )
...
&        C_ENCODER_MTG2_P(1), F_ENCODER_CFG, F_ENCODER_OPTIONS, HOOKS )
    PP_DEBUG_CRITICAL_COND_THROW( C_ASSOCIATED(C_ENCODER_MTG2_P(1)), ERRFLAG_ENCODER_NOT_ASSOCIATED )
