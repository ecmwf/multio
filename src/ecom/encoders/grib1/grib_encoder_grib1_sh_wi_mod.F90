...
#define PP_FILE_NAME 'grib_encoder_grib1_sh_wi_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'GRIB_ENCODER_GRIB1_SH_WI_MOD'
...
CONTAINS
  ! Virtual procedures
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INITIALISE => ENCODER_GRIB1_SH_WI_INITIALISE
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ENCODE_ATM => ENCODER_GRIB1_SH_WI_ENCODE_ATM
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ENCODE_WAM => ENCODER_GRIB1_SH_WI_ENCODE_WAM
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: FINALISE   => ENCODER_GRIB1_SH_WI_FINALISE
END TYPE

! Name of the grib sample to be loaded
! CHARACTER(LEN=*), PARAMETER :: SAMPLE_NAME_GRIB1_SH_WI='sh_sfc'
CHARACTER(LEN=*), PARAMETER :: SAMPLE_NAME_GRIB1_SH_WI='multio-sh-sfc-grib1'

! Whitelist of public symbols
PUBLIC :: MAKE_GRIB1_SH_WI_ENCODER
PUBLIC :: DESTROY_GRIB1_SH_WI_ENCODER

CONTAINS


#define PP_PROCEDURE_TYPE 'SUBROUTINE'
#define PP_PROCEDURE_NAME 'MAKE_GRIB1_SH_WI_ENCODER'
SUBROUTINE MAKE_GRIB1_SH_WI_ENCODER( CFG, MODEL_PARAMS, METADATA_KIND, ENCODER, MIOH )
...
END SUBROUTINE MAKE_GRIB1_SH_WI_ENCODER
...
#define PP_PROCEDURE_TYPE 'SUBROUTINE'
#define PP_PROCEDURE_NAME 'DESTROY_GRIB1_SH_WI_ENCODER'
SUBROUTINE DESTROY_GRIB1_SH_WI_ENCODER( ENCODER )
...
END SUBROUTINE DESTROY_GRIB1_SH_WI_ENCODER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'SUBROUTINE'
#define PP_PROCEDURE_NAME 'ENCODER_GRIB1_SH_WI_INITIALISE'
SUBROUTINE ENCODER_GRIB1_SH_WI_INITIALISE( THIS, MODEL_PARAMS, METADATA_KIND, MIOH )
...
#define PP_PROCEDURE_NAME 'ENCODER_GRIB1_SH_WI_ENCODE_ATM'
FUNCTION ENCODER_GRIB1_SH_WI_ENCODE_ATM( THIS, MODEL_PARAMS, GRIB_INFO, &
...
END FUNCTION ENCODER_GRIB1_SH_WI_ENCODE_ATM
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'ENCODER_GRIB1_SH_WI_ENCODE_WAM'
FUNCTION ENCODER_GRIB1_SH_WI_ENCODE_WAM( THIS, MODEL_PARAMS, GRIB_INFO, &
& TIME_HIST, CURR_TIME, MSG, METADATA ) RESULT(EX)
...
END FUNCTION ENCODER_GRIB1_SH_WI_ENCODE_WAM
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'SUBROUTINE'
#define PP_PROCEDURE_NAME 'ENCODER_GRIB1_SH_WI_FINALISE'
...
END MODULE GRIB_ENCODER_GRIB1_SH_WI_MOD
