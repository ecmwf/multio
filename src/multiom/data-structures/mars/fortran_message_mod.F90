...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_IACTIVITY2CACTIVITY=9_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_IDATASET2CDATASET=10_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_IEXPERIMENT2CEXPERIMENT=11_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_IRESOLUTION2CRESOLUTION=12_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_DATE_TO_STRING=13_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TIME_TO_STRING=14_JPIB_K
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_IEXPERIMENT2CEXPERIMENT=11_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_IRESOLUTION2CRESOLUTION=12_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_OUT_OF_BOUNDS=13_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_ALLOCATE=14_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_DATE_TO_STRING=15_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TIME_TO_STRING=16_JPIB_K
