...
IMPLICIT NONE
  ...
  CASE (2)
    ...
    PP_TRYCALL(ERRFLAG_ALLOCATION_ERROR) G2S4_002_MAKE( GRIB2_SECTION4, HOOKS )
  ...
  CASE (12)
    ...
    PP_TRYCALL(ERRFLAG_ALLOCATION_ERROR) G2S4_012_ALLOCATE( GRIB2_SECTION4, HOOKS )
