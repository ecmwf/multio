!>
!> @file grib2_section4_icelayerabovewatersurface_mod.F90
!>
!> @brief Module for managing GRIB2 Section 4 level configuration operations.
!>
!> The `G2S4_ICELAYERABOVEWATERSURFACE_MOD` module contains procedures to initialize, allocate,
...
!>   - @see G2S4_ICELAYERABOVEWATERSURFACE_INIT
!>   - @see G2S4_ICELAYERABOVEWATERSURFACE_ALLOC
!>   - @see G2S4_ICELAYERABOVEWATERSURFACE_PRESET
!>   - @see G2S4_ICELAYERABOVEWATERSURFACE_RT
!>   - @see G2S4_ICELAYERABOVEWATERSURFACE_TBE
!>   - @see G2S4_ICELAYERABOVEWATERSURFACE_FREE
!>
...
#define PP_FILE_NAME 'grib2_section4_icelayerabovewatersurface_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'GRIB2_SECTION4_ICELAYERABOVEWATERSURFACE_MOD'
MODULE GRIB2_SECTION4_ICELAYERABOVEWATERSURFACE_MOD
...
!>
!> The `GRIB2_SECTION4_ICELAYERABOVEWATERSURFACE_T` type extends the base class `GRIB_SECTION_BASE_A` and
...
!> environments.
!>
TYPE, EXTENDS(GRIB_SECTION_BASE_A) :: GRIB2_SECTION4_ICELAYERABOVEWATERSURFACE_T
...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_CFG => G2S4_ICELAYERABOVEWATERSURFACE_INIT_CFG
  ...
  !> the GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_LAZY => G2S4_ICELAYERABOVEWATERSURFACE_INIT_LAZY
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ALLOCATE => G2S4_ICELAYERABOVEWATERSURFACE_ALLOC
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => G2S4_ICELAYERABOVEWATERSURFACE_PRESET
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => G2S4_ICELAYERABOVEWATERSURFACE_RT
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => G2S4_ICELAYERABOVEWATERSURFACE_TBE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: FREE => G2S4_ICELAYERABOVEWATERSURFACE_FREE
  ...
  !>
  PROCEDURE, PRIVATE, PASS, NON_OVERRIDABLE :: SET_LEVELS => G2S4_ICELAYERABOVEWATERSURFACE_SET_LEVELS
...
PUBLIC :: GRIB2_SECTION4_ICELAYERABOVEWATERSURFACE_T
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION4_ICELAYERABOVEWATERSURFACE_T` representing the GRIB section being initialized.
...
#define PP_PROCEDURE_NAME 'G2S4_ICELAYERABOVEWATERSURFACE_INIT_CFG'
PP_THREAD_SAFE FUNCTION G2S4_ICELAYERABOVEWATERSURFACE_INIT_CFG( THIS, &
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(GRIB2_SECTION4_ICELAYERABOVEWATERSURFACE_T),  INTENT(INOUT) :: THIS
  ...
  THIS%SUBTYPE_ = 'LEVEL'
  THIS%KIND_   = 'ICELAYERABOVEWATERSURFACE'
...
END FUNCTION G2S4_ICELAYERABOVEWATERSURFACE_INIT_CFG
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_ICELAYERABOVEWATERSURFACE_INIT_LAZY'
PP_THREAD_SAFE FUNCTION G2S4_ICELAYERABOVEWATERSURFACE_INIT_LAZY( THIS, &
...
END FUNCTION G2S4_ICELAYERABOVEWATERSURFACE_INIT_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION4_ICELAYERABOVEWATERSURFACE_T` representing the GRIB section to allocate resources for.
!>   @param [in]    MSG      All the mars keywords needed to describe the field `FORTRAN_MESSAGE_T`.
!>   @param [in]    PAR      All information outside mars keywords needed to describe the field `PARAMETRIZATION_T`.
!>   @param [in]    OPT      The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_ICELAYERABOVEWATERSURFACE_ALLOC'
PP_THREAD_SAFE FUNCTION G2S4_ICELAYERABOVEWATERSURFACE_ALLOC( THIS, &
...
END FUNCTION G2S4_ICELAYERABOVEWATERSURFACE_ALLOC
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION4_ICELAYERABOVEWATERSURFACE_T` representing the GRIB section to be preset.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_ICELAYERABOVEWATERSURFACE_PRESET'
PP_THREAD_SAFE FUNCTION G2S4_ICELAYERABOVEWATERSURFACE_PRESET( THIS, &
&  MSG, PAR, OPT,  METADATA, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_ICELAYERABOVEWATERSURFACE_PRESET
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS      An object of type `GRIB2_SECTION4_ICELAYERABOVEWATERSURFACE_T` representing the GRIB section for runlevel execution.
!>   @param [in]    MSG       The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR       The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_ICELAYERABOVEWATERSURFACE_RT'
PP_THREAD_SAFE FUNCTION G2S4_ICELAYERABOVEWATERSURFACE_RT( THIS, &
...
END FUNCTION G2S4_ICELAYERABOVEWATERSURFACE_RT
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS          An object of type `GRIB2_SECTION4_ICELAYERABOVEWATERSURFACE_T` representing the GRIB section being checked.
!>   @param [in]    MSG           The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR           The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
!>   @param [in]    TIME_HIST     The time history object of type `TIME_HISTORY_T` providing historical level data.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_ICELAYERABOVEWATERSURFACE_TBE'
PP_THREAD_SAFE FUNCTION G2S4_ICELAYERABOVEWATERSURFACE_TBE( THIS, &
...
END FUNCTION G2S4_ICELAYERABOVEWATERSURFACE_TBE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION4_ICELAYERABOVEWATERSURFACE_T` representing the GRIB section to be freed.
!>   @param [in]    OPT   The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_ICELAYERABOVEWATERSURFACE_FREE'
PP_THREAD_SAFE FUNCTION G2S4_ICELAYERABOVEWATERSURFACE_FREE( THIS, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_ICELAYERABOVEWATERSURFACE_FREE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_ICELAYERABOVEWATERSURFACE_SET_LEVELS'
PP_THREAD_SAFE FUNCTION G2S4_ICELAYERABOVEWATERSURFACE_SET_LEVELS( THIS, &
&  MSG, PAR, OPT, METADATA, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_ICELAYERABOVEWATERSURFACE_SET_LEVELS
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


END MODULE GRIB2_SECTION4_ICELAYERABOVEWATERSURFACE_MOD
