...
#define PP_FILE_NAME 'regular_ll_map_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'REGULAR_LL_MAP_MOD'
MODULE REGULAR_LL_MAP_MOD
...
TYPE :: REGULAR_LL_GEOM_NODE_T

  !> Key
  CHARACTER(LEN=8) :: KEY=REPEAT(' ', 8)

  !> Value
  TYPE(REGULAR_LL_GEOMETRY_T), POINTER :: GEOMETRY_ => NULL()
  ...
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER :: PARENT => NULL()

  !> Pointer to the lef subtree
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER :: LEFT   => NULL()

  !> Pointer to the right subtree
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER :: RIGHT  => NULL()

END TYPE


!> @brief Datatype used to to store the entire map
TYPE :: REGULAR_LL_GEOM_MAP_T

  !> Pointer to the class
  PRIVATE

  !> Pointer to the root node
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER :: ROOT => NULL()
...
TYPE(REGULAR_LL_GEOM_NODE_T), TARGET :: NIL

!> Whitelist of public symbols
PUBLIC :: REGULAR_LL_GEOM_MAP_T
PUBLIC :: REGULAR_LL_GEOMETRY_T
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER, INTENT(INOUT) :: ROOT
  CHARACTER(LEN=8),                      INTENT(IN)    :: KEY
  TYPE(REGULAR_LL_GEOMETRY_T), POINTER,  INTENT(IN)    :: GEOM
  ...
  ! Local variables
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER :: INSERTION_POINT
  LOGICAL :: FOUND
  LOGICAL :: KEY_LT
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER, INTENT(INOUT) :: CURRENT
  TYPE(HOOKS_T),                         INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(REGULAR_LL_GEOM_NODE_T),          INTENT(INOUT) :: THIS
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER, INTENT(IN)    :: PARENT
  CHARACTER(LEN=8),                      INTENT(IN)    :: KEY
  TYPE(REGULAR_LL_GEOMETRY_T), POINTER,  INTENT(IN)    :: GEOM
  TYPE(HOOKS_T),                         INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER, INTENT(INOUT) :: X
  TYPE(HOOKS_T),                         INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER, INTENT(INOUT) :: ROOT
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER, INTENT(INOUT) :: CUR
  TYPE(HOOKS_T),                         INTENT(INOUT) :: HOOKS
  ...
  ! Local variables
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER :: Y
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER :: X
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER, INTENT(INOUT) :: ROOT
  TYPE(REGULAR_LL_GEOM_NODE_T), TARGET,  INTENT(INOUT) :: X_
  TYPE(HOOKS_T),                         INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER, INTENT(IN)    :: X
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER, INTENT(IN)    :: X
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER, INTENT(OUT)   :: Y
  TYPE(HOOKS_T),                         INTENT(INOUT) :: HOOKS
  ...
  ! Local variables
  LOGICAL :: IS_LEAF
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER :: X_
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER, INTENT(INOUT) :: NODE_1
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER, INTENT(INOUT) :: NODE_2
  TYPE(HOOKS_T),                         INTENT(INOUT) :: HOOKS
  ...
  ! Local variables
  CHARACTER(LEN=8) :: KEY
  TYPE(REGULAR_LL_GEOMETRY_T), POINTER :: GEOM
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER, INTENT(INOUT) :: ROOT
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER, INTENT(INOUT) :: Z
  TYPE(HOOKS_T),                         INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Local variables
  LOGICAL :: IS_LEAF
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER :: W
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER, INTENT(IN)    :: ROOT
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER, INTENT(IN)    :: CURRENT
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(REGULAR_LL_GEOM_NODE_T), INTENT(INOUT) :: ROOT
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  CLASS(REGULAR_LL_GEOM_NODE_T), INTENT(INOUT) :: ROOT
  INTEGER(KIND=JPIB_K),          INTENT(IN)    :: UNIT
  TYPE(HOOKS_T),                 INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER, INTENT(INOUT) :: NODE
  ...
  ! Local variables
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER :: Y
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER :: PREV
  LOGICAL :: IS_LEAF
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  CLASS(REGULAR_LL_GEOM_MAP_T), INTENT(INOUT) :: ENCODERS_MAP
  TYPE(HOOKS_T),                INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Dummy arguments
  CLASS(REGULAR_LL_GEOM_MAP_T),         INTENT(INOUT) :: THIS
  CHARACTER(LEN=8),                     INTENT(IN)    :: KEY
  TYPE(REGULAR_LL_GEOMETRY_T), POINTER, INTENT(IN)    :: GEOM
  TYPE(HOOKS_T),                        INTENT(INOUT) :: HOOKS
...
IMPLICIT NONE
  ...
  ! Local variables
  LOGICAL :: ROOT_IS_LEAF
  TYPE(REGULAR_LL_GEOM_NODE_T), POINTER :: SEARCHED_NODE
...
IMPLICIT NONE
  ...
  CLASS(REGULAR_LL_GEOM_MAP_T),         INTENT(INOUT) :: THIS
  CHARACTER(LEN=8),                     INTENT(IN)    :: KEY
  TYPE(REGULAR_LL_GEOMETRY_T), POINTER, INTENT(OUT)   :: GEOM
  LOGICAL,                              INTENT(OUT)   :: LMATCH
  TYPE(HOOKS_T),                        INTENT(INOUT) :: HOOKS
