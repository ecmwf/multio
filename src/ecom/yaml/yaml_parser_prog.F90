...
IMPLICIT NONE
  ...
  CALL MATCH_TIME_ASSUMPTION_RULES( 75_JPIB_K, 4_JPIB_K, 1_JPIB_K, 0_JPIB_K, .FALSE., TIME_ASSUMPTIONS )

  CALL MATCH_TIME_ASSUMPTION_RULES( 75_JPIB_K, 4_JPIB_K, 1_JPIB_K, 0_JPIB_K, .TRUE., TIME_ASSUMPTIONS )

  CALL MATCH_TIME_ASSUMPTION_RULES( 76_JPIB_K, 4_JPIB_K, 1_JPIB_K, 0_JPIB_K, .FALSE., TIME_ASSUMPTIONS )
