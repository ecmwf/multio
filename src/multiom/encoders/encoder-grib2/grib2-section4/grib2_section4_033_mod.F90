!>
!> @file grib2_section4_033_mod.F90
!>
!> @brief Module for managing GRIB2 Section 4 operations.
!>
!> The `GRIB2_SECTION4_033_MOD` module contains procedures to initialize, allocate,
...
!>   - @see GRIB2_SECTION4_033_INIT
!>   - @see GRIB2_SECTION4_033_ALLOCATE
!>   - @see GRIB2_SECTION4_033_PRESET
!>   - @see GRIB2_SECTION4_033_RUNTIME
!>   - @see GRIB2_SECTION4_033_TO_BE_ENCODED
!>   - @see GRIB2_SECTION4_033_FREE
!>
...
#define PP_FILE_NAME 'grib2_section4_033_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'GRIB2_SECTION4_033_MOD'
MODULE GRIB2_SECTION4_033_MOD
...
!>
!> The `GRIB2_SECTION4_033_T` type extends the base class `GRIB_SECTION_BASE_A` and
...
!> environments.
!>
TYPE, EXTENDS(GRIB_SECTION_BASE_A) :: GRIB2_SECTION4_033_T
...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_CFG => GRIB2_SECTION4_033_INIT_CFG
  ...
  !> the GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_LAZY => GRIB2_SECTION4_033_INIT_LAZY
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ALLOCATE => GRIB2_SECTION4_033_ALLOCATE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => GRIB2_SECTION4_033_PRESET
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => GRIB2_SECTION4_033_RUNTIME
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => GRIB2_SECTION4_033_TO_BE_ENCODED
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: FREE => GRIB2_SECTION4_033_FREE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRINT => GRIB2_SECTION4_033_PRINT
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_TIME_CONFIGURATOR => GRIB2_SECTION4_033_BUILD_TIME_HANDLER
  ...
  !> This procedure allocates the proper time configurator
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_MODEL_CONFIGURATOR => GRIB2_SECTION4_033_BUILD_MODEL_HANDLER
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_ENSEMBLE_CONFIGURATOR => GRIB2_SECTION4_033_BUILD_ENSEMBLE_HANDLER
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_SATELLITE_CONFIGURATOR => GRIB2_SECTION4_033_BUILD_SATELLITE_HANDLER
...
PUBLIC :: G2S4_033_ALLOCATE

CONTAINS


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_033_ALLOCATE'
PP_THREAD_SAFE FUNCTION G2S4_033_ALLOCATE( GRIB_SECTION, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ALLOCATE( GRIB2_SECTION4_033_T::GRIB_SECTION, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
...
END FUNCTION G2S4_033_ALLOCATE
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION4_033_T` representing the GRIB section being initialized.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_033_INIT_CFG'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_033_INIT_CFG( THIS, &
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(GRIB2_SECTION4_033_T),  INTENT(INOUT) :: THIS
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_INIT_SATELLITE_HANDLER=4_JPIB_K
...
END FUNCTION GRIB2_SECTION4_033_INIT_CFG
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_033_INIT_LAZY'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_033_INIT_LAZY( THIS, &
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_BUILD_SATELLITE_CONFIGURATOR=4_JPIB_K
...
&  THIS%PARAMID_, THIS%TEMPLATE_NUMBER_, MSG, PAR, OPT, HOOKS )
  ...
  ! Build the ensemble configurator
...
END FUNCTION GRIB2_SECTION4_033_INIT_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION4_033_T` representing the GRIB section to allocate resources for.
!>   @param [in]    MSG      All the mars keywords needed to describe the field `FORTRAN_MESSAGE_T`.
!>   @param [in]    PAR      All information outside mars keywords needed to describe the field `PARAMETRIZATION_T`.
!>   @param [in]    OPT      The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_033_ALLOCATE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_033_ALLOCATE( THIS, &
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_ALLOCATE_SATELLITE=6_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PARAMID_CONFIGURATOR_NOT_ASSOCIATED=7_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_SATELLITE_CONFIGURATOR_NOT_ASSOCIATED=8_JPIB_K
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_ALLOCATE_ENSEMBLE=12_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_ENSEMBLE_CONFIGURATOR_NOT_ASSOCIATED=13_JPIB_K
...
END FUNCTION GRIB2_SECTION4_033_ALLOCATE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION4_033_T` representing the GRIB section to be preset.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_033_PRESET'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_033_PRESET( THIS, &
&  MSG, PAR, OPT,  METADATA, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PRESET_SATELLITE=6_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PARAMID_CONFIGURATOR_NOT_ASSOCIATED=7_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_SATELLITE_CONFIGURATOR_NOT_ASSOCIATED=8_JPIB_K
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PRESET_ENSEMBLE=11_JPIB_K
...
END FUNCTION GRIB2_SECTION4_033_PRESET
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS      An object of type `GRIB2_SECTION4_033_T` representing the GRIB section for runtime execution.
!>   @param [in]    MSG       The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR       The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_033_RUNTIME'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_033_RUNTIME( THIS, &
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_RUNTIME_SATELLITE=6_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PARAMID_CONFIGURATOR_NOT_ASSOCIATED=7_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_SATELLITE_CONFIGURATOR_NOT_ASSOCIATED=8_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TIME_CONFIGURATOR_NOT_ASSOCIATED=9_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_MODEL_CONFIGURATOR_NOT_ASSOCIATED=10_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_RUNTIME_ENSEMBLE=11_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_ENSEMBLE_CONFIGURATOR_NOT_ASSOCIATED=12_JPIB_K
...
END FUNCTION GRIB2_SECTION4_033_RUNTIME
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS          An object of type `GRIB2_SECTION4_033_T` representing the GRIB section being checked.
!>   @param [in]    MSG           The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR           The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
!>   @param [in]    TIME_HIST     The time history object of type `TIME_HISTORY_T` providing historical time data.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_033_TO_BE_ENCODED'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_033_TO_BE_ENCODED( THIS, &
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TO_BE_ENCODED_SATELLITE=6_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PARAMID_CONFIGURATOR_NOT_ASSOCIATED=7_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_SATELLITE_CONFIGURATOR_NOT_ASSOCIATED=8_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TIME_CONFIGURATOR_NOT_ASSOCIATED=9_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_MODEL_CONFIGURATOR_NOT_ASSOCIATED=10_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TO_BE_ENCODED_ENSEMBLE=11_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_ENSEMBLE_CONFIGURATOR_NOT_ASSOCIATED=12_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_TO_BE_ENCODED_SATELLITE) THIS%SATELLITE_%TO_BE_ENCODED(  MSG, PAR, TIME_HIST, CURR_TIME, OPT, TO_BE_ENCODED_SUBS(4), HOOKS )
...
END FUNCTION GRIB2_SECTION4_033_TO_BE_ENCODED
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION4_033_T` representing the GRIB section to be freed.
!>   @param [in]    OPT   The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_033_FREE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_033_FREE( THIS, OPT, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_DESTROY_INSTANT=2_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_DESTROY_PARAM=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_DESTROY_SATELLITE=4_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_SATELLITE_CONFIGURATOR_NOT_ASSOCIATED=6_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PARAMID_CONFIGURATOR_NOT_ASSOCIATED=7_JPIB_K
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_DESTROY_ENSEMBLE=10_JPIB_K
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_DESTROY_MODEL )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to destroy model' )
    CASE ( ERRFLAG_DESTROY_ENSEMBLE )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to destroy ensemble' )
...
END FUNCTION GRIB2_SECTION4_033_FREE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_033_PRINT'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_033_PRINT( THIS, &
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CALL_PRINT_SATELLITE=8_JPIB_K
...
&     '(', TRIM(ADJUSTL(THIS%KIND_)), '){'
  ...
  PP_TRYCALL(ERRFLAG_CALL_PRINT_SATELLITE) THIS%SATELLITE_%PRINT( UNIT, OFFSET+2, OPT, HOOKS, ', ...' )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_CALL_PRINT_SATELLITE)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'error calling print satellite' )
...
END FUNCTION GRIB2_SECTION4_033_PRINT
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @brief Builds the param handler for GRIB2 section 4, template 033.
!>
!> This function constructs the param handler for GRIB2 section 4, template 033,
...
!> @see GRIB2_SECTION4_033_ALLOCATE
!> @see GRIB2_SECTION4_033_PRESET
!> @see GRIB2_SECTION4_033_RUNPARAM
!> @see GRIB2_SECTION4_033_TO_BE_ENCODED
!> @see GRIB2_SECTION4_033_FREE
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_033_BUILD_PARAM_HANDLER'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_033_BUILD_PARAM_HANDLER( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_033_BUILD_PARAM_HANDLER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @brief Builds the satellite handler for GRIB2 section 4, template 033.
!>
!> This function constructs the satellite handler for GRIB2 section 4, template 033,
!> based on the provided configuration (`CFG`), options (`OPT`).
!> It modifies the `THIS` structure accordingly and returns an error code if the operation fails.
!> The function is thread-safe and uses preprocessor directives for debugging, logging, and tracing.
!>
...
!> @see GRIB2_SECTION4_033_ALLOCATE
!> @see GRIB2_SECTION4_033_PRESET
!> @see GRIB2_SECTION4_033_RUNSATELLITE
!> @see GRIB2_SECTION4_033_TO_BE_ENCODED
!> @see GRIB2_SECTION4_033_FREE
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_033_BUILD_SATELLITE_HANDLER'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_033_BUILD_SATELLITE_HANDLER( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_033_BUILD_SATELLITE_HANDLER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_033_BUILD_TIME_HANDLER'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_033_BUILD_TIME_HANDLER( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_033_BUILD_TIME_HANDLER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_033_BUILD_MODEL_HANDLER'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_033_BUILD_MODEL_HANDLER( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_033_BUILD_MODEL_HANDLER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_033_BUILD_ENSEMBLE_HANDLER'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_033_BUILD_ENSEMBLE_HANDLER( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_033_BUILD_ENSEMBLE_HANDLER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


END MODULE GRIB2_SECTION4_033_MOD
