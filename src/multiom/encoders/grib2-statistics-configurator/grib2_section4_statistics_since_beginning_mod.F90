...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_SECTION4_STATISTICS_SINCE_BEGINNING_INIT
...
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_STATISTICS_SINCE_BEGINNING_INIT'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_STATISTICS_SINCE_BEGINNING_INIT( THIS, &
...
END FUNCTION GRIB2_SECTION4_STATISTICS_SINCE_BEGINNING_INIT
...
&        MSG, PAR, OPT, TIME_SINCE_START, HOOKS )
  ...
  PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'startStep',  0_JPIB_K )
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_STATISTICS_SINCE_BEGINNING_FREE( THIS, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
