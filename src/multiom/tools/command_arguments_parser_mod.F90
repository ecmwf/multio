...
INTEGER(KIND=JPIB_K), PARAMETER :: ARG_STEP_E = 13_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: ARG_FREQUENCY_E = 14_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: ARG_DIRCTION_E = 15_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: ARG_FILTER_FILE_E = 16_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: ARG_USAGE_E = 17_JPIB_K
INTEGER(KIND=JPIB_K), PARAMETER :: ARG_LAST_E = 17_JPIB_K
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PARSE_OUTPUT_MANAGER_TYPE = 11_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PARSE_CONFIGURATION_FILE = 12_JPIB_K
...
IMPLICIT NONE
  ...
  IF ( INITIALIZED ) THEN
    PP_TRYCALL(ERRFLAG_MATCH) THIS%LEVTYPE_SET%MATCH( PREFIX, FOUND, HOOKS )
    IF ( THIS%MATCH_LEVTYPE ) THEN
      MATCH = MATCH .AND. FOUND
    ELSE
      MATCH = MATCH .AND. .NOT.FOUND
...
IMPLICIT NONE
  ...
  !PP_TRYCALL(ERRFLAG_READ_INTEGER_ARRAY) THIS%LEVTYPE_SET%LIST_WITH_FILTER( 6_JPIB_K, ' - levtype: ', RFILTER, HOOKS )
