...
IMPLICIT NONE
  ...
  PP_DEBUG_CRITICAL_COND_THROW( ASSOCIATED(THIS%HEAD) .NE. 0, ERRFLAG_ALREADY_INITIALIZED )
  PP_DEBUG_CRITICAL_COND_THROW( ASSOCIATED(THIS%TAIL) .NE. 0, ERRFLAG_ALREADY_INITIALIZED )
