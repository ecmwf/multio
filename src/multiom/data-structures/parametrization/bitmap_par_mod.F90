...
FUNCTION BITMAP_PAR_FREE( BITMAP_PAR, HOOKS ) RESULT(RET)
...
FUNCTION BITMAP_PAR_SET_VALUE_OF_MISSING_VALUES( BITMAP_PAR, VALUE, HOOKS ) RESULT(RET)
...
FUNCTION BITMAP_PAR_GET_VALUE_OF_MISSING_VALUES( BITMAP_PAR, VALUE, HOOKS ) RESULT(RET)
...
FUNCTION BITMAP_PAR_SET_NUMBER_OF_MISSING_VALUES( BITMAP_PAR, VALUE, HOOKS ) RESULT(RET)
...
FUNCTION BITMAP_PAR_GET_NUMBER_OF_MISSING_VALUES( BITMAP_PAR, VALUE, HOOKS ) RESULT(RET)
...
FUNCTION BITMAP_PAR_COPY_FROM( BITMAP_PAR_TO, BITMAP_PAR_FROM, HOOKS ) RESULT(RET)
...
FUNCTION READ_BITMAP_PAR_FROM_YAML( BITMAP_PAR, CONFIG, HOOKS ) RESULT(RET)
...
FUNCTION WRITE_BITMAP_PAR_TO_YAML( BITMAP_PAR, UNIT, OFFSET, HOOKS ) RESULT(RET)
