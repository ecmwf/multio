...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_INIT_DIRFREQ_HANDLER) THIS%BUILD_DIRFREQ_CONFIGURATOR( CFG, OPT, FACTORIES, HOOKS )
...
&  THIS%PARAMID_, THIS%TEMPLATE_NUMBER_, MSG, PAR, OPT, FACTORIES, HOOKS )
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_BUILD_DIRFREQ_CONFIGURATOR) FACTORIES%MAKE_GRIB2_DIRFREQ_CONFIGURATOR_LAZY( &
&  THIS%DIRFREQ_, THIS%TEMPLATE_NUMBER_, MSG, PAR, OPT, FACTORIES, HOOKS )
...
IMPLICIT NONE
  ...
  !> Make the indicator-section
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_DIRFREQ_CONFIGURATOR) FACTORIES%MAKE_GRIB2_DIRFREQ_CONFIGURATOR_CFG( &
&    THIS%DIRFREQ_, THIS%TEMPLATE_NUMBER_, DIRFREQ_CONFIGURATOR_CFG, OPT, FACTORIES, HOOKS )
