...
IMPLICIT NONE
  ...
  PP_DEBUG_CRITICAL_COND_THROW( VALUE%IS_ALLOCATED_, ERRFLAG_CFG_ALREADY_ALLOCATED )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_YAML_FILE_NOT_PRESENT)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'Unable to find the YAML file' )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'file: '//TRIM(ADJUSTL(YAML_FILE_NAME)) )
