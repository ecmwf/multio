...
#define PP_PROCEDURE_NAME 'GG_GEOMETRY_PRESET_GRIB2_WAM_S'
SUBROUTINE GG_GEOMETRY_PRESET_GRIB2_WAM_S( MODEL_PARAMS, METADATA )
...
END SUBROUTINE GG_GEOMETRY_PRESET_GRIB2_WAM_S
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
