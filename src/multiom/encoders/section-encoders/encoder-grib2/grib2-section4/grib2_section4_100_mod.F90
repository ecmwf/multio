!>
!> @file grib2_section4_100_mod.F90
!>
!> @brief Module for managing GRIB2 Section 4 operations.
!>
!> The `GRIB2_SECTION4_100_MOD` module contains procedures to initialize, allocate,
...
!>   - @see GRIB2_SECTION4_100_INIT
!>   - @see GRIB2_SECTION4_100_ALLOCATE
!>   - @see GRIB2_SECTION4_100_PRESET
!>   - @see GRIB2_SECTION4_100_RUNTIME
!>   - @see GRIB2_SECTION4_100_TO_BE_ENCODED
!>   - @see GRIB2_SECTION4_100_FREE
!>
...
#define PP_FILE_NAME 'grib2_section4_100_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'GRIB2_SECTION4_100_MOD'
MODULE GRIB2_SECTION4_100_MOD
...
!>
!> The `GRIB2_SECTION4_100_T` type extends the base class `GRIB_SECTION_BASE_A` and
...
!> environments.
!>
TYPE, EXTENDS(GRIB_SECTION_BASE_A) :: GRIB2_SECTION4_100_T

  !> Default symbols visibility
  PRIVATE

  !> Integer section number
  INTEGER(KIND=JPIB_K) :: TEMPLATE_NUMBER_ = 100_JPIB_K
  ...
  CLASS(GRIB_SECTION_BASE_A), POINTER :: DIRFREQ_ => NULL()
...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_CFG => GRIB2_SECTION4_100_INIT_CFG
  ...
  !> the GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_LAZY => GRIB2_SECTION4_100_INIT_LAZY
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ALLOCATE => GRIB2_SECTION4_100_ALLOCATE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => GRIB2_SECTION4_100_PRESET
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => GRIB2_SECTION4_100_RUNTIME
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => GRIB2_SECTION4_100_TO_BE_ENCODED
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: FREE => GRIB2_SECTION4_100_FREE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRINT => GRIB2_SECTION4_100_PRINT
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_TIME_CONFIGURATOR => GRIB2_SECTION4_100_BUILD_TIME_HANDLER
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_MODEL_CONFIGURATOR => GRIB2_SECTION4_100_BUILD_MODEL_HANDLER
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_PARAM_CONFIGURATOR => GRIB2_SECTION4_100_BUILD_PARAM_HANDLER
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_DIRFREQ_CONFIGURATOR => GRIB2_SECTION4_100_BUILD_FREQDIR_HANDLER
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_ENSEMBLE_CONFIGURATOR => GRIB2_SECTION4_100_BUILD_ENSEMBLE_HANDLER
...
PUBLIC :: G2S4_100_ALLOCATE

CONTAINS


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_100_ALLOCATE'
PP_THREAD_SAFE FUNCTION G2S4_100_ALLOCATE( GRIB_SECTION, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ALLOCATE( GRIB2_SECTION4_100_T::GRIB_SECTION, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
...
END FUNCTION G2S4_100_ALLOCATE
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION4_100_T` representing the GRIB section being initialized.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_100_INIT_CFG'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_100_INIT_CFG( THIS, &
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(GRIB2_SECTION4_100_T),  INTENT(INOUT) :: THIS
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_INIT_DIRFREQ_HANDLER=3_JPIB_K
  ...
  THIS%TEMPLATE_NUMBER_ = 100_JPIB_K
  THIS%TYPE_ = 'SECTION'
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_INIT_DIRFREQ_HANDLER) THIS%BUILD_DIRFREQ_CONFIGURATOR( CFG, OPT, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_UNABLE_TO_INIT_DIRFREQ_HANDLER )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to initialize dirfreq handler' )
...
END FUNCTION GRIB2_SECTION4_100_INIT_CFG
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_100_INIT_LAZY'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_100_INIT_LAZY( THIS, &
&               MSG, PAR, OPT, HOOKS ) RESULT(RET)
  ...
  USE :: GRIB2_SECTION4_DIRFREQ_FACTORY_MOD,       ONLY: MAKE_GRIB2_DIRFREQ_CONFIGURATOR
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_BUILD_DIRFREQ_CONFIGURATOR=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_BUILD_ENSEMBLE_CONFIGURATOR=4_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_BUILD_MODEL_CONFIGURATOR=5_JPIB_K
...
&  THIS%PARAMID_, THIS%TEMPLATE_NUMBER_, MSG, PAR, OPT, HOOKS )
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_BUILD_DIRFREQ_CONFIGURATOR) MAKE_GRIB2_DIRFREQ_CONFIGURATOR( &
&  THIS%DIRFREQ_, THIS%TEMPLATE_NUMBER_, MSG, PAR, OPT, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_UNABLE_TO_BUILD_DIRFREQ_CONFIGURATOR )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to build dirfreq configurator' )
...
END FUNCTION GRIB2_SECTION4_100_INIT_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION4_100_T` representing the GRIB section to allocate resources for.
!>   @param [in]    MSG      All the mars keywords needed to describe the field `FORTRAN_MESSAGE_T`.
!>   @param [in]    PAR      All information outside mars keywords needed to describe the field `PARAMETRIZATION_T`.
!>   @param [in]    OPT      The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_100_ALLOCATE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_100_ALLOCATE( THIS, &
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_ALLOCATE_DIRFREQ=5_JPIB_K
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_DIRFREQ_CONFIGURATOR_NOT_ASSOCIATED=8_JPIB_K
  ...
  PP_DEBUG_CRITICAL_COND_THROW( .NOT. ASSOCIATED(THIS%DIRFREQ_), ERRFLAG_DIRFREQ_CONFIGURATOR_NOT_ASSOCIATED )
  ...
  PP_TRYCALL(ERRFLAG_ALLOCATE_DIRFREQ) THIS%DIRFREQ_%ALLOCATE( MSG, PAR, OPT, METADATA, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_ALLOCATE_DIRFREQ )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to allocate dirfreq' )
    ...
    CASE ( ERRFLAG_DIRFREQ_CONFIGURATOR_NOT_ASSOCIATED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'dirfreq configurator not associated' )
...
END FUNCTION GRIB2_SECTION4_100_ALLOCATE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION4_100_T` representing the GRIB section to be preset.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_100_PRESET'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_100_PRESET( THIS, &
&  MSG, PAR, OPT,  METADATA, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PRESET_DIRFREQ=5_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_PRESET_DIRFREQ) THIS%DIRFREQ_%PRESET( MSG, PAR, OPT, METADATA, HOOKS )
...
END FUNCTION GRIB2_SECTION4_100_PRESET
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS      An object of type `GRIB2_SECTION4_100_T` representing the GRIB section for runtime execution.
!>   @param [in]    MSG       The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR       The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_100_RUNTIME'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_100_RUNTIME( THIS, &
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_RUNTIME_DIRFREQ=5_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_RUNTIME_DIRFREQ) THIS%DIRFREQ_%RUNTIME( MSG, PAR, TIME_HIST, CURR_TIME, OPT, METADATA, HOOKS )
...
END FUNCTION GRIB2_SECTION4_100_RUNTIME
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS          An object of type `GRIB2_SECTION4_100_T` representing the GRIB section being checked.
!>   @param [in]    MSG           The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR           The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
!>   @param [in]    TIME_HIST     The time history object of type `TIME_HISTORY_T` providing historical time data.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_100_TO_BE_ENCODED'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_100_TO_BE_ENCODED( THIS, &
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TO_BE_ENCODED_DIRFREQ=4_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_TO_BE_ENCODED_DIRFREQ) THIS%DIRFREQ_%TO_BE_ENCODED( MSG, PAR, TIME_HIST, CURR_TIME, OPT, TO_BE_ENCODED_SUBS(3), HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_TO_BE_ENCODED_DIRFREQ )
...
END FUNCTION GRIB2_SECTION4_100_TO_BE_ENCODED
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION4_100_T` representing the GRIB section to be freed.
!>   @param [in]    OPT   The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_100_FREE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_100_FREE( THIS, OPT, HOOKS ) RESULT(RET)
  ...
  USE :: GRIB2_SECTION4_DIRFREQ_FACTORY_MOD, ONLY: DESTROY_GRIB2_DIRFREQ_CONFIGURATOR
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_DESTROY_DIRFREQ=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_DESTROY_ENSEMBLE=4_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_DIRFREQ_CONFIGURATOR_NOT_ASSOCIATED=5_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PARAMID_CONFIGURATOR_NOT_ASSOCIATED=6_JPIB_K
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_DESTROY_MODEL=9_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_DESTROY_DIRFREQ)  DESTROY_GRIB2_DIRFREQ_CONFIGURATOR( THIS%DIRFREQ_, OPT, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_DESTROY_MODEL )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to model ensemble' )
    CASE ( ERRFLAG_TIME_CONFIGURATOR_NOT_ASSOCIATED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'time configurator not associated' )
    CASE ( ERRFLAG_MODEL_CONFIGURATOR_NOT_ASSOCIATED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'model configurator not associated' )
...
END FUNCTION GRIB2_SECTION4_100_FREE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_100_PRINT'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_100_PRINT( THIS, &
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K) :: WRITE_STAT
   ...
   ! Local error codes
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_PARAMID_CONFIGURATOR_NOT_ASSOCIATED=1_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_DIRFREQ_CONFIGURATOR_NOT_ASSOCIATED=2_JPIB_K
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CALL_PRINT_DIRFREQ=7_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CALL_PRINT_ENSEMBLE=8_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_MODEL_CONFIGURATOR_NOT_ASSOCIATED=9_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CALL_PRINT_MODEL=10_JPIB_K
...
&     '(', TRIM(ADJUSTL(THIS%KIND_)), '){'
  ...
  PP_TRYCALL(ERRFLAG_CALL_PRINT_DIRFREQ)  THIS%DIRFREQ_%PRINT( UNIT, OFFSET+2, OPT, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_PARAMID_CONFIGURATOR_NOT_ASSOCIATED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'paramId configurator not associated' )
    CASE ( ERRFLAG_DIRFREQ_CONFIGURATOR_NOT_ASSOCIATED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'directions/frequencies configurator not associated' )
    CASE ( ERRFLAG_ENSEMBLE_CONFIGURATOR_NOT_ASSOCIATED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'ensemble configurator not associated' )
    CASE ( ERRFLAG_MODEL_CONFIGURATOR_NOT_ASSOCIATED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'model configurator not associated' )
    ...
    CASE (ERRFLAG_CALL_PRINT_DIRFREQ)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'error calling print directions/frequencies' )
...
END FUNCTION GRIB2_SECTION4_100_PRINT
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @brief Builds the param handler for GRIB2 section 4, template 100.
!>
!> This function constructs the param handler for GRIB2 section 4, template 100,
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_100_BUILD_PARAM_HANDLER'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_100_BUILD_PARAM_HANDLER( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_100_BUILD_PARAM_HANDLER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_100_BUILD_FREQDIR_HANDLER'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_100_BUILD_FREQDIR_HANDLER( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Local variables
  LOGICAL :: HAS_DIRFREQ_CONFIGURATOR
  TYPE(YAML_CONFIGURATION_T) :: DIRFREQ_CONFIGURATOR_CFG

  !> Local parameters
  CHARACTER(LEN=*), PARAMETER :: DIRFREQ_CONFIGURATOR_NAME='directions-frequencies-configurator'

  ! Local error codes
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_DIRFREQ_CONFIGURATOR_ALREADY_ASSOCIATED=1_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_READ_CFG=2_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_DIRFREQ_CONFIGURATOR_CFG_NOT_PRESENT=3_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_READ_SUBCFG=4_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_MAKE_DIRFREQ_CONFIGURATOR=5_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_DEALLOCATE=6_JPIB_K
  ...
  !> Error handling
  PP_DEBUG_CRITICAL_COND_THROW( ASSOCIATED(THIS%DIRFREQ_), ERRFLAG_DIRFREQ_CONFIGURATOR_ALREADY_ASSOCIATED )

  !> Check if a configuration for the indicator-section is available
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_CFG) YAML_CONFIGURATION_HAS_KEY( CFG, DIRFREQ_CONFIGURATOR_NAME, HAS_DIRFREQ_CONFIGURATOR, HOOKS )
  PP_DEBUG_CRITICAL_COND_THROW( .NOT. HAS_DIRFREQ_CONFIGURATOR, ERRFLAG_DIRFREQ_CONFIGURATOR_CFG_NOT_PRESENT )

  !> Read the subconfiguration for the indicator-section
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_SUBCFG) YAML_GET_SUBCONFIGURATION( CFG, DIRFREQ_CONFIGURATOR_NAME, DIRFREQ_CONFIGURATOR_CFG, HOOKS )

  !> Make the indicator-section
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_DIRFREQ_CONFIGURATOR) MAKE_GRIB2_DIRFREQ_CONFIGURATOR( THIS%DIRFREQ_, THIS%TEMPLATE_NUMBER_, DIRFREQ_CONFIGURATOR_CFG, OPT, HOOKS )

  !> Deallocate the indicator-section configuration
  PP_TRYCALL( ERRFLAG_UNABLE_TO_DEALLOCATE ) YAML_DELETE_CONFIGURATION( DIRFREQ_CONFIGURATOR_CFG, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    ! Handle different errors
    SELECT CASE(ERRIDX)
    CASE ( ERRFLAG_DIRFREQ_CONFIGURATOR_ALREADY_ASSOCIATED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'param configurator already associated' )
    CASE ( ERRFLAG_UNABLE_TO_READ_CFG )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to read configuration' )
    CASE ( ERRFLAG_DIRFREQ_CONFIGURATOR_CFG_NOT_PRESENT )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'param configurator configuration not present' )
    CASE ( ERRFLAG_UNABLE_TO_READ_SUBCFG )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to read subconfiguration' )
    CASE ( ERRFLAG_UNABLE_TO_MAKE_DIRFREQ_CONFIGURATOR )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to make param configurator' )
    CASE ( ERRFLAG_UNABLE_TO_DEALLOCATE )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to deallocate param configurator object' )
    CASE DEFAULT
...
END FUNCTION GRIB2_SECTION4_100_BUILD_FREQDIR_HANDLER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_100_BUILD_ENSEMBLE_HANDLER'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_100_BUILD_ENSEMBLE_HANDLER( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_100_BUILD_ENSEMBLE_HANDLER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_100_BUILD_TIME_HANDLER'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_100_BUILD_TIME_HANDLER( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_100_BUILD_TIME_HANDLER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_100_BUILD_MODEL_HANDLER'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_100_BUILD_MODEL_HANDLER( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_100_BUILD_MODEL_HANDLER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE

END MODULE GRIB2_SECTION4_100_MOD
