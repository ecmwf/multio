!>
!> @file floatop_unary_op_mod.F90
!>
!> @brief Module containing definitions and procedures for unary_opeter operations.
!>
!> This module defines the `FLOATOP_UNARY_OP_T` type, along with its associated
...
#define PP_FILE_NAME 'floatop_unary_op_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'FLOATOP_UNARY_OP_MOD'
MODULE FLOATOP_UNARY_OP_MOD
...
!>
!> This derived type extends `FLOATOP_BASE_A` and is used for operationing based on unary_opeters.
...
!>
TYPE, EXTENDS(FLOATOP_BASE_A) :: FLOATOP_UNARY_OP_T
  ...
  !> First operand
  CLASS(FLOATOP_BASE_A), POINTER :: OPERAND_ => NULL()

CONTAINS

  !> @brief Initializes the operation unary_opeter type.
  !> @details This procedure sets up the `FLOATOP_UNARY_OP_T` type, initializing its components.
  !>
  !> @unary_op [in] this The instance of `FLOATOP_UNARY_OP_T` to initialize.
  PROCEDURE, NON_OVERRIDABLE, PUBLIC, PASS :: INIT  => FLOATOP_UNARY_OP_INIT
  PROCEDURE, NON_OVERRIDABLE, PUBLIC, PASS :: SET   => FLOATOP_UNARY_OP_SET_OPERAND
  PROCEDURE, NON_OVERRIDABLE, PUBLIC, PASS :: GET   => FLOATOP_UNARY_OP_GET_OPERAND
  ...
  !>
  !> @unary_op [in] this The instance of `FLOATOP_UNARY_OP_T`.
  PROCEDURE, NON_OVERRIDABLE, PUBLIC, PASS :: EVAL => FLOATOP_UNARY_OP_EVALUATE
  ...
  !>
  !> @unary_op [in] this The instance of `FLOATOP_UNARY_OP_T` to print.
  PROCEDURE, NON_OVERRIDABLE, PUBLIC, PASS :: PRINT => FLOATOP_UNARY_OP_PRINT

  !> @brief Frees resources allocated for the operation.
  !> @details Cleans up the `FLOATOP_UNARY_OP_T` type, deallocating any resources used by the operation.
  !>
  !> @unary_op [in] this The instance of `FLOATOP_UNARY_OP_T` to free.
  PROCEDURE, NON_OVERRIDABLE, PUBLIC, PASS :: FREE  => FLOATOP_UNARY_OP_FREE
...
PUBLIC :: FLOATOP_UNARY_OP_T

CONTAINS


!>
!> @brief Initializes the `FLOATOP_UNARY_OP_T` operation from a YAML configuration.
!>
!> This function initializes the `FLOATOP_UNARY_OP_T` type based on the provided YAML
...
!>
!> @unary_op [inout] THIS The operation object (`FLOATOP_UNARY_OP_T`) that will be initialized.
...
#define PP_PROCEDURE_NAME 'FLOATOP_UNARY_OP_INIT'
FUNCTION FLOATOP_UNARY_OP_INIT( THIS, CFG, HOOKS ) RESULT(RET)

  !> Symbols imported from other modules within the project.
  USE :: DATAKINDS_DEF_MOD,     ONLY: JPIB_K
  USE :: YAML_CORE_UTILS_MOD,   ONLY: YAML_CONFIGURATION_T
  USE :: HOOKS_MOD,             ONLY: HOOKS_T
  USE :: ENUMERATORS_MOD,       ONLY: CFLOATOPUNARY2IFLOATOPUNARY
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(FLOATOP_UNARY_OP_T),   INTENT(INOUT) :: THIS
  ...
  !> Local variables
  PROCEDURE(FUN_C2I_IF), POINTER :: P_CFLOATOPUNARY2IFLOATOPUNARY
  ...
  P_CFLOATOPUNARY2IFLOATOPUNARY => CFLOATOPUNARY2IFLOATOPUNARY
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_OPERATION) YAML_READ_INTEGER_WITH_FILTER( CFG, 'operation', THIS%UNARY_OP_TYPE_, P_CFLOATOPUNARY2IFLOATOPUNARY, HOOKS )
...
END FUNCTION FLOATOP_UNARY_OP_INIT
...
!>
!> @unary_op [inout] THIS  The operation object (`FLOATOP_UNARY_OP_T`) used for matching.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'FLOATOP_UNARY_OP_EVALUATE'
FUNCTION FLOATOP_UNARY_OP_EVALUATE( THIS, MSG, PAR, RESULT, HOOKS ) RESULT(RET)
  ...
  USE :: HOOKS_MOD,           ONLY: HOOKS_T
  USE :: ENUMERATORS_MOD,     ONLY: FLOATOP_UNARY_NEG_E
...
END FUNCTION FLOATOP_UNARY_OP_EVALUATE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'FLOATOP_UNARY_OP_SET_OPERAND'
FUNCTION FLOATOP_UNARY_OP_SET_OPERAND( THIS, OPERAND, HOOKS ) RESULT(RET)
...
END FUNCTION FLOATOP_UNARY_OP_SET_OPERAND
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'FLOATOP_UNARY_OP_GET_OPERAND'
FUNCTION FLOATOP_UNARY_OP_GET_OPERAND( THIS, OPERAND, HOOKS ) RESULT(RET)
...
END FUNCTION FLOATOP_UNARY_OP_GET_OPERAND
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @unary_op [inout] THIS    The operation object (`FLOATOP_UNARY_OP_T`) whose details are to be printed.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'FLOATOP_UNARY_OP_PRINT'
FUNCTION FLOATOP_UNARY_OP_PRINT( THIS, UNIT, OFFSET, HOOKS, SEPARATOR ) RESULT(RET)

  !> Symbols imported from other modules within the project.
  USE :: DATAKINDS_DEF_MOD, ONLY: JPIB_K
  USE :: HOOKS_MOD,         ONLY: HOOKS_T
  USE :: ENUMERATORS_MOD,   ONLY: IFLOATOPUNARY2CFLOATOPUNARY
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_CONVERT_OPERATION) IFLOATOPUNARY2CFLOATOPUNARY( THIS%UNARY_OP_TYPE_, FLOATOP_TYPE_STR, HOOKS )

  !> Print the unary_op operation
  WRITE(UNIT,'(A)') REPEAT(' ',OFFSET)//'unary_op::'//TRIM(ADJUSTL(FLOATOP_TYPE_STR))//'('
...
END FUNCTION FLOATOP_UNARY_OP_PRINT
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @unary_op [inout] THIS   The operation object (`FLOATOP_UNARY_OP_T`) whose resources are to be freed.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'FLOATOP_UNARY_OP_FREE'
FUNCTION FLOATOP_UNARY_OP_FREE( THIS, HOOKS ) RESULT(RET)
...
END FUNCTION FLOATOP_UNARY_OP_FREE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE

END MODULE FLOATOP_UNARY_OP_MOD
