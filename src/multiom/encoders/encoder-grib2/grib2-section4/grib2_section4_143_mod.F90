...
PP_THREAD_SAFE FUNCTION G2S4_143_FREE( THIS, OPT, DESTRUCTORS, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_DESTROY_RANDOM_PATTERNS) DESTRUCTORS%DESTROY_GRIB2_RANDOM_PATTERNS_CONFIGURATOR( THIS%RANDOM_PATTERNS_, OPT, DESTRUCTORS, HOOKS )
