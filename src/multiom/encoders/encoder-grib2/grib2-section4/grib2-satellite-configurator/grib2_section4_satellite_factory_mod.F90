...
PP_THREAD_SAFE FUNCTION DESTROY_GRIB2_SATELLITE_CONFIGURATOR( GRIB2_SATELLITE_CONFIGURATOR, OPT, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Free the section
  PP_TRYCALL(ERRFLAG_FREE_ERROR)  GRIB2_SATELLITE_CONFIGURATOR%FREE( OPT, HOOKS )
