!>
!> @file G2S4_060_mod.F90
!>
!> @brief Module for managing GRIB2 Section 4 operations.
!>
!> The `G2S4_060_MOD` module contains procedures to initialize, allocate,
...
!>   - @see G2S4_060_INIT
!>   - @see G2S4_060_ALLOCATE
!>   - @see G2S4_060_PRESET
!>   - @see G2S4_060_RUNTIME
!>   - @see G2S4_060_TO_BE_ENCODED
!>   - @see G2S4_060_FREE
!>
...
#define PP_FILE_NAME 'grib2_section4_060_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'GRIB2_SECTION4_060_MOD'
MODULE GRIB2_SECTION4_060_MOD
...
CHARACTER(LEN=*), PARAMETER :: G2S4_060_NAME = 'g2s4::060'

!>
!> @brief Type definition for GRIB2 Section 4 handler.
!>
!> The `G2S4_060_T` type extends the base class `GRIB_SECTION_BASE_A` and
...
!> environments.
!>
TYPE, EXTENDS(GRIB_SECTION_BASE_A) :: G2S4_060_T

  !> Default symbols visibility
  PRIVATE

  !> Integer section number
  INTEGER(KIND=JPIB_K) :: TEMPLATE_NUMBER_ = 60_JPIB_K
...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_CFG => G2S4_060_INIT_CFG
  ...
  !> the GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_LAZY => G2S4_060_INIT_LAZY
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ALLOCATE => G2S4_060_ALLOCATE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => G2S4_060_PRESET
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => G2S4_060_RUNTIME
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => G2S4_060_TO_BE_ENCODED
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: FREE => G2S4_060_FREE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRINT => G2S4_060_PRINT
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_MODEL_CONFIGURATOR_CFG => G2S4_060_BUILD_MODEL_HANDLER_CFG
  ...
  !> This procedure allocates the proper time configurator
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_TIME_CONFIGURATOR_CFG => G2S4_060_BUILD_TIME_HANDLER_CFG
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_PARAM_CONFIGURATOR_CFG => G2S4_060_BUILD_PARAM_HANDLER_CFG
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_LEVEL_CONFIGURATOR_CFG => G2S4_060_BUILD_LEVEL_HANDLER_CFG
  ...
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_ENSEMBLE_CONFIGURATOR_CFG => G2S4_060_BUILD_ENSEMBLE_HANDLER_CFG
  ...
  !> This procedure allocates the proper param configurator
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_PARAM_CONFIGURATOR_LAZY => G2S4_060_BUILD_PARAM_HANDLER_LAZY
  ...
  !> This procedure allocates the proper level configurator
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_LEVEL_CONFIGURATOR_LAZY => G2S4_060_BUILD_LEVEL_HANDLER_LAZY
  ...
  !> This procedure allocates the proper time configurator
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_TIME_CONFIGURATOR_LAZY => G2S4_060_BUILD_TIME_HANDLER_LAZY
  ...
  !> This procedure allocates the proper time configurator
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_MODEL_CONFIGURATOR_LAZY => G2S4_060_BUILD_MODEL_HANDLER_LAZY
  ...
  !> This procedure allocates the proper ensemble configurator
  !>
  PROCEDURE, PRIVATE, PASS :: BUILD_ENSEMBLE_CONFIGURATOR_LAZY => G2S4_060_BUILD_ENSEMBLE_HANDLER_LAZY
...
PUBLIC :: G2S4_060_MAKE
PUBLIC :: G2S4_060_REGISTER
PUBLIC :: G2S4_060_DESTROY

CONTAINS


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_060_REGISTER'
PP_THREAD_SAFE FUNCTION G2S4_060_REGISTER( IDX ) BIND(C, NAME='g2s4_060_register') RESULT(RET)
...
!$omp single
  ...
  IF ( ASSOCIATED(HOOKS) ) THEN
    ...
    PP_TRYCALL(ERRFLAG_UNABLE_TO_REGISTER) REG%REGISTER( G2S4_060_NAME, FA, FD, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_UNABLE_TO_REGISTER )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to register section: '//TRIM(ADJUSTL(G2S4_060_NAME)) )
...
END FUNCTION G2S4_060_REGISTER
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_060_MAKE'
PP_THREAD_SAFE FUNCTION G2S4_060_MAKE( GRIB_SECTION, HOOKS ) RESULT(RET)
...
!$omp critical(G2S4_ALLOCATE)
  ALLOCATE( G2S4_060_T::GRIB_SECTION, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_060_DESTROY'
PP_THREAD_SAFE FUNCTION G2S4_060_DESTROY( GRIB_SECTION, HOOKS ) RESULT(RET)
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `G2S4_060_T` representing the GRIB section being initialized.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_060_INIT_CFG'
PP_THREAD_SAFE FUNCTION G2S4_060_INIT_CFG( THIS, &
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(G2S4_060_T),            INTENT(INOUT) :: THIS
  ...
  THIS%TEMPLATE_NUMBER_ = 60_JPIB_K
  THIS%TYPE_ = 'SECTION'
...
END FUNCTION G2S4_060_INIT_CFG
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_060_INIT_LAZY'
PP_THREAD_SAFE FUNCTION G2S4_060_INIT_LAZY( THIS, &
...
&  THIS%ENSEMBLE_, THIS%TEMPLATE_NUMBER_, MSG, PAR, OPT, HOOKS )
...
END FUNCTION G2S4_060_INIT_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `G2S4_060_T` representing the GRIB section to allocate resources for.
!>   @param [in]    MSG      All the mars keywords needed to describe the field `FORTRAN_MESSAGE_T`.
!>   @param [in]    PAR      All information outside mars keywords needed to describe the field `PARAMETRIZATION_T`.
!>   @param [in]    OPT      The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_060_ALLOCATE'
PP_THREAD_SAFE FUNCTION G2S4_060_ALLOCATE( THIS, &
...
IMPLICIT NONE
  ...
  If(ASSOCIATED(THIS%LEVEL_)) THEN
...
END FUNCTION G2S4_060_ALLOCATE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `G2S4_060_T` representing the GRIB section to be preset.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_060_PRESET'
PP_THREAD_SAFE FUNCTION G2S4_060_PRESET( THIS, &
&  MSG, PAR, OPT,  METADATA, HOOKS ) RESULT(RET)
...
!>
!> @section interface
!>   @param [in]    THIS      An object of type `G2S4_060_T` representing the GRIB section for runtime execution.
!>   @param [in]    MSG       The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR       The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_060_RUNTIME'
PP_THREAD_SAFE FUNCTION G2S4_060_RUNTIME( THIS, &
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_TIME_CONFIGURATOR_NOT_ASSOCIATED=10_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_MODEL_CONFIGURATOR_NOT_ASSOCIATED=11_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_CONVERT_DATETIME=12_JPIB_K
  ...
  ! Set mars.date and mars.time in model version - in section1 mars.date is set instead
  PP_TRYCALL(ERRFLAG_UNABLE_TO_CONVERT_DATETIME) YYYYMMDD_HHMMSS_TO_DATETIME( MSG%DATE, MSG%TIME, DATE_TIME, HOOKS )
  PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'YearOfModelVersion',   DATE_TIME(1) )
  PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'MonthOfModelVersion',  DATE_TIME(2) )
  PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'DayOfModelVersion',    DATE_TIME(3) )
  PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'HourOfModelVersion',   DATE_TIME(4) )
  PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'MinuteOfModelVersion', DATE_TIME(5) )
  PP_METADATA_SET( METADATA, ERRFLAG_METADATA, 'SecondOfModelVersion', DATE_TIME(6) )
...
!>
!> @section interface
!>   @param [inout] THIS          An object of type `G2S4_060_T` representing the GRIB section being checked.
!>   @param [in]    MSG           The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR           The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
!>   @param [in]    TIME_HIST     The time history object of type `TIME_HISTORY_T` providing historical time data.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_060_TO_BE_ENCODED'
PP_THREAD_SAFE FUNCTION G2S4_060_TO_BE_ENCODED( THIS, &
...
END FUNCTION G2S4_060_TO_BE_ENCODED
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `G2S4_060_T` representing the GRIB section to be freed.
!>   @param [in]    OPT   The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_060_FREE'
PP_THREAD_SAFE FUNCTION G2S4_060_FREE( THIS, OPT, HOOKS ) RESULT(RET)
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_060_PRINT'
PP_THREAD_SAFE FUNCTION G2S4_060_PRINT( THIS, &
...
!>
!> @brief Builds the param handler for GRIB2 section 4, template 060.
!>
!> This function constructs the param handler for GRIB2 section 4, template 060,
...
!> @see G2S4_060_ALLOCATE
!> @see G2S4_060_PRESET
!> @see G2S4_060_RUNPARAM
!> @see G2S4_060_TO_BE_ENCODED
!> @see G2S4_060_FREE
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_060_BUILD_PARAM_HANDLER_CFG'
PP_THREAD_SAFE FUNCTION G2S4_060_BUILD_PARAM_HANDLER_CFG( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_060_BUILD_PARAM_HANDLER_CFG
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_060_BUILD_PARAM_HANDLER_LAZY'
PP_THREAD_SAFE FUNCTION G2S4_060_BUILD_PARAM_HANDLER_LAZY( THIS, &
&               MSG, PAR, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_060_BUILD_PARAM_HANDLER_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


!>
!> @brief Builds the level handler for GRIB2 section 4, template 060.
!>
!> This function constructs the level handler for GRIB2 section 4, template 060,
!> based on the provided configuration (`CFG`), options (`OPT`).
!> It modifies the `THIS` structure accordingly and returns an error code if the operation fails.
!> The function is thread-safe and uses preprocessor directives for debugging, logging, and tracing.
!>
...
!> @see G2S4_060_ALLOCATE
!> @see G2S4_060_PRESET
!> @see G2S4_060_RUNLEVEL
!> @see G2S4_060_TO_BE_ENCODED
!> @see G2S4_060_FREE
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_060_BUILD_LEVEL_HANDLER_CFG'
PP_THREAD_SAFE FUNCTION G2S4_060_BUILD_LEVEL_HANDLER_CFG( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_060_BUILD_LEVEL_HANDLER_CFG
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_060_BUILD_LEVEL_HANDLER_LAZY'
PP_THREAD_SAFE FUNCTION G2S4_060_BUILD_LEVEL_HANDLER_LAZY( THIS, &
&               MSG, PAR, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_060_BUILD_LEVEL_HANDLER_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_060_BUILD_ENSEMBLE_HANDLER_CFG'
PP_THREAD_SAFE FUNCTION G2S4_060_BUILD_ENSEMBLE_HANDLER_CFG( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_060_BUILD_ENSEMBLE_HANDLER_CFG
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_060_BUILD_ENSEMBLE_HANDLER_LAZY'
PP_THREAD_SAFE FUNCTION G2S4_060_BUILD_ENSEMBLE_HANDLER_LAZY( THIS, &
&               MSG, PAR, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_060_BUILD_ENSEMBLE_HANDLER_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE

#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_060_BUILD_TIME_HANDLER_CFG'
PP_THREAD_SAFE FUNCTION G2S4_060_BUILD_TIME_HANDLER_CFG( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_060_BUILD_TIME_HANDLER_CFG
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_060_BUILD_TIME_HANDLER_LAZY'
PP_THREAD_SAFE FUNCTION G2S4_060_BUILD_TIME_HANDLER_LAZY( THIS, &
&               MSG, PAR, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_060_BUILD_TIME_HANDLER_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_060_BUILD_MODEL_HANDLER_CFG'
PP_THREAD_SAFE FUNCTION G2S4_060_BUILD_MODEL_HANDLER_CFG( THIS, &
&               CFG, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_060_BUILD_MODEL_HANDLER_CFG
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'G2S4_060_BUILD_MODEL_HANDLER_LAZY'
PP_THREAD_SAFE FUNCTION G2S4_060_BUILD_MODEL_HANDLER_LAZY( THIS, &
&               MSG, PAR, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION G2S4_060_BUILD_MODEL_HANDLER_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


END MODULE GRIB2_SECTION4_060_MOD
