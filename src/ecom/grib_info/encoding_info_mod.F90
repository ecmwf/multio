...
SUBROUTINE ENCODING_INFO_ACCESS_OR_CREATE( MODEL_PARAMS, PARAM_ID, PREFIX, REPRES, LEVEL, STEP, GRIB_INFO, TIME_HIST )
  ...
  USE :: YAML_TIME_ASSUMPTIONS_MOD, ONLY: MATCH_TIME_ASSUMPTION_RULES
...
IMPLICIT NONE
  ...
  ELSE
    ...
    CALL MATCH_TIME_ASSUMPTION_RULES( PARAM_ID, LEV_TYPE, REPRES, LEVEL, IS_ENSAMBLE_SIMULATION( MODEL_PARAMS ), TIME_ASSUMPTIONS )
