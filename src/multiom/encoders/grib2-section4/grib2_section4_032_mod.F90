...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_SECTION4_032_INIT
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_032_INIT'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_032_INIT( THIS, &
...
END FUNCTION GRIB2_SECTION4_032_INIT
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
