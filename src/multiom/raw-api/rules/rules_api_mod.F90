...
&   C_RULE_PP, 1_JPIB_K, C_RULE_P, HOOKS )
  ...
  !> Error handling
  PP_DEBUG_CRITICAL_COND_THROW( C_ASSOCIATED(C_TAG_P(1)), ERRFLAG_TAG_ALREADY_ASSOCIATED )
  PP_DEBUG_CRITICAL_COND_THROW( C_ASSOCIATED(C_NAME_P(1)), ERRFLAG_NAME_ALREADY_ASSOCIATED )
  PP_DEBUG_CRITICAL_COND_THROW( C_ASSOCIATED(C_SAMPLE_NAME_P(1)), ERRFLAG_SAMPLE_NAME_ALREADY_ASSOCIATED )
  PP_DEBUG_CRITICAL_COND_THROW( C_ASSOCIATED(C_RULE_P(1)), ERRFLAG_RULE_ALREADY_ASSOCIATED )
